...
* `action` possible values:
  ...
  * `incoming_rich_message_postback` - triggers on action
    [link to change](../agent-chat-api/#incoming-rich-message-postback),
  ...
  * `last_seen_timestamp_updated` - triggers on action
    [agent-chat-api push](../agent-chat-api/#last-seen-timestamp-updated),
    available filters for the action: `chat_properties` and `chat_member_ids`
  * `thread_closed` - triggers on action
    [agent-chat-api push](../agent-chat-api/#thread-closed),
    available filters for the action: `chat_properties`, `thread_properties` and `chat_member_ids`
  * `chat_scopes_updated` - triggers on action
    [agent-chat-api push](../agent-chat-api/#chat-scopes-updated),
    available filters for the action: `chat_properties` and `chat_member_ids`
  * `chat_properties_updated` - triggers on action
    [agent-chat-api push](../agent-chat-api/#chat-properties-updated),
    available filters for the action: `chat_properties` and `chat_member_ids`
  * `chat_thread_properties_updated` - triggers on action
    [agent-chat-api push](../agent-chat-api/#chat-thread-properties-updated),
    available filters for the action: `chat_properties` and `chat_member_ids`
  * `chat_user_added` - triggers on action
    [agent-chat-api push](../agent-chat-api/#chat-user-added),
    available filters for the action: `chat_properties` and `chat_member_ids`
  * `chat_user_removed` - triggers on action
    [agent-chat-api push](../agent-chat-api/#chat-user-removed),
    available filters for the action: `chat_properties` and `chat_member_ids`
...
* [`incoming_chat_thread`](../agent-chat-api/#incoming-chat-thread)
* [`incoming_event`](../agent-chat-api/#incoming-event)
* [`last_seen_timestamp_updated`](../agent-chat-api/#last-seen-timestamp-updated)
* [`thread_closed`](../agent-chat-api/#thread-closed)
* [`chat_scopes_updated`](../agent-chat-api/#chat-scopes-updated)
* [`chat_properties_updated`](../agent-chat-api/#chat-properties-updated)
* [`chat_thread_properties_updated`](../agent-chat-api/#chat-thread-properties-updated)
* [`chat_user_added`](../agent-chat-api/#chat-user-added)
* [`chat_user_removed`](../agent-chat-api/#chat-chat-user-removed)
...
Note: for more information about properties see [Properties Guide](../apis-overview/#properties)
