...
| sendMessage    | Sends a message. More information about message format you can find [here](https://developers.livechatinc.com/beta-docs/customer-sdk/#sendmessage).                                                                            |
| rateChat       | Enables chat ratings. More info [here](https://developers.livechatinc.com/beta-docs/customer-sdk/#ratechat).                                                                                                                   |
| setSneakPeek   | Enables sneak peeks to see what the visitor is typing in before they actually send the message. More info [here](https://developers.livechatinc.com/beta-docs/customer-sdk/#setsneakpeek).                                     |
| getVisitorData | Collects the visitor information. More info [here](https://developers.livechatinc.com/beta-docs/customer-sdk/#getvisitordata).                                                                                                 |
| setVisitorData | Set the visitor information. More info [here](https://developers.livechatinc.com/beta-docs/customer-sdk/#setvisitordata).                                                                                                      |
| getTicketForm  | Get ticket form fields configured in chat window settings section in agent app.                                                                                                                               |
| sendTicketForm | Send ticket form filled in by visitor. Ticket form should be rendered using fields fetched by getTicketForm method. More info [here](https://developers.livechatinc.com/beta-docs/customer-sdk/#sendticketform).               |
