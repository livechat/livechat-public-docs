...
This document describes the **LiveChat Reports API v3.2**, which is a legacy version. For production-ready applications, it's best to use to the current stable version. [Read more about versioning...](/data-reporting/#api-versioning)
