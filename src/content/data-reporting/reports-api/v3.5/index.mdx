...
This document describes the **LiveChat Reports API v3.5**. This is the developer preview version that provides a preview of the upcoming changes to the API. **It's not open to public use.** However, if you want to test some features, contact us at developers@livechat.com or <OpenChatLink>ask on the chat</OpenChatLink>, and we'll give you access. [Read more about versioning...](/data-reporting/#api-versioning)
