...
To find out more about resource limits and the possibilities to change them, <OpenChatLink><button style={{ background: 'none!important',
border: 'none',
padding: '0!important',
color: '#2200FF',
textDecoration: 'none',
cursor: 'pointer'}} >contact our support</button></OpenChatLink>.
