...
Bots are authorized with the use of the [agent token](/authorization/agent-authorization/). Using bots requires sending the `X-Author-Id` header for the Web API and the `author_id` property for the RTM API.
