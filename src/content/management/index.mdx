...
|                 |                                                                                                                                                                                                                                                                                  |
| --------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **dev preview** | It gives a preview of the features that are currently in development. **It's subject to change and comes with limited access**. Contact us at developers@livechat.com or <OpenChatLink>ask on the chat</OpenChatLink> to get access. Lasts for ~6-7 months. |
