...
For backend applications, you can specify the region in the request header. The mechanism is the same as in [Customer Chat Web API reference](/messaging/customer-chat-api/v3.5/#data-centers). It doesn't work for frontend applications, though.
