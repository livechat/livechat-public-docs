...
This document describes the **Customer Chat Real-Time Messaging API v3.2**. This is the **legacy** version. We encourage you to migrate to the latest stable version. [Read more about versioning...](/messaging/#api-versioning)
