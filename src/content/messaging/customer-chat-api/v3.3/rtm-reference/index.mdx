...
For backend applications, you can specify the region in the request header. The mechanism is the same as in [Customer Chat Web API reference](/messaging/customer-chat-api/v3.3/#data-centers). It doesn't work for frontend applications, though.
...
| ---------------------- | ------------------------------------------------------------- |
| **Action**             | `list_chats`                                                  |
| **Web API equivalent** | [`list_chats`](/messaging/customer-chat-api/v3.3/#list-chats) |
| **Push message**       | -                                                             |
...
| ---------------------- | ----------------------------------------------------------------- |
| **Action**             | `list_threads`                                                    |
| **Web API equivalent** | [`list_threads`](/messaging/customer-chat-api/v3.3/#list-threads) |
| **Push message**       | -                                                                 |
...
| ---------------------- | --------------------------------------------------------- |
| **Action**             | `get_chat`                                                |
| **Web API equivalent** | [`get_chat`](/messaging/customer-chat-api/v3.3/#get-chat) |
| **Push message**       | -                                                         |
...
| ---------------------- | ------------------------------------------------------------------------- |
| **Action**             | `start_chat`                                                              |
| **Web API equivalent** | [`start_chat`](/messaging/customer-chat-api/v3.3/#start-chat)             |
...
| ---------------------- | ------------------------------------------------------------------------- |
| **Action**             | `resume_chat`                                                             |
| **Web API equivalent** | [`resume_chat`](/messaging/customer-chat-api/v3.3/#resume-chat)           |
| **Push message**       | [`incoming_chat`](/messaging/customer-chat-api/rtm-pushes/#incoming_chat) |
...
| **Web API equivalent** | [`deactivate_chat`](/messaging/customer-chat-api/v3.3/#deactivate-chat)                                                                                         |
...
| ---------------------- | --------------------------------------------------------------------------- |
| **Action**             | `send_event`                                                                |
| **Web API equivalent** | [`send_event`](/messaging/customer-chat-api/v3.3/#send-event)               |
...
| **Web API equivalent** | [`send_rich_message_postback`](/messaging/customer-chat-api/v3.3/#send-rich-message-postback)                     |
...
| **Web API equivalent** | [`send_sneak_peek`](/messaging/customer-chat-api/v3.3/#send-sneak-peek) |
| **Push message**       | -                                                                       |
...
| **Web API equivalent** | [`update_chat_properties`](/messaging/customer-chat-api/v3.3/#update-chat-properties)         |
...
| **Web API equivalent** | [`delete_chat_properties`](/messaging/customer-chat-api/v3.3/#delete-chat-properties)         |
...
| **Web API equivalent** | [`update_thread_properties`](/messaging/customer-chat-api/v3.3/#update-thread-properties)         |
...
| **Web API equivalent** | [`delete_thread_properties`](/messaging/customer-chat-api/v3.3/#delete-thread-properties)         |
...
| **Web API equivalent** | [`update_event_properties`](/messaging/customer-chat-api/v3.3/#update-event-properties)         |
...
| **Web API equivalent** | [`delete_event_properties`](/messaging/customer-chat-api/v3.3/#delete-event-properties)         |
...
| **Web API equivalent** | [`update_customer`](/messaging/customer-chat-api/v3.3/#update-customer)         |
...
| **Web API equivalent** | [`set_customer_session_fields`](/messaging/customer-chat-api/v3.3/#set-customer-session-fields) |
| **Push message**       | [`customer_updated`](/messaging/customer-chat-api/rtm-pushes/#customer_updated)                 |
...
| ---------------------- | ----------------------------------------------------------------- |
| **Action**             | `get_customer`                                                    |
| **Web API equivalent** | [`get_customer`](/messaging/customer-chat-api/v3.3/#get-customer) |
| **Push message**       | -                                                                 |
...
| **Web API equivalent** | [`list_group_statuses`](/messaging/customer-chat-api/v3.3/#list-group-statuses) |
| **Push message**       | -                                                                               |
...
| ---------------------- | --------------------------------------------------------- |
| **Action**             | `get_form`                                                |
| **Web API equivalent** | [`get_form`](/messaging/customer-chat-api/v3.3/#get-form) |
| **Push message**       | -                                                         |
...
| **Web API equivalent** | [`get_predicted_agent`](/messaging/customer-chat-api/v3.3/#get-predicted-agent) |
| **Push message**       | -                                                                               |
...
| ---------------------- | ----------------------------------------------------------------- |
| **Action**             | `get_url_info`                                                    |
| **Web API equivalent** | [`get_url_info`](/messaging/customer-chat-api/v3.3/#get-url-info) |
| **Push message**       | -                                                                 |
...
| **Web API equivalent** | [`mark_events_as_seen`](/messaging/customer-chat-api/v3.3/#mark-events-as-seen)           |
...
| **Web API equivalent** | [`accept_greeting`](/messaging/customer-chat-api/v3.3/#accept-greeting)           |
...
| **Web API equivalent** | [`cancel_greeting`](/messaging/customer-chat-api/v3.3/#cancel-greeting)           |
