...
Team Chat API by Text is a backend service that allows for a two-way communication between users using the HTTP protocol ([Web reference](#web-reference)) or via WebSockets ([RTM reference](#rtm-reference)). It supports the communication between agents/team members, not between customers and agents.
...
To see the Web API documetation, visit [Web reference](/text/team-chat-api/web-reference/).

# RTM API Reference

The Team Chat RTM API reference is available in the AsyncAPI format. You can look up the specification <a href="https://github.com/livechat/livechat-public-docs/blob/master/src/configs/redoc/chat-api/spec-rtm.yml" target="_blank">in our repository</a>.

You can copy the file's content and paste it into https://studio.asyncapi.com/ to generate easy-to-read documentation.
