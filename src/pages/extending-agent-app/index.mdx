...
This document presents how you can change and extend the LiveChat and HelpDesk products and their interfaces, so they're personalized and follow your needs. You can do it by configuring your app to be displayed in one of the available **App locations** described below.
...
In the example above, we've installed the <a href="https://www.livechat.com/marketplace/apps/helpdesk/#description" target="_blank">HelpDesk app</a>, which helps you to manage all customer messages in one place. If you want to play with some apps, <a href="https://github.com/livechat/sample-apps/tree/master/Tag%20Master" target="_blank">take a look and clone</a> the **Tag master** app. It's one of the open-source <a href="https://github.com/livechat/sample-apps" target="_blank">sample apps</a>.
