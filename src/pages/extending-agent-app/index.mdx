...
<div style={{marginBottom: "15px"}}>
  <img alt="LiveChat Chat Actions" src="/images/extending-agent-app/livechat-chat-actions.jpg" width="800px" height="467px"/>
</div>
...
<div style={{marginBottom: "15px"}}>
  <img alt="LiveChat Tag Master" src="/images/extending-agent-app/livechat-tag-master-app.jpg" width="800px" height="467px"/>
</div>
...
<div style={{marginBottom: "15px"}}>
<img alt="LiveChat Customer Details widgets" src="/images/extending-agent-app/livechat-cards-for-shopify.jpg" width="800px" height="467px"/>
</div>
...
<div style={{marginBottom: "15px"}}>
<img alt="LiveChat Fullscreen app" src="/images/extending-agent-app/livechat-fullscreen-app.jpg" width="800px" height="467px"/>
</div>
