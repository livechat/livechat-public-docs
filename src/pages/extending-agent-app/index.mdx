...
This document presents how you can change and extend the LiveChat App and its interface, so it is personalized and follow your needs. You can do it using [Chat Actions](/extending-agent-app#chat-actions) or [App locations](/extending-agent-app#app-locations).
