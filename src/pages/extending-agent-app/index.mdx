...
<div style={{marginBottom: "15px"}}>
  <img alt="LiveChat Chat Actions" src="/images/extending-agent-app/livechat-chat-actions-placement.png" width="2377px" height="1383px"/>
</div>
...
<div style={{marginBottom: "15px"}}>
  <img alt="LiveChat Details Section" src="/images/extending-agent-app/livechat-chat-details-placement.png" width="2377px" height="1383px"/>
</div>
...
<div style={{marginBottom: "15px"}}>
<img alt="LiveChat Customer Details widgets" src="/images/extending-agent-app/livechat-customer-details-placement.png" width="2455px" height="1383px"/>
</div>
...
<div style={{marginBottom: "15px"}}>
<img alt="LiveChat Fullscreen app" src="/images/extending-agent-app/livechat-fullscreen-placement.png" width="3275px" height="1933px"/>
</div>
...
<div style={{marginBottom: "15px"}}>
<img alt="LiveChat Messagebox" src="/images/extending-agent-app/livechat-message-box-placement.png" width="2377px" height="1383px"/>
</div>
...
- triggering [app authorization](/authorization/oauth-authorization#sign-in-with-livechat), especially if the app doesn't have a Chat Details widget.

<div style={{marginBottom: "15px"}}>
  <img alt="LiveChat Details Section" src="/images/extending-agent-app/livechat-settings-placement.png" width="3275px" height="1933px"/>
</div>

💡 If <a href="https://platform.text.com/docs/guides/console-guides/in-app-upgrades" target="_blank">In-App upgrades</a> were added to your app in the Developer Console, they will be visible App Settings as a seperate tab.
