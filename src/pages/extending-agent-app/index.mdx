...
This document presents how you can change and extend the LiveChat App and its interface, so it is personalized and follow your needs. You can do it by configuring your app to be displayed in one of the available **App locations** described below.
