...
This document presents how you can change and extend the LiveChat and HelpDesk Apps and their interfaces, so they're personalized and follow your needs. You can do it by configuring your app to be displayed in one of the available **App locations** described below.
