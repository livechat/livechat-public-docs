...
If you want to access the current threads with private mode toggled, you should use the `getPrivateModeThreads` method.

<CodeSample>

```js
const { threads } = widget.getPrivateModeThreads();
```
