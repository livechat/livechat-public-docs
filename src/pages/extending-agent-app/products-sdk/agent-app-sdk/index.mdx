...
4. Go to **Building blocks** and add a new **LiveChat Widgets** block.
    ...
    - Choose the **widget placement**. It allows you to decide where exactly in the LiveChat App you want to display your integration. Currently, the possible locations are: the Details section, Message Box, App settings, Fullscreen apps. [Read more](/extending-ui/extending-agent-app/#app-locations) about app locations.  
