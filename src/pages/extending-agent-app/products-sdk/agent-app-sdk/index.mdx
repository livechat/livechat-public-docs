...
If you want to connect a Settings widget to the LiveChat Agent App, you should use the `createSettingsWidget` function. It returns a promise resolving to a Settings widget instance.
