...
5. Go to **Building blocks** and add a new **HelpDesk Widgets** block.
    ...
    - Choose the **widget placement**. It allows you to decide where exactly in the HelpDesk App you want to display your integration. Currently, the possible locations are the Details section, Fullscreen Apps, or App Settings. [Read more](/extending-agent-app#app-locations) about app locations.  
