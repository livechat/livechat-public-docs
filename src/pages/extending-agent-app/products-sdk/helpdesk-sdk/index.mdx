...
App Widgets are web applications loaded inside the **HelpDesk App**. They live in iframes and can interact and communicate with the HelpDesk App. Read about their possible locations in the [App locations](/guides/helpdesk-apps#app-locations-in-helpdesk) guide. The HelpDesk SDK is currently the primary way to develop your own widgets and can be used in a [basic](/extending-agent-app/products-sdk/helpdesk-sdk#basic-use) or [advanced](/extending-agent-app/products-sdk/helpdesk-sdk#advanced-use) way.
...
You can leverage the OAuth 2.1 authorization flow to use <a href="https://api.helpdesk.com/docs" target="_blank">HelpDesk API</a>. Head to [Sign in with LiveChat](/authorization/oauth-authorization#sign-in-with-livechat/) docs for more information.
...
To read more about the HelpDesk Widgets, please see our [App Guides](/guides/console-guides/helpdesk-widgets).
