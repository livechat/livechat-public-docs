...
App Widgets are web applications loaded inside the **HelpDesk App**. They live in iframes and can interact and communicate with the HelpDesk App. Read about their possible locations in the [App locations](/getting-started/helpdesk-apps#app-locations-in-helpdesk) guide. The HelpDesk SDK is currently the primary way to develop your own widgets and can be used in a [basic](/extending-agent-app/products-sdk/helpdesk-sdk#basic-use) or [advanced](/extending-agent-app/products-sdk/helpdesk-sdk#advanced-use) way.
