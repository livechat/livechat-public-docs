...
| | **Invoices** | [`get_license_invoices`](#get-licenses-invoices) [`get_text_license_invoices`](#get-text-licenses-invoices) [`get_license_invoice_pdf`](#get-licenses-invoice-pdf) [`get_text_license_invoice`](#get-text-licenses-invoice) |
...
This method does not support Text licenses. For Text licenses, use [Get Text License's Invoices](#get-text-licenses-invoices).
...
This method does not support Text licenses. For Text licenses, use [Get Text License's Invoice](#get-text-licenses-invoice).
...
#### Get Text License's Invoice

Returns an invoice for a Text license.
