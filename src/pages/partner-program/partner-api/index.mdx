...
`GET https://api.livechatinc.com/v2/partners/status` - check if the API is running
...
You can create your token in the [API tokens section](https://partners.livechat.com/app/v2/account/token) in Dashboard.
