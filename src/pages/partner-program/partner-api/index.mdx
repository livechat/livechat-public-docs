...
| Area | Group | Methods |
| ---- | ----- | ------- |
| **Account** | **Profile** | [`get_profile`](#get-profile) [`update_profile`](#update-profile) |
| | **Account data** | [`get_stats`](#get-stats) [`get_coupons`](#get-coupons) |
| | **Earnings and commissions** | [`get_earnings`](#get-earnings) [`get_commission_report`](#get-commission-report) [`get_partners_referred_earnings_report`](#get-partners-referred-earnings-report) [`get_commission_metric`](#get-commission-metric) |
| | **Billing and withdrawals** | [`get_billing`](#get-billing) [`update_billing`](#update-billing) [`get_balance`](#get-balance) [`request_withdrawal`](#request-withdrawal) [`get_withdrawals`](#get-withdrawals) |
| | **API tokens** | [`create_api_token`](#create-api-token) [`get_api_tokens`](#get-api-tokens) [`revoke_api_token`](#revoke-api-token) |
| **Affiliate Partner** | **Campaigns** | [`create_campaign`](#create-campaign) [`search_campaigns`](#search-campaigns) [`get_campaigns`](#get-campaigns) [`disable_campaign`](#disable-campaign) [`get_affiliate_links`](#get-affiliate-links) |
| | **Licenses and referrals** | [`get_affiliate_licenses`](#get-affiliate-licenses) [`get_partners_referred`](#get-partners-referred) |
| | **Metrics** | [`get_trials_metrics`](#get-trials-metrics) [`get_earnings_metrics`](#get-earnings-metrics) [`get_conversions_metrics`](#get-conversions-metrics) [`get_clicks_metrics`](#get-clicks-metrics) [`get_referred_partners_commission_metrics`](#get-referred-partners-commission-metrics) |
| | **Reports** | [`get_performance_report`](#get-performance-report) [`get_trials_report`](#get-trials-report) [`get_earnings_report`](#get-earnings-report) [`get_conversions_report`](#get-conversions-report) [`get_clicks_report`](#get-clicks-report) |
| | **Campaign performance** | [`get_campaigns_earnings_metric`](#get-campaigns-earnings-metric) [`get_campaigns_earnings_report`](#get-campaigns-earnings-report) [`get_campaigns_summary`](#get-campaigns-summary) [`get_best_performing_campaigns_clicks_report`](#get-best-performing-campaigns-clicks-report) [`get_best_performing_campaigns_trials_report`](#get-best-performing-campaigns-trials-report) [`get_best_performing_campaigns_conversions_report`](#get-best-performing-campaigns-conversions-report) [`get_best_performing_campaigns_earnings_report`](#get-best-performing-campaigns-earnings-report) [`get_best_performing_campaigns_clicks_metrics`](#get-best-performing-campaigns-clicks-metrics) [`get_best_performing_campaigns_trials_metrics`](#get-best-performing-campaigns-trials-metrics) [`get_best_performing_campaigns_conversions_metrics`](#get-best-performing-campaigns-conversions-metrics) [`get_best_performing_campaigns_earnings_metrics`](#get-best-performing-campaigns-earnings-metrics) |
| | **Summary** | [`get_summary`](#get-summary) |
| **Solution Partner** | **Organizations** | [`create_organization`](#create-organization) [`get_organization_licenses`](#get-organization-licenses) [`get_organization_details`](#get-organization-details) |
| | **Licenses** | [`create_license`](#create-license) [`get_solution_licenses`](#get-solution-licenses) [`get_solution_licenses_by_status`](#get-solution-licenses-by-status) [`get_license_details`](#get-license-details) [`update_license_details`](#update-license-details) [`invite_license_operators`](#invite-license-operators) [`transfer_license`](#transfer-license) |
| | **Invoices** | [`get_license_invoices`](#get-license-invoices) [`get_text_license_invoices`](#get-text-license-invoices) [`get_license_invoice_pdf`](#get-license-invoice-pdf) [`get_text_license_invoice_pdf`](#get-text-license-invoice-pdf) |
| | **Subscriptions** | [`create_subscription`](#create-subscription) [`create_text_subscription`](#create-text-subscription) [`update_subscription`](#update-subscription) [`update_text_subscription`](#update-text-subscription) [`get_latest_text_subscription`](#get-latest-text-subscription) [`preview_text_subscription`](#preview-text-subscription) [`close_subscription`](#close-subscription) |
| | **Billing and payments** | [`update_license_billing`](#update-license-billing) [`create_text_payment_method`](#create-text-payment-method) [`get_text_payment_method`](#get-text-payment-method) [`update_text_payment_method`](#update-text-payment-method) [`get_recurly_token`](#get-recurly-token) |
| | **Reports** | [`get_license_metrics`](#get-license-metrics) [`get_solution_licenses_report`](#get-solution-licenses-report) [`get_solution_licenses_csv_report`](#get-solution-licenses-csv-report) [`get_solution_summary`](#get-solution-summary) |
| | **Leads** | [`get_leads`](#get-leads) [`get_lead_details`](#get-lead-details) [`get_lead_history`](#get-lead-history) [`submit_lead`](#submit-lead) |
...
Some of the solution partner API methods are product-specific. Refer to each method for information about product support.
...
| `<product>`         | Yes      | `string`  | The product. Possible values: `livechat`, `chatbot`, `helpdesk`, `textapp`.                                                                                                                  |
...
| `payment_origin`    | Yes      | `string`  | Who would manage the subscription. Possible values: `client`, `partner`. For Text licenses, only `partner` is currently supported.                                                          |
| `trial_duration`    | Yes      | `int`     | The number of days of a trial period (min. 14 - default, max. 30). For Text licenses, the trial period is always 14 days.                                                                    |
...
| Parameter         | Required | Data type  | Notes                                                                                                    |
| ----------------- | -------- | ---------- | -------------------------------------------------------------------------------------------------------- |
| `<product>`       | Yes      | `string`   | The product. Possible values: `livechat`, `helpdesk`, `textapp`.                                         |
| `<license_id>`    | Yes      | `string`   | The license ID.                                                                                          |
...
This method does not support Text licenses. Transferring Text licenses to clients is not currently supported.
...
This method does not support Text licenses. For Text licenses, use [Get Text License Invoices](#get-text-license-invoices).
...
#### Get Text License Invoices

Returns invoices for a Text license.

##### Specifics

|                |                                                                                                          |
| -------------- | -------------------------------------------------------------------------------------------------------- |
| **Method URL** | `https://api.livechatinc.com/v2/partners/solutions/licenses/ORG-<organization_id>/textapp/adapter/invoices` |
...
```shell
curl --request GET \
  --url https://api.livechatinc.com/v2/partners/solutions/licenses/ORG-66c29d75-909b-491b-a0bf-49f79f57e3d5/textapp/adapter/invoices \
  --header 'Authorization: Bearer <YOUR_API_TOKEN>'
```
...
[
  {
    "organization_id": "66c29d75-909b-491b-a0bf-49f79f57e3d5",
    "invoice_id": "2d39135d-2644-4ae4-823a-e31281d53d5d",
    "billing_profile_id": "37bea38c-132c-4ac5-9a8c-9bd430046ec5",
    "status": "paid",
    "line_items": [
      {
        "description": "[Text App] Growth, 12 months"
      }
    ],
    "amount": 4999.99,
    "updated_at": "0001-01-01T00:00:00Z",
    "created_at": "2026-08-31T07:01:17Z"
  }
]
```
...
#### Get License Invoice PDF

Returns a PDF invoice.

This method does not support Text licenses. For Text licenses, use [Get Text License Invoice PDF](#get-text-license-invoice-pdf).
...
#### Get Text License Invoice PDF

Returns a PDF invoice for a Text license.

##### Specifics

|                |                                                                                                                       |
| -------------- | --------------------------------------------------------------------------------------------------------------------- |
| **Method URL** | `https://api.livechatinc.com/v2/partners/solutions/licenses/ORG-<organization_id>/textapp/adapter/invoices/<invoice_id>` |
...
| ------------------- | -------- | --------- | -------------------- |
| `<organization_id>` | Yes      | `string`  | The organization ID. |
| `<invoice_id>`      | Yes      | `string`  | The invoice ID.      |
...
```shell
curl --request GET \
  --url https://api.livechatinc.com/v2/partners/solutions/licenses/ORG-66c29d75-909b-491b-a0bf-49f79f57e3d5/textapp/adapter/invoices/2d39135d-2644-4ae4-823a-e31281d53d5d \
  --header 'Authorization: Bearer <YOUR_API_TOKEN>'
```
...
This method does not support Text licenses. For Text licenses, use [Create Text Subscription](#create-text-subscription).
...
#### Create Text Subscription

Creates a new subscription for an expired Text license.

##### Specifics

|                |                                                                                                                |
| -------------- | -------------------------------------------------------------------------------------------------------------- |
| **Method URL** | `https://api.livechatinc.com/v2/partners/solutions/licenses/ORG-<organization_id>/textapp/adapter/subscriptions` |
...
| -------------------- | -------- | ---------- | -------------------------------------------------------- |
| `<organization_id>`  | Yes      | `string`   | The organization ID.                                     |
| `billing_profile_id` | Yes      | `string`   | The subscription's billing profile ID.                   |
| `plan_name`          | Yes      | `string`   | The plan. Possible values: `essential`, `growth`.         |
| `cycle_length`       | Yes      | `int`      | The billing cycle in months. Possible values: `1`, `12`. |
| `add_ons`            | No       | `object[]` | The list of add-ons.                                     |
| `add_ons.code`       | Yes      | `string`   | The add-on code.                                         |
| `add_ons.quantity`   | Yes      | `int`      | The add-on quantity.                                     |
...
```shell
curl --request POST \
  --url https://api.livechatinc.com/v2/partners/solutions/licenses/ORG-66c29d75-909b-491b-a0bf-49f79f57e3d5/textapp/adapter/subscriptions \
  --header 'Authorization: Bearer <YOUR_API_TOKEN>' \
  --header 'Content-Type: application/json' \
  --data '{
    "billing_profile_id": "37bea38c-132c-4ac5-9a8c-9bd430046ec5",
...
```json
{
  ...
  "converted_at": null,
  "created_at": "2026-08-27T15:06:45Z",
  "current_period_ends_at": "2026-09-10T15:06:45Z",
  "current_period_started_at": "2026-08-27T15:06:45Z",
  "cycle_length": 1,
  "expires_at": null,
  "organization_id": "66c29d75-909b-491b-a0bf-49f79f57e3d5",
  "payment_method_id": "5cd94e43-6446-48e9-99e8-dffb8c4e10db",
  "plan_name": "growth",
  "quantity": 1,
  "state": "active",
  "subscription_id": "25e844ff-2b50-4173-ad4a-7f8b87b23c38",
  "trial_ends_at": "2026-09-10T15:06:45Z",
  "trial_started_at": "2026-08-27T15:06:45Z",
  "unit_amount": 99,
  "updated_at": "2026-08-28T06:05:11Z",
  "add_ons": [
    {
      "code": "accounts",
      "unit_amount": 99,
...
This method does not support Text licenses. For Text licenses, use [Update Text Subscription](#update-text-subscription).
...
#### Update Text Subscription

Updates an existing subscription for a Text license.

##### Specifics

|                |                                                                                                                                  |
| -------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| **Method URL** | `https://api.livechatinc.com/v2/partners/solutions/licenses/ORG-<organization_id>/textapp/adapter/subscriptions/<subscription_id>` |
...
| ----------------------- | -------- | ---------- | -------------------------------------------------------- |
| `<organization_id>`     | Yes      | `string`   | The organization ID.                                     |
| `<subscription_id>`     | Yes      | `string`   | The subscription ID.                                     |
| `plan_name`             | Yes      | `string`   | The plan. Possible values: `essential`, `growth`.         |
| `cycle_length`          | Yes      | `int`      | The billing cycle in months. Possible values: `1`, `12`. |
| `add_ons`               | No       | `object[]` | The list of add-ons.                                     |
| `add_ons.code`          | Yes      | `string`   | The add-on code.                                         |
...
```shell
curl --request PATCH \
  --url https://api.livechatinc.com/v2/partners/solutions/licenses/ORG-66c29d75-909b-491b-a0bf-49f79f57e3d5/textapp/adapter/subscriptions/25e844ff-2b50-4173-ad4a-7f8b87b23c38 \
  --header 'Authorization: Bearer <YOUR_API_TOKEN>' \
  --header 'Content-Type: application/json' \
  --data '{
    "plan_name": "growth",
...
#### Get Latest Text Subscription

Returns the latest subscription for a Text license.

##### Specifics

|                |                                                                                                                          |
| -------------- | ------------------------------------------------------------------------------------------------------------------------ |
| **Method URL** | `https://api.livechatinc.com/v2/partners/solutions/licenses/ORG-<organization_id>/textapp/adapter/subscriptions:latest` |
...
The `pending_change` object represents a change scheduled to take effect on the next renewal.
...
```shell
curl --request GET \
  --url https://api.livechatinc.com/v2/partners/solutions/licenses/ORG-66c29d75-909b-491b-a0bf-49f79f57e3d5/textapp/adapter/subscriptions:latest \
  --header 'Authorization: Bearer <YOUR_API_TOKEN>'
```
...
```json
{
  ...
  "collection_method": "automatic",
  "converted_at": null,
  "created_at": "2026-09-03T07:34:07Z",
  "current_period_ends_at": "2027-08-28T08:41:49Z",
  "current_period_started_at": "2026-09-03T08:01:44Z",
  "cycle_length": 12,
  "expires_at": null,
  "organization_id": "0bd84b44-5309-4ff1-998b-183b20beabf3",
  "payment_method_id": "5cd94e43-6446-48e9-99e8-dffb8c4e10db",
  "plan_name": "growth",
  "quantity": 1,
  "state": "active",
  ...
  "unit_amount": 948,
  "updated_at": "2026-09-03T08:01:49Z",
  "add_ons": [
    {
      "code": "text-intelligence.ai-agent.resolution",
      "unit_amount": 49.5,
      "quantity": 1
    },
    {
  ...
  "pending_change": {
    ...
    "created_at": "2026-09-03T08:01:48Z",
    "updated_at": "2026-09-03T08:01:48Z"
  }
}
```
...
#### Preview Text Subscription

Returns a preview of changes to a Text subscription.

##### Specifics

|                |                                                                                                                                          |
| -------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| **Method URL** | `https://api.livechatinc.com/v2/partners/solutions/licenses/ORG-<organization_id>/textapp/adapter/subscriptions/<subscription_id>:preview` |
...
| `<organization_id>`             | Yes      | `string`  | The organization ID.                                     |
| `<subscription_id>`             | Yes      | `string`  | The subscription ID.                                     |
| `quantity`                      | Yes      | `int`     | The subscription quantity.                               |
| `plan_name`                     | Yes      | `string`  | The plan. Possible values: `essential`, `growth`.         |
| `cycle_length`                  | Yes      | `int`     | The billing cycle in months. Possible values: `1`, `12`. |
| `add_ons.<index>.code`          | No       | `string`  | The add-on code.                                         |
| `add_ons.<index>.quantity`      | No       | `int`     | The add-on quantity.                                     |
...
```shell
curl --request GET \
  --url 'https://api.livechatinc.com/v2/partners/solutions/licenses/ORG-66c29d75-909b-491b-a0bf-49f79f57e3d5/textapp/adapter/subscriptions/25e844ff-2b50-4173-ad4a-7f8b87b23c38:preview?quantity=1&plan_name=growth&cycle_length=1&add_ons.0.code=accounts&add_ons.0.quantity=0&add_ons.1.code=text-intelligence.ai-agent.resolution&add_ons.1.quantity=0&add_ons.2.code=platform.developer-tools.api-calls&add_ons.2.quantity=0' \
  --header 'Authorization: Bearer <YOUR_API_TOKEN>'
```
...
```json
{
  ...
  "changes_meta": {
    "now": {
      ...
      "add_ons": {
        "accounts": "none",
        "platform.developer-tools.api-calls": "none",
        "text-intelligence.ai-agent.resolution": "none"
      }
    },
    "renewal": {
      "plan_name": "none",
      "cycle_length": "downgrade",
      "add_ons": {
        "accounts": "downgrade",
        "platform.developer-tools.api-calls": "downgrade",
        "text-intelligence.ai-agent.resolution": "downgrade"
      }
    }
  }
}
...
This method does not support Text licenses. Closing Text subscriptions is not currently supported.
...
This method does not support Text licenses. For Text licenses, use [Create Text Payment Method](#create-text-payment-method) or [Update Text Payment Method](#update-text-payment-method).
...
Creates a payment method for a Text license.

##### Specifics

|                |                                                                                                                        |
| -------------- | ---------------------------------------------------------------------------------------------------------------------- |
| **Method URL** | `https://api.livechatinc.com/v2/partners/solutions/licenses/ORG-<organization_id>/textapp/adapter/payment_methods` |
...
```shell
curl --request POST \
  --url https://api.livechatinc.com/v2/partners/solutions/licenses/ORG-66c29d75-909b-491b-a0bf-49f79f57e3d5/textapp/adapter/payment_methods \
  --header 'Authorization: Bearer <YOUR_API_TOKEN>' \
  --header 'Content-Type: application/json' \
  --data '{
    "billing_profile_id": "37bea38c-132c-4ac5-9a8c-9bd430046ec5",
...
```json
{
  ...
  "updated_at": "2026-09-01T10:33:49Z",
  "created_at": "2026-09-01T10:33:48Z",
  "version": 1
}
```
...
#### Get Text Payment Method

Returns a payment method for a Text license.

##### Specifics

|                |                                                                                                                                                    |
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Method URL** | `https://api.livechatinc.com/v2/partners/solutions/licenses/ORG-<organization_id>/textapp/adapter/payment_methods/<payment_method_id>` |
...
| --------------------- | -------- | --------- | ---------------------- |
| `<organization_id>`   | Yes      | `string`  | The organization ID.   |
| `<payment_method_id>` | Yes      | `string`  | The payment method ID. |
...
```shell
curl --request GET \
  --url https://api.livechatinc.com/v2/partners/solutions/licenses/ORG-66c29d75-909b-491b-a0bf-49f79f57e3d5/textapp/adapter/payment_methods/5cd94e43-6446-48e9-99e8-dffb8c4e10db \
  --header 'Authorization: Bearer <YOUR_API_TOKEN>'
```
...
Updates a payment method for a Text license.
