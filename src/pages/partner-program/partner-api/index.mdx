...
```shell
curl --request GET \
  --url https://api.livechatinc.com/v2/partners/solutions/licenses/ORG-66c29d75-909b-491b-a0bf-49f79f57e3d5/textapp/adapter/invoices/<invoice_id> \
  --header 'Authorization: Bearer <YOUR_API_TOKEN>'
```
...
```shell
curl --request PATCH \
  --url https://api.livechatinc.com/v2/partners/solutions/licenses/ORG-66c29d75-909b-491b-a0bf-49f79f57e3d5/textapp/adapter/subscriptions/<subscription_id> \
  --header 'Authorization: Bearer <YOUR_API_TOKEN>' \
  --header 'Content-Type: application/json' \
  --data '{
    "plan_name": "growth",
...
```json
{
  "billing_profile_id": "019f5fca-1dac-78d7-b42b-269a296c5832",
  "canceled_at": null,
  "collection_method": "automatic",
  "converted_at": null,
  ...
  "payment_method_id": "01a06630-6ec8-7120-ac7b-e3937d8b7ab6",
  "plan_name": "growth",
  "quantity": 1,
  "state": "active",
  "subscription_id": "01a06630-7943-7ae0-81c0-718cf6457ebe",
  "trial_ends_at": null,
...
```shell
curl --request GET \
  --url 'https://api.livechatinc.com/v2/partners/solutions/licenses/ORG-66c29d75-909b-491b-a0bf-49f79f57e3d5/textapp/adapter/subscriptions/<subscription_id>:preview?quantity=1&plan_name=growth&cycle_length=1&add_ons.0.code=accounts&add_ons.0.quantity=0&add_ons.1.code=text-intelligence.ai-agent.resolution&add_ons.1.quantity=0&add_ons.2.code=platform.developer-tools.api-calls&add_ons.2.quantity=0' \
  --header 'Authorization: Bearer <YOUR_API_TOKEN>'
```
...
```shell
curl --request GET \
  --url https://api.livechatinc.com/v2/partners/solutions/licenses/ORG-66c29d75-909b-491b-a0bf-49f79f57e3d5/textapp/adapter/payment_methods/2bd49d02-b7b2-48bf-8708-fbac6731ff2d \
  --header 'Authorization: Bearer <YOUR_API_TOKEN>'
```
...
{
  "organization_id": "66c29d75-909b-491b-a0bf-49f79f57e3d5",
  "payment_method_id": "2bd49d02-b7b2-48bf-8708-fbac6731ff2d",
  "billing_profile_id": "<billing_profile_id>",
  "card_type": "Visa",
  "first_six": "411111",
  "last_four": "1111",
