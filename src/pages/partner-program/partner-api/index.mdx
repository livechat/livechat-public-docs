...
The LiveChat Partner API provides a RESTful interface that enables partners to programmatically access and manage their partnership data. Use this API to retrieve earnings reports, manage customer licenses, and oversee affiliate campaigns.
