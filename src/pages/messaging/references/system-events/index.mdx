...
This document is a reference of the system events generated in the Text ecosystem.

[Read more](/messaging/agent-chat-api/data-structures/#system) about the system event push type.
...
| `order.sales_channel.id`      | Yes      | `string`  | Sales channel unique identifier                                |
