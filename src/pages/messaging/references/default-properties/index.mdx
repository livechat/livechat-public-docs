...
Specifies a threshold of queued chats after which the queue is reopened. It cannot exceed the [`queue.limit`](#queuelimit). This setting can be overridden per group by the [`queue.reopen_threshold.override`](#queue_reopen_thresholdoverride) property.
