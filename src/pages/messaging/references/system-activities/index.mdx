...
Messaging source includes system events related to messaging activities, such as information about generation of thread summaries.

### summary

Sent as a result of generating thread summary in active threads. [Read more](/messaging/agent-chat-api#request-thread-summary).
