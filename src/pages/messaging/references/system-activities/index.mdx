...
| Content                                    | Generated when                                                   |
| ------------------------------------------ | ---------------------------------------------------------------- |
| _Custom skill %name% started_              | Custom skill execution has begun. |

## custom_skill_awaiting_feedback

| Content                                    | Generated when                                                   |
| ------------------------------------------ | ---------------------------------------------------------------- |
| _Custom skill %name% is awaiting human feedback_              | Custom skill execution is awaiting user input. |

## custom_skill_completed

| Content                                    | Generated when                                                   |
| ------------------------------------------ | ---------------------------------------------------------------- |
| _Custom skill %name% completed successfully_              | Custom skill execution has completed successfully. |

## custom_skill_started

| Content                                    | Generated when                                                   |
| ------------------------------------------ | ---------------------------------------------------------------- |
| _Custom skill %name% has failed_              | Custom skill execution has failed. |
