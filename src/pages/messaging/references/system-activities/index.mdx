...
<Code>
  <CodeResponse
    title={"Sample system event body"}
    type={"messaging-references"}
    json={"systemEventBody"}
  />
</Code>
...
| Source                    | Subtypes                                                                                                                                                                                                                                    |
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`ai_agents`](#ai_agents) | [`custom_skill_awaiting_feedback`](#custom_skill_awaiting_feedback) [`custom_skill_completed`](#custom_skill_completed) [`custom_skill_failed`](#custom_skill_failed) [`custom_skill_rejected`](#custom_skill_rejected) [`custom_skill_started`](#custom_skill_started) |
...
AI Agents source includes system events related to AI Agent activities, such as custom skill execution. Custom skill system events are visible to agents.

### custom_skill_awaiting_feedback

Generated when a custom skill is awaiting human feedback to continue execution.

#### Version 1

| Parameter   | Required | Data type | Notes                                 |
| ----------- | -------- | --------- | ------------------------------------- |
| `agentId`   | Yes      | `string`  | The ID of the AI Agent.               |
| `skillId`   | Yes      | `string`  | The ID of the executed custom skill.  |
| `skillName` | Yes      | `string`  | The name of the executed custom skill. |

<Code>
  <CodeResponse
    title={"Sample system event payload"}
    type={"messaging-references"}
    json={"customSkillAwaitingFeedbackV2"}
  />
</Code>

### custom_skill_completed

Generated when a custom skill has completed its execution successfully.
...
<Code>
  <CodeResponse
    title={"Sample system event payload"}
    type={"messaging-references"}
    json={"customSkillCompletedV2"}
  />
</Code>

### custom_skill_failed

Generated when a custom skill execution has failed.
...
| `skillId`   | Yes      | `string`  | The ID of the executed custom skill.  |
| `skillName` | Yes      | `string`  | The name of the executed custom skill. |
| `error`     | Yes      | `string`  | The error that occurred during execution. |
| `reason`    | Yes      | `string`  | The reason why the execution failed.  |

<Code>
  <CodeResponse
    title={"Sample system event payload"}
    type={"messaging-references"}
    json={"customSkillFailedV2"}
  />
</Code>

### custom_skill_rejected

Generated when a custom skill execution has been rejected by an agent.
...
<Code>
  <CodeResponse
    title={"Sample system event payload"}
    type={"messaging-references"}
    json={"customSkillRejectedV2"}
  />
</Code>

### custom_skill_started

Generated when a custom skill execution has started.
...
<Code>
  <CodeResponse
    title={"Sample system event payload"}
    type={"messaging-references"}
    json={"storeProductAddedToCartV1"}
  />
</Code>
...
<Code>
  <CodeResponse
    title={"Sample system event payload"}
    type={"messaging-references"}
    json={"storeProductRemovedFromCartV1"}
  />
</Code>
...
Sent when [requesting a thread summary](/messaging/agent-chat-api#request-thread-summary) in active threads.
...
<Code>
  <CodeResponse
    title={"Sample system message event body"}
    type={"messaging-references"}
    json={"systemMessageBody"}
  />
</Code>
