...
There are two types of native system activities sent to users as [events](/messaging/agent-chat-api/data-structures/#events) in various situations:
...
This section is a reference of the system event subtypes generated in the Text ecosystem.
...
The sources send the newest version available but existing chat documents can contain older versions.
...
| Source               | Subtypes                                                                                                                                                                                  |
|----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [`cdp`](#source-cdp) | [`store_order_was_created`](#store_order_was_created) [`store_product_added_to_cart`](#store_product_added_to_cart) [`store_product_removed_from_cart`](#store_product_removed_from_cart) |
...
This section is a reference of the system message types generated in the Text ecosystem. Apart from those listed in this section, there are also the ones sent by integrations. By default, applications can define their own system messages.

The content of the system message event is a string stored in the `text` property and its format depends on the `system_message_type`. Variables used to generate the `text` are specified in the `text_vars`.
...
The list of system message types sorted out alphabetically:
