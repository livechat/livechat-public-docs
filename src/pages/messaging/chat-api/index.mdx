...
desc: "API for a two-way communication between users. Available as a Web API and Real-timen messaging API."
---

# Introduction

Chat API by Text is a backend service that allows for a two-way communication between users using either a websocket (RTM reference) or the HTTP protocol (Web reference).
