...
|                        |                                                                             |
| ---------------------- | --------------------------------------------------------------------------- |
| **Action**             | `track_sales_event`                                                         |
| **Web API equivalent** | [`track_sales_event`](/messaging/customer-chat-api/v3.6/#track_sales_event) |
| **Push message**       | -                                                                           |
