...
This document describes the **Customer Chat Web API v3.6**. This is the developer preview version that provides a preview of the upcoming changes to the API. **It's not open to public use.** However, if you want to test some features, contact us at developers@text.com or <ChatWindow>ask on the chat</ChatWindow>, and we'll give you access. [Read more about versioning...](/messaging/#api-versioning)
