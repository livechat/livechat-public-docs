import {Section} from "../../../../components/extensions/CodeBlocks";
---
weight: 30
category: "messaging"
...
Deletes an [Event](/messaging/customer-chat-api/v3.6/data-structures/#events) object.
...
| Parameter               | Required | Data type | Notes                                                                                                                                                             |
| ----------------------- | -------- | --------- | -------------------------------------------------------- |
| `chat_id`               | Yes      | `string`  | Id of the chat that you want to delete a message from.   |
| `thread_id`             | Yes      | `string`  | Id of the thread that you want to delete a message from. |
