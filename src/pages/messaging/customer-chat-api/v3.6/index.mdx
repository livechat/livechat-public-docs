...
|                  |                                                                                                                 |
| ---------------- | --------------------------------------------------------------------------------------------------------------- |
| `name`           | [Customer's](/messaging/customer-chat-api/v3.6/data-structures/#customer) name. Returned only if set.           |
| `email`          | [Customer's](/messaging/customer-chat-api/v3.6/data-structures/#customer) email. Returned only if set.          |
| `avatar`         | [Customer's](/messaging/customer-chat-api/v3.6/data-structures/#customer) avatar. Returned only if set.         |
...
Allows tracking sales events (like `store_order_was_created`).

#### Specifics

|                        |                                                                                           |
| ---------------------- | ----------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.6/customer/action/track_sales_event`                      |
| **RTM API equivalent** | [`track_sales_event`](/messaging/customer-chat-api/v3.6/rtm-reference/#track_sales_event) |
| **Webhook**            | -                                                                                         |
...
| Parameter      | Required | Data type | Notes               |
| -------------- | -------- | --------- | ------------------- |
| `website_uuid` | Yes      | `string`  | Website UUID        |
| `payload`      | Yes      | `object`  | Sales event payload |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.6/customer/action/track_sales_event?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "website_uuid": "687dc79a-20a9-4a0c-ba7e-099d3d6c3398",
    "payload": {
        "customer_id": "8ac2f9d9-d028-45e3-8a79-3e708861e60e",
        "platform": "shopify",
        "occurred_at": "2025-06-24T10:44:24.441Z",
        "event": {
...
| `unique_id`   | Yes      | `string`  | ID of the greeting to accept. You can get it from the [`incoming_greeting`](/messaging/customer-chat-api/v3.6/rtm-pushes/#incoming_greeting) push. |
...
| Parameter   | Required | Data type | Notes                                                                                                                                              |
| ----------- | -------- | --------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| `unique_id` | Yes      | `string`  | ID of the greeting to cancel. You can get it from the [`incoming_greeting`](/messaging/customer-chat-api/v3.6/rtm-pushes/#incoming_greeting) push. |
