...
This document describes the **Customer Chat Real-Time Messaging API v3.1**. This version is **deprecated**. We encourage you to migrate to the latest stable version. [Read more about versioning...](/messaging/#api-versioning)
