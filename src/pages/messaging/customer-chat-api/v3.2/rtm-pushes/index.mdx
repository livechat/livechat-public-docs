...
Indicates about an incoming [event](/messaging/customer-chat-api/v3.2/data-structures/#events) sent to a chat.
...
Indicates that an [event](/messaging/customer-chat-api/v3.2/data-structures/#events) was updated.
...
Indicates about an incoming [rich message](/messaging/customer-chat-api/v3.2/data-structures/#rich-message) postback. The push payload contains the info on the postback itself, as well as the chat it was sent in.
