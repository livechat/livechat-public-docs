...
| `customer.suggested_email`    | No       | `string`   | An email address suggested for the customer but not confirmed by them. An empty value clears an existing suggestion; omit the field to leave it untouched. |
