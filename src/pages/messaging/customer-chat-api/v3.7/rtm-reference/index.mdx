...
| **Other**      | [`get_form`](#get-form) [`get_predicted_agent`](#get-predicted-agent) [`get_url_info`](#get-url-info) [`mark_events_as_seen`](#mark-events-as-seen) [`accept_greeting`](#accept-greeting) [`cancel_greeting`](#cancel-greeting) [`send_greeting_button_clicked`](#send-greeting-button-clicked)                                     |
...
| `chat.thread.events`     | No       | `array`   | An array of initial chat [events](/messaging/customer-chat-api/data-structures/#events). Does not support the `form` type event in the LiveChat app. |
...
| `chat.properties`        | No       | `object` | The initial chat properties.                                                                 |
| `chat.thread`            | No       | `object` |                                                                                              |
| `chat.thread.events`     | No       | `array`  | An array of initial chat events.                                                             |
| `chat.thread.properties` | No       | `object` | The initial thread properties.                                                               |
| `active`                 | No       | `bool`   | If set to `false`: creates an inactive thread. Default: `true`.                              |
...
| **Web API equivalent** | [`get_predicted_agent`](/messaging/customer-chat-api/v3.7/#get-predicted-agent) |
| **Push message**       | -                                                                               |
