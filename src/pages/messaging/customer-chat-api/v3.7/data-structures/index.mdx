...
<CodeResponse version="v3.7" type="customer" title={'Sample Customer Omnichannel data structure'} json="omnichannel"/>
...
<CodeResponse version="v3.7" type="customer" title={'Sample Facebook Messenger data structure'} json="omnichannel_fb_messenger"/>
