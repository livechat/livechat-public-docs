...
| `omnichannel`    | optional  | An array of customer's omnichannel data.                                                                                |
...
<CodeResponse version="v3.7" type="customer" title={'Sample Omnichannel data structure'} json="omnichannel"/>

| Field            | Required | Data type | Note                                                                                |
| ---------------- | -------  | --------- | ----------------------------------------------------------------------------------- |
| `fb_messenger`   | No       | `object`  |                                                                                     | 
| `twilio`         | No       | `object`  |										        | 

### Facebook Messenger

<CodeResponse version="v3.7" type="customer" title={'Sample Thread data structure'} json="omnichannel_fb_messenger"/>
...
<CodeResponse version="v3.7" type="customer" title={'Sample Thread data structure'} json="omnichannel_twilio"/>
