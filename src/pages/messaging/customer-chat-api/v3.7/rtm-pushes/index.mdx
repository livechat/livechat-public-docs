...
Informs about an incoming [event](/messaging/customer-chat-api/v3.7/data-structures/#events) preview sent to a chat.
...
Informs about an incoming [event](/messaging/customer-chat-api/v3.7/data-structures/#events) sent to a chat.
...
Informs that an [event](/messaging/customer-chat-api/v3.7/data-structures/#events) was deleted.
...
Informs that an [event](/messaging/customer-chat-api/v3.7/data-structures/#events) was updated.
...
Informs about an incoming [rich message](/messaging/customer-chat-api/v3.7/data-structures/#rich-message) postback. The push payload contains the info on the postback itself, as well as the chat it was sent in.
