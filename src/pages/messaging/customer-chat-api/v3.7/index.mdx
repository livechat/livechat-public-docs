...
Updates customer's fields. Allows to clear the values of `name`, `email`, `suggested_email`, and `address` components by providing an empty string as the new field value.
