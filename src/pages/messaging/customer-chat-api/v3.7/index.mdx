...
| `name`                                     | No       | `string`   |                                                                                  |
| `email`                                    | No       | `string`   |                                                                                  |
| `suggested_email`                          | No       | `string`   | An email address suggested for the customer but not confirmed by them. A non-empty value is ignored when it isn't a valid address or when the customer already has a valid `email`; an empty value always clears the suggestion. |
...
| `suggested_email` | An email address suggested for the [customer](/messaging/customer-chat-api/v3.7/data-structures/#customer) but not confirmed by them. Returned only if set. |
