...
The welcome message event will be generated asynchronously and sent via the ([`incoming_welcome_message`](/messaging/customer-chat-api/v3.7/rtm-pushes/#incoming_welcome_message)) push.
