...
|                  |                                                                                                               |
| ---------------- | ------------------------------------------------------------------------------------------------------------- |
| `name`           | [Customer's](/messaging/customer-chat-api/v3.7/data-structures/#customer) name. Returned only if set.         |
| `email`          | [Customer's](/messaging/customer-chat-api/v3.7/data-structures/#customer) email. Returned only if set.        |
| `avatar`         | [Customer's](/messaging/customer-chat-api/v3.7/data-structures/#customer) avatar. Returned only if set.       |
