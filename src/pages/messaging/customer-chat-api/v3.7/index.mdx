...
desc: "Check how to use the Customer Chat Web API to interact as a customer."
apiVersion: "3.7"
robots: "noindex"
---
...
<SmallLinksSection
  ...
  links={[
    { to: "/guides/api-guides/customer-chat-api-guide", children: "Customer Chat API implementation guide" },
    { to: "/guides/custom-chat-widgets/", children: "Custom chat widgets with Customer Chat API" },
  ]}
/>
...
This document describes the **Customer Chat Web API v3.7**. This is the developer preview version that provides a preview of the upcoming changes to the API. **It's not open to public use.** However, if you want to test some features, contact us at developers@text.com or <a href="#open-chat" onClick={openChatWindow}>ask on the chat</a>, and we'll give you access. [Read more about versioning...](/messaging/#api-versioning)
...
**Not what you're looking for?** Perhaps, you need to use [**Customer Chat RTM API**](/messaging/customer-chat-api/v3.7/rtm-reference/) instead.

## Access

**Customer authentication** is handled with access tokens. Find out how to get an **access token** from [Customer authorization flow](/authorization/customer-authorization). Take note that **it's not the same** token you would use for the Agent Chat or Configuration API.
...
To find sample payloads of **events**, **users**, and **other common structures** such as chats or threads [visit the Data structures](/messaging/customer-chat-api/v3.7/data-structures) document.
...
| ----------- | ----------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **POST**    | `https://api.livechatinc.com/v3.7/customer/action/<action>` | All except for **List License Properties**, **List Group Properties**, **Dynamic Config**, **Config** and **Localization**                                                                                                                                           |
| **GET**     | `https://api.livechatinc.com/v3.7/customer/action/<action>` | [**List License Properties**](#list-license-properties), [**List Group Properties**](#list-group-properties), [**Get Dynamic Configuration**](#get-dynamic-configuration), [**Get Configuration**](#get-configuration) and [**Get Localization**](#get-localization) |

| Header          |                   Value                    |                                                                                                                                                                                                         Notes |
| --------------- | :----------------------------------------: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
| `X-API-Version` |                   `3.7`                    |                                                                                                                                                         Not needed if you specify the API version in the URL. |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.7/customer/action?organization_id=<organization_id> \
...
| **Events**        | [`send_event`](#send-event) [`delete_event`](#delete-event) [`upload_file`](#upload-file) [`send_rich_message_postback`](#send-rich-message-postback) [`send_sneak_peek`](#send-sneak-peek)                                                                                                                                                                                                                                                 |
...
| **Other**         | [`check_goals`](#check-goals) [`get_form`](#get-form) [`get_url_info`](#get-url-info) [`mark_events_as_seen`](#mark-events-as-seen) [`accept_greeting`](#accept-greeting) [`cancel_greeting`](#cancel-greeting) [`request_email_verification`](#request-email-verification) [`request_welcome_message`](#request-welcome-message) [`send_greeting_button_clicked`](#send-greeting-button-clicked)                                           |
...
|                        |                                                                             |
| ---------------------- | --------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/list_chats`               |
| **RTM API equivalent** | [`list_chats`](/messaging/customer-chat-api/v3.7/rtm-reference/#list-chats) |
| **Webhook**            | -                                                                           |
...
| ------------ | -------- | -------- | ------------------------------------------------------------------------------------------------------------------- |
| `limit`      | No       | `number` | The maximum number of records returned on each [page](#pagination). Default: 10, maximum: 25.                       |
| `sort_order` | No       | `string` | Possible values: `asc`, `desc` (default). The chat info entries are sorted by the creation date of its last thread. |
| `page_id`    | No       | `string` |                                                                                                                     |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.7/customer/action/list_chats?organization_id=<organization_id>' \
...
|                        |                                                                                 |
| ---------------------- | ------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/list_threads`                 |
| **RTM API equivalent** | [`list_threads`](/messaging/customer-chat-api/v3.7/rtm-reference/#list-threads) |
| **Webhook**            | -                                                                               |
...
| `limit`            | No       | `number`  | The maximum number of records returned on each [page](#pagination). Default: 3, maximum: 100.                                                                                                                                                               |
| `page_id`          | No       | `string`  |                                                                                                                                                                                                                                                             |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.7/customer/action/list_threads \
  -H 'Authorization: Bearer <customer_access_token>' \
  -H 'Content-Type: application/json' \
  -d '{
      "chat_id": "PWJ8Y4THAV",
...
|                        |                                                                         |
| ---------------------- | ----------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/get_chat`             |
| **RTM API equivalent** | [`get_chat`](/messaging/customer-chat-api/v3.7/rtm-reference/#get-chat) |
| **Webhook**            | -                                                                       |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.7/customer/action/get_chat?organization_id=<organization_id> \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
      "chat_id": "PJ0MRSHTDG",
...
|                        |                                                                             |
| ---------------------- | --------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/start_chat`               |
| **RTM API equivalent** | [`start_chat`](/messaging/customer-chat-api/v3.7/rtm-reference/#start-chat) |
| **Webhook**            | [`incoming_chat`](/management/webhooks/v3.7/#incoming_chat)                 |
...
| `chat.thread.events`     | No       | `array`   | The initial chat [events](/messaging/customer-chat-api/data-structures/#events) array. Does not support the `form` type event in the LiveChat app.          |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.7/customer/action/start_chat?organization_id=<organization_id> \
  -H 'Content-Type: <content-type>' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{}'
```
...
|                        |                                                                               |
| ---------------------- | ----------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/resume_chat`                |
| **RTM API equivalent** | [`resume_chat`](/messaging/customer-chat-api/v3.7/rtm-reference/#resume-chat) |
| **Webhook**            | [`incoming_chat`](/management/webhooks/v3.7/#incoming_chat)                   |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.7/customer/action/resume_chat?organization_id=<organization_id> \
  -H 'Content-Type: <content-type>' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "chat": {
...
|                        |                                                                                                                                     |
| ---------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/deactivate_chat`                                                                  |
| **RTM API equivalent** | [`deactivate_chat`](/messaging/customer-chat-api/v3.7/rtm-reference/#deactivate-chat)                                               |
| **Webhook**            | [`incoming_event`](/management/webhooks/v3.7/#incoming_event) and [`chat_deactivated`](/management/webhooks/v3.7/#chat_deactivated) |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.7/customer/action/deactivate_chat?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "id": "PWLW03ICW7"
...
| ---------------------- | ---------------------------------------------------------------------------- |
| **HTTP Method**        | **GET**                                                                      |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/get_dynamic_configuration` |
| **RTM API equivalent** | -                                                                            |
| **Webhook**            | -                                                                            |
...
| `livechat.ai_agent_active`       | `bool`    | Specifies if the AI agent is accepting chats.                                                                                        |
...
```shell
curl -X GET \
  'https://api.livechatinc.com/v3.7/customer/action/get_dynamic_configuration?license_id=<license_id>&group_id=0'
```
...
| ---------------------- | -------------------------------------------------------------------- |
| **HTTP Method**        | **GET**                                                              |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/get_configuration` |
| **RTM API equivalent** | -                                                                    |
| **Webhook**            | -                                                                    |
...
```shell
curl -X GET \
  'https://api.livechatinc.com/v3.7/customer/action/get_configuration?organization_id=<organization_id>&group_id=0&version=84cc87cxza5ee24ed0f84fe3027fjf0c71'
```
...
Sends an [Event](/messaging/customer-chat-api/v3.7/data-structures/#events) object. Use this method to send a message by specifying the [Message](/messaging/customer-chat-api/v3.7/data-structures/#message) event type in the request.
...
|                        |
| ---------------------- | --------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/send_event`               |
| **RTM API equivalent** | [`send_event`](/messaging/customer-chat-api/v3.7/rtm-reference/#send-event) |
| **Webhook**            | [`incoming_event`](/management/webhooks/v3.7/#incoming_event)               |
...
| `event`                 | Yes      | `object`  | The [Event](/messaging/customer-chat-api/data-structures/#events) object. Does not support the `form` type event in the LiveChat app.                               |
| `attach_to_last_thread` | No       | `bool`    | When set to `true`, the event will be added to the last thread for inactive chats. When set to `false`, the request will fail for inactive chats. Default: `false`. |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.7/customer/action/send_event?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "chat_id": "PWLW03ICW7",
...
Deletes an [Event](/messaging/customer-chat-api/v3.7/data-structures/#events) object. Deleted events are hidden from all Customer Chat API responses but remain visible via the Agent Chat API.

In the Agent Chat API, the [Delete Event](#delete-event) method replaces the original event with a [Deleted Event](/messaging/agent-chat-api/v3.7/data-structures#deleted-event) for agents with the `normal` role. Agents with higher roles (`administrator`, `viceowner`, and `owner`) see the original event with a `deleted` flag.

#### Specifics

|                        |
| ---------------------- | ------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/delete_event`                 |
| **RTM API equivalent** | [`delete_event`](/messaging/customer-chat-api/v3.7/rtm-reference/#delete-event) |
| **Webhook**            | [`event_deleted`](/management/webhooks/v3.7/#event_deleted)                     |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.7/customer/action/delete_event?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "chat_id": "PJ0MRSHTDG",
...
|                        |                                                                      |
| ---------------------- | -------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/upload_file`       |
| **RTM API equivalent** | -                                                                    |
| **Webhook**            | [`incoming_event`](/management/webhooks/v3.7/#incoming_event) **\*** |
...
| Parameter | Required | Data type | Notes                                              |
| --------- | -------- | --------- | -------------------------------------------------- |
| `file`    | Yes      | `binary`  | Maximum size: 10MB. Executable files are rejected. |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.7/customer/action/upload_file?organization_id=<organization_id> \
  -H 'Authorization: Bearer <customer_access_token>' \
...
|                        |                                                                                                             |
| ---------------------- | ----------------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/send_rich_message_postback`                               |
| **RTM API equivalent** | [`send_rich_message_postback`](/messaging/customer-chat-api/v3.7/rtm-reference/#send-rich-message-postback) |
| **Webhook**            | [`incoming_rich_message_postback`](/management/webhooks/v3.7/#incoming_rich_message_postback)**\***         |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.7/customer/action/send_rich_message_postback?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "chat_id": "PJ0MRSHTDG",
    ...
    "postback": {
      ...
      "toggled": true,
      "button_type: "url",
      "button_value": "https://developers.livechat.com",
      "ecommerce": {
        "product_id": "12345",
        "option_id": "red-xl",
        "quantity": 1
...
|                        |                                                                                       |
| ---------------------- | ------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/send_sneak_peek`                    |
| **RTM API equivalent** | [`send_sneak_peek`](/messaging/customer-chat-api/v3.7/rtm-reference/#send-sneak-peek) |
| **Webhook**            | -                                                                                     |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.7/customer/action/send_sneak_peek?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "chat_id": "PJ0MRSHTDG",
...
| ---------------------- | ------------------------------------------------------------------- |
| **HTTP Method**        | **GET**                                                             |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/get_localization` |
| **RTM API equivalent** | -                                                                   |
| **Webhook**            | -                                                                   |
...
```shell
curl -X GET \
  'https://api.livechatinc.com/v3.7/customer/action/get_localization?organization_id=<organization_id>&group_id=0&language=en&version=79cc87cea5ee24ed0f84fe3027fc0c74'
```
...
|                        |                                                                                                     |
| ---------------------- | --------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/update_chat_properties`                           |
| **RTM API equivalent** | [`update_chat_properties`](/messaging/customer-chat-api/v3.7/rtm-reference/#update-chat-properties) |
| **Webhook**            | [`chat_properties_updated`](/management/webhooks/v3.7/#chat_properties_updated)                     |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.7/customer/action/update_chat_properties?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "id": "Q1GZ3FNAT9",
...
|                        |                                                                                                     |
| ---------------------- | --------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/delete_chat_properties`                           |
| **RTM API equivalent** | [`delete_chat_properties`](/messaging/customer-chat-api/v3.7/rtm-reference/#delete-chat-properties) |
| **Webhook**            | [`chat_properties_deleted`](/management/webhooks/v3.7/#chat_properties_deleted)                     |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.7/customer/action/delete_chat_properties?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "id": "Q1GZ3FNAT9",
...
|                        |                                                                                                         |
| ---------------------- | ------------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/update_thread_properties`                             |
| **RTM API equivalent** | [`update_thread_properties`](/messaging/customer-chat-api/v3.7/rtm-reference/#update-thread-properties) |
| **Webhook**            | [`thread_properties_updated`](/management/webhooks/v3.7/#thread_properties_updated)                     |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.7/customer/action/update_thread_properties?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "chat_id": "Q1GZ3FNAT9",
...
|                        |                                                                                                         |
| ---------------------- | ------------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/delete_thread_properties`                             |
| **RTM API equivalent** | [`delete_thread_properties`](/messaging/customer-chat-api/v3.7/rtm-reference/#delete-thread-properties) |
| **Webhook**            | [`thread_properties_deleted`](/management/webhooks/v3.7/#thread_properties_deleted)                     |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.7/customer/action/delete_thread_properties?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "chat_id": "Q1GZ3FNAT9",
...
|                        |                                                                                                       |
| ---------------------- | ----------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/update_event_properties`                            |
| **RTM API equivalent** | [`update_event_properties`](/messaging/customer-chat-api/v3.7/rtm-reference/#update-event-properties) |
| **Webhook**            | [`event_properties_updated`](/management/webhooks/v3.7/#event_properties_updated)                     |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.7/customer/action/update_event_properties?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "chat_id": "Q1GZ3FNAT9",
...
|                        |                                                                                                       |
| ---------------------- | ----------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/delete_event_properties`                            |
| **RTM API equivalent** | [`delete_event_properties`](/messaging/customer-chat-api/v3.7/rtm-reference/#delete-event-properties) |
| **Webhook**            | [`event_properties_deleted`](/management/webhooks/v3.7/#event_properties_deleted)                     |
...
| `properties` | Yes      | `object` | The event properties to delete. You should stick to the [general properties format](/management/configuration-api/#properties) and include _namespace_, _property name_ and _value_. |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.7/customer/action/delete_event_properties?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "chat_id": "Q1GZ3FNAT9",
...
| ---------------------- | -------------------------------------------------------------------------- |
| **HTTP Method**        | **GET**                                                                    |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/list_license_properties` |
| **RTM API equivalent** | -                                                                          |
| **Webhook**            | -                                                                          |
...
```shell
curl -X GET \
  'https://api.livechatinc.com/v3.7/customer/action/list_license_properties?organization_id=123&namespace=0805e283233042b37f460ed8fbf22160&name=string_property' \
  -H 'Content-Type: application/json'
```
...
| ---------------------- | ------------------------------------------------------------------------ |
| **HTTP Method**        | **GET**                                                                  |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/list_group_properties` |
| **RTM API equivalent** | -                                                                        |
| **Webhook**            | -                                                                        |
...
```shell
curl -X GET \
  'https://api.livechatinc.com/v3.7/customer/action/list_group_properties?organization_id=11069052&id=1&namespace=0805e283233042b37f460ed8fbf22160&name=string_property' \
  -H 'Content-Type: application/json'
```
...
Updates customer's fields. Allows to clear the values of `name`, `email`, `phone_number`, `suggested_email`, and `address` components by providing an empty string as the new field value.

#### Specifics

|                        |                                                                                                                 |
| ---------------------- | --------------------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/update_customer`                                              |
| **RTM API equivalent** | [`update_customer`](/messaging/customer-chat-api/v3.7/rtm-reference/#update-customer)                           |
| **Webhook**            | [`customer_session_fields_updated`](/management/configuration-api/v3.7/#customer_session_fields_updated) **\*** |
...
| `name`                                     | No       | `string`   |                                                                                  |
| `email`                                    | No       | `string`   |                                                                                  |
| `suggested_email`                          | No       | `string`   | The email address suggested for the customer based on tracked activity, such as a form submission. The suggested email isn't confirmed by the customer. An empty value clears the suggestion. |
...
| `omnichannel.whatsapp`                     | No       | `object`   |                                                                                  |
| `omnichannel.whatsapp.id`                  | Yes      | `string`   | Required only when `omnichannel.whatsapp` is included.                           |
| `omnichannel.whatsapp.name`                | No       | `string`   |                                                                                  |
| `omnichannel.whatsapp.phone_number`        | Yes      | `string`   | E.164 format. Required only when `omnichannel.whatsapp` is included.             |
...
```shell
curl -X POST \
'https://api.livechatinc.com/v3.7/customer/action/update_customer?organization_id=<organization_id>' \
-H 'Content-Type: application/json' \
-H 'Authorization: Bearer <customer_access_token>' \
-d '{
...
|                        |                                                                                                                 |
| ---------------------- | --------------------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/set_customer_session_fields`                                  |
| **RTM API equivalent** | [`set_customer_session_fields`](/messaging/customer-chat-api/v3.7/rtm-reference/#set-customer-session-fields)   |
| **Webhook**            | [`customer_session_fields_updated`](/management/configuration-api/v3.7/#customer_session_fields_updated) **\*** |
...
```shell
curl -X POST \
'https://api.livechatinc.com/v3.7/customer/action/set_customer_session_fields?organization_id=<organization_id>' \
-H 'Content-Type: application/json' \
-H 'Authorization: Bearer <customer_access_token>' \
-d '{
    "session_fields": [{
...
|                        |                                                                                 |
| ---------------------- | ------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/get_customer`                 |
| **RTM API equivalent** | [`get_customer`](/messaging/customer-chat-api/v3.7/rtm-reference/#get-customer) |
| **Webhook**            | -                                                                               |
...
|                  |                                                                                                                   |
| ---------------- | ----------------------------------------------------------------------------------------------------------------- |
| `name`           | The [customer's](/messaging/customer-chat-api/v3.7/data-structures/#customer) name. Returned only if set.         |
| `email`          | The [customer's](/messaging/customer-chat-api/v3.7/data-structures/#customer) email. Returned only if set.        |
| `avatar`         | The [customer's](/messaging/customer-chat-api/v3.7/data-structures/#customer) avatar. Returned only if set.       |
| `phone_number`   | The [customer's](/messaging/customer-chat-api/v3.7/data-structures/#customer) phone number. Returned only if set. |
| `suggested_email` | The email address suggested for the [customer](/messaging/customer-chat-api/v3.7/data-structures/#customer) based on tracked activity, such as a form submission. The suggested email isn't confirmed by the customer. Returned only if set. |
...
| `omnichannel`    | An object of customer's [omnichannel data](/messaging/customer-chat-api/v3.7/data-structures/#customer).          |
| `address`        | An object of the customer's address data. Returned only if set.                                                   |
...
```shell
curl -X POST \
'https://api.livechatinc.com/v3.7/customer/action/get_customer?organization_id=<organization_id>' \
-H 'Content-Type: application/json' \
-H 'Authorization: Bearer <customer_access_token>' \
-d '{}'
```
...
|                        |                                                                                               |
| ---------------------- | --------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/list_group_statuses`                        |
| **RTM API equivalent** | [`list_group_statuses`](/messaging/customer-chat-api/v3.7/rtm-reference/#list-group-statuses) |
| **Webhook**            | -                                                                                             |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.7/customer/action/list_group_statuses?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "all": true
...
|                        |                                                                |
| ---------------------- | -------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/check_goals` |
| **RTM API equivalent** | -                                                              |
| **Webhook**            | -                                                              |
...
```shell
curl -X POST \
'https://api.livechatinc.com/v3.7/customer/action/check_goals?organization_id=<organization_id>' \
-H 'Content-Type: application/json' \
-H 'Authorization: Bearer <customer_access_token>' \
-d '{
...
|                        |                                                                         |
| ---------------------- | ----------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/get_form`             |
| **RTM API equivalent** | [`get_form`](/messaging/customer-chat-api/v3.7/rtm-reference/#get-form) |
| **Webhook**            | -                                                                       |
...
| `form`    | The [Form](/messaging/customer-chat-api/v3.7/data-structures/#form) data structure.                                        |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.7/customer/action/get_form?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "group_id": 0,
...
|                        |                                                                                 |
| ---------------------- | ------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/get_url_info`                 |
| **RTM API equivalent** | [`get_url_info`](/messaging/customer-chat-api/v3.7/rtm-reference/#get-url-info) |
| **Webhook**            | -                                                                               |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.7/customer/action/get_url_info?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
...
|                        |                                                                                               |
| ---------------------- | --------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/mark_events_as_seen`                        |
| **RTM API equivalent** | [`mark_events_as_seen`](/messaging/customer-chat-api/v3.7/rtm-reference/#mark-events-as-seen) |
| **Webhook**            | [`events_marked_as_seen`](/management/webhooks/v3.7/#events_marked_as_seen)                   |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.7/customer/action/mark_events_as_seen?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "chat_id": "PJ0MRSHTDG",
...
|                        |                                                                                       |
| ---------------------- | ------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/accept_greeting`                    |
| **RTM API equivalent** | [`accept_greeting`](/messaging/customer-chat-api/v3.7/rtm-reference/#accept-greeting) |
| **Webhook**            | -                                                                                     |
...
| `unique_id`   | Yes      | `string`  | The ID of the greeting to accept. You can get it from the [`incoming_greeting`](/messaging/customer-chat-api/v3.7/rtm-pushes/#incoming_greeting) push. |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.7/customer/action/accept_greeting?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "greeting_id": 7,
...
|                        |                                                                                       |
| ---------------------- | ------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/cancel_greeting`                    |
| **RTM API equivalent** | [`cancel_greeting`](/messaging/customer-chat-api/v3.7/rtm-reference/#cancel-greeting) |
| **Webhook**            | -                                                                                     |
...
| Parameter   | Required | Data type | Notes                                                                                                                                                  |
| ----------- | -------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `unique_id` | Yes      | `string`  | The ID of the greeting to cancel. You can get it from the [`incoming_greeting`](/messaging/customer-chat-api/v3.7/rtm-pushes/#incoming_greeting) push. |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.7/customer/action/cancel_greeting?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "unique_id": "Q10X0W041P"
...
Requests a welcome message from the system. The response contains the predicted agent the customer will chat with once the chat starts. This method requires the customer to be [logged in](/messaging/customer-chat-api/v3.7/rtm-reference/#login).

The welcome message event is sent asynchronously via the [`incoming_welcome_message`](/messaging/customer-chat-api/v3.7/rtm-pushes/#incoming_welcome_message) push.

#### Specifics

|                        |                                                                                                       |
| ---------------------- | ----------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/request_welcome_message`                            |
| **RTM API equivalent** | [`request_welcome_message`](/messaging/customer-chat-api/v3.7/rtm-reference/#request-welcome-message) |
| **Webhook**            | -                                                                                                     |
...
| `ai_agent_response_scope` | No       | `string`  | The scope of the AI agent response. Possible values: `message_and_questions`, `questions_only`. Default: `message_and_questions`. |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.7/customer/action/request_welcome_message?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{}'
```
...
|                        |                                                                                                                 |
| ---------------------- | --------------------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/send_greeting_button_clicked`                                 |
| **RTM API equivalent** | [`send_greeting_button_clicked`](/messaging/customer-chat-api/v3.7/rtm-reference/#send-greeting-button-clicked) |
| **Webhook**            | -                                                                                                               |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.7/customer/action/send_greeting_button_clicked?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
...
|                        |                                                                               |
| ---------------------- | ----------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/customer/action/request_email_verification` |
| **RTM API equivalent** | -                                                                             |
| **Webhook**            | -                                                                             |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.7/customer/action/request_email_verification?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
...
<SectionLink to={"/management/configuration-api/v3.7/#webhooks"}>See webhook methods</SectionLink>
<SectionLink to={"/management/webhooks/v3.7/"}>See webhook payloads</SectionLink>
