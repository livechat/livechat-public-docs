...
The welcome message event will be generated asynchrounously and sent via the ([`incoming_welcome_message`](/messaging/customer-chat-api/v3.6/rtm-pushes/#incoming_welcome_message)) push.
To use this method, the customer needs to be logged in, which can be done via the [`login`](/messaging/customer-chat-api/v3.6/rtm-reference/#login) method.
