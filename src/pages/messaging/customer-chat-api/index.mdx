...
<SmallSectionLink to={"/guides/api-guides/customer-chat-api-guide"}>Custmer Chat API implementation guide</SmallSectionLink>
<br />
<SmallSectionLink to={"guides/custom-chat-widgets"}>Custom chat widgets with Customer Chat API</SmallSectionLink>
