...
This document describes the **Customer Chat Web API v3.4**. This is the latest stable version recommended for the production use. [Read more about versioning...](/messaging/#api-versioning)
...
| `online_group_ids`      | `array`   | It is returned in response with all the groups' numbers where agents accept chats. It is not visible when there is no such group.    |
