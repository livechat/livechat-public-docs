...
This document describes the **Customer Chat Web API v3.6**. This is the latest stable version recommended for the production use. [Read more about versioning...](/messaging/#api-versioning)
...
**Not what you're looking for?** Perhaps, you need to use [**Customer Chat RTM API**](/messaging/customer-chat-api/v3.6/rtm-reference/) instead.
...
To find sample payloads of **events**, **users**, and **other common structures** such as chats or threads [visit the Data structures](/messaging/customer-chat-api/v3.6/data-structures) document.
...
| ----------- | ----------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **POST**    | `https://api.livechatinc.com/v3.6/customer/action/<action>` | All except for **List License Properties**, **List Group Properties**, **Dynamic Config**, **Config** and **Localization**                                                                                                                                           |
| **GET**     | `https://api.livechatinc.com/v3.6/customer/action/<action>` | [**List License Properties**](#list-license-properties), [**List Group Properties**](#list-group-properties), [**Get Dynamic Configuration**](#get-dynamic-configuration), [**Get Configuration**](#get-configuration) and [**Get Localization**](#get-localization) |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.6/customer/action?organization_id=<organization_id> \
...
It returns [summaries](/messaging/customer-chat-api/v3.6/data-structures/#chat-summaries) of the chats a customer participated in.
...
| **RTM API equivalent** | [`list_chats`](/messaging/customer-chat-api/v3.6/rtm-reference/#list-chats) |
| **Webhook**            | -                                                                           |
...
| `chats_summary`    | `array`   | Array of [Chat summary](/messaging/customer-chat-api/v3.6/data-structures/#chat-summaries) data structures.     |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.6/customer/action/list_chats?organization_id=<organization_id>' \
...
| **RTM API equivalent** | [`list_threads`](/messaging/customer-chat-api/v3.6/rtm-reference/#list-threads) |
| **Webhook**            | -                                                                               |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.6/customer/action/list_threads \
  -H 'Authorization: Bearer <customer_access_token>' \
  -H 'Content-Type: application/json' \
  -d '{
      "chat_id": "PWJ8Y4THAV",
...
| **RTM API equivalent** | [`get_chat`](/messaging/customer-chat-api/v3.6/rtm-reference/#get-chat) |
| **Webhook**            | -                                                                       |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.6/customer/action/get_chat?organization_id=<organization_id> \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
      "chat_id": "PJ0MRSHTDG",
...
| **RTM API equivalent** | [`start_chat`](/messaging/customer-chat-api/v3.6/rtm-reference/#start-chat) |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.6/customer/action/start_chat?organization_id=<organization_id> \
  -H 'Content-Type: <content-type>' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{}'
```
...
|                        |                                                                               |
| ---------------------- | ----------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.6/customer/action/resume_chat`                |
| **RTM API equivalent** | [`resume_chat`](/messaging/customer-chat-api/v3.6/rtm-reference/#resume-chat) |
| **Webhook**            | [`incoming_chat`](/management/webhooks/v3.6/#incoming_chat)                   |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.6/customer/action/resume_chat?organization_id=<organization_id> \
  -H 'Content-Type: <content-type>' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "chat": {
...
|                        |                                                                                                                                     |
| ---------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.6/customer/action/deactivate_chat`                                                                  |
| **RTM API equivalent** | [`deactivate_chat`](/messaging/customer-chat-api/v3.6/rtm-reference/#deactivate-chat)                                               |
| **Webhook**            | [`incoming_event`](/management/webhooks/v3.6/#incoming_event) and [`chat_deactivated`](/management/webhooks/v3.6/#chat_deactivated) |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.6/customer/action/deactivate_chat?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "id": "PWLW03ICW7"
...
```shell
curl -X GET \
  'https://api.livechatinc.com/v3.6/customer/action/get_dynamic_configuration?license_id=<license_id>&group_id=0'
```
...
```shell
curl -X GET \
  'https://api.livechatinc.com/v3.6/customer/action/get_configuration?organization_id=<organization_id>&group_id=0&version=84cc87cxza5ee24ed0f84fe3027fjf0c71'
```
...
Sends an [Event](/messaging/customer-chat-api/v3.6/data-structures/#events) object. Use this method to send a message by specifying the [Message](/messaging/customer-chat-api/v3.6/data-structures/#message) event type in the request.
...
|                        |
| ---------------------- | --------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.6/customer/action/send_event`               |
| **RTM API equivalent** | [`send_event`](/messaging/customer-chat-api/v3.6/rtm-reference/#send-event) |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.6/customer/action/send_event?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "chat_id": "PWLW03ICW7",
...
Deletes an [Event](/messaging/customer-chat-api/v3.6/data-structures/#events) object. Deleted events are hidden from all Customer Chat API responses but remain visible via the Agent Chat API.

In the Agent Chat API, the [Delete Event](#delete-event) method replaces the original event with a [Deleted Event](/messaging/agent-chat-api/v3.6/data-structures#deleted-event) for agents with the `normal` role. Agents with higher roles (`administrator`, `viceowner`, and `owner`) see the original event with a `deleted` flag.

#### Specifics

|                        |
| ---------------------- | ------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.6/customer/action/delete_event`                 |
| **RTM API equivalent** | [`delete_event`](/messaging/customer-chat-api/v3.6/rtm-reference/#delete-event) |
| **Webhook**            | [`event_deleted`](/management/webhooks/v3.6/#event_deleted)                     |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.6/customer/action/delete_event?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "chat_id": "PJ0MRSHTDG",
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.6/customer/action/upload_file?organization_id=<organization_id> \
  -H 'Authorization: Bearer <customer_access_token>' \
...
|                        |                                                                                                             |
| ---------------------- | ----------------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.6/customer/action/send_rich_message_postback`                               |
| **RTM API equivalent** | [`send_rich_message_postback`](/messaging/customer-chat-api/v3.6/rtm-reference/#send-rich-message-postback) |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.6/customer/action/send_rich_message_postback?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "chat_id": "PJ0MRSHTDG",
...
| **RTM API equivalent** | [`send_sneak_peek`](/messaging/customer-chat-api/v3.6/rtm-reference/#send-sneak-peek) |
| **Webhook**            | -                                                                                     |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.6/customer/action/send_sneak_peek?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "chat_id": "PJ0MRSHTDG",
...
```shell
curl -X GET \
  'https://api.livechatinc.com/v3.6/customer/action/get_localization?organization_id=<organization_id>&group_id=0&language=en&version=79cc87cea5ee24ed0f84fe3027fc0c74'
```
...
|                        |                                                                                                     |
| ---------------------- | --------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.6/customer/action/update_chat_properties`                           |
| **RTM API equivalent** | [`update_chat_properties`](/messaging/customer-chat-api/v3.6/rtm-reference/#update-chat-properties) |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.6/customer/action/update_chat_properties?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "id": "Q1GZ3FNAT9",
...
|                        |                                                                                                     |
| ---------------------- | --------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.6/customer/action/delete_chat_properties`                           |
| **RTM API equivalent** | [`delete_chat_properties`](/messaging/customer-chat-api/v3.6/rtm-reference/#delete-chat-properties) |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.6/customer/action/delete_chat_properties?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "id": "Q1GZ3FNAT9",
...
|                        |                                                                                                         |
| ---------------------- | ------------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.6/customer/action/update_thread_properties`                             |
| **RTM API equivalent** | [`update_thread_properties`](/messaging/customer-chat-api/v3.6/rtm-reference/#update-thread-properties) |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.6/customer/action/update_thread_properties?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "chat_id": "Q1GZ3FNAT9",
...
|                        |                                                                                                         |
| ---------------------- | ------------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.6/customer/action/delete_thread_properties`                             |
| **RTM API equivalent** | [`delete_thread_properties`](/messaging/customer-chat-api/v3.6/rtm-reference/#delete-thread-properties) |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.6/customer/action/delete_thread_properties?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "chat_id": "Q1GZ3FNAT9",
...
|                        |                                                                                                       |
| ---------------------- | ----------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.6/customer/action/update_event_properties`                            |
| **RTM API equivalent** | [`update_event_properties`](/messaging/customer-chat-api/v3.6/rtm-reference/#update-event-properties) |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.6/customer/action/update_event_properties?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "chat_id": "Q1GZ3FNAT9",
...
|                        |                                                                                                       |
| ---------------------- | ----------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.6/customer/action/delete_event_properties`                            |
| **RTM API equivalent** | [`delete_event_properties`](/messaging/customer-chat-api/v3.6/rtm-reference/#delete-event-properties) |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.6/customer/action/delete_event_properties?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "chat_id": "Q1GZ3FNAT9",
...
```shell
curl -X GET \
  'https://api.livechatinc.com/v3.6/customer/action/list_license_properties?organization_id=123&namespace=0805e283233042b37f460ed8fbf22160&name=string_property' \
  -H 'Content-Type: application/json'
```
...
```shell
curl -X GET \
  'https://api.livechatinc.com/v3.6/customer/action/list_group_properties?organization_id=11069052&id=1&namespace=0805e283233042b37f460ed8fbf22160&name=string_property' \
  -H 'Content-Type: application/json'
```
...
|                        |                                                                                                                 |
| ---------------------- | --------------------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.6/customer/action/update_customer`                                              |
| **RTM API equivalent** | [`update_customer`](/messaging/customer-chat-api/v3.6/rtm-reference/#update-customer)                           |
| **Webhook**            | [`customer_session_fields_updated`](/management/configuration-api/v3.6/#customer_session_fields_updated) **\*** |
...
```shell
curl -X POST \
'https://api.livechatinc.com/v3.6/customer/action/update_customer?organization_id=<organization_id>' \
-H 'Content-Type: application/json' \
-H 'Authorization: Bearer <customer_access_token>' \
-d '{
...
|                        |                                                                                                                 |
| ---------------------- | --------------------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.6/customer/action/set_customer_session_fields`                                  |
| **RTM API equivalent** | [`set_customer_session_fields`](/messaging/customer-chat-api/v3.6/rtm-reference/#set-customer-session-fields)   |
| **Webhook**            | [`customer_session_fields_updated`](/management/configuration-api/v3.6/#customer_session_fields_updated) **\*** |
...
```shell
curl -X POST \
'https://api.livechatinc.com/v3.6/customer/action/set_customer_session_fields?organization_id=<organization_id>' \
-H 'Content-Type: application/json' \
-H 'Authorization: Bearer <customer_access_token>' \
-d '{
    "session_fields": [{
...
| **RTM API equivalent** | [`get_customer`](/messaging/customer-chat-api/v3.6/rtm-reference/#get-customer) |
| **Webhook**            | -                                                                               |
...
| `suggested_email` | The email address suggested for the [customer](/messaging/customer-chat-api/v3.6/data-structures/#customer) based on tracked activity, such as a form submission. The suggested email isn't confirmed by the customer. Returned only if set. |
...
| `omnichannel`    | An object of the customer's [omnichannel data](/messaging/customer-chat-api/data-structures/#customer).           |
...
```shell
curl -X POST \
'https://api.livechatinc.com/v3.6/customer/action/get_customer?organization_id=<organization_id>' \
-H 'Content-Type: application/json' \
-H 'Authorization: Bearer <customer_access_token>' \
-d '{}'
```
...
| **RTM API equivalent** | [`list_group_statuses`](/messaging/customer-chat-api/v3.6/rtm-reference/#list-group-statuses) |
| **Webhook**            | -                                                                                             |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.6/customer/action/list_group_statuses?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "all": true
...
```shell
curl -X POST \
'https://api.livechatinc.com/v3.6/customer/action/check_goals?organization_id=<organization_id>' \
-H 'Content-Type: application/json' \
-H 'Authorization: Bearer <customer_access_token>' \
-d '{
...
| **RTM API equivalent** | [`get_form`](/messaging/customer-chat-api/v3.6/rtm-reference/#get-form) |
| **Webhook**            | -                                                                       |
...
| `form`    | The [Form](/messaging/customer-chat-api/v3.6/data-structures/#form) data structure.                                                              |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.6/customer/action/get_form?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "group_id": 0,
...
Gets the predicted agent - the one the customer will chat with when the chat starts. To use this method, the customer needs to be logged in, which can be done via the [`login`](/messaging/customer-chat-api/v3.6/rtm-reference/#login) method.
...
| **RTM API equivalent** | [`get_predicted_agent`](/messaging/customer-chat-api/v3.6/rtm-reference/#get-predicted-agent) |
| **Webhook**            | -                                                                                             |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.6/customer/action/get_predicted_agent?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{}'
```
...
| **RTM API equivalent** | [`get_url_info`](/messaging/customer-chat-api/v3.6/rtm-reference/#get-url-info) |
| **Webhook**            | -                                                                               |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.6/customer/action/get_url_info?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
...
|                        |                                                                                               |
| ---------------------- | --------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.6/customer/action/mark_events_as_seen`                        |
| **RTM API equivalent** | [`mark_events_as_seen`](/messaging/customer-chat-api/v3.6/rtm-reference/#mark-events-as-seen) |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.6/customer/action/mark_events_as_seen?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "chat_id": "PJ0MRSHTDG",
...
| **RTM API equivalent** | [`accept_greeting`](/messaging/customer-chat-api/v3.6/rtm-reference/#accept-greeting) |
| **Webhook**            | -                                                                                     |
...
| `unique_id`   | Yes      | `string`  | The ID of the greeting to accept. You can get it from the [`incoming_greeting`](/messaging/customer-chat-api/v3.6/rtm-pushes/#incoming_greeting) push. |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.6/customer/action/accept_greeting?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "greeting_id": 7,
...
| **RTM API equivalent** | [`cancel_greeting`](/messaging/customer-chat-api/v3.6/rtm-reference/#cancel-greeting) |
| **Webhook**            | -                                                                                     |
...
| Parameter   | Required | Data type | Notes                                                                                                                                                  |
| ----------- | -------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `unique_id` | Yes      | `string`  | The ID of the greeting to cancel. You can get it from the [`incoming_greeting`](/messaging/customer-chat-api/v3.6/rtm-pushes/#incoming_greeting) push. |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.6/customer/action/cancel_greeting?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
    "unique_id": "Q10X0W041P"
...
Requests a welcome message from the system. The response contains the predicted agent the customer will chat with once the chat starts. This method requires the customer to be [logged in](/messaging/customer-chat-api/v3.6/rtm-reference/#login). 

The welcome message event is sent asynchronously via the [`incoming_welcome_message`](/messaging/customer-chat-api/v3.6/rtm-pushes/#incoming_welcome_message) push.
``
...
|                        |                                                                                                       |
| ---------------------- | ----------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.6/customer/action/request_welcome_message`                            |
| **RTM API equivalent** | [`request_welcome_message`](/messaging/customer-chat-api/v3.6/rtm-reference/#request-welcome-message) |
| **Webhook**            | -                                                                                                     |
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.6/customer/action/request_welcome_message?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{}'
```
...
```shell
curl -X POST \
  'https://api.livechatinc.com/v3.6/customer/action/request_email_verification?organization_id=<organization_id>' \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <customer_access_token>' \
  -d '{
