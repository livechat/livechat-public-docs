...
| ------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------- |
| `access_token_expired`               | Access token lifetime has elapsed.                                                                                                   | Reconnect. Please regenerate your access token. |
| `connection_evicted`                 | The Customer Chat API should be available again soon; reconnecting is advised                                                        | Reconnect.                                      |
...
| `internal_error`                     | Internal, unexpected error; reconnecting is advised                                                                                  | Reconnect.                                      |
...
| `service_temporarily_unavailable`    | The Customer Chat API should be available again soon; reconnecting is advised                                                        | Reconnect.                                      |
