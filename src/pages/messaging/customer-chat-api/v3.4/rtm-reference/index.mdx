...
Informs about an incoming [event](/messaging/customer-chat-api/v3.4/data-structures/#events) sent to a chat.
...
Informs that an [event](/messaging/customer-chat-api/v3.4/data-structures/#events) was updated.
...
Informs about an incoming [rich message](/messaging/customer-chat-api/v3.4/data-structures/#rich-message) postback. The push payload contains the info on the postback itself, as well as the chat it was sent in.
...
| `event`                | Greeting event ([Message](/messaging/customer-chat-api/v3.4/data-structures/#message) or [Rich message](/messaging/customer-chat-api/v3.4/data-structures/#rich-message)) |
