...
This document describes the **Customer Chat Real-Time Messaging API v3.4**, which is a legacy version. For production-ready applications, it's best to use to the current stable version. [Read more about versioning...](/messaging/#api-versioning)
...
For backend applications, you can specify the region in the request header. The mechanism is the same as in [Customer Chat Web API reference](/messaging/customer-chat-api/v3.4/#data-centers). It doesn't work for frontend applications, though.
...
| ---------------------- | ------------------------------------------------------------- |
| **Action**             | `list_chats`                                                  |
| **Web API equivalent** | [`list_chats`](/messaging/customer-chat-api/v3.4/#list-chats) |
| **Push message**       | -                                                             |
...
| ---------------------- | ----------------------------------------------------------------- |
| **Action**             | `list_threads`                                                    |
| **Web API equivalent** | [`list_threads`](/messaging/customer-chat-api/v3.4/#list-threads) |
| **Push message**       | -                                                                 |
...
| ---------------------- | --------------------------------------------------------- |
| **Action**             | `get_chat`                                                |
| **Web API equivalent** | [`get_chat`](/messaging/customer-chat-api/v3.4/#get-chat) |
| **Push message**       | -                                                         |
...
| ---------------------- | ------------------------------------------------------------------------------ |
| **Action**             | `start_chat`                                                                   |
| **Web API equivalent** | [`start_chat`](/messaging/customer-chat-api/v3.4/#start-chat)                  |
| **Push message**       | [`incoming_chat`](/messaging/customer-chat-api/v3.4/rtm-pushes/#incoming_chat) |
...
| ---------------------- | ------------------------------------------------------------------------------ |
| **Action**             | `resume_chat`                                                                  |
| **Web API equivalent** | [`resume_chat`](/messaging/customer-chat-api/v3.4/#resume-chat)                |
| **Push message**       | [`incoming_chat`](/messaging/customer-chat-api/v3.4/rtm-pushes/#incoming_chat) |
...
| **Web API equivalent** | [`deactivate_chat`](/messaging/customer-chat-api/v3.4/#deactivate-chat)                                                                                                   |
| **Push message**       | [`incoming_event`](/messaging/customer-chat-api/v3.4/rtm-pushes/#incoming_event) and [`chat_deactivated`](/messaging/customer-chat-api/v3.4/rtm-pushes/#chat_deactivated) |
...
| ---------------------- | -------------------------------------------------------------------------------- |
| **Action**             | `send_event`                                                                     |
| **Web API equivalent** | [`send_event`](/messaging/customer-chat-api/v3.4/#send-event)                    |
| **Push message**       | [`incoming_event`](/messaging/customer-chat-api/v3.4/rtm-pushes/#incoming_event) |
...
| **Web API equivalent** | [`send_rich_message_postback`](/messaging/customer-chat-api/v3.4/#send-rich-message-postback)                          |
| **Push message**       | [`incoming_rich_message_postback`](/messaging/customer-chat-api/v3.4/rtm-pushes/#incoming_rich_message_postback)**\*** |
...
| **Web API equivalent** | [`send_sneak_peek`](/messaging/customer-chat-api/v3.4/#send-sneak-peek) |
| **Push message**       | -                                                                       |
...
| **Web API equivalent** | [`update_chat_properties`](/messaging/customer-chat-api/v3.4/#update-chat-properties)              |
| **Push message**       | [`chat_properties_updated`](/messaging/customer-chat-api/v3.4/rtm-pushes/#chat_properties_updated) |
...
| **Web API equivalent** | [`delete_chat_properties`](/messaging/customer-chat-api/v3.4/#delete-chat-properties)              |
| **Push message**       | [`chat_properties_deleted`](/messaging/customer-chat-api/v3.4/rtm-pushes/#chat_properties_deleted) |
...
| **Web API equivalent** | [`update_thread_properties`](/messaging/customer-chat-api/v3.4/#update-thread-properties)              |
| **Push message**       | [`thread_properties_updated`](/messaging/customer-chat-api/v3.4/rtm-pushes/#thread_properties_updated) |
...
| **Web API equivalent** | [`delete_thread_properties`](/messaging/customer-chat-api/v3.4/#delete-thread-properties)              |
| **Push message**       | [`thread_properties_deleted`](/messaging/customer-chat-api/v3.4/rtm-pushes/#thread_properties_deleted) |
...
| **Web API equivalent** | [`update_event_properties`](/messaging/customer-chat-api/v3.4/#update-event-properties)              |
| **Push message**       | [`event_properties_updated`](/messaging/customer-chat-api/v3.4/rtm-pushes/#event_properties_updated) |
...
| **Web API equivalent** | [`delete_event_properties`](/messaging/customer-chat-api/v3.4/#delete-event-properties)              |
| **Push message**       | [`event_properties_deleted`](/messaging/customer-chat-api/v3.4/rtm-pushes/#event_properties_deleted) |
...
| **Web API equivalent** | [`update_customer`](/messaging/customer-chat-api/v3.4/#update-customer)              |
| **Push message**       | [`customer_updated`](/messaging/customer-chat-api/v3.4/rtm-pushes/#customer_updated) |
...
| **Web API equivalent** | [`set_customer_session_fields`](/messaging/customer-chat-api/v3.4/#set-customer-session-fields) |
| **Push message**       | [`customer_updated`](/messaging/customer-chat-api/v3.4/rtm-pushes/#customer_updated)            |
...
| ---------------------- | ----------------------------------------------------------------- |
| **Action**             | `get_customer`                                                    |
| **Web API equivalent** | [`get_customer`](/messaging/customer-chat-api/v3.4/#get-customer) |
| **Push message**       | -                                                                 |
...
| **Web API equivalent** | [`list_group_statuses`](/messaging/customer-chat-api/v3.4/#list-group-statuses) |
| **Push message**       | -                                                                               |
...
| ---------------------- | --------------------------------------------------------- |
| **Action**             | `get_form`                                                |
| **Web API equivalent** | [`get_form`](/messaging/customer-chat-api/v3.4/#get-form) |
| **Push message**       | -                                                         |
...
| **Web API equivalent** | [`get_predicted_agent`](/messaging/customer-chat-api/v3.4/#get-predicted-agent) |
| **Push message**       | -                                                                               |
...
| ---------------------- | ----------------------------------------------------------------- |
| **Action**             | `get_url_info`                                                    |
| **Web API equivalent** | [`get_url_info`](/messaging/customer-chat-api/v3.4/#get-url-info) |
| **Push message**       | -                                                                 |
...
| **Web API equivalent** | [`mark_events_as_seen`](/messaging/customer-chat-api/v3.4/#mark-events-as-seen)                |
| **Push message**       | [`events_marked_as_seen`](/messaging/customer-chat-api/v3.4/rtm-pushes/#events_marked_as_seen) |
...
| **Web API equivalent** | [`accept_greeting`](/messaging/customer-chat-api/v3.4/#accept-greeting)                |
| **Push message**       | [`greeting_accepted`](/messaging/customer-chat-api/v3.4/rtm-pushes/#greeting_accepted) |
...
| **Web API equivalent** | [`cancel_greeting`](/messaging/customer-chat-api/v3.4/#cancel-greeting)                |
| **Push message**       | [`greeting_canceled`](/messaging/customer-chat-api/v3.4/rtm-pushes/#greeting_canceled) |
...
- There are no retries for pushes. To determine if a customer has seen an event, compare the [event's](/messaging/customer-chat-api/v3.4/data-structures/#response) `created_at` parameter with the [customer's](/messaging/customer-chat-api/v3.4/data-structures/#customer) `events_seen_up_to` field.

<SectionLink to={"/messaging/customer-chat-api/v3.4/rtm-pushes"}>See available pushes</SectionLink>
