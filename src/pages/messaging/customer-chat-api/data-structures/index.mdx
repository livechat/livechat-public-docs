...
<CodeResponse version="v3.6" type="customer" title={'Sample Omnichannel data structure'} json="omnichannel"/>
...
<CodeResponse version="v3.6" type="customer" title={'Sample Thread data structure'} json="omnichannel_fb_messenger"/>
...
<CodeResponse version="v3.6" type="customer" title={'Sample Thread data structure'} json="omnichannel_twilio"/>
