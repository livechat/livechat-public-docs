...
File event indicates about a file being uploaded.
...
<CodeResponse version="v3.6" type="customer" title={'Sample File in response'} json="file"/>
...
<Code>
<CodeResponse version="v3.6" type="customer" title={'Sample Form in response'} json="form"/>
</Code>
</Section>
...
<CodeResponse version="v3.6" type="customer" title={'Sample Filled form in response'} json="filledForm"/>
...
<Code>
<CodeResponse version="v3.6" type="customer" title={'Sample Message in response'} json="message"/>
</Code>
...
<Code>
<CodeResponse version="v3.6" type="customer" title={'Sample Rich message in response'} json="richMessage"/>
</Code>
</Section>
...
<Code>
<CodeResponse version="v3.6" type="customer" title={'Sample Custom event in response'} json="custom"/>
</Code>
</Section>
...
<Code>
<CodeResponse version="v3.6" type="customer" title={'Sample System message in response'} json="systemMessage"/>
</Code>
</Section>
...
<CodeResponse version="v3.6" type="customer" title={'Sample Customer data structure'} json="customer"/>
...
<CodeResponse version="v3.6" type="customer" title={'Sample Agent data structure'} json="agent"/>
...
<CodeResponse version="v3.6" type="customer" title={'Sample Access data structure'} json="access"/>
...
<CodeResponse version="v3.6" type="customer" title={'Sample Chat data structure'} json="chat"/>
...
<CodeResponse version="v3.6" type="customer" title={'Sample Chat summary data structure'} json="chatSummary"/>

## Forms

A template of a prechat, postchat, or a ticket form.

<CodeResponse version="v3.6" type="customer" title={'Sample Form data structure'} json="form"/>
...
<CodeResponse version="v3.6" type="customer" title={'Sample Form fields'} json="formFields"/>
...
<CodeResponse version="v3.6" type="customer" title={'Sample Form fields'} json="filledFormFields"/>
...
<CodeResponse version="v3.6" type="customer" title={'Sample Properties data structure'} json="properties"/>

## Threads

<CodeResponse version="v3.6" type="customer" title={'Sample Thread data structure'} json="thread"/>
