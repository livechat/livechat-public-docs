...
| `omnichannel`    | optional  | An object of customer's omnichannel data.                                                                                |
...
<CodeResponse version="v3.6" type="customer" title={'Sample Customer Omnichannel data structure'} json="omnichannel"/>
...
<CodeResponse version="v3.6" type="customer" title={'Sample Facebook Messenger data structure'} json="omnichannel_fb_messenger"/>
