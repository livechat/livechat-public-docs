...
This push can be emitted with `user.present` set to `false` when a user writes to a chat without joining it. You can achieve that via the [Send Event](/messaging/agent-chat-api/v3.5/rtm-reference/#send-event) method.
...
Indicates about an incoming [event](/messaging/customer-chat-api/v3.5/data-structures/#events) sent to a chat.
...
Indicates that an [event](/messaging/customer-chat-api/v3.5/data-structures/#events) was updated.
...
Indicates about an incoming [rich message](/messaging/customer-chat-api/v3.5/data-structures/#rich-message) postback. The push payload contains the info on the postback itself, as well as the chat it was sent in.
...
| `event`                | Greeting event ([Message](/messaging/customer-chat-api/v3.5/data-structures/#message) or [Rich message](/messaging/customer-chat-api/v3.5/data-structures/#rich-message)) |
