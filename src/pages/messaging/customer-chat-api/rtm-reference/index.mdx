...
This document describes the **Customer Chat Real-Time Messaging API v3.3**. This is the latest stable version recommended for the production use. [Read more about versioning...](/messaging/#api-versioning)
...
<Code>
<CodeResponse version="v3.3" type="customer" title={'Sample Rich message in response'} json="message"/>
</Code>
