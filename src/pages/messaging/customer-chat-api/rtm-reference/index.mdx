...
This document describes the **Customer Chat Real-Time Messaging API v3.6**. This is the latest stable version recommended for the production use. [Read more about versioning...](/messaging/#api-versioning)
...
| The API endpoint                                 |
| ------------------------------------------------ |
| `wss://api.livechatinc.com/v3.6/customer/rtm/ws` |
...
| **Other**      | [`get_form`](#get-form) [`get_predicted_agent`](#get-predicted-agent) [`get_url_info`](#get-url-info) [`mark_events_as_seen`](#mark-events-as-seen) [`accept_greeting`](#accept-greeting) [`cancel_greeting`](#cancel-greeting) [`request_welcome_message`](#request-welcome-message) [`send_greeting_button_clicked`](#send-greeting-button-clicked) |
...
| ---------------------- | ------------------------------------------------------------- |
| **Action**             | `list_chats`                                                  |
| **Web API equivalent** | [`list_chats`](/messaging/customer-chat-api/v3.6/#list-chats) |
| **Push message**       | -                                                             |
...
| `sort_order` | No       | `string` | Possible values: `asc`, `desc`. Default: `desc`. Chat summaries are sorted by the creation date of its last thread. |
| `page_id`    | No       | `string` |                                                                                                                     |
...
| `chats_summary`    | `array`   | An array of [chat summary](/messaging/customer-chat-api/v3.6/data-structures/#chat-summaries) data structures.  |
...
| ---------------------- | ----------------------------------------------------------------- |
| **Action**             | `list_threads`                                                    |
| **Web API equivalent** | [`list_threads`](/messaging/customer-chat-api/v3.6/#list-threads) |
| **Push message**       | -                                                                 |
...
| `page_id`          | No       | `string`  |                                                                                                                                                                                                                                                                  |
| `min_events_count` | No       | `number`  | The minimum number of events to be returned in the response. This is the **total** number of events, so they can come from more than one thread. You'll get as many latest threads as needed to meet the `min_events_count` condition. Minimum: 1. Maximum: 100. |
...
| ---------------------- | --------------------------------------------------------- |
| **Action**             | `get_chat`                                                |
| **Web API equivalent** | [`get_chat`](/messaging/customer-chat-api/v3.6/#get-chat) |
| **Push message**       | -                                                         |
...
| ---------------------- | ------------------------------------------------------------------------------ |
| **Action**             | `start_chat`                                                                   |
| **Web API equivalent** | [`start_chat`](/messaging/customer-chat-api/v3.6/#start-chat)                  |
| **Push message**       | [`incoming_chat`](/messaging/customer-chat-api/v3.6/rtm-pushes/#incoming_chat) |
...
| ---------------------- | ------------------------------------------------------------------------------ |
| **Action**             | `resume_chat`                                                                  |
| **Web API equivalent** | [`resume_chat`](/messaging/customer-chat-api/v3.6/#resume-chat)                |
| **Push message**       | [`incoming_chat`](/messaging/customer-chat-api/v3.6/rtm-pushes/#incoming_chat) |
...
| `chat.thread.properties` | No       | `object` | The initial thread properties.                                                                                                                          |
| `active`                 | No       | `bool`   | If set to `false`, creates an inactive thread. Default: `true`.                                                                                         |
| `continuous`             | No       | `bool`   | If set to `true`, sets a chat to the continuous mode. If set to `false`, sets a chat to the non-continuous mode. When unset, leaves the mode unchanged. |
...
| **Web API equivalent** | [`deactivate_chat`](/messaging/customer-chat-api/v3.6/#deactivate-chat)                                                                                                   |
| **Push message**       | [`incoming_event`](/messaging/customer-chat-api/v3.6/rtm-pushes/#incoming_event) and [`chat_deactivated`](/messaging/customer-chat-api/v3.6/rtm-pushes/#chat_deactivated) |
...
| ---------------------- | -------------------------------------------------------------------------------- |
| **Action**             | `send_event`                                                                     |
| **Web API equivalent** | [`send_event`](/messaging/customer-chat-api/v3.6/#send-event)                    |
| **Push message**       | [`incoming_event`](/messaging/customer-chat-api/v3.6/rtm-pushes/#incoming_event) |
...
| ---------------------- | ------------------------------------------------------------------------------ |
| **Action**             | `delete_event`                                                                 |
| **Web API equivalent** | [`delete_event`](/messaging/customer-chat-api/v3.6/#delete-event)              |
| **Push message**       | [`event_deleted`](/messaging/customer-chat-api/v3.6/rtm-pushes/#event_deleted) |
...
| **Web API equivalent** | [`send_rich_message_postback`](/messaging/customer-chat-api/v3.6/#send-rich-message-postback)                          |
| **Push message**       | [`incoming_rich_message_postback`](/messaging/customer-chat-api/v3.6/rtm-pushes/#incoming_rich_message_postback)**\*** |
...
| **Web API equivalent** | [`send_sneak_peek`](/messaging/customer-chat-api/v3.6/#send-sneak-peek) |
| **Push message**       | -                                                                       |
...
| **Web API equivalent** | [`update_chat_properties`](/messaging/customer-chat-api/v3.6/#update-chat-properties)              |
| **Push message**       | [`chat_properties_updated`](/messaging/customer-chat-api/v3.6/rtm-pushes/#chat_properties_updated) |
...
| **Web API equivalent** | [`delete_chat_properties`](/messaging/customer-chat-api/v3.6/#delete-chat-properties)              |
| **Push message**       | [`chat_properties_deleted`](/messaging/customer-chat-api/v3.6/rtm-pushes/#chat_properties_deleted) |
...
| **Web API equivalent** | [`update_thread_properties`](/messaging/customer-chat-api/v3.6/#update-thread-properties)              |
| **Push message**       | [`thread_properties_updated`](/messaging/customer-chat-api/v3.6/rtm-pushes/#thread_properties_updated) |
...
| **Web API equivalent** | [`delete_thread_properties`](/messaging/customer-chat-api/v3.6/#delete-thread-properties)              |
| **Push message**       | [`thread_properties_deleted`](/messaging/customer-chat-api/v3.6/rtm-pushes/#thread_properties_deleted) |
...
| **Web API equivalent** | [`update_event_properties`](/messaging/customer-chat-api/v3.6/#update-event-properties)              |
| **Push message**       | [`event_properties_updated`](/messaging/customer-chat-api/v3.6/rtm-pushes/#event_properties_updated) |
...
| **Web API equivalent** | [`delete_event_properties`](/messaging/customer-chat-api/v3.6/#delete-event-properties)              |
| **Push message**       | [`event_properties_deleted`](/messaging/customer-chat-api/v3.6/rtm-pushes/#event_properties_deleted) |
...
| **Web API equivalent** | [`update_customer`](/messaging/customer-chat-api/v3.6/#update-customer)              |
| **Push message**       | [`customer_updated`](/messaging/customer-chat-api/v3.6/rtm-pushes/#customer_updated) |
...
| **Web API equivalent** | [`set_customer_session_fields`](/messaging/customer-chat-api/v3.6/#set-customer-session-fields) |
| **Push message**       | [`customer_updated`](/messaging/customer-chat-api/v3.6/rtm-pushes/#customer_updated)            |
...
| ---------------------- | ----------------------------------------------------------------- |
| **Action**             | `get_customer`                                                    |
| **Web API equivalent** | [`get_customer`](/messaging/customer-chat-api/v3.6/#get-customer) |
| **Push message**       | -                                                                 |
...
|                  |                                                                                                                   |
| ---------------- | ----------------------------------------------------------------------------------------------------------------- |
| `name`           | [The customer's](/messaging/customer-chat-api/v3.6/data-structures/#customer) name. Returned only if set.         |
| `email`          | [The customer's](/messaging/customer-chat-api/v3.6/data-structures/#customer) email. Returned only if set.        |
| `avatar`         | [The customer's](/messaging/customer-chat-api/v3.6/data-structures/#customer) avatar. Returned only if set.       |
...
| **Web API equivalent** | [`list_group_statuses`](/messaging/customer-chat-api/v3.6/#list-group-statuses) |
| **Push message**       | -                                                                               |
...
| ---------------------- | --------------------------------------------------------- |
| **Action**             | `get_form`                                                |
| **Web API equivalent** | [`get_form`](/messaging/customer-chat-api/v3.6/#get-form) |
| **Push message**       | -                                                         |
...
| `type`     | Yes      | `string`  | The form type. Possible values: `prechat`, `postchat`, or `ticket`. |

#### Response

| Field     | Notes                                                                                                                   |
| --------- | ----------------------------------------------------------------------------------------------------------------------- |
| `enabled` | If set to `false`: the `form` object is not returned; prechat/postchat survey is disabled in the LiveChat Agent App UI. |
...
| **Web API equivalent** | [`get_predicted_agent`](/messaging/customer-chat-api/v3.6/#get-predicted-agent) |
| **Push message**       | -                                                                               |
...
| ---------------------- | ----------------------------------------------------------------- |
| **Action**             | `get_url_info`                                                    |
| **Web API equivalent** | [`get_url_info`](/messaging/customer-chat-api/v3.6/#get-url-info) |
| **Push message**       | -                                                                 |
...
| Field                | Data type | Notes                                                       |
| -------------------- | --------- | ----------------------------------------------------------- |
| `image_url`          | `string`  | The URL of the minified image hosted on the LiveChat's CDN. |
...
| **Web API equivalent** | [`mark_events_as_seen`](/messaging/customer-chat-api/v3.6/#mark-events-as-seen)                |
| **Push message**       | [`events_marked_as_seen`](/messaging/customer-chat-api/v3.6/rtm-pushes/#events_marked_as_seen) |
...
| **Web API equivalent** | [`accept_greeting`](/messaging/customer-chat-api/v3.6/#accept-greeting)                |
| **Push message**       | [`greeting_accepted`](/messaging/customer-chat-api/v3.6/rtm-pushes/#greeting_accepted) |
...
| **Web API equivalent** | [`cancel_greeting`](/messaging/customer-chat-api/v3.6/#cancel-greeting)                |
| **Push message**       | [`greeting_canceled`](/messaging/customer-chat-api/v3.6/rtm-pushes/#greeting_canceled) |
...
| **Web API equivalent** | [`send_greeting_button_clicked`](/messaging/customer-chat-api/v3.6/#send-greeting-button-clicked) |
| **Push message**       | -                                                                                                 |
...
| **Web API equivalent** | [`request_welcome_message`](/messaging/customer-chat-api/v3.6/#request-welcome-message)              |
| **Push message**       | [`incoming_welcome_message`](/messaging/customer-chat-api/v3.6/rtm-pushes/#incoming_welcome_message) |
...
<SectionLink to={"/messaging/customer-chat-api/v3.6/rtm-pushes"}>See available pushes</SectionLink>
