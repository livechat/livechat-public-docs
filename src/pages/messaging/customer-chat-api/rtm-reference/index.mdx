...
| `customer.suggested_email`    | No       | `string`   | An email address suggested for the customer but not confirmed by them. An empty value is ignored in this version; clearing a suggestion requires [v3.7](/messaging/customer-chat-api/v3.7/rtm-reference/#login). |
