...
For backend applications, you can specify the region in the request header. The mechanism is the same as in [Agent Chat Web API reference](/messaging/agent-chat-api/v3.5/#data-centers). It doesn't work for frontend applications, though.
Instead, frontend apps connect to a region different than the default one by specifying the region suffix in the URL.

**`fra`:** `wss://api-fra.livechatinc.com/v3.5/agent/rtm/ws`

**`dal`:** `wss://api.livechatinc.com/v3.5/agent/rtm/ws`
...
| The API endpoint                              |
| --------------------------------------------- |
| `wss://api.livechatinc.com/v3.5/agent/rtm/ws` |
...
| **Status**      | [`login`](#login) [`set_routing_status`](#set-routing-status) [`set_away_status`](#set-away-status) [`logout`](#logout) [`list_routing_statuses`](#list-routing-statuses)                                                                                                                                                           |
...
| **Web API equivalent** | [`list_chats`](/messaging/agent-chat-api/v3.5/#list-chats) |
| **Push message**       | -                                                          |
...
| **Action**             | `list_threads`                                                 |
| **Required scopes**    | `chats--all:ro` **\*** or `chats--access:ro` **\*\***          |
| **Web API equivalent** | [`list_threads`](/messaging/agent-chat-api/v3.5/#list-threads) |
| **Push message**       | -                                                              |
...
| **Web API equivalent** | [`get_chat`](/messaging/agent-chat-api/v3.5/#get-chat)                                             |
| **Push message**       | -                                                                                                  |
...
| **Required scopes**    | `chats--all:ro` **\*** or `chats--access:ro` **\*\***            |
| **Web API equivalent** | [`list_archives`](/messaging/agent-chat-api/v3.5/#list-archives) |
| **Push message**       | -                                                                |
...
| **Web API equivalent** | [`start_chat`](/messaging/agent-chat-api/v3.5/#start-chat)                               |
| **Push message**       | [`incoming_chat`](/messaging/agent-chat-api/v3.5/rtm-pushes/#incoming_chat)              |
...
| **Action**             | `resume_chat`                                                                            |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***, depending on the requested groups |
| **Web API equivalent** | [`resume_chat`](/messaging/agent-chat-api/v3.5/#resume-chat)                             |
| **Push message**       | [`incoming_chat`](/messaging/agent-chat-api/v3.5/rtm-pushes/#incoming_chat)              |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***, depending on the requested groups |
| **Web API equivalent** | [`deactivate_chat`](/messaging/agent-chat-api/v3.5/#deactivate-chat)                     |
| **Push message**       | [`chat_deactivated`](/messaging/agent-chat-api/v3.5/rtm-pushes/#chat_deactivated)        |
...
| **Web API equivalent** | [`follow_chat`](/messaging/agent-chat-api/v3.5/#follow-chat)                             |
| **Push message**       | [`incoming_chat`](/messaging/agent-chat-api/v3.5/rtm-pushes/#incoming_chat)**\*\*\***    |
...
| **Required scopes**    | -                                                                               |
| **Web API equivalent** | [`unfollow_chat`](/messaging/agent-chat-api/v3.5/#unfollow-chat)                |
| **Push message**       | [`chat_unfollowed`](/messaging/agent-chat-api/v3.5/rtm-pushes/#chat_unfollowed) |
...
| **Web API equivalent** | [`transfer_chat`](/messaging/agent-chat-api/v3.5/#transfer-chat)                  |
| **Push message**       | [`chat_transferred`](/messaging/agent-chat-api/v3.5/rtm-pushes/#chat_transferred) |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                        |
| **Web API equivalent** | [`remove_user_from_chat`](/messaging/agent-chat-api/v3.5/#remove-user-from-chat)             |
| **Push message**       | [`user_removed_from_chat`](messaging/agent-chat-api/v3.5/rtm-pushes/#user_removed_from_chat) |
...
| **Action**             | `send_event`                                                                  |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                         |
| **Web API equivalent** | [`send_event`](/messaging/agent-chat-api/v3.5/#send-event)                    |
| **Push message**       | [`incoming_event`](/messaging/agent-chat-api/v3.5/rtm-pushes/#incoming_event) |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                                                   |
| **Web API equivalent** | [`send_rich_message_postback`](/messaging/agent-chat-api/v3.5/#send-rich-message-postback)                              |
| **Push message**       | [`incoming_rich_message_postback`](/messaging/agent-chat-api/v3.5/rtm-pushes/#incoming_rich_message_postback)**\*\*\*** |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                           |
| **Web API equivalent** | [`update_chat_properties`](/messaging/agent-chat-api/v3.5/#update-chat-properties)              |
| **Push message**       | [`chat_properties_updated`](/messaging/agent-chat-api/v3.5/rtm-pushes/#chat_properties_updated) |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                           |
| **Web API equivalent** | [`delete_chat_properties`](/messaging/agent-chat-api/v3.5/#delete-chat-properties)              |
| **Push message**       | [`chat_properties_deleted`](/messaging/agent-chat-api/v3.5/rtm-pushes/#chat_properties_deleted) |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                               |
| **Web API equivalent** | [`update_thread_properties`](/messaging/agent-chat-api/v3.5/#update-thread-properties)              |
| **Push message**       | [`thread_properties_updated`](/messaging/agent-chat-api/v3.5/rtm-pushes/#thread_properties_updated) |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                               |
| **Web API equivalent** | [`delete_thread_properties`](/messaging/agent-chat-api/v3.5/#delete-thread-properties)              |
| **Push message**       | [`thread_properties_deleted`](/messaging/agent-chat-api/v3.5/rtm-pushes/#thread_properties_deleted) |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                             |
| **Web API equivalent** | [`update_event_properties`](/messaging/agent-chat-api/v3.5/#update-event-properties)              |
| **Push message**       | [`event_properties_updated`](/messaging/agent-chat-api/v3.5/rtm-pushes/#event_properties_updated) |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                             |
| **Web API equivalent** | [`delete_event_properties`](/messaging/agent-chat-api/v3.5/#delete-event-properties)              |
| **Push message**       | [`event_properties_deleted`](/messaging/agent-chat-api/v3.5/rtm-pushes/#event_properties_deleted) |
...
Read how to [list all available tags](/management/configuration-api/v3.5#list-tags) and [create a new tag](/management/configuration-api/v3.5#create-tag).
...
| **Action**             | `tag_thread`                                                                |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                       |
| **Web API equivalent** | [`tag_thread`](/messaging/agent-chat-api/v3.5/#tag-thread)                  |
| **Push message**       | [`thread_tagged`](/messaging/agent-chat-api/v3.5/rtm-pushes/#thread_tagged) |
...
| **Action**             | `untag_thread`                                                                  |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                           |
| **Web API equivalent** | [`untag_thread`](/messaging/agent-chat-api/v3.5/#untag-thread)                  |
| **Push message**       | [`thread_untagged`](/messaging/agent-chat-api/v3.5/rtm-pushes/#thread_untagged) |
...
| **Web API equivalent** | [`get_customer`](/messaging/agent-chat-api/v3.5/#get-customer) |
| **Push message**       | -                                                              |
...
| **Required scopes**    | `customers:ro`                                                     |
| **Web API equivalent** | [`list_customers`](/messaging/agent-chat-api/v3.5/#list-customers) |
| **Push message**       | -                                                                  |
...
| **Web API equivalent** | [`create_customer`](/messaging/agent-chat-api/v3.5/#create-customer)                |
| **Push message**       | [`incoming_customer`](/messaging/agent-chat-api/v3.5/rtm-pushes/#incoming_customer) |
...
| **Required scopes**    | `customers:rw`                                                                    |
| **Web API equivalent** | [`update_customer`](/messaging/agent-chat-api/v3.5/#update-customer)              |
| **Push message**       | [`customer_updated`](/messaging/agent-chat-api/v3.5/rtm-pushes/#customer_updated) |
...
| **Web API equivalent** | [`ban_customer`](/messaging/agent-chat-api/v3.5/#ban-customer)                  |
| **Push message**       | [`customer_banned`](/messaging/agent-chat-api/v3.5/rtm-pushes/#customer_banned) |
...
| **Required scopes**    | `customers:ro`                                                                            |
| **Web API equivalent** | [`follow_customer`](/messaging/agent-chat-api/v3.5/#follow-customer)                      |
| **Push message**       | [`incoming_customer`](/messaging/agent-chat-api/v3.5/rtm-pushes/#incoming_customer)**\*** |
...
| **Required scopes**    | -                                                                                       |
| **Web API equivalent** | [`unfollow_customer`](/messaging/agent-chat-api/v3.5/#unfollow-customer)                |
| **Push message**       | [`customer_unfollowed`](/messaging/agent-chat-api/v3.5/rtm-pushes/#customer_unfollowed) |
...
| **Web API equivalent** | [`set_routing_status`](/messaging/agent-chat-api/v3.5/#set-routing-status)                                                                           |
| **Push message**       | [`routing_status_set`](/messaging/agent-chat-api/v3.5/rtm-pushes/#routing_status_set)                                                                |
...
| **Web API equivalent** | [`list_routing_statuses`](/messaging/agent-chat-api/v3.5/#list-routing-statuses) |
| **Push message**       | -                                                                                |
...
| **Required scopes**    | `chats--all:ro` **\*** or `chats--access:ro` **\*\***                                       |
| **Web API equivalent** | [`mark_events_as_seen`](/messaging/agent-chat-api/v3.5/#mark-events-as-seen)                |
| **Push message**       | [`events_marked_as_seen`](/messaging/agent-chat-api/v3.5/rtm-pushes/#events_marked_as_seen) |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                            |
| **Web API equivalent** | [`send_typing_indicator`](/messaging/agent-chat-api/v3.5/#send-typing-indicator) |
| **Push message**       | -                                                                                |
...
| **Web API equivalent** | [`multicast`](/messaging/agent-chat-api/v3.5/#multicast)                              |
| **Push message**       | [`incoming_multicast`](/messaging/agent-chat-api/v3.5/rtm-pushes/#incoming_multicast) |
...
| **Required scopes**    | -                                                                                      |
| **Web API equivalent** | [`list_agents_for_transfer`](/messaging/agent-chat-api/v3.5/#list-agents-for-transfer) |
| **Push message**       | -                                                                                      |
...
- Their equivalents in Web API are [webhooks](/management/configuration-api/v3.5/#webhooks). Pushes and webhooks have similar payloads.
- There are no retries for pushes. To determine if a user has seen an event, compare the [event's](/messaging/agent-chat-api/v3.5/data-structures/#response) `created_at` parameter with the [user's](/messaging/agent-chat-api/v3.5/data-structures/#users) `events_seen_up_to` field.

<SectionLink to={"/messaging/agent-chat-api/v3.5/rtm-pushes"}>See available pushes</SectionLink>
