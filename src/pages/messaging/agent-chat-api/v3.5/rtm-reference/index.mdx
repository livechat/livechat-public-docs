...
This document describes the **Agent Chat Real-Time Messaging API v3.5**, which is a legacy version. For production-ready applications, it's best to use to the current stable version. [Read more about versioning...](/messaging/#api-versioning)
...
| -------------------------------------------------------------------------------- | --------- | ------------------------------------------------------------------------------------------ |
| `page_id`                                                                        | `string`  |                                                                                            |
| `limit`                                                                          | `number`  | Maximum number of records returned on each [page](#pagination). Default: 10, maximum: 100. |
