...
Read how to [list all available chats](/management/configuration-api/v3.5/#list-tags) and [create a new tag](/management/configuration-api/v3.5/#create-tag). In this method, letter case needs to be respected for tag names.
...
Untags a given **thread**. In this method, letter case needs to be respected for tag names.
