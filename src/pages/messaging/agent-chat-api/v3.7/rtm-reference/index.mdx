...
| **Required scopes**    | `customers:ro`                                                                            |
| **Web API equivalent** | [`follow_customer`](/messaging/agent-chat-api/v3.7/#follow-customer)                      |
| **Push message**       | [`incoming_customer`](/messaging/agent-chat-api/v3.7/rtm-pushes/#incoming_customer)**\*** |
...
| **Required scopes**    | -                                                                                       |
| **Web API equivalent** | [`unfollow_customer`](/messaging/agent-chat-api/v3.7/#unfollow-customer)                |
| **Push message**       | [`customer_unfollowed`](/messaging/agent-chat-api/v3.7/rtm-pushes/#customer_unfollowed) |
