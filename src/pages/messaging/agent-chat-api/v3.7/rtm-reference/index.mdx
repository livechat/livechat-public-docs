...
| The API endpoint                              |
| --------------------------------------------- |
| `wss://api.livechatinc.com/v3.7/agent/rtm/ws` |

When connecting to the Agent Chat RTM API, clients have to send over the required query string parameters.
...
| **Web API equivalent** | [`list_chats`](/messaging/agent-chat-api/v3.7/#list-chats) |
| **Push message**       | -                                                          |
...
| **Action**             | `list_threads`                                                 |
| **Required scopes**    | `chats--all:ro` **\*** or `chats--access:ro` **\*\***          |
| **Web API equivalent** | [`list_threads`](/messaging/agent-chat-api/v3.7/#list-threads) |
| **Push message**       | -                                                              |
...
| **Web API equivalent** | [`get_chat`](/messaging/agent-chat-api/v3.7/#get-chat)                                             |
| **Push message**       | -                                                                                                  |
...
| **Required scopes**    | `chats--all:ro` **\*** or `chats--access:ro` **\*\***            |
| **Web API equivalent** | [`list_archives`](/messaging/agent-chat-api/v3.7/#list-archives) |
| **Push message**       | -                                                                |
...
| `filters.agents.<filter_type>`<sup>**2**</sup>                                   | No       | `any`     | Described below. If `exists` is set to `false`: returns unassigned chats. If set to `true`: returns assigned chats.                                                      |
...
- `values` (`string[]` - an array of [Event](/messaging/agent-chat-api/v3.7/data-structures/#events) types, duplicates are ignored)
- `exclude_values` (`string[]` - an array of [Event](/messaging/agent-chat-api/v3.7/data-structures/#events) types, duplicates are ignored)
- `require_every_value` (`bool`) - if set to `true`, will return only those chats that have all elements passed in `values` or `exclude_values`
...
- `from` (`string`) - A date & time format compatible with RFC3339 with a resolution of microseconds, `YYYY-MM-DDTHH:MM:SS.ssssss+HH:MM`
- `to` (`string`) - A date & time format compatible with RFC3339 with a resolution of microseconds, `YYYY-MM-DDTHH:MM:SS.ssssss+HH:MM`
- `exists` (`bool`)
...
| **Web API equivalent** | [`start_chat`](/messaging/agent-chat-api/v3.7/#start-chat)                               |
| **Push message**       | [`incoming_chat`](/messaging/agent-chat-api/v3.7/rtm-pushes/#incoming_chat)              |
...
| `chat.thread.events`     | No       | `array`    | The list of the initial chat [events](/messaging/agent-chat-api/data-structures/#events) objects. Does not support the `form` type event in the LiveChat app. |
...
| **Action**             | `resume_chat`                                                                            |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***, depending on the requested groups |
| **Web API equivalent** | [`resume_chat`](/messaging/agent-chat-api/v3.7/#resume-chat)                             |
| **Push message**       | [`incoming_chat`](/messaging/agent-chat-api/v3.7/rtm-pushes/#incoming_chat)              |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***, depending on the requested groups |
| **Web API equivalent** | [`deactivate_chat`](/messaging/agent-chat-api/v3.7/#deactivate-chat)                     |
| **Push message**       | [`chat_deactivated`](/messaging/agent-chat-api/v3.7/rtm-pushes/#chat_deactivated)        |
...
| **Web API equivalent** | [`follow_chat`](/messaging/agent-chat-api/v3.7/#follow-chat)                             |
| **Push message**       | [`incoming_chat`](/messaging/agent-chat-api/v3.7/rtm-pushes/#incoming_chat)**\*\*\***    |
...
| **Required scopes**    | -                                                                               |
| **Web API equivalent** | [`unfollow_chat`](/messaging/agent-chat-api/v3.7/#unfollow-chat)                |
| **Push message**       | [`chat_unfollowed`](/messaging/agent-chat-api/v3.7/rtm-pushes/#chat_unfollowed) |
...
| **Web API equivalent** | [`transfer_chat`](/messaging/agent-chat-api/v3.7/#transfer-chat)                  |
| **Push message**       | [`chat_transferred`](/messaging/agent-chat-api/v3.7/rtm-pushes/#chat_transferred) |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                 |
| **Web API equivalent** | [`add_user_to_chat`](/messaging/agent-chat-api/v3.7/#add-user-to-chat)                |
| **Push message**       | [`user_added_to_chat`](/messaging/agent-chat-api/v3.7/rtm-pushes/#user_added_to_chat) |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                        |
| **Web API equivalent** | [`remove_user_from_chat`](/messaging/agent-chat-api/v3.7/#remove-user-from-chat)             |
| **Push message**       | [`user_removed_from_chat`](messaging/agent-chat-api/v3.7/rtm-pushes/#user_removed_from_chat) |
...
Sends an [event](/messaging/agent-chat-api/v3.7/data-structures/#events) that isn't saved in the chat. Use this method when you're preparing a longer response and want to send a partial update before sending the final message with [Send Event](/messaging/agent-chat-api/v3.7/rtm-reference#send-event). Only [Message](/messaging/agent-chat-api/v3.7/data-structures/#message) is supported. Visibility must be set to `all` or skipped. The user must be [added to the chat](/messaging/agent-chat-api/rtm-pushes/#user_added_to_chat) before they can send an event.
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                      |
| **Web API equivalent** | [`send_event_preview`](/messaging/agent-chat-api/v3.7/#send-event-preview) |
| **Push message**       | -                                                                          |
...
| **Action**             | `send_event`                                                                  |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                         |
| **Web API equivalent** | [`send_event`](/messaging/agent-chat-api/v3.7/#send-event)                    |
| **Push message**       | [`incoming_event`](/messaging/agent-chat-api/v3.7/rtm-pushes/#incoming_event) |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                                                   |
| **Web API equivalent** | [`send_rich_message_postback`](/messaging/agent-chat-api/v3.7/#send-rich-message-postback)                              |
| **Push message**       | [`incoming_rich_message_postback`](/messaging/agent-chat-api/v3.7/rtm-pushes/#incoming_rich_message_postback)**\*\*\*** |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                           |
| **Web API equivalent** | [`update_chat_properties`](/messaging/agent-chat-api/v3.7/#update-chat-properties)              |
| **Push message**       | [`chat_properties_updated`](/messaging/agent-chat-api/v3.7/rtm-pushes/#chat_properties_updated) |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                           |
| **Web API equivalent** | [`delete_chat_properties`](/messaging/agent-chat-api/v3.7/#delete-chat-properties)              |
| **Push message**       | [`chat_properties_deleted`](/messaging/agent-chat-api/v3.7/rtm-pushes/#chat_properties_deleted) |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                               |
| **Web API equivalent** | [`update_thread_properties`](/messaging/agent-chat-api/v3.7/#update-thread-properties)              |
| **Push message**       | [`thread_properties_updated`](/messaging/agent-chat-api/v3.7/rtm-pushes/#thread_properties_updated) |
...
| `thread_id`  | Yes      | `string`  | A thread ID.                                                                                                                                                                     |
| `properties` | Yes      | `object`  | The chat properties to set. You should stick to the [general properties format](/management/configuration-api/#properties) and include _namespace_, _property name_ and _value_. |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                               |
| **Web API equivalent** | [`delete_thread_properties`](/messaging/agent-chat-api/v3.7/#delete-thread-properties)              |
| **Push message**       | [`thread_properties_deleted`](/messaging/agent-chat-api/v3.7/rtm-pushes/#thread_properties_deleted) |
...
| Parameter    | Required | Data type | Notes                                                 |
| ------------ | -------- | --------- | ----------------------------------------------------- |
| `chat_id`    | Yes      | `string`  | The ID of the chat you want to delete property for.   |
| `thread_id`  | Yes      | `string`  | The ID of the thread you want to delete property for. |
| `properties` | Yes      | `object`  | The chat properties to delete.                        |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                             |
| **Web API equivalent** | [`update_event_properties`](/messaging/agent-chat-api/v3.7/#update-event-properties)              |
| **Push message**       | [`event_properties_updated`](/messaging/agent-chat-api/v3.7/rtm-pushes/#event_properties_updated) |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                             |
| **Web API equivalent** | [`delete_event_properties`](/messaging/agent-chat-api/v3.7/#delete-event-properties)              |
| **Push message**       | [`event_properties_deleted`](/messaging/agent-chat-api/v3.7/rtm-pushes/#event_properties_deleted) |
...
| **Action**             | `tag_thread`                                                                |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                       |
| **Web API equivalent** | [`tag_thread`](/messaging/agent-chat-api/v3.7/#tag-thread)                  |
| **Push message**       | [`thread_tagged`](/messaging/agent-chat-api/v3.7/rtm-pushes/#thread_tagged) |
...
| **Action**             | `untag_thread`                                                                  |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                           |
| **Web API equivalent** | [`untag_thread`](/messaging/agent-chat-api/v3.7/#untag-thread)                  |
| **Push message**       | [`thread_untagged`](/messaging/agent-chat-api/v3.7/rtm-pushes/#thread_untagged) |
...
| **Web API equivalent** | [`get_customer`](/messaging/agent-chat-api/v3.7/#get-customer) |
| **Push message**       | -                                                              |
...
| **Web API equivalent** | [`update_customer`](/messaging/agent-chat-api/v3.7/#update-customer)              |
| **Push message**       | [`customer_updated`](/messaging/agent-chat-api/v3.7/rtm-pushes/#customer_updated) |
...
| **Web API equivalent** | [`ban_customer`](/messaging/agent-chat-api/v3.7/#ban-customer)                  |
| **Push message**       | [`customer_banned`](/messaging/agent-chat-api/v3.7/rtm-pushes/#customer_banned) |
...
| `away` __*__                | No       | `bool`     | If set to `true`: the connection is set to the `away` state. Default: `false`.                                                                                                                                     |
| `customer_monitoring_level` | No       | `string`   | Possible values: `my`, `chatting`, `invited`, `online`, `highest_available` __**__. Defaults to `my` if [login](#login) creates the first session; otherwise it preserves the current `customer_monitoring_level`. |
...
```json
{
  ...
  "chats_info": [{
    ...
    "last_thread_info": {
      ...
      "created_at": "2020-05-07T07:11:28.288340Z",
      "last_event_per_type": {
        // the last event of each type in thread
        "message": {
          // Message event
        },
        "system_message": {
...
| **Web API equivalent** | [`set_routing_status`](/messaging/agent-chat-api/v3.7/#set-routing-status)                                                                           |
| **Push message**       | [`routing_status_set`](/messaging/agent-chat-api/v3.7/rtm-pushes/#routing_status_set)                                                                |
...
| **Web API equivalent** | [`list_routing_statuses`](/messaging/agent-chat-api/v3.7/#list-routing-statuses) |
| **Push message**       | -                                                                                |
...
| **Required scopes**    | `chats--all:ro` **\*** or `chats--access:ro` **\*\***                                       |
| **Web API equivalent** | [`mark_events_as_seen`](/messaging/agent-chat-api/v3.7/#mark-events-as-seen)                |
| **Push message**       | [`events_marked_as_seen`](/messaging/agent-chat-api/v3.7/rtm-pushes/#events_marked_as_seen) |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                                   |
| **Web API equivalent** | [`send_thinking_indicator`](/messaging/agent-chat-api/v3.7/#send-thinking-indicator)                    |
| **Push message**       | [`incoming_thinking_indicator`](/messaging/agent-chat-api/v3.7/rtm-pushes/#incoming_thinking_indicator) |

**\*)** `chats--all:rw` - to send the thinking indicator to a chat taking place in any group.

**\*\*)** `chats--access:rw` - to send the thinking indicator to a chat taking place in groups that the requester (related to the token) is a member of (the agent groups and the chat groups must intersect - at least one group must be in common).
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                            |
| **Web API equivalent** | [`send_typing_indicator`](/messaging/agent-chat-api/v3.7/#send-typing-indicator) |
| **Push message**       | -                                                                                |

**\*)** `chats--all:rw` - to send the typing indicator to a chat taking place in any group.

**\*\*)** `chats--access:rw` - to send the typing indicator to a chat taking place in groups that the requester (related to the token) is a member of (the agent groups and the chat groups must intersect - at least one group must be in common).
...
| **Web API equivalent** | [`multicast`](/messaging/agent-chat-api/v3.7/#multicast)                              |
| **Push message**       | [`incoming_multicast`](/messaging/agent-chat-api/v3.7/rtm-pushes/#incoming_multicast) |
...
| **Required scopes**    | -                                                                                      |
| **Web API equivalent** | [`list_agents_for_transfer`](/messaging/agent-chat-api/v3.7/#list-agents-for-transfer) |
| **Push message**       | -                                                                                      |
...
- Their equivalents in Web API are [webhooks](/management/configuration-api/v3.7/#webhooks). Pushes and webhooks have similar payloads.
- There are no retries for pushes. To determine if a user has seen an event, compare the [event's](/messaging/agent-chat-api/v3.7/data-structures/#response) `created_at` parameter with the [user's](/messaging/agent-chat-api/v3.7/data-structures/#users) `events_seen_up_to` field.

<SectionLink to={"/messaging/agent-chat-api/v3.7/rtm-pushes"}>See available pushes</SectionLink>
