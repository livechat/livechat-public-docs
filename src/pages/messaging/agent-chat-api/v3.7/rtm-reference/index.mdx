...
| `chat.thread.events`     | No       | `array`    | The list of initial chat [events](/messaging/agent-chat-api/data-structures/#events) objects. Does not support the `form` type event in the LiveChat app. |
