...
| `elements.image`                                 | no       | `image`   | Displays images on RMs. Required param: `url`; Optional params: `name`, `content_type`, `size`, `width`, `height`, `alternative_text`.                                                                                                           |
...
| `elements.ecommerce.options`                     | no       | `array`   | Array of options for product. Required string params: `option_id`, `label`. Optional string params: `price`, `regular_price`, `currency`, `color`, `image_url`, `image_thumbnail_url`. Optional boolean params: `available`, `selected`.         |
| `elements.ecommerce.addons`                      | no       | `array`   | Array of addons for product. Required string param: `addon_type`. Optional string params: `range_from`, `range_to`, `currency`.                                                                                                                  |
...
| `suggested_email`                | optional  | The email address suggested for the customer based on tracked activity, such as a form submission. The suggested email isn't confirmed by the customer and isn't used for identity merging or segmentation.                                    |
...
<CodeResponse version="v3.7" type="agent" title={'Sample Cart data structure'} json="cart"/>

| Field               | Data type          | Notes                                          |
| ------------------- | ------------------ | ---------------------------------------------- |
| `store_uuid`        | `string`           | The unique identifier of the store.            |
| `store_platform`    | `string`           | The platform of the store (e.g., `shopify`).   |
...
<CodeResponse version="v3.7" type="agent" title={'Sample Cart Item data structure'} json="cartItem"/>
...
<CodeResponse version="v3.7" type="agent" title={'Sample Customer Property data structure'} json="customerProperty"/>
...
| `type`                 | yes      | `string`           | Possible values: `checkbox`, `email`, `name`, `question`, `subject`, `textarea`, `phone`, `date`, `group_chooser`, `radio`, `select` |
| `id`                   | yes      | `string`           | Field id, for all field types                                                                                                        |
| `label`                | yes      | `string`           | Field label; for all field types                                                                                                     |
| `customer_property_id` | no       | `string`           | The ID of the [customer property](#customer-property) to update when the customer submits the form.                                  |
