...
| `elements.ecommerce` | no | `object` | Variant selector configuration. |
| `elements.ecommerce.label` | no | `string` | Label displayed above the variants selector. |
| `elements.ecommerce.type` | no | `string` | Variant selector presentation. Possible values: `tags`, `swatch`, `images`, `select`. |
| `elements.ecommerce.options` | no | `array` | Variant options shown to the user. |
| `elements.ecommerce.options.label` | yes | `string` | Variant option label visible to users. |
| `elements.ecommerce.options.value` | yes | `string` | Variant identifier or value submitted in postbacks. |
| `elements.ecommerce.options.price` | no | `string` or `number` | Current variant price. |
| `elements.ecommerce.options.regular_price` | no | `string` or `number` | Non-discounted variant price. |
| `elements.ecommerce.options.max_price` | no | `string` or `number` | Maximum variant price. Used for ranges when needed. |
...
| `elements.ecommerce.options.color` | no | `string` | Used only when `elements.ecommerce.type` is `swatch`. Hex color value. |
| `elements.ecommerce.options.image` | no | `object` | Used only when `elements.ecommerce.type` is `images`. |
...
| `elements.ecommerce.addons` | no | `array` | Additional ecommerce controls displayed with variants. |
