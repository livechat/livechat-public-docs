...
| `postback.ecommerce`            | no       | `object`  | Object containing data specific to rich messages with `ecommerce` `template_id` like `product_id`.                           |
| `postback.ecommerce.product_id` | yes      | `string`  | ID of the product displayed by the rich message.                                                                             |
| `postback.ecommerce.option_id`  | yes      | `string`  | ID of the selected option for the product.                                                                                   |
...
| `postback.ecommerce.product_id` | always     |                                                                                                 |
| `postback.ecommerce.option_id`  | always     |                                                                                                 |
...
| `elements.ecommerce.view_type`                   | yes      | `string`  | Defines how the product and its options are displayed. Possible values: `tags`, `swatch`, `images`, `select`.                                                                                                                                    |
| `elements.ecommerce.product_id`                  | yes      | `string`  |                                                                                                                                                                                                                                                  |
...
| `elements.ecommerce.view_type`                   | always     | Can be either `tags`, `swatch`, `images` or `select`.                                                                                                                   |
| `elements.ecommerce.product_id`                  | always     |                                                                                                                                                                         |
