...
<Code>
<CodeResponse version="v3.7" type="agent" title={'Sample File in response'} json="file"/>
</Code>
</Section>
...
<Code>
<CodeResponse version="v3.7" type="agent" title={'Sample Form in response'} json="form"/>
</Code>
</Section>
...
<Code>
<CodeResponse version="v3.7" type="agent" title={'Sample Filled form in response'} json="filledForm"/>
</Code>
</Section>
...
<Code>
<CodeResponse version="v3.7" type="agent" title={'Sample Message in response'} json="message"/>
</Code>
</Section>
...
| `template_id` | yes | `string` | Defines how every Rich Message will be presented. Values: `cards`, `sticker`, `ecommerce`, or `quick_replies`. |
...
| `elements.image` | yes | `image` | Displays images on rich messages. Required param: `url`; Optional params: `name`, `content_type`, `size`, `width`, `height`, `alternative_text`. |
| `elements.ecommerce` | no | `object` | Additional ecommerce data attached to an element. See dedicated ecommerce tables below. |
| `elements.ecommerce.label` | no | `string` | Label displayed above the ecommerce selector. |
| `elements.ecommerce.type` | no | `string` | Ecommerce selector presentation. Possible values: `tags`, `swatch`, `images`, `select`. |
| `elements.ecommerce.options` | no | `array` | Ecommerce options shown to the user. Shape depends on `elements.ecommerce.type`. |
| `elements.ecommerce.addons` | no | `array` | Additional ecommerce controls. Possible addon types: `more_items`, `price_range`. |
...
| `elements.buttons.type` | yes | `string` | Defines the behavior after a user clicks the button. Possible values: `webview`, `message`, `url`, `phone`, `add_to_cart`, `show_gallery`, `open_external`. |
| `elements.buttons.value` | yes | `string` | Should be used together with `elements.buttons.type`. Can store the URL, phone number, message body, or action payload. |
| `elements.buttons.webview_height` | yes | `string` | Required only for button type `webview`. Possible values: `compact`, `full`, `tall`. |
...
| `elements.buttons.target` | no | `string` | Should be used for button types `url` and `open_external`. Specifies if the URL should open in the current or a new tab. Possible values: `new`, `current`. |

## Shared ecommerce fields

These fields apply to every `elements.ecommerce` object, regardless of type.

| Parameter | Required | Data type | Notes |
| --- | --- | --- | --- |
| `elements.ecommerce.label` | no | `string` | Label displayed above the ecommerce selector. |
| `elements.ecommerce.type` | yes | `string` | Selector presentation. Possible values: `tags`, `swatch`, `images`, `select`. |
| `elements.ecommerce.options` | no | `array` | Selector options. Use the type-specific table below for the option shape. |
| `elements.ecommerce.addons` | no | `array` | Additional ecommerce controls displayed with the selector. |
| `elements.ecommerce.addons.type` | yes | `string` | Possible values: `more_items`, `price_range`. |
| `elements.ecommerce.addons.webview_url` | no | `string` | Required for addon type `more_items`. URL opened in webview. |
| `elements.ecommerce.addons.from` | no | `string` or `number` | Required for addon type `price_range`. Minimum price. |
| `elements.ecommerce.addons.to` | no | `string` or `number` | Required for addon type `price_range`. Maximum price. |
| `elements.ecommerce.addons.currency` | no | `string` | Required for addon type `price_range`. ISO 4217 currency code. |

## Tags ecommerce

Use this shape when `elements.ecommerce.type` is `tags`.

| Parameter | Required | Data type | Notes |
| --- | --- | --- | --- |
| `elements.ecommerce.options.label` | yes | `string` | Option label visible to users. |
| `elements.ecommerce.options.value` | yes | `string` | Variant identifier or value submitted in postbacks. |
| `elements.ecommerce.options.price` | no | `string` or `number` | Current option price. |
| `elements.ecommerce.options.regular_price` | no | `string` or `number` | Non-discounted option price. |
| `elements.ecommerce.options.max_price` | no | `string` or `number` | Maximum price value when ranges are needed. |
| `elements.ecommerce.options.currency` | no | `string` | ISO 4217 currency code, for example `AUD`. |
| `elements.ecommerce.options.selected` | no | `boolean` | Indicates whether the option is selected by default. |

## Swatch ecommerce

Use this shape when `elements.ecommerce.type` is `swatch`.
...
| `elements.ecommerce.options.currency` | no | `string` | ISO 4217 currency code, for example `AUD`. |
| `elements.ecommerce.options.selected` | no | `boolean` | Indicates whether the option is selected by default. |
| `elements.ecommerce.options.color` | yes | `string` | Hex color value displayed for the swatch. |

## Images ecommerce

Use this shape when `elements.ecommerce.type` is `images`.
...
| `elements.ecommerce.options.currency` | no | `string` | ISO 4217 currency code, for example `AUD`. |
| `elements.ecommerce.options.selected` | no | `boolean` | Indicates whether the option is selected by default. |
| `elements.ecommerce.options.image` | yes | `object` | Image displayed for the option. |
| `elements.ecommerce.options.image.thumbnail_url` | no | `string` | Variant thumbnail image URL. |
| `elements.ecommerce.options.image.url` | yes | `string` | Variant full image URL. |

## Select ecommerce

Use this shape when `elements.ecommerce.type` is `select`.
...
<Code>
<CodeResponse version="v3.7" type="agent" title={'Sample Rich message in response'} json="richMessage"/>
</Code>
</Section>
...
<Code>
<CodeResponse version="v3.7" type="agent" title={'Sample Custom event in response'} json="custom"/>
</Code>
</Section>
...
| `system_message_type` | yes      | `string`  | [System message type](/messaging/references/system-activities#system-messages)                                                   |
...
<Code>
<CodeResponse version="v3.7" type="agent" title={'Sample System message in response'} json="systemMessage"/>
</Code>
</Section>
...
| `id`         | always     | Generated server-side                                                                     |
| `custom_id`  | optionally |                                                                                           |
| `source`     | always     | [System event source](/messaging/references/system-activities#system-events)              |
| `type`       | always     | `system`                                                                                  |
| `subtype`    | always     | [System event subtype](/messaging/references/system-activities#system-events)             |
| `version`    | always     |                                                                                           |
| `details`    | always     |                                                                                           |
| `created_at` | always     | Date & time format with a resolution of microseconds, `UTC string`; generated server-side |
| `visibility` | always     |                                                                                           |
...
<Code>
<CodeResponse version="v3.7" type="agent" title={'Sample System event in response'} json="system"/>
</Code>
</Section>
...
<CodeResponse version="v3.7" type="agent" title={'Sample Agent data structure'} json="agent"/>
...
<CodeResponse version="v3.7" type="agent" title={'Sample My profile data structure'} json="myProfile"/>
...
<CodeResponse version="v3.7" type="agent" title={'Sample Customer data structure'} json="customer"/>
...
| `created_at`                     | optional  |                                                                                                                                                           |
| `email`                          | optional  |                                                                                                                                                           |
| `email_verified`                 | optional  | Specifies if the customer confirmed their email address. See [Request Email Verification](/messaging/customer-chat-api/v3.7/#request-email-verification). |
...
<CodeResponse version="v3.7" type="agent" title={'Sample Access data structure'} json="access"/>
...
<CodeResponse version="v3.7" type="agent" title={'Sample Chat data structure'} json="chat"/>
...
<CodeResponse version="v3.7" type="agent" title={'Sample Form fields'} json="formFields"/>
...
<CodeResponse version="v3.7" type="agent" title={'Sample Form fields'} json="filledFormFields"/>
...
<CodeResponse version="v3.7" type="agent" title={'Sample Properties data structure'} json="properties"/>

## Threads

<CodeResponse version="v3.7" type="agent" title={'Sample Thread data structure'} json="thread"/>
...
<CodeResponse version="v3.7" type="agent" title={'Sample Deleted event in response'} json="deletedEvent"/>
