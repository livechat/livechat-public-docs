...
<CodeResponse version="v3.7" type="agent" title={'Sample Customer Omnichannel data structure'} json="omnichannel"/>

| Field            | Required | Data type | Note                                                                                |
| ---------------- | -------  | --------- | ----------------------------------------------------------------------------------- |
| `fb_messenger`   | No       | `list`    |                                                                                     | 
| `twilio`         | No       | `list`    |										        | 

### Facebook Messenger

<CodeResponse version="v3.7" type="agent" title={'Sample Fabcebook Messenger data structure'} json="omnichannel_fb_messenger"/>
...
| `gender`  	     | No       | `string`   |											|
| `locale` 	     | No       | `string`   |											|
| `is_verified_user` | No       | `bool`     |                                                                                  |

### Twilio

<CodeResponse version="v3.7" type="customer" title={'Sample Twilio data structure'} json="omnichannel_twilio"/>

| Parameter       | Required | Data type  | Notes                                                                              	|
| --------------- | -------- | ---------- | ----------------------------------------------------------------------------------- |
| `phone_number`  | Yes      | `string`   | E.164 format.                                                                   	|
