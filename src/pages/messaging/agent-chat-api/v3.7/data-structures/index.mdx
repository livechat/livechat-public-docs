...
| `customer_properties`            | optional  | An object where the keys are the IDs of the customer properties and the values are their data. See [Customer Property](#customer-property).               |
...
| ------------------------------- | --------- | --------- | ------------------------------------------------------ |
| `value`                         | required  | `any`     | Current value of the property.                         |
