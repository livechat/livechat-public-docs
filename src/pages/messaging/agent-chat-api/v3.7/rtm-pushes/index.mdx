...
An empty `suggested_email` means the suggestion was accepted or dismissed and is no longer set on the customer.
...
Indicates that a [customer property](/messaging/agent-chat-api/v3.7/data-structures#customer-property) definition was deleted within an organization. The payload contains only the ID of the deleted definition. The deletion is permanent.
