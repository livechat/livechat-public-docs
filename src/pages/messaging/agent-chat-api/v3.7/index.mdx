...
|                        |                                                                                    |
| ---------------------- | ---------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/follow_customer`                    |
| **Required scopes**    | `customers:ro`                                                                     |
| **RTM API equivalent** | [`follow_customer`](/messaging/agent-chat-api/v3.7/rtm-reference/#follow-customer) |
| **Webhook**            | -                                                                                  |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.7/agent/action/follow_customer \
-H 'Authorization: Bearer <your_access_token>' \
-H 'Content-Type: application/json' \
-d '{
   "id": "b7eff798-f8df-4364-8059-649c35c9ed0c"
...
|                        |                                                                                        |
| ---------------------- | -------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/unfollow_customer`                      |
| **Required scopes**    | -                                                                                      |
| **RTM API equivalent** | [`unfollow_customer`](/messaging/agent-chat-api/v3.7/rtm-reference/#unfollow-customer) |
| **Webhook**            | -                                                                                      |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.7/agent/action/unfollow_customer \
-H 'Authorization: Bearer <your_access_token>' \
-H 'Content-Type: application/json' \
-d '{
   "id": "b7eff798-f8df-4364-8059-649c35c9ed0c"
