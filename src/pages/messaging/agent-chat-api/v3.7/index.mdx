...
Requests to the Agent Chat Web API must be authenticated every time you make a request.
...
To call the API as a bot, you need to use the bot token. You can generate it using the [**Issue Bot Token**](/management/configuration-api/v3.7/#issue-bot-token) method.

# Data structures

To find sample payloads of **events**, **users**, and **other common structures** such as chats or threads [visit the Data structures](/messaging/agent-chat-api/v3.7/data-structures) document.
...
| ----------- | -------------------------------------------------------- |
| `POST`      | `https://api.livechatinc.com/v3.7/agent/action/<action>` |

If you specify the API version in the URL, you don't have to include the optional `"X-API-Version: 3.7"` header.
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.7/agent/action/<action> \
...
|                        |                                                                          |
| ---------------------- | ------------------------------------------------------------------------ |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/list_chats`               |
| **Required scopes**    | `chats--all:ro` **\*** or `chats--access:ro` **\*\***                    |
| **RTM API equivalent** | [`list_chats`](/messaging/agent-chat-api/v3.7/rtm-reference/#list-chats) |
| **Webhook**            | -                                                                        |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.7/agent/action/list_chats \
...
```json
{
  ...
  "chats_info": [{
    ...
    "last_thread_info": {
      ...
      // "restricted_access": "User has no access to following resource" — when present, "last_event_per_type" is not sent
    },
    "properties": {
      // "Properties" object
    },
...
|                        |                                                                              |
| ---------------------- | ---------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/list_threads`                 |
| **Required scopes**    | `chats--all:ro` **\*** or `chats--access:ro` **\*\***                        |
| **RTM API equivalent** | [`list_threads`](/messaging/agent-chat-api/v3.7/rtm-reference/#list-threads) |
| **Webhook**            | -                                                                            |
...
| `limit`            | No       | `number`  | The maximum number of records returned on each [page](#pagination). Default: 3. Maximum: 100. To limit the total number of returned records, use `filters`.                                                                                                         |
| `page_id`          | No       | `string`  |                                                                                                                                                                                                                                                                     |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.7/agent/action/list_threads \
  -H 'Authorization: Basic <your_personal_access_token>' \
  -H 'Content-Type: application/json' \
  -d '{
      "chat_id": "PWJ8Y4THAV"
...
|                        |                                                                                                    |
| ---------------------- | -------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/get_chat`                                           |
| **Required scopes**    | `chats--all:ro` **\*** or `chats--access:ro` **\*\***, depending on the requested thread’s groups. |
| **RTM API equivalent** | [`get_chat`](/messaging/agent-chat-api/v3.7/rtm-reference/#get-chat)                               |
| **Webhook**            | -                                                                                                  |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.7/agent/action/get_chat \
  -H 'Authorization: Basic <your_personal_access_token>' \
  -H 'Content-Type: application/json' \
  -d '{
      "chat_id": "PWJ8Y4THAV",
...
|                        |                                                                                |
| ---------------------- | ------------------------------------------------------------------------------ |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/list_archives`                  |
| **Required scopes**    | `chats--all:ro` **\*** or `chats--access:ro` **\*\***                          |
| **RTM API equivalent** | [`list_archives`](/messaging/agent-chat-api/v3.7/rtm-reference/#list-archives) |
| **Webhook**            | -                                                                              |
...
| `filters.group_ids`                                                              | No       | `array`   | An array of group IDs. Maximum array size: 200.                                                                                                                          |
| `filters.properties.<namespace>.<name>.<properties_filter_type>`<sup>**1**</sup> | No       | `any`     | Described below.                                                                                                                                                         |
| `filters.agents.<filter_type>`<sup>**2**</sup>                                   | No       | `any`     | Described below. If `exists` is set to `false`: returns unassigned chats. If set to `true`: returns the assigned ones.                                                   |
| `filters.tags.<filter_type>`                                                     | No       | `any`     |                                                                                                                                                                          |
| `filters.sales.<filter_type>`                                                    | No       | `any`     |                                                                                                                                                                          |
| `filters.goals.<filter_type>`                                                    | No       | `any`     |                                                                                                                                                                          |
| `filters.forms.<form>`<sup>**3**</sup>                                           | No       | `array`   | Described below.                                                                                                                                                         |
| `filters.event_types.<event_type_filter_type>`<sup>**4**</sup>                   | No       | `any`     | Described below.                                                                                                                                                         |
| `filters.greetings.<greetings_filter_type>`<sup>**6**</sup>                      | No       | `any`     | Described below.                                                                                                                                                         |
| `filters.agent_response.<agent_response_filter_type>`<sup>**7**</sup>            | No       | `any`     | Described below.                                                                                                                                                         |
| `filters.agent_types.<agent_type_filter_type>`<sup>**8**</sup>                   | No       | `any`     | Described below.                                                                                                                                                         |
| `filters.ecommerce_sales.<ecommerce_sales_filter_type>`<sup>**9**</sup>          | No       | `any`     | Described below.                                                                                                                                                         |
...
| `page_id`                                                                        | No       | `string`  |                                                                                                                                                                          |
| `sort_order`<sup>**5**</sup>                                                     | No       | `string`  | Default: `desc`.                                                                                                                                                         |
...
**8)**
`<agent_type_filter_type>` can take the following values:
...
Allowed agent type values: `human`, `chatbot`, `ai_agent`. Each value can be used only once across all arrays.

You can provide more than one filter type at a time, for example, `all_values` and `exclude_values`.

**9)**
`<ecommerce_sales_filter_type>` can take the following values:
...
Allowed ecommerce sales type values: `direct`, `indirect`. Each value can be used only once across all arrays.
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.7/agent/action/list_archives \
  -H 'Authorization: Basic <your_personal_access_token>' \
  -H 'Content-Type: application/json' \
  -d '{
    "filters": {
...
|                        |                                                                                          |
| ---------------------- | ---------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/start_chat`                               |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***, depending on the requested groups |
| **RTM API equivalent** | [`start_chat`](/messaging/agent-chat-api/v3.7/rtm-reference/#start-chat)                 |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.7/agent/action/start_chat \
  -H 'Authorization: Basic <your_personal_access_token>' \
  -H 'Content-Type: application/json' \
  -d '{}'
```
...
|                        |                                                                                          |
| ---------------------- | ---------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/resume_chat`                              |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***, depending on the requested groups |
| **RTM API equivalent** | [`resume_chat`](/messaging/agent-chat-api/v3.7/rtm-reference/#resume-chat)               |
| **Webhook**            | [`incoming_chat`](/management/webhooks/v3.7/#incoming_chat)                              |
...
| `chat.users.type`        | Yes      | `string`   | Possible values: `agent`, `customer`.                                                                    |
| `chat.thread`            | No       | `object`   |                                                                                                          |
| `chat.thread.events`     | No       | `array`    | An initial chat events array.                                                                            |
| `chat.thread.properties` | No       | `object`   | The initial thread properties.                                                                           |
| `active`                 | No       | `bool`     | If set to `false`: creates an inactive thread. Default: `true`.                                          |
| `continuous`             | No       | `bool`     | If set to `true`: sets a chat to the continuous mode. When unset: leaves the mode unchanged.             |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.7/agent/action/resume_chat \
  -H 'Authorization: Basic <your_personal_access_token>' \
  -H 'Content-Type: application/json' \
  -d '{
    "chat": {
...
|                        |                                                                                          |
| ---------------------- | ---------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/deactivate_chat`                          |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***, depending on the requested groups |
| **RTM API equivalent** | [`deactivate_chat`](/messaging/agent-chat-api/v3.7/rtm-reference/#deactivate-chat)       |
| **Webhook**            | [`chat_deactivated`](/management/webhooks/v3.7/#chat_deactivated)                        |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.7/agent/action/deactivate_chat \
  -H 'Authorization: Basic <your_personal_access_token>' \
  -H 'Content-Type: application/json' \
  -d '{
    "id": "PJ0MRSHTDG"
...
|                        |                                                                                          |
| ---------------------- | ---------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/follow_chat`                              |
| **Required scopes**    | `chats--all:ro` **\*** or `chats--access:ro` **\*\***, depending on the requested groups |
| **RTM API equivalent** | [`follow_chat`](/messaging/agent-chat-api/v3.7/rtm-reference/#follow-chat)               |
| **Webhook**            | -                                                                                        |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.7/agent/action/follow_chat \
-H 'Authorization: Basic <your_personal_access_token>' \
-H 'Content-Type: application/json' \
-d '{
  "id": "PW94SJTGW6"
...
|                        |                                                                                |
| ---------------------- | ------------------------------------------------------------------------------ |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/unfollow_chat`                  |
| **Required scopes**    | -                                                                              |
| **RTM API equivalent** | [`unfollow_chat`](/messaging/agent-chat-api/v3.7/rtm-reference/#unfollow-chat) |
| **Webhook**            | -                                                                              |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.7/agent/action/unfollow_chat \
-H 'Authorization: Basic <your_personal_access_token>' \
-H 'Content-Type: application/json' \
-d '{
    "id": "PJ0MRSHTDG"
...
|                        |                                                                                |
| ---------------------- | ------------------------------------------------------------------------------ |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/transfer_chat`                  |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                          |
| **RTM API equivalent** | [`transfer_chat`](/messaging/agent-chat-api/v3.7/rtm-reference/#transfer-chat) |
| **Webhook**            | [`chat_transferred`](/management/webhooks/v3.7/#chat_transferred)              |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.7/agent/action/transfer_chat \
-H 'Authorization: Basic <your_personal_access_token>' \
-H 'Content-Type: application/json' \
-d '{
    "id": "PJ0MRSHTDG",
...
|                        |                                                                                      |
| ---------------------- | ------------------------------------------------------------------------------------ |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/add_user_to_chat`                     |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                |
| **RTM API equivalent** | [`add_user_to_chat`](/messaging/agent-chat-api/v3.7/rtm-reference/#add-user-to-chat) |
| **Webhook**            | [`user_added_to_chat`](/management/webhooks/v3.7/#user_added_to_chat)                |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.7/agent/action/add_user_to_chat \
-H 'Authorization: Basic <your_personal_access_token>' \
-H 'Content-Type: application/json' \
-d '{
    "chat_id": "PW94SJTGW6",
...
|                        |                                                                                                |
| ---------------------- | ---------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/remove_user_from_chat`                          |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                          |
| **RTM API equivalent** | [`remove_user_from_chat`](/messaging/agent-chat-api/v3.7/rtm-reference/#remove-user-from-chat) |
| **Webhook**            | [`user_removed_from_chat`](/management/webhooks/v3.7/#user_removed_from_chat)                  |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.7/agent/action/remove_user_from_chat \
-H 'Authorization: Basic <your_personal_access_token>' \
-H 'Content-Type: application/json' \
-d '{
    "chat_id": "PW94SJTGW6",
...
Sends an [event](/messaging/agent-chat-api/v3.7/data-structures/#events) that isn't saved in the chat. Use this method when you're preparing a longer response and want to send a partial update before sending the final message with [Send Event](/messaging/agent-chat-api/v3.7/#send-event). Only [Message](/messaging/agent-chat-api/v3.7/data-structures/#message) is supported. Visibility must be set to `all` or skipped. The user must be [added to the chat](/messaging/agent-chat-api/rtm-pushes/#user_added_to_chat) before they can send an event.

#### Specifics

|                        |                                                                                          |
| ---------------------- | ---------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/send_event_preview`                       |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                    |
| **RTM API equivalent** | [`send_event_preview`](/messaging/agent-chat-api/v3.7/rtm-reference/#send-event_preview) |
| **Webhook**            | -                                                                                        |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.7/agent/action/send_event_preview \
-H 'Authorization: Basic <your_personal_access_token>' \
-H 'Content-Type: application/json' \
-d '{
    "chat_id": "PW94SJTGW6",
...
Sends an [Event](/messaging/agent-chat-api/v3.7/data-structures/#events) object. Use this method to send a message by specifying the [Message](/messaging/agent-chat-api/v3.7/data-structures/#message) event type in the request.
...
|                        |
| ---------------------- | ------------------------------------------------------------------------ |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/send_event`               |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                    |
| **RTM API equivalent** | [`send_event`](/messaging/agent-chat-api/v3.7/rtm-reference/#send-event) |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.7/agent/action/send_event \
-H 'Authorization: Basic <your_personal_access_token>' \
-H 'Content-Type: application/json' \
-d '{
   "chat_id": "PW94SJTGW6",
...
|                        |                                                                      |
| ---------------------- | -------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/upload_file`          |
| **Required scopes**    | -                                                                    |
| **RTM API equivalent** | -                                                                    |
| **Webhook**            | [`incoming_event`](/management/webhooks/v3.7/#incoming_event) **\*** |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.7/agent/action/upload_file \
  -H 'Authorization: Basic <your_personal_access_token>' \
...
|                        |                                                                                                          |
| ---------------------- | -------------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/send_rich_message_postback`                               |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                                    |
| **RTM API equivalent** | [`send_rich_message_postback`](/messaging/agent-chat-api/v3.7/rtm-reference/#send-rich-message-postback) |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.7/agent/action/send_rich_message_postback \
-H 'Authorization: Basic <your_personal_access_token>' \
-H 'Content-Type: application/json' \
-d '{
   "chat_id": "PJ0MRSHTDG",
...
|                        |                                                                                                  |
| ---------------------- | ------------------------------------------------------------------------------------------------ |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/update_chat_properties`                           |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                            |
| **RTM API equivalent** | [`update_chat_properties`](/messaging/agent-chat-api/v3.7/rtm-reference/#update-chat-properties) |
...
| Parameter    | Required | Data type | Notes                                                                                                                                                                            |
| ------------ | -------- | --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `id`         | Yes      | `string`  | The ID of the chat you to set properties for.                                                                                                                                    |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.7/agent/action/update_chat_properties \
-H 'Authorization: Basic <your_personal_access_token>' \
-H 'Content-Type: application/json' \
-d '{
  "id": "Q1VZR7AJCE",
...
|                        |                                                                                                  |
| ---------------------- | ------------------------------------------------------------------------------------------------ |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/delete_chat_properties`                           |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                            |
| **RTM API equivalent** | [`delete_chat_properties`](/messaging/agent-chat-api/v3.7/rtm-reference/#delete-chat-properties) |
...
| Parameter    | Required | Data type | Notes                                              |
| ------------ | -------- | --------- | -------------------------------------------------- |
| `id`         | Yes      | `string`  | The ID of the chat you want to delete property of. |
...
```shell
  curl -X POST \
  https://api.livechatinc.com/v3.7/agent/action/delete_chat_properties \
  -H 'Authorization: Basic <your_personal_access_token>' \
  -H 'Content-Type: application/json' \
  -d '{
    "id": "Q1VZR7AJCE",
...
|                        |                                                                                                      |
| ---------------------- | ---------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/update_thread_properties`                             |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                                |
| **RTM API equivalent** | [`update_thread_properties`](/messaging/agent-chat-api/v3.7/rtm-reference/#update-thread-properties) |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.7/agent/action/update_thread_properties \
  -H 'Authorization: Basic <your_personal_access_token>' \
  -H 'Content-Type: application/json' \
  -d '{
    "chat_id": "Q1WZ073OA7",
...
|                        |                                                                                                      |
| ---------------------- | ---------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/delete_thread_properties`                             |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                                |
| **RTM API equivalent** | [`delete_thread_properties`](/messaging/agent-chat-api/v3.7/rtm-reference/#delete-thread-properties) |
...
| Parameter    | Required | Data type | Notes                                                  |
| ------------ | -------- | --------- | ------------------------------------------------------ |
| `chat_id`    | Yes      | `string`  | The ID of the chat you want to delete properties of.   |
| `thread_id`  | Yes      | `string`  | The ID of the thread you want to delete properties of. |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.7/agent/action/delete_thread_properties \
-H 'Authorization: Basic <your_personal_access_token>' \
-H 'Content-Type: application/json' \
-d '{
  "chat_id": "Q1WZ073OA7",
...
|                        |                                                                                                    |
| ---------------------- | -------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/update_event_properties`                            |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                              |
| **RTM API equivalent** | [`update_event_properties`](/messaging/agent-chat-api/v3.7/rtm-reference/#update-event-properties) |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.7/agent/action/update_event_properties \
-H 'Authorization: Basic <your_personal_access_token>' \
-H 'Content-Type: application/json' \
-d '{
  "chat_id": "Q1GZ3FNAT9",
...
|                        |                                                                                                    |
| ---------------------- | -------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/delete_event_properties`                            |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                              |
| **RTM API equivalent** | [`delete_event_properties`](/messaging/agent-chat-api/v3.7/rtm-reference/#delete-event-properties) |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.7/agent/action/delete_event_properties \
-H 'Authorization: Basic <your_personal_access_token>' \
-H 'Content-Type: application/json' \
-d '{
  "chat_id": "Q16ZSBGX3J",
...
Read how to [list all available tags](/management/configuration-api/v3.7#list-tags) and [create a new tag](/management/configuration-api/v3.7#create-tag).

#### Specifics

|                        |                                                                          |
| ---------------------- | ------------------------------------------------------------------------ |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/tag_thread`               |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                    |
| **RTM API equivalent** | [`tag_thread`](/messaging/agent-chat-api/v3.7/rtm-reference/#tag-thread) |
| **Webhook**            | [`thread_tagged`](/management/webhooks/v3.7/#thread_tagged)              |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.7/agent/action/tag_thread \
-H 'Authorization: Basic <your_personal_access_token>' \
-H 'Content-Type: application/json' \
-d '{
  "chat_id": "PW94SJTGW6",
...
|                        |                                                                              |
| ---------------------- | ---------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/untag_thread`                 |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                        |
| **RTM API equivalent** | [`untag_thread`](/messaging/agent-chat-api/v3.7/rtm-reference/#untag-thread) |
| **Webhook**            | [`thread_untagged`](/management/webhooks/v3.7/#thread_untagged)              |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.7/agent/action/untag_thread \
-H 'Authorization: Basic <your_personal_access_token>' \
-H 'Content-Type: application/json' \
-d '{
  "chat_id": "PW94SJTGW6",
...
|                        |                                                                              |
| ---------------------- | ---------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/get_customer`                 |
| **Required scopes**    | `customers:ro`                                                               |
| **RTM API equivalent** | [`get_customer`](/messaging/agent-chat-api/v3.7/rtm-reference/#get-customer) |
| **Push message**       | -                                                                            |
...
| Parameter | Required | Data type | Notes              |
| --------- | -------- | --------- | ------------------ |
| `id`      | Yes      | string    | The customer's ID. |
...
| `suggested_email`     | string    | The email address suggested for the customer based on tracked activity, such as a form submission. The suggested email isn't confirmed by the customer. Returned only if set.                                      |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.7/agent/action/get_customer \
-H 'Authorization: Basic <your_personal_access_token>' \
-H 'Content-Type: application/json' \
-d '{
    "id": "b7eff798-f8df-4364-8059-649c35c9ed0c"
...
|                        |                                                                                                        |
| ---------------------- | ------------------------------------------------------------------------------------------------------ |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/update_customer`                                        |
| **Required scopes**    | `customers:rw`                                                                                         |
| **RTM API equivalent** | [`update_customer`](/messaging/agent-chat-api/v3.7/rtm-reference/#update-customer)                     |
| **Webhook**            | [`customer_session_fields_updated`](/management/webhooks/v3.7/#customer_session_fields_updated) **\*** |
...
| `name`                                     | No       | `string`   | The customer's name.                                                             |
| `email`                                    | No       | `string`   | The customer's email.                                                            |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.7/agent/action/update_customer \
-H 'Authorization: Basic <your_personal_access_token>' \
-H 'Content-Type: application/json' \
-d '{
    "id": "b7eff798-f8df-4364-8059-649c35c9ed0c",
...
|                        |                                                                              |
| ---------------------- | ---------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/ban_customer`                 |
| **Required scopes**    | `customers.ban:rw`                                                           |
| **RTM API equivalent** | [`ban_customer`](/messaging/agent-chat-api/v3.7/rtm-reference/#ban-customer) |
| **Webhook**            | -                                                                            |
...
| ---------- | -------- | --------- | -------------------------- |
| `id`       | Yes      | `string`  | The customer's ID.         |
| `ban`      | Yes      | `object`  | The ban object.            |
| `ban.days` | Yes      | `number`  | The number of days to ban. |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.7/agent/action/ban_customer \
-H 'Authorization: Basic <your_personal_access_token>' \
-H 'Content-Type: application/json' \
-d '{
   "id": "b7eff798-f8df-4364-8059-649c35c9ed0c",
...
|                        |                                                                                                                                                      |
| ---------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/set_routing_status`                                                                                   |
| **Required scopes**    | for Agents: `agents--my:rw` **\*** or `agents--all:rw` **\*\***; for bot agents: `agents-bot--my:rw` **\*\*\*** or `agents-bot--all:rw` **\*\*\*\*** |
| **RTM API equivalent** | [`set_routing_status`](/messaging/agent-chat-api/v3.7/rtm-reference/#set-routing-status)                                                             |
| **Webhook**            | [`routing_status_set`](/management/webhooks/v3.7/#routing_status_set)                                                                                |
...
**\*\*\*\*)** `agents-bot--all:rw` - to set the routing status of any bots within a license. For bots of type `ai_agent`, you can only change the routing status with tokens issued for the `client_id` that owns them.

| Parameter  | Required | Data type | Notes                                                                                                                                                        |
| ---------- | -------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `status`   | Yes      | `string`  | For agents: Possible values: `accepting_chats`, `not_accepting_chats`. For bot agents: Possible values: `accepting_chats`, `not_accepting_chats`, `offline`. |
| `agent_id` | No       | `string`  | The ID of the agent. If not specified, the requester's status will be updated.                                                                               |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.7/agent/action/set_routing_status \
-H 'Authorization: Basic <your_personal_access_token>' \
-H 'Content-Type: application/json' \
-d '{
...
|                        |                                                                                                |
| ---------------------- | ---------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/list_routing_statuses`                          |
| **Required scopes**    | `agents--all:ro` **\*** and `agents-bot--all:ro` **\*\***                                      |
| **RTM API equivalent** | [`list_routing_statuses`](/messaging/agent-chat-api/v3.7/rtm-reference/#list-routing-statuses) |
| **Webhook**            | -                                                                                              |
...
| Parameter           | Required | Type     | Notes               |
| ------------------- | -------- | -------- | ------------------- |
| `filters`           | No       | `object` | The filters object. |
| `filters.group_ids` | No       | `array`  | The group IDs.      |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.7/agent/action/list_routing_statuses \
-H 'Authorization: Basic <your_personal_access_token>' \
-H 'Content-Type: application/json' \
-d '{
    "filters": {
...
|                        |                                                                                            |
| ---------------------- | ------------------------------------------------------------------------------------------ |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/mark_events_as_seen`                        |
| **Required scopes**    | `chats--all:ro` **\*** or `chats--access:ro` **\*\***                                      |
| **RTM API equivalent** | [`mark_events_as_seen`](/messaging/agent-chat-api/v3.7/rtm-reference/#mark-events-as-seen) |
...
| Parameter    | Required | Data type | Notes                      |
| ------------ | -------- | --------- | -------------------------- |
| `chat_id`    | Yes      | `string`  | The chat ID.               |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.7/agent/action/mark_events_as_seen \
-H 'Authorization: Basic <your_personal_access_token>' \
-H 'Content-Type: application/json' \
-d '{
   "chat_id": "PJ0MRSHTDG",
...
|                        |                                                                                                    |
| ---------------------- | -------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/send_thinking_indicator`                            |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                              |
| **RTM API equivalent** | [`send_thinking_indicator`](/messaging/agent-chat-api/v3.7/rtm-reference/#send-thinking-indicator) |
| **Webhook**            | -                                                                                                  |
...
| `title`       | No       | `string`  | The title of the thinking indicator.                  |
| `description` | No       | `string`  | The description of the thinking indicator.            |
| `visibility`  | No       | `string`  | Possible values: `all`, `agents`. Default: `all`.     |
| `custom_id`   | No       | `string`  | A custom ID for the thinking indicator.               |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.7/agent/action/send_thinking_indicator \
-H 'Authorization: Basic <your_personal_access_token>' \
-H 'Content-Type: application/json' \
-d '{
    "chat_id": "PJ0MRSHTDG",
...
|                        |                                                                                                |
| ---------------------- | ---------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/send_typing_indicator`                          |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                          |
| **RTM API equivalent** | [`send_typing_indicator`](/messaging/agent-chat-api/v3.7/rtm-reference/#send-typing-indicator) |
| **Webhook**            | -                                                                                              |
...
| `visibility` | No       | `string`  | Possible values: `all`, `agents`. Default: `all`.   |
| `is_typing`  | Yes      | `bool`    | If set to `true`: the typing indicator is shown.    |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.7/agent/action/send_typing_indicator \
-H 'Authorization: Basic <your_personal_access_token>' \
-H 'Content-Type: application/json' \
-d '{
   "chat_id": "PJ0MRSHTDG",
...
|                        |                                                                        |
| ---------------------- | ---------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/multicast`              |
| **Required scopes**    | `multicast:rw`                                                         |
| **RTM API equivalent** | [`multicast`](/messaging/agent-chat-api/v3.7/rtm-reference/#multicast) |
| **Webhook**            | -                                                                      |
...
| Parameter    | Required | Data type | Notes                         |
| ------------ | -------- | --------- | ----------------------------- |
| `recipients` | Yes      | `object`  | The recipients object. **\*** |
...
At least one `recipients` type (`agents.all`, `agents.ids`, `agents.groups`) is required.
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.7/agent/action/multicast \
-H 'Authorization: Basic <your_personal_access_token>' \
-H 'Content-Type: application/json' \
-d '{
    "recipients": {
...
|                        |                                                                                                      |
| ---------------------- | ---------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.7/agent/action/list_agents_for_transfer`                             |
| **Required scopes**    | -                                                                                                    |
| **RTM API equivalent** | [`list_agents_for_transfer`](/messaging/agent-chat-api/v3.7/rtm-reference/#list-agents-for-transfer) |
| **Webhook**            | -                                                                                                    |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.7/agent/action/list_agents_for_transfer \
-H 'Authorization: Basic <your_personal_access_token>' \
-H 'Content-Type: application/json' \
-d '{
  "chat_id": "PJ0MRSHTDG"
...
Requests an AI-generated summary of a specific thread. A deactivated thread can be summarized only once. For active threads, this method can be called multiple times, and the resulting summaries will be delivered as [system events](/messaging/references/system-activities/#summary) inside a thread for which the summary was requested.
...
| Parameter   | Required | Data type | Notes                 |
| ----------- | -------- | --------- | --------------------- |
| `chat_id`   | Yes      | `string`  | The ID of the chat.   |
| `thread_id` | Yes      | `string`  | The ID of the thread. |
