...
| `filters.agent_types.<agent_type_filter_type>`                   | No       | `any`     | **\*\*\*\*\*\*\*\*** **described below**                                                                                                                                 |
...
- `all_values` (`string[]` - an array of agent type values; allowed values: `human`, `chatbot`, `ai_agent`)
- `any_values` (`string[]` - an array of agent type values; allowed values: `human`, `chatbot`, `ai_agent`)
- `exclude_values` (`string[]` - an array of agent type values; allowed values: `human`, `chatbot`, `ai_agent`)
