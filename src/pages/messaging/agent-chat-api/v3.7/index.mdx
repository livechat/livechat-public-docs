...
- `all_values` (`string[]` - an array of agent type values; allowed values: `human`, `chatbot`, `ai-agent`)
- `any_values` (`string[]` - an array of agent type values; allowed values: `human`, `chatbot`, `ai-agent`)
- `exclude_values` (`string[]` - an array of agent type values; allowed values: `human`, `chatbot`, `ai-agent`)
