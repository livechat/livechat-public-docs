...
Informs that one of the chat users (an Agent or a Bot) is currently typing a message. The message hasn't been sent yet. The push payload contains the typing indicator object.
