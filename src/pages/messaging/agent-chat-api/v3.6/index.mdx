...
|                        |                                                                                  |
| ---------------------- | -------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.6/agent/action/list_customers`                   |
| **Required scopes**    | `customers:ro`                                                                   |
| **RTM API equivalent** | [`list_customers`](/messaging/agent-chat-api/v3.6/rtm-reference/#list_customers) |
| **Webhook**            | -                                                                                |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.6/agent/action/list_customers \
-H 'Authorization: Bearer <your_access_token>' \
-H 'Content-Type: application/json' \
-d '{}'
```
