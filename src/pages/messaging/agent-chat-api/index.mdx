...
It marks an agent’s events up to a specific time as read on a customer’s chat.

This method requires an `access_token` to authorize requests. More information about the Agent authorization flows can be found [here](/authorization/authorizing-api-calls#agent-authorization-flows).
