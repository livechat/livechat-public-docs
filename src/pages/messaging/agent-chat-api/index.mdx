...
Tags a given thread. The following restrictions apply:

- Active and inactive chats can be tagged.
- One or more tags can be added to the specific **thread**.
- To tag a chat, the **tag** needs to be created first. It can be done in the [LiveChat Application](https://accounts.livechat.com/) or via the [Configuration API](/management/configuration-api/v2.0#tags).
- Tags are case sensitive.
- Tags are defined by each client individually. The **list of tags** can be found in the [LiveChat Application](https://my.livechatinc.com/settings/tags). 
...
Untags a given thread. The following restrictions apply:

- Active and inactive chats can be untagged. 
- One or more tags can be removed from the specific **thread**. 
- Tags are case sensitive.
