...
Changing the customer `name`, `email`, `avatar`, and `session_fields` while the customer has an active chat will succeed, but the change will apply after the chat has closed.
