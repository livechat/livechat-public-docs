...
[Read how to list all available chats](https://my.livechatinc.com/settings/tags) and [create a new tag](/management/configuration-api/v2.0#add-a-tag). **Tags** are case sensitive in this method.
