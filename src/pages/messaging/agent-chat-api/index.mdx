...
This document describes the **Agent Chat Web API v3.5**. This is the latest stable version recommended for the production use. [Read more about versioning...](/messaging/#api-versioning)
