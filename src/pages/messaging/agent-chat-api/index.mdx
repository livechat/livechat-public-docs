...
[<div style={{maxWidth: '123px'}}><img alt="Run in Postman" src="https://run.pstmn.io/button.svg" width="123px" height="30px"/></div>](https://app.getpostman.com/run-collection/18768877-db1e2ed9-ca99-4fa5-8a1e-3d98a83e4171?action=collection%2Ffork&collection-url=entityId%3D18768877-db1e2ed9-ca99-4fa5-8a1e-3d98a83e4171%26entityType%3Dcollection%26workspaceId%3D5e6fb31b-587b-4258-b215-4dccaae38a38#?env%5B%5Bstable%5D%20LiveChat%20APIs%5D=)
...
To make a request, you need to specify the **tag name**, the **Id of the chat** and the **Id of the thread** you want to add a **tag** to. Active and inactive chats can be tagged, and one or more tags can be added to the specific **thread**. To tag a chat, the **tag** needs to be created first. It's possible to do that in the [LiveChat Application](https://accounts.livechat.com/) or via the [Configuration API](/management/configuration-api). Tags are case sensitive and are defined by each client individually. The **list of tags** can be found in the [LiveChat Application](https://my.livechatinc.com/settings/tags). 

The **tagged threads** can be untagged using [Untag Thread](/messaging/agent-chat-api#untag-thread).
...
To make a request, you need to specify the **tag name**, the **Id of the chat** and the **Id of the thread** you want to remove a **tag** from. Active and inactive chats can be untagged, and one or more tags can be removed from the specific **thread**. Tags are case sensitive.

The **untagged threads** can be tagged using [Tag Thread](/messaging/agent-chat-api#tag-thread).
