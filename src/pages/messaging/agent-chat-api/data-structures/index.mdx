...
<CodeResponse version="v3.6" type="agent" title={'Sample Customer Omnichannel data structure'} json="omnichannel"/>
...
<CodeResponse version="v3.6" type="agent" title={'Sample Fabcebook Messenger data structure'} json="omnichannel_fb_messenger"/>
...
<CodeResponse version="v3.6" type="customer" title={'Sample Twilio data structure'} json="omnichannel_twilio"/>
