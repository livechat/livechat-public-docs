...
This document describes the **Agent Chat Real-Time Messaging API v3.4**, which is a legacy version. For production-ready applications, it's best to use to the current stable version. [Read more about versioning...](/messaging/#api-versioning)
...
* `highest_available` - sets customer monitoring level to highest available level based on license configuration. More information about the license configuration is available by contacting support
