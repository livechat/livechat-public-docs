...
| `filters.greetings.from`                                         | No       | `string`  | Date & time format with a resolution of microseconds, UTC string, `YYYY-MM-DDTHH:MM:SS.ssssssZHH:MM`                  |
| `filters.greetings.to`                                           | No       | `string`  | Date & time format with a resolution of microseconds, UTC string, `YYYY-MM-DDTHH:MM:SS.ssssssZHH:MM`                  |
| `filters.greetings.values`                                       | No       | `int[]`   | Array of greetings IDs.                                                                                               |
| `filters.greetings.exclude_values`                               | No       | `int[]`   | Array of greetings IDs.                                                                                               |
| `filters.greetings.exists`                                       | No       | `bool`    |                                                                                                                       |
| `filters.greetings.groups.values`                                | No       | `int[]`   | Array of group IDs.                                                                                                   |
| `filters.greetings.groups.exclude_values`                        | No       | `int[]`   | Array of group IDs.                                                                                                   |
| `page_id`                                                        | No       | `string`  |                                                                                                                       |
