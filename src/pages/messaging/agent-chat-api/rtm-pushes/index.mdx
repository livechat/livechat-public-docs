...
Informs about an incoming [rich message](/messaging/agent-chat-api/v3.5/data-structures/#rich-message) postback. The push payload contains the info on the postback itself, as well as the chat it was sent in.
...
Informs about customers the agent should be aware of. It's sent after [`login`](/messaging/agent-chat-api/rtm-reference/#login).
