...
Indicates that a [customer property](/messaging/agent-chat-api/data-structures#customer-property) definition was deleted within an organization. The payload contains only the ID of the deleted definition. The deletion is permanent.
