...
| `name`                                     | No       | `string`   |                                                                                  |
| `email`                                    | No       | `string`   |                                                                                  |
| `suggested_email`                          | No       | `string`   | An email address suggested for the customer but not confirmed by them. This version can't clear a suggestion: an empty value is ignored, and a request carrying nothing else fails validation - use [v3.7](/messaging/agent-chat-api/v3.7/rtm-reference/#update-customer) to clear one. |
