...
Establishing a wesocket connection as a bot is currently unsupported. If you want to call the Agent Chat API as bot, you should use the [Web API](/messaging/agent-chat-api#calling-the-api-as-a-bot) instead.
