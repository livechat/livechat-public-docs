...
To call the API as a bot, you need to use the bot token. You can generate it using the [**Issue Bot Token**](/management/configuration-api/v3.5/#issue-bot-token) method.
