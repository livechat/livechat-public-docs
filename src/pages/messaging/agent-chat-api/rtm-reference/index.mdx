...
**\*)** `chats--all:rw` - to resume chat in any group.

**\*\*)** `chats--access:rw` - to resume chat in groups that the requester (related to the token) is a member of.
...
**\*)** `chats--all:rw` - to deactivate chat in any group.

**\*\*)** `chats--access:rw` - to deactivate chat in groups that the agent (related to the token) is a member of.
...
**\*)** `chats--all:rw` - to transfer chat taking place in any group.

**\*\*)** `chats--access:rw` - to transfer chat taking place in groups that the requester (related to the token) is a member of (the requester groups and the current groups of the chat must intersect - at least one group must be common).
...
**\*\*)** `chats--access:rw` - to add a user to a chat taking place in groups that the requester (related to the token) is a member of (the agent groups and the chat groups must intersect - at least one group must be common); starting from v3.4, the user being added must also be a member of the group, so both requester’s and the user’s groups must intersect with chat groups.
...
**\*\*)** `chats--access:rw` - to remove a user from a chat taking place in groups that the requester (related to the token) is a member of (the agent groups and the chat groups must intersect - at least one group must be common).
...
**\*\*)** `chats--access:rw` - to send an event to a chat taking place in groups that the requester (related to the token) is a member of (the agent groups and the chat groups must intersect - at least one group must be common).
...
**\*\*)** `chats--access:rw` - to send a postback to a chat taking place in groups that the requester (related to the token) is a member of (the agent groups and the chat groups must intersect - at least one group must be common).
...
**\*\*)** `chats--access:rw` - to update properties in a chat taking place in groups that the requester (related to the token) is a member of (the agent groups and the chat groups must intersect - at least one group must be common).
...
**\*\*)** `chats--access:rw` - to delete properties in a chat taking place in groups that the requester (related to the token) is a member of (the agent groups and the chat groups must intersect - at least one group must be common).
...
**\*\*)** `chats--access:rw` - to update properties in a thread taking place in groups that the requester (related to the token) is a member of (the agent groups and the chat groups must intersect - at least one group must be common).
...
**\*\*)** `chats--access:rw` - to delete properties in a thread taking place in groups that the requester (related to the token) is a member of (the agent groups and the chat groups must intersect - at least one group must be common).
...
**\*\*)** `chats--access:rw` - to update properties in an event taking place in groups that the requester (related to the token) is a member of (the agent groups and the chat groups must intersect - at least one group must be common).
...
**\*\*)** `chats--access:rw` - to delete properties in an event taking place in groups that the requester (related to the token) is a member of (the agent groups and the chat groups must intersect - at least one group must be common).
...
**\*\*)** `chats--access:rw` - to tag a thread taking place in groups that the requester (related to the token) is a member of (the agent groups and the chat groups must intersect - at least one group must be common).
...
**\*\*)** `chats--access:rw` - to untag a thread taking place in groups that the requester (related to the token) is a member of (the agent groups and the chat groups must intersect - at least one group must be common).
...
**\*\*\*\*)** `agents--all:ro` - to get pushes about agents updates.
...
**\*\*)** `agents--all:rw` - to set routing status of any agent in a license.

**\*\*\*)** `agents-bot--my:rw` - to set routing status of bots that belong to the `client_id` related to the token (in a license).

**\*\*\*\*)** `agents-bot--all:rw` - to set routing status of any bots in a license.
...
**\*\*)** `chats--access:ro` - to mark events as seen in a chat taking place in any group.
...
**\*)** `chats--all:rw` - to send typing indicator to a chat taking place in any group.

**\*\*)** `chats--access:rw` - to send typing indicator to a chat taking place in groups that the requester (related to the token) is a member of (the agent groups and the chat groups must intersect - at least one group must be common).
