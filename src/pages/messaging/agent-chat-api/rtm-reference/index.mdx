...
This document describes the **Agent Chat Real-Time Messaging API v3.6**. This is the latest stable version recommended for the production use. [Read more about versioning...](/messaging/#api-versioning)
...
| The API endpoint                              |
| --------------------------------------------- |
| `wss://api.livechatinc.com/v3.6/agent/rtm/ws` |
...
| **Web API equivalent** | [`list_chats`](/messaging/agent-chat-api/v3.6/#list-chats) |
| **Push message**       | -                                                          |
...
| ----------------------------------------------------- | -------- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `filters`                                             | No       | `object` | When paginating, the `filters` provided in the first request are remembered and automatically used for the subsequent requests. Providing a new `filters` object will result in a `validation` error. To reset the filters, start paginating with a new set of filters. |
...
| `filters.include_chats_without_threads`               | No       | `bool`   | If set to `true`: the returned chat summary includes chats without any threads. Default: `true`.                                                                                                                                                                        |
...
| `next_page_id`     | `string`  | In relation to the `page_id` specified in the request. Appears in the response only when there's a next page.     |
| `previous_page_id` | `string`  | In relation to the `page_id` specified in the request. Appears in the response only when there's a previous page. |
...
| **Action**             | `list_threads`                                                 |
| **Required scopes**    | `chats--all:ro` **\*** or `chats--access:ro` **\*\***          |
| **Web API equivalent** | [`list_threads`](/messaging/agent-chat-api/v3.6/#list-threads) |
| **Push message**       | -                                                              |
...
| `page_id`          | No       | `string`  |                                                                                                                                                                                                                                                               |
| `min_events_count` | No       | `number`  | The minimum number of events to be returned in the response. It's the **total** number of events, so they can come from more than one thread. You'll get as many latest threads as needed to meet the `min_events_count` condition. Minimum: 1. Maximum: 100. |
| `filters`          | No       | `object`  |                                                                                                                                                                                                                                                               |
...
| **Web API equivalent** | [`get_chat`](/messaging/agent-chat-api/v3.6/#get-chat)                                             |
| **Push message**       | -                                                                                                  |
...
| **Required scopes**    | `chats--all:ro` **\*** or `chats--access:ro` **\*\***            |
| **Web API equivalent** | [`list_archives`](/messaging/agent-chat-api/v3.6/#list-archives) |
| **Push message**       | -                                                                |
...
| `filters.agents.<filter_type>`<sup>**2**</sup>                                   | No       | `any`     | Described below. If `exists` is set to `false`, will return unassigned chats; `true` will return the assigned ones.                                                      |
...
| **Web API equivalent** | [`start_chat`](/messaging/agent-chat-api/v3.6/#start-chat)                               |
| **Push message**       | [`incoming_chat`](/messaging/agent-chat-api/v3.6/rtm-pushes/#incoming_chat)              |
...
| **Action**             | `resume_chat`                                                                            |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***, depending on the requested groups |
| **Web API equivalent** | [`resume_chat`](/messaging/agent-chat-api/v3.6/#resume-chat)                             |
| **Push message**       | [`incoming_chat`](/messaging/agent-chat-api/v3.6/rtm-pushes/#incoming_chat)              |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***, depending on the requested groups |
| **Web API equivalent** | [`deactivate_chat`](/messaging/agent-chat-api/v3.6/#deactivate-chat)                     |
| **Push message**       | [`chat_deactivated`](/messaging/agent-chat-api/v3.6/rtm-pushes/#chat_deactivated)        |
...
| **Web API equivalent** | [`follow_chat`](/messaging/agent-chat-api/v3.6/#follow-chat)                             |
| **Push message**       | [`incoming_chat`](/messaging/agent-chat-api/v3.6/rtm-pushes/#incoming_chat)**\*\*\***    |
...
| **Required scopes**    | -                                                                               |
| **Web API equivalent** | [`unfollow_chat`](/messaging/agent-chat-api/v3.6/#unfollow-chat)                |
| **Push message**       | [`chat_unfollowed`](/messaging/agent-chat-api/v3.6/rtm-pushes/#chat_unfollowed) |
...
| **Web API equivalent** | [`transfer_chat`](/messaging/agent-chat-api/v3.6/#transfer-chat)                  |
| **Push message**       | [`chat_transferred`](/messaging/agent-chat-api/v3.6/rtm-pushes/#chat_transferred) |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                        |
| **Web API equivalent** | [`remove_user_from_chat`](/messaging/agent-chat-api/v3.6/#remove-user-from-chat)             |
| **Push message**       | [`user_removed_from_chat`](messaging/agent-chat-api/v3.6/rtm-pushes/#user_removed_from_chat) |
...
| **Action**             | `send_event`                                                                  |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                         |
| **Web API equivalent** | [`send_event`](/messaging/agent-chat-api/v3.6/#send-event)                    |
| **Push message**       | [`incoming_event`](/messaging/agent-chat-api/v3.6/rtm-pushes/#incoming_event) |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                                                   |
| **Web API equivalent** | [`send_rich_message_postback`](/messaging/agent-chat-api/v3.6/#send-rich-message-postback)                              |
| **Push message**       | [`incoming_rich_message_postback`](/messaging/agent-chat-api/v3.6/rtm-pushes/#incoming_rich_message_postback)**\*\*\*** |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                           |
| **Web API equivalent** | [`update_chat_properties`](/messaging/agent-chat-api/v3.6/#update-chat-properties)              |
| **Push message**       | [`chat_properties_updated`](/messaging/agent-chat-api/v3.6/rtm-pushes/#chat_properties_updated) |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                           |
| **Web API equivalent** | [`delete_chat_properties`](/messaging/agent-chat-api/v3.6/#delete-chat-properties)              |
| **Push message**       | [`chat_properties_deleted`](/messaging/agent-chat-api/v3.6/rtm-pushes/#chat_properties_deleted) |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                               |
| **Web API equivalent** | [`update_thread_properties`](/messaging/agent-chat-api/v3.6/#update-thread-properties)              |
| **Push message**       | [`thread_properties_updated`](/messaging/agent-chat-api/v3.6/rtm-pushes/#thread_properties_updated) |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                               |
| **Web API equivalent** | [`delete_thread_properties`](/messaging/agent-chat-api/v3.6/#delete-thread-properties)              |
| **Push message**       | [`thread_properties_deleted`](/messaging/agent-chat-api/v3.6/rtm-pushes/#thread_properties_deleted) |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                             |
| **Web API equivalent** | [`update_event_properties`](/messaging/agent-chat-api/v3.6/#update-event-properties)              |
| **Push message**       | [`event_properties_updated`](/messaging/agent-chat-api/v3.6/rtm-pushes/#event_properties_updated) |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                                             |
| **Web API equivalent** | [`delete_event_properties`](/messaging/agent-chat-api/v3.6/#delete-event-properties)              |
| **Push message**       | [`event_properties_deleted`](/messaging/agent-chat-api/v3.6/rtm-pushes/#event_properties_deleted) |
...
| **Action**             | `tag_thread`                                                                |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                       |
| **Web API equivalent** | [`tag_thread`](/messaging/agent-chat-api/v3.6/#tag-thread)                  |
| **Push message**       | [`thread_tagged`](/messaging/agent-chat-api/v3.6/rtm-pushes/#thread_tagged) |
...
| **Action**             | `untag_thread`                                                                  |
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                           |
| **Web API equivalent** | [`untag_thread`](/messaging/agent-chat-api/v3.6/#untag-thread)                  |
| **Push message**       | [`thread_untagged`](/messaging/agent-chat-api/v3.6/rtm-pushes/#thread_untagged) |
...
| **Web API equivalent** | [`get_customer`](/messaging/agent-chat-api/v3.6/#get-customer) |
| **Push message**       | -                                                              |
...
| **Web API equivalent** | [`update_customer`](/messaging/agent-chat-api/v3.6/#update-customer)              |
| **Push message**       | [`customer_updated`](/messaging/agent-chat-api/v3.6/rtm-pushes/#customer_updated) |
...
| **Web API equivalent** | [`ban_customer`](/messaging/agent-chat-api/v3.6/#ban-customer)                  |
| **Push message**       | [`customer_banned`](/messaging/agent-chat-api/v3.6/rtm-pushes/#customer_banned) |
...
| `customer_monitoring_level` | No       | `string`   | Possible values: `my`, `chatting`, `invited`, `online`, `highest_available` __**__. Default: `my` if [login](#login) creates the first session; otherwise it preserves the current `customer_monitoring_level`. |
...
| **Web API equivalent** | [`set_routing_status`](/messaging/agent-chat-api/v3.6/#set-routing-status)                                                                           |
| **Push message**       | [`routing_status_set`](/messaging/agent-chat-api/v3.6/rtm-pushes/#routing_status_set)                                                                |
...
| **Web API equivalent** | [`list_routing_statuses`](/messaging/agent-chat-api/v3.6/#list-routing-statuses) |
| **Push message**       | -                                                                                |
...
| **Required scopes**    | `chats--all:ro` **\*** or `chats--access:ro` **\*\***                                       |
| **Web API equivalent** | [`mark_events_as_seen`](/messaging/agent-chat-api/v3.6/#mark-events-as-seen)                |
| **Push message**       | [`events_marked_as_seen`](/messaging/agent-chat-api/v3.6/rtm-pushes/#events_marked_as_seen) |
...
| **Required scopes**    | `chats--all:rw` **\*** or `chats--access:rw` **\*\***                            |
| **Web API equivalent** | [`send_typing_indicator`](/messaging/agent-chat-api/v3.6/#send-typing-indicator) |
| **Push message**       | -                                                                                |
...
| **Web API equivalent** | [`multicast`](/messaging/agent-chat-api/v3.6/#multicast)                              |
| **Push message**       | [`incoming_multicast`](/messaging/agent-chat-api/v3.6/rtm-pushes/#incoming_multicast) |
...
| **Required scopes**    | -                                                                                      |
| **Web API equivalent** | [`list_agents_for_transfer`](/messaging/agent-chat-api/v3.6/#list-agents-for-transfer) |
| **Push message**       | -                                                                                      |
...
- There are no retries for pushes. To determine if a user has seen an event, compare the [event's](/messaging/agent-chat-api/v3.6/data-structures/#response) `created_at` parameter with the [user's](/messaging/agent-chat-api/v3.6/data-structures/#users) `events_seen_up_to` field.

<SectionLink to={"/messaging/agent-chat-api/v3.6/rtm-pushes"}>See available pushes</SectionLink>
