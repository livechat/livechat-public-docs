...
All authorization scopes are listed in the [Scopes](/authorization/scopes/) document. If a method requires particular authorization scopes, you'll find them included in the method description.

## Data centers

LiveChat system operates in two data centers: `dal` (USA) and `fra` (Europe). The default data center is `dal`.

For backend applications, you can specify the region in the request header. The mechanism is the same as in [Agent Chat Web API reference](/messaging/agent-chat-api/v3.3/#data-centers). It doesn't work for frontend applications, though.
Instead, frontend apps connect to a region different than the default one by specifying the region suffix in the URL.

**`fra`:** `wss://api-fra.livechatinc.com/v3.3/agent/rtm/ws`

**`dal`:** `wss://api.livechatinc.com/v3.3/agent/rtm/ws`
...
| **Web API equivalent** | [`list_chats`](/messaging/agent-chat-api/v3.3/#list-chats)                                   |
| **Push message**       | -                                                                                            |
...
| **Action**             | `list_threads`                                                                               |
| **Required scopes**    | `chats--all:ro`<sup>1</sup> or `chats--access:ro`<sup>2</sup> or `chats--my:ro` <sup>3</sup> |
| **Web API equivalent** | [`list_threads`](/messaging/agent-chat-api/v3.3/#list-threads)                               |
| **Push message**       | -                                                                                            |
...
| **Web API equivalent** | [`get_chat`](/messaging/agent-chat-api/v3.3/#get-chat)                                                                                    |
| **Push message**       | -                                                                                                                                         |
...
| **Required scopes**    | `chats--all:ro`<sup>1</sup> or `chats--access:ro`<sup>2</sup> or `chats--my:ro`<sup>3</sup> |
| **Web API equivalent** | [`list_archives`](/messaging/agent-chat-api/v3.3/#list-archives)                            |
| **Push message**       | -                                                                                           |
...
3) `chats--my:ro` - to get a chat that the requester is added to.
...
| **Web API equivalent** | [`start_chat`](/messaging/agent-chat-api/v3.3/#start-chat)                               |
| **Push message**       | [`incoming_chat`](/messaging/agent-chat-api/rtm-pushes/#incoming_chat)                   |
...
| **Action**             | `resume_chat`                                                                            |
| **Required scopes \*** | `chats.conversation--all:rw` `chats.conversation--access:rw` `chats.conversation--my:rw` |
| **Web API equivalent** | [`resume_chat`](/messaging/agent-chat-api/v3.3/#resume-chat)                             |
| **Push message**       | [`incoming_chat`](/messaging/agent-chat-api/rtm-pushes/#incoming_chat)                   |
...
| **Web API equivalent** | [`deactivate_chat`](/messaging/agent-chat-api/v3.3/#deactivate-chat)                                                             |
| **Push message**       | [`chat_deactivated`](/messaging/agent-chat-api/rtm-pushes/#chat_deactivated)                                                     |
...
| **Web API equivalent** | [`follow_chat`](/messaging/agent-chat-api/v3.3/#follow-chat)                                                                    |
| **Push message**       | [`incoming_chat`](/messaging/agent-chat-api/rtm-pushes/#incoming_chat)<sup>4</sup>                                              |
...
4) It won't be sent when the requester already follows the chat or is the chat member.
...
| **Required scopes**    | -                                                                          |
| **Web API equivalent** | [`unfollow_chat`](/messaging/agent-chat-api/v3.3/#unfollow-chat)           |
| **Push message**       | [`chat_unfollowed`](/messaging/agent-chat-api/rtm-pushes/#chat_unfollowed) |
...
| **Web API equivalent** | [`grant_chat_access`](/messaging/agent-chat-api/v3.3/#grant-chat-access)                     |
| **Push message**       | [`chat_access_granted`](/messaging/agent-chat-api/rtm-pushes/#chat_access_granted)           |
...
| **Required scopes**    | `chats--all:rw`<sup>1</sup> or `chats--access:rw`<sup>2</sup> or `chats--my:rw` <sup>3</sup> |
| **Web API equivalent** | [`revoke_chat_access`](/messaging/agent-chat-api/v3.3/#revoke-chat-access)                   |
| **Push message**       | [`chat_access_revoked`](/messaging/agent-chat-api/rtm-pushes/#chat_access_revoked)           |
...
| **Required scopes**    | `chats--all:rw`<sup>1</sup> or `chats--access:rw`<sup>2</sup> or `chats--my:rw` <sup>3</sup> |
| **Web API equivalent** | [`transfer_chat`](/messaging/agent-chat-api/v3.3/#transfer-chat)                             |
...
| **Required scopes**    | `chats--all:rw`<sup>1</sup> or `chats--access:rw`<sup>2</sup> or `chats--my:rw` <sup>3</sup> |
| **Web API equivalent** | [`add_user_to_chat`](/messaging/agent-chat-api/v3.3/#add-user-to-chat)                       |
| **Push message**       | [`user_added_to_chat`](/messaging/agent-chat-api/rtm-pushes/#user_added_to_chat)             |
...
| **Required scopes**    | `chats--all:rw`<sup>1</sup> or `chats--access:rw`<sup>2</sup> or `chats--my:rw` <sup>3</sup> |
| **Web API equivalent** | [`remove_user_from_chat`](/messaging/agent-chat-api/v3.3/#remove-user-from-chat)             |
| **Push message**       | [`user_removed_from_chat`](messaging/agent-chat-api/rtm-pushes/#user_removed_from_chat)      |
...
| **Action**             | `send_event`                                                                             |
| **Required scopes**    | `chats.conversation--all:rw` `chats.conversation--access:rw` `chats.conversation--my:rw` |
| **Web API equivalent** | [`send_event`](/messaging/agent-chat-api/v3.3/#send-event)                               |
| **Push message**       | [`incoming_event`](/messaging/agent-chat-api/rtm-pushes/#incoming_event)                 |
...
| **Web API equivalent** | [`send_rich_message_postback`](/messaging/agent-chat-api/v3.3/#send-rich-message-postback)                     |
| **Push message**       | [`incoming_rich_message_postback`](/messaging/agent-chat-api/rtm-pushes/#incoming_rich_message_postback)**\*** |
...
| **Required scopes**    | `chats.conversation--all:rw` `chats.conversation--access:rw` `chats.conversation--my:rw`   |
| **Web API equivalent** | [`update_chat_properties`](/messaging/agent-chat-api/v3.3/#update-chat-properties)         |
| **Push message**       | [`chat_properties_updated`](/messaging/agent-chat-api/rtm-pushes/#chat_properties_updated) |
...
| **Required scopes**    | `chats.conversation--all:rw` `chats.conversation--access:rw` `chats.conversation--my:rw`   |
| **Web API equivalent** | [`delete_chat_properties`](/messaging/agent-chat-api/v3.3/#delete-chat-properties)         |
| **Push message**       | [`chat_properties_deleted`](/messaging/agent-chat-api/rtm-pushes/#chat_properties_deleted) |
...
| **Required scopes**    | `chats.conversation--all:rw` `chats.conversation--access:rw` `chats.conversation--my:rw`       |
| **Web API equivalent** | [`update_thread_properties`](/messaging/agent-chat-api/v3.3/#update-thread-properties)         |
| **Push message**       | [`thread_properties_updated`](/messaging/agent-chat-api/rtm-pushes/#thread_properties_updated) |
...
| **Required scopes**    | `chats.conversation--all:rw` `chats.conversation--access:rw` `chats.conversation--my:rw`       |
| **Web API equivalent** | [`delete_thread_properties`](/messaging/agent-chat-api/v3.3/#delete-thread-properties)         |
| **Push message**       | [`thread_properties_deleted`](/messaging/agent-chat-api/rtm-pushes/#thread_properties_deleted) |
...
| **Required scopes**    | `chats.conversation--all:rw` `chats.conversation--access:rw` `chats.conversation--my:rw`     |
| **Web API equivalent** | [`update_event_properties`](/messaging/agent-chat-api/v3.3/#update-event-properties)         |
| **Push message**       | [`event_properties_updated`](/messaging/agent-chat-api/rtm-pushes/#event_properties_updated) |
...
| **Required scopes**    | `chats.conversation--all:rw` `chats.conversation--access:rw` `chats.conversation--my:rw`     |
| **Web API equivalent** | [`delete_event_properties`](/messaging/agent-chat-api/v3.3/#delete-event-properties)         |
| **Push message**       | [`event_properties_deleted`](/messaging/agent-chat-api/rtm-pushes/#event_properties_deleted) |
...
| **Action**             | `tag_thread`                                                                                 |
| **Required scopes**    | `chats--all:rw`<sup>1</sup> or `chats--access:rw`<sup>2</sup> or `chats--my:rw` <sup>3</sup> |
| **Web API equivalent** | [`tag_thread`](/messaging/agent-chat-api/v3.3/#tag-thread)                                   |
| **Push message**       | [`thread_tagged`](/messaging/agent-chat-api/rtm-pushes/#thread_tagged)                       |
...
| **Action**             | `untag_thread`                                                                               |
| **Required scopes**    | `chats--all:rw`<sup>1</sup> or `chats--access:rw`<sup>2</sup> or `chats--my:rw` <sup>3</sup> |
| **Web API equivalent** | [`untag_thread`](/messaging/agent-chat-api/v3.3/#untag-thread)                               |
| **Push message**       | [`thread_untagged`](/messaging/agent-chat-api/rtm-pushes/#thread_untagged)                   |
...
| **Web API equivalent** | [`get_customer`](/messaging/agent-chat-api/v3.3/#get-customer) |
| **Push message**       | -                                                              |
...
| **Required scopes**    | `customers:ro`                                                     |
| **Web API equivalent** | [`list_customers`](/messaging/agent-chat-api/v3.3/#list-customers) |
| **Push message**       | -                                                                  |
...
| **Web API equivalent** | [`create_customer`](/messaging/agent-chat-api/v3.3/#create-customer)           |
| **Push message**       | [`incoming_customer`](/messaging/agent-chat-api/rtm-pushes/#incoming_customer) |
...
| **Required scopes**    | `customers:rw`                                                               |
| **Web API equivalent** | [`update_customer`](/messaging/agent-chat-api/v3.3/#update-customer)         |
| **Push message**       | [`customer_updated`](/messaging/agent-chat-api/rtm-pushes/#customer_updated) |
...
| **Web API equivalent** | [`ban_customer`](/messaging/agent-chat-api/v3.3/#ban-customer)             |
| **Push message**       | [`customer_banned`](/messaging/agent-chat-api/rtm-pushes/#customer_banned) |
...
| **Required scopes**    | `customers:ro`                                                                       |
| **Web API equivalent** | [`follow_customer`](/messaging/agent-chat-api/v3.3/#follow-customer)                 |
| **Push message**       | [`incoming_customer`](/messaging/agent-chat-api/rtm-pushes/#incoming_customer)**\*** |
...
| **Required scopes**    | -                                                                                  |
| **Web API equivalent** | [`unfollow_customer`](/messaging/agent-chat-api/v3.3/#unfollow-customer)           |
| **Push message**       | [`customer_unfollowed`](/messaging/agent-chat-api/rtm-pushes/#customer_unfollowed) |
...
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Action**             | `login`                                                                                                                                                            |
| **Required scopes**    | `chats--access:ro`<sup>1</sup> and `customers:ro`<sup>2</sup> and `multicast:ro`<sup>3</sup> and `agents--all:ro`<sup>4</sup> and `agents-bot--all:ro`<sup>5</sup> |
| **Web API equivalent** | -                                                                                                                                                                  |
| **Push message**       | -                                                                                                                                                                  |

1) `chats--access:ro` - to get pushes about chats from the requester groups.

2) `customers:ro` - to get pushes about customers.

3) `multicast:ro` - to get pushes about multicast.

4) `agents--all:ro` - to get pushes about agent updates.

5) `agents-bot--all:ro` - to get pushes about bot updates.
...
| **Web API equivalent** | [`set_routing_status`](/messaging/agent-chat-api/v3.3/#set-routing-status)                                                                                       |
| **Push message**       | [`routing_status_set`](/messaging/agent-chat-api/rtm-pushes/#routing_status_set)                                                                                 |
...
| **Web API equivalent** | [`list_routing_statuses`](/messaging/agent-chat-api/v3.3/#list-routing-statuses) |
| **Push message**       | -                                                                                |
...
| **Web API equivalent** | [`mark_events_as_seen`](/messaging/agent-chat-api/v3.3/#mark-events-as-seen)           |
| **Push message**       | [`events_marked_as_seen`](/messaging/agent-chat-api/rtm-pushes/#events_marked_as_seen) |
...
| **Required scopes**    | `chats.conversation--all:rw` `chats.conversation--access:rw` `chats.conversation--my:rw` |
| **Web API equivalent** | [`send_typing_indicator`](/messaging/agent-chat-api/v3.3/#send-typing-indicator)         |
| **Push message**       | -                                                                                        |
...
| **Web API equivalent** | [`multicast`](/messaging/agent-chat-api/v3.3/#multicast)                         |
| **Push message**       | [`incoming_multicast`](/messaging/agent-chat-api/rtm-pushes/#incoming_multicast) |
...
| **Required scopes**    | -                                                                                      |
| **Web API equivalent** | [`list_agents_for_transfer`](/messaging/agent-chat-api/v3.3/#list-agents-for-transfer) |
| **Push message**       | -                                                                                      |
...
<SectionLink to={"/messaging/agent-chat-api/rtm-pushes"}>See available pushes</SectionLink>
...
<Errors errors="authentication,authorization,chat_inactive,internal,license_expired,pending_requests_limit_reached,requester_already_offline,requester_awaiting_approval,request_timeout,requester_suspended,seats_limit_exceeded,service_unavailable,too_many_requests,validation,wrong_product_version"/>
