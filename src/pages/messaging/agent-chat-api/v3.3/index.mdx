...
Read how to [list all available chats](/management/configuration-api/v2.0#list-all-tags) and [create a new tag](/management/configuration-api/v2.0#add-a-tag). **Tags** are case sensitive in this method.
...
Untags a given **thread**. **Tags** are case sensitive in this method.
