...
|                        |                                                                              |
| ---------------------- | ---------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.3/agent/action/get_customer`                 |
...
For example, it could be used in an app that sends notifications to agents, when a certain condition is met (e.g. an important customer started the chat).
