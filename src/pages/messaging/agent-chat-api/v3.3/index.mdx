...
You can find all the requests from the Agent Chat Web API v3.3 in Postman. In our collection, we use [environment variables](https://learning.getpostman.com/docs/postman/environments_and_globals/manage_environments/) for the API version and the access token. Importing the collection from the link below downloads the **LiveChat Web API** environment as well. Remember to replace sample tokens with your own.

[<div style={{maxWidth: '123px'}}><img alt="Run in Postman" src="https://run.pstmn.io/button.svg" width="123px" height="30px"/></div>](https://god.gw.postman.com/run-collection/15474443-7f5c3298-9327-4ce5-977f-a61260d950b2?action=collection%2Ffork&collection-url=entityId%3D15474443-7f5c3298-9327-4ce5-977f-a61260d950b2%26entityType%3Dcollection%26workspaceId%3D5e6fb31b-587b-4258-b215-4dccaae38a38#?env%5BLiveChat%20APIs%5D=)

# Data structures

To find sample payloads of **events**, **users**, and **other common structures** such as chats or threads [visit the Data structures](/messaging/agent-chat-api/data-structures) document.
...
It returns [summaries](/messaging/agent-chat-api/data-structures/#chat-summaries) of the chats an Agent has access to.
...
| **Required scopes**    | `chats--all:ro`<sup>1</sup> or `chats--access:ro`<sup>2</sup> or `chats--my:ro` <sup>3</sup> |
| **RTM API equivalent** | [`list_chats`](/messaging/agent-chat-api/v3.3/rtm-reference/#list-chats)                     |
| **Webhook**            | -                                                                                            |

1) `chats--all:ro` - to find chats from all groups.

2) `chats--access:ro` - to find chats from groups that the requester (related to the token) is a member of.

3) `chats--my:ro` - to find a chat that the requester is added to.
...
| ------------------ | --------- | ------------------------------------------------------------------------------------------------------------ |
| `chats_summary`    | `array`   | An array of [Chat summary](/messaging/agent-chat-api/data-structures/#chat-summaries) data structures        |
...
| **Required scopes**    | `chats--all:ro`<sup>1</sup> or `chats--access:ro`<sup>2</sup> or `chats--my:ro` <sup>3</sup> |
| **RTM API equivalent** | [`list_threads`](/messaging/agent-chat-api/v3.3/rtm-reference/#list-threads)                 |
| **Webhook**            | -                                                                                            |

1) `chats--all:ro` - to find threads from all groups.

2) `chats--access:ro` - to find threads from groups that the requester (related to the token) is a member of.

3) `chats--my:ro` - to find threads that the requester is added to.
...
| **Required scopes**    | `chats--all:ro`<sup>1</sup> or `chats--access:ro`<sup>2</sup> or `chats--my:ro` <sup>3</sup>, depending on the requested thread’s groups. |
| **RTM API equivalent** | [`get_chat`](/messaging/agent-chat-api/v3.3/rtm-reference/#get-chat)                                                                      |
| **Webhook**            | -                                                                                                                                         |

1) `chats--all:ro` - to get chat from any group.

2) `chats--access:ro` - to get chat from a group that the requester (related to the token) is a member of.

3) `chats--my:ro` - to get chat that the requester is added to.
...
| **Required scopes**    | `chats--all:ro`<sup>1</sup> or `chats--access:ro`<sup>2</sup>                  |
| **RTM API equivalent** | [`list_archives`](/messaging/agent-chat-api/v3.3/rtm-reference/#list-archives) |
| **Webhook**            | -                                                                              |
...
| `filters.events.types`                                | No       | `array`   | Array of [Event](/messaging/agent-chat-api/data-structures/#events) types. Duplicates are ignored.                    |
| `page_id`                                             | No       | `string`  |                                                                                                                       |
...
| **RTM API equivalent** | [`start_chat`](/messaging/agent-chat-api/v3.3/rtm-reference/#start-chat)                 |
| **Webhook**            | [`incoming_chat`](/management/webhooks/v3.3/#incoming_chat)                              |
...
| **Required scopes \*** | `chats.conversation--all:rw` `chats.conversation--access:rw` `chats.conversation--my:rw` |
| **RTM API equivalent** | [`resume_chat`](/messaging/agent-chat-api/v3.3/rtm-reference/#resume-chat)               |
| **Webhook**            | [`incoming_chat`](/management/webhooks/v3.3/#incoming_chat)                              |
...
| **Required scopes**    | `chats--all:rw`<sup>1</sup> or `chats--access:rw`<sup>2</sup> or `chats--my:rw` <sup>3</sup>, depending on the requested groups.|
| **RTM API equivalent** | [`deactivate_chat`](/messaging/agent-chat-api/v3.3/rtm-reference/#deactivate-chat)                                              |
| **Webhook**            | [`chat_deactivated`](/management/webhooks/v3.3/#chat_deactivated)                                                               |

1) `chats--all:rw` - to deactivate a chat in any group.

2) `chats--access:rw` - to deactivate a chat in groups that the agent (related to the token) is a member of.

3) `chats--my:rw` - to deactivate a chat that the requester is added to.
...
| **Required scopes**    | `chats--all:ro`<sup>1</sup> or `chats--access:ro`<sup>2</sup> or `chats--my:ro` <sup>3</sup>, depending on the requested groups |
| **RTM API equivalent** | [`follow_chat`](/messaging/agent-chat-api/v3.3/rtm-reference/#follow-chat)                                                      |
| **Webhook**            | -                                                                                                                               |

1) `chats--all:ro` - to follow chats from all groups.

2) `chats--access:ro` - to follow chats from groups that the requester (related to the token) is a member of.

3) `chats--my:ro` - to follow a chat that the requester is added to.
...
| **Required scopes**    | -                                                                              |
| **RTM API equivalent** | [`unfollow_chat`](/messaging/agent-chat-api/v3.3/rtm-reference/#unfollow-chat) |
| **Webhook**            | -                                                                              |
...
| **Required scopes**    | `chats--all:rw`<sup>1</sup> or `chats--access:rw`<sup>2</sup> or `chats--my:rw` <sup>3</sup> |
| **RTM API equivalent** | [`grant_chat_access`](/messaging/agent-chat-api/v3.3/rtm-reference/#grant-chat-access)       |
| **Webhook**            | [`chat_access_granted`](/management/webhooks/v3.3/#chat_access_granted)                      |

1) `chats--all:rw` - to grant access to a chat taking place in any group.

2) `chats--access:rw` - to grant access to a chat taking place in groups that the requester (related to the token) is a member of. (The requester groups and the current groups of the chat must overlap - at least one group must be in common.)

3) `chats--my:rw` - to grant access to a chat that the requester is added to.
...
| **Required scopes**    | `chats--all:rw`<sup>1</sup> or `chats--access:rw`<sup>2</sup> or `chats--my:rw` <sup>3</sup> |
| **RTM API equivalent** | [`revoke_chat_access`](/messaging/agent-chat-api/v3.3/rtm-reference/#revoke-chat-access)     |
| **Webhook**            | [`chat_access_revoked`](/management/webhooks/v3.3/#chat_access_revoked)                      |

1) `chats--all:rw` - to revoke access to a chat taking place in any group.

2) `chats--access:rw` - to revoke access to a chat taking place in groups that the requester (related to the token) is a member of. (The requester groups and the current groups of the chat must overlap - at least one group must be in common.)

3) `chats--my:rw` - to revoke access to a chat that the requester is added to.
...
| **Required scopes**    | `chats--all:rw`<sup>1</sup> or `chats--access:rw`<sup>2</sup> or `chats--my:rw` <sup>3</sup> |
| **RTM API equivalent** | [`transfer_chat`](/messaging/agent-chat-api/v3.3/rtm-reference/#transfer-chat)               |
| **Webhook**            | [`chat_transferred`](/management/webhooks/v3.3/#chat_transferred)                            |

1) `chats--all:rw` - to transfer a chat taking place in any group.

2) `chats--access:rw` - to transfer a chat taking place in groups that the requester (related to the token) is a member of. (The requester groups and the current groups of the chat must overlap - at least one group must be in common.)

3) `chats--my:rw` - to transfer a chat that the requester is added to.
...
| **Required scopes**    | `chats--all:rw`<sup>1</sup> or `chats--access:rw`<sup>2</sup> or `chats--my:rw` <sup>3</sup> |
| **RTM API equivalent** | [`add_user_to_chat`](/messaging/agent-chat-api/v3.3/rtm-reference/#add-user-to-chat)         |
| **Webhook**            | [`user_added_to_chat`](/management/webhooks/v3.3/#user_added_to_chat)                        |

1) `chats--all:rw` - to add a user to a chat taking place in any group.

2) `chats--access:rw` - to add a user to a chat taking place in groups that the requester (related to the token) is a member of. (The agent groups and the chat groups must overlap - at least one group must be in common.)

3) `chats--my:rw` - to add a user to a chat that the requester is added to.
...
| **Required scopes**    | `chats--all:rw`<sup>1</sup> or `chats--access:rw`<sup>2</sup> or `chats--my:rw` <sup>3</sup>   |
| **RTM API equivalent** | [`remove_user_from_chat`](/messaging/agent-chat-api/v3.3/rtm-reference/#remove-user-from-chat) |
| **Webhook**            | [`user_removed_from_chat`](/management/webhooks/v3.3/#user_removed_from_chat)                  |

1) `chats--all:rw` - to remove user from a chat taking place in any group.

2) `chats--access:rw` - to remove user from a chat taking place in groups that the requester (related to the token) is a member of. (The agent groups and the chat groups must overlap - at least one group must be in common.)

3) `chats--my:rw` - to remove a user from a chat that the requester is added to.
...
Sends an [Event](/messaging/agent-chat-api/data-structures/#events) object. Use this method to send a message by specifying the [Message](/messaging/agent-chat-api/data-structures/#message) event type in the request.

It's possible to write to a chat without joining it. The user sending an event will be automatically added to the chat with the `present` parameter set to `false` (see [`user_added_to_chat`](/messaging/agent-chat-api/rtm-pushes/#user_added_to_chat)). **Sample use case:** a Bot Agent that sends messages visible to all chat participants without actually joining the chat.
...
| **Required scopes**    | `chats.conversation--all:rw` `chats.conversation--access:rw` `chats.conversation--my:rw` |
| **RTM API equivalent** | [`send_event`](/messaging/agent-chat-api/v3.3/rtm-reference/#send-event)                 |
| **Webhook**            | [`incoming_event`](/management/webhooks/v3.3/#incoming_event)                            |
...
| **RTM API equivalent** | [`send_rich_message_postback`](/messaging/agent-chat-api/v3.3/rtm-reference/#send-rich-message-postback) |
| **Webhook**            | [`incoming_rich_message_postback`](/management/webhooks/v3.3/#incoming_rich_message_postback)**\***      |
...
| **Required scopes**    | `chats.conversation--all:rw` `chats.conversation--access:rw` `chats.conversation--my:rw`         |
| **RTM API equivalent** | [`update_chat_properties`](/messaging/agent-chat-api/v3.3/rtm-reference/#update-chat-properties) |
| **Webhook**            | [`chat_properties_updated`](/management/webhooks/v3.3/#chat_properties_updated)                  |
...
| **Required scopes**    | `chats.conversation--all:rw` `chats.conversation--access:rw` `chats.conversation--my:rw`         |
| **RTM API equivalent** | [`delete_chat_properties`](/messaging/agent-chat-api/v3.3/rtm-reference/#delete-chat-properties) |
| **Webhook**            | [`chat_properties_deleted`](/management/webhooks/v3.3/#chat_properties_deleted)                  |
...
| **Required scopes**    | `chats.conversation--all:rw` `chats.conversation--access:rw` `chats.conversation--my:rw`             |
| **RTM API equivalent** | [`update_thread_properties`](/messaging/agent-chat-api/v3.3/rtm-reference/#update-thread-properties) |
| **Webhook**            | [`thread_properties_updated`](/management/webhooks/v3.3/#thread_properties_updated)                  |
...
| **Required scopes**    | `chats.conversation--all:rw` `chats.conversation--access:rw` `chats.conversation--my:rw`             |
| **RTM API equivalent** | [`delete_thread_properties`](/messaging/agent-chat-api/v3.3/rtm-reference/#delete-thread-properties) |
| **Webhook**            | [`thread_properties_deleted`](/management/webhooks/v3.3/#thread_properties_deleted)                  |
...
| **Required scopes**    | `chats.conversation--all:rw` `chats.conversation--access:rw` `chats.conversation--my:rw`           |
| **RTM API equivalent** | [`update_event_properties`](/messaging/agent-chat-api/v3.3/rtm-reference/#update-event-properties) |
| **Webhook**            | [`event_properties_updated`](/management/webhooks/v3.3/#event_properties_updated)                  |
...
| **Required scopes**    | `chats.conversation--all:rw` `chats.conversation--access:rw` `chats.conversation--my:rw`           |
| **RTM API equivalent** | [`delete_event_properties`](/messaging/agent-chat-api/v3.3/rtm-reference/#delete-event-properties) |
| **Webhook**            | [`event_properties_deleted`](/management/webhooks/v3.3/#event_properties_deleted)                  |
...
Read how to [list all available tags](/management/configuration-api/v2.0#list-all-tags) and [create a new tag](/management/configuration-api/v2.0#add-a-tag).
...
| **Required scopes**    | `chats--all:rw`<sup>1</sup> or `chats--access:rw`<sup>2</sup> or `chats--my:rw` <sup>3</sup> |
| **RTM API equivalent** | [`tag_thread`](/messaging/agent-chat-api/v3.3/rtm-reference/#tag-thread)                     |
| **Webhook**            | [`thread_tagged`](/management/webhooks/v3.3/#thread_tagged)                                  |

1) `chats--all:rw` - to tag a thread taking place in any group.

2) `chats--access:rw` - to tag a thread taking place in groups that the requester (related to the token) is a member of. (The agent groups and the chat groups must overlap - at least one group must be in common.)

3) `chats--my:rw` - to tag a thread that the requester is added to.
...
| **Required scopes**    | `chats--all:rw`<sup>1</sup> or `chats--access:rw`<sup>2</sup> or `chats--my:rw` <sup>3</sup> |
| **RTM API equivalent** | [`untag_thread`](/messaging/agent-chat-api/v3.3/rtm-reference/#untag-thread)                 |
| **Webhook**            | [`thread_untagged`](/management/webhooks/v3.3/#thread_untagged)                              |

1) `chats--all:rw` - to untag a thread taking place in any group.

2) `chats--access:rw` - to untag a thread taking place in groups that the requester (related to the token) is a member of. (The agent groups and the chat groups must overlap - at least one group must be in common.)

3) `chats--my:rw` - to untag a thread that the requester is added to.
...
| **RTM API equivalent** | [`get_customer`](/messaging/agent-chat-api/v3.3/rtm-reference/#get-customer) |
| **Push message**       | -                                                                            |
...
| Field            | Data type | Notes                                                                                                                             |
| ---------------- | --------- | --------------------------------------------------------------------------------------------------------------------------------- |
| `id`             | string    | [Customer's](/messaging/agent-chat-api/data-structures/#customer) ID.                                                             |
...
| **Required scopes**    | `customers:ro`                                                                   |
| **RTM API equivalent** | [`list_customers`](/messaging/agent-chat-api/v3.3/rtm-reference/#list_customers) |
| **Webhook**            | -                                                                                |
...
Creates a new [Customer](/messaging/agent-chat-api/data-structures/#customer) user type.
...
| **RTM API equivalent** | [`create_customer`](/messaging/agent-chat-api/v3.3/rtm-reference/#create-customer) |
...
| **Required scopes**    | `customers:rw`                                                                                                  |
| **RTM API equivalent** | [`update_customer`](/messaging/agent-chat-api/v3.3/rtm-reference/#update-customer)                              |
...
| **RTM API equivalent** | [`ban_customer`](/messaging/agent-chat-api/v3.3/rtm-reference/#ban-customer) |
| **Webhook**            | -                                                                            |
...
| **Required scopes**    | `customers:ro`                                                                     |
| **RTM API equivalent** | [`follow_customer`](/messaging/agent-chat-api/v3.3/rtm-reference/#follow-customer) |
| **Webhook**            | -                                                                                  |
...
| **Required scopes**    | -                                                                                      |
| **RTM API equivalent** | [`unfollow_customer`](/messaging/agent-chat-api/v3.3/rtm-reference/#unfollow-customer) |
| **Webhook**            | -                                                                                      |
...
| **Required scopes**    | for Agents: `agents--my:rw` <sup>1</sup> or `agents--all:rw` <sup>2</sup>; for Bot Agents: `agents-bot--my:rw` <sup>3</sup> or `agents-bot--all:rw` <sup>4</sup> |
| **RTM API equivalent** | [`set_routing_status`](/messaging/agent-chat-api/v3.3/rtm-reference/#set-routing-status)                                                                         |
| **Webhook**            | [`routing_status_set`](/management/webhooks/v3.3/#routing_status_set)                                                                                            |

1) `agents--my:rw` - to set my routing status.

2) `agents--all:rw` - to set the routing status of any agent within a license.

3) `agents-bot--my:rw` - to set the routing status of bots that belong to the `client_id` related to the token (within a license).

4) `agents-bot--all:rw` - to set the routing status of any bots within a license.
...
| **Required scopes**    | `agents--all:ro`<sup>1</sup> and `agents-bot--all:ro` <sup>2</sup>                             |
| **RTM API equivalent** | [`list_routing_statuses`](/messaging/agent-chat-api/v3.3/rtm-reference/#list-routing-statuses) |
| **Webhook**            | -                                                                                              |

1) `agents--all:ro` - to list statuses of agents.

2) `agents-bot--all:ro` - to list statuses of bots.
...
| **Required scopes**    | `chats--access:ro`<sup>1</sup> or `chats--all:ro`<sup>2</sup>                              |
| **RTM API equivalent** | [`mark_events_as_seen`](/messaging/agent-chat-api/v3.3/rtm-reference/#mark-events-as-seen) |
| **Webhook**            | [`events_marked_as_seen`](/management/webhooks/v3.3/#events_marked_as_seen)                |

1) `chats--access:ro` - to mark events as seen in a chat taking place in groups that the requester (related to the token) is a member of (the agent groups and the chat groups must intersect - at least one group must be common).

2) `chats--all:ro` - to mark events as seen in a chat taking place in any group.
...
| **Required scopes**    | `chats.conversation--all:rw` `chats.conversation--access:rw` `chats.conversation--my:rw`       |
| **RTM API equivalent** | [`send_typing_indicator`](/messaging/agent-chat-api/v3.3/rtm-reference/#send-typing-indicator) |
| **Webhook**            | -                                                                                              |
...
| **RTM API equivalent** | [`multicast`](/messaging/agent-chat-api/v3.3/rtm-reference/#multicast) |
| **Webhook**            | -                                                                      |
...
| **Required scopes**    | -                                                                                                    |
| **RTM API equivalent** | [`list_agents_for_transfer`](/messaging/agent-chat-api/v3.3/rtm-reference/#list-agents-for-transfer) |
| **Webhook**            | -                                                                                                    |
...
<SectionLink to={"/management/configuration-api/#webhooks"}>See webhook methods</SectionLink>
<SectionLink to={"/management/webhooks/"}>See webhook payloads</SectionLink>
...
<Errors errors="authentication,authorization,chat_inactive,entity_too_large,internal,license_expired,license_not_found,limit_reached,misdirected_request,request_timeout,service_unavailable,too_many_requests,unsupported_version,validation,wrong_product_version"/>
