...
This document describes the **Agent Chat Web API v3.1**. This version is **deprecated**. We encourage you to migrate to the latest stable version. [Read more about versioning...](/messaging/#api-versioning)
...
- When using RTM API, you can be also notified about events with [pushes](/messaging/agent-chat-api/v3.1/rtm-pushes).
