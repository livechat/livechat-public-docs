...
This document describes the **Agent Chat Web API v3.2**. This is the **deprecated** version. We encourage you to migrate to the latest stable version. [Read more about versioning...](/messaging/#api-versioning)
