...
This documentation describes the **Agent Chat Real-Time Messaging API v3.2**. This is the **deprecated** version. We encourage you to migrate to the latest stable version. [Read more about versioning...](/messaging/#api-versioning)
