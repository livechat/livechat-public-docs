...
Indicates about an incoming [rich message](/messaging/agent-chat-api/v3.2/data-structures/#rich-message) postback. The push payload contains the info on the postback itself, as well as the chat it was sent in.
...
Indicates that a customer entered the tracked website.
