...
The maximum number of concurrent chats an agent can participate in is **20**. It can be configured in the LiveChat Agent App by the license Owner or Admin.
...
To use both APIs, you need to be _authorized_. We explained this topic in the [Authorizing API calls](/authorization/) document.
