...
Agent-side communication allows you to chat not only chat as an agent **but also as a bot** (also known as bot agent). You can perform **simple actions** such as **browsing archives** or **banning customers** or **build your custom agent application** (a [sample one](/messaging/chat-sdk/#simple-agent) was built using Chat SDK).
