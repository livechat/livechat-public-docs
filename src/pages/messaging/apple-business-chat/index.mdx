...
Let the customer choose from a list of replies by sending a quick replies. More about <a href="https://register.apple.com/resources/messages/msp-rest-api/type-interactive#quick-reply-message-beta" target="_blank" rel="noopener noreferrer">**quick replies...**</a>
