...
<Scopes scopes="properties--my:ro,properties--my:rw,properties--all:ro,properties.configuration:rw,properties.license.value--my.rw,properties.license.value--all.rw,properties.group.value--my.rw,properties.group.value--all.rw" />
