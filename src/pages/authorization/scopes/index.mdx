...
desc: "Learn how to use OAuth 2.1 to access LiveChat data securely. Check general rules of scopes."
---
...
<Scopes scopes="canned_responses--groups:ro,canned_responses--groups:rw,canned_responses--all:ro,canned_responses--all:rw" />
