...
The authorization methods described in this document may be used to create the LiveChat and HelpDesk products. To call either of these APIs, you need to authorize your calls with an access token. This document describes three authorization flows that let you acquire a token:
