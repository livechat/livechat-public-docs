...
To make calls to Customer Chat API, you need a different `access_token`. For that, see [Customer Authorisation](/authorization/customer-authorization/).

# Postman collection

<here you can copy the content from the "Authorizing API calls" document>
