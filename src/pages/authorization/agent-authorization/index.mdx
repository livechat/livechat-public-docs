...
Start in <a href="https://platform.text.com/console/" target="_blank">Developer Console</a>. Then, go to **Tools -> Personal Access Tokens** and create a new token together with necessary [scopes](/authorization/scopes/). You won't be able to change those scopes once you create the token.
