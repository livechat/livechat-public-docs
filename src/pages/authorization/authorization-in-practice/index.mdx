...
- **Access scopes** - most methods require certain scopes. <a href="https://developers.livechat.com/docs/messaging/agent-chat-api/v3.2/#list-chats" target="_blank">See the API documentation </a> to find out what scope your app needs to use the List Chats method.
