...
- There's a new method, [**Abandoned Carts**](/data-reporting/reports-api/v3.7/#abandoned-carts), which returns the number of abandoned carts and their total value during the specified period.
