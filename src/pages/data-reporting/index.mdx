...
- export data to Excel ([see blogpost](https://platform.text.com/blog/how-to-get-livechat-api-data-with-microsoft-excel-or-power-bi/)) or 3rd-party analytics and BI tools,
