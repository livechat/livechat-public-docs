...
| `filters.agent_response.first`                                        | No       | `bool`    | Modifier that makes the other `agent_response` filters operate on first response time.                                                                                                                                                      |
| `filters.agent_response.agents.<string_filter_type>`<sup>**2**</sup>  | No       | `any`     | Described below.                                                                                                                                                                                                                            |
| `filters.agent_response.groups.<integer_filter_type>`<sup>**3**</sup> | No       | `any`     | Described below.                                                                                                                                                                                                                            |
...
Shows the average response time of agents within a license.

#### Specifics

|                     |                                                                 |
| ------------------- | --------------------------------------------------------------- |
| **Method URL**      | `https://api.livechatinc.com/v3.4/reports/agents/response_time` |
| **HTTP method**     | POST, GET                                                       |
| **Required scopes** | `reports_read`                                                  |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.4/reports/agents/response_time \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <your_access_token>' \
  -d '{
    "filters": {
...
Shows the average first response time of agents within a license.

#### Specifics

|                     |                                                                       |
| ------------------- | --------------------------------------------------------------------- |
| **Method URL**      | `https://api.livechatinc.com/v3.4/reports/agents/first_response_time` |
| **HTTP method**     | POST, GET                                                             |
| **Required scopes** | `reports_read`                                                        |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.4/reports/agents/first_response_time \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <your_access_token>' \
  -d '{
    "filters": {
