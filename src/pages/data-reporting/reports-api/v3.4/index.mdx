...
Shows the distribution of chats based on the engagement during the specified period.
...
| Field                         | Notes                                                        |
|-------------------------------|--------------------------------------------------------------|
| `total`                       | The total number of engagements in the specified date range. |
| `records`                     | Contains the `distribution` objects, for example, `day`.     |
| `records.day.total`           | The total number of engagements that `day`.                  |
| `records.day.auto_invite`     | The number of chats from automatic invitations that `day`.   |
