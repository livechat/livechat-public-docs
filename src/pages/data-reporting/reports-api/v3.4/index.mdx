...
|            |                                                                                                                                                                                                                     |
| ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Chats**  | [`duration`](#duration) [`tags`](#tags) [`total_chats`](#total-chats) [`ratings`](#ratings) [`ranking`](#ranking) [`engagement`](#engagement) [`greetings_conversion`](#greetings-conversion) [`surveys`](#surveys) |
...
Presents how many suveys where filled in and what was count of specific answers.
...
| Field                                                   | Notes                                                                                                  |
| ------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| `records`                                               | Contains `survey` objects per Group ID.                                                                |
