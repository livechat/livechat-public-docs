...
Progress is a simple app that creates reports based on data from chats. It can display the daily, weekly, monthly, and annual statistics. The App indirectly uses **Reports API 2.0** endpoints:
...
<div style={{maxWidth: '890px'}}>
  <img src="/images/data-reporting/livechat-reporting-progress-app.png" alt="Progress app preview" width="886px" height="881px"/>
</div>
...
This method is indirectly used by one of our Sample Apps, the <a href="https://github.com/livechat/progress-app" target="_blank">Progress</a> app. Check it out and experiment with an already existing app.
