...
This document describes the **LiveChat Reports API v3.4**. This is the latest stable version recommended for the production use. [Read more about versioning...](/management/#api-versioning)
...
| `filters.from`                                                        | No       | `string`  | Filters out chats that took place within the time range defined as <`from`,`to`>. Date & time format compatible with RFC3339 with optional resolution of microseconds, `YYYY-MM-DDTHH:MM:SS.ssssssZHH:MM`.                                                                                                        |
| `filters.to`                                                          | No       | `string`  | Filters out chats that took place within the time range defined as <`from`,`to`>. Date & time format compatible with RFC3339 with optional resolution of microseconds, `YYYY-MM-DDTHH:MM:SS.ssssssZHH:MM`.                                                                                                        |
...
| `filters.greetings.from`                                              | No       | `string`  | Filters out chats started from a greeting that was sent within the time range defined as <`from`,`to`>. Date & time format compatible with RFC3339 with optional resolution of microseconds, `YYYY-MM-DDTHH:MM:SS.ssssssZHH:MM`.                                                                                  |
| `filters.greetings.to`                                                | No       | `string`  | Filters out chats started from a greeting that was sent within the time range defined as <`from`,`to`>. Date & time format compatible with RFC3339 with optional resolution of microseconds, `YYYY-MM-DDTHH:MM:SS.ssssssZHH:MM`.                                                                                  |
...
<CodeResponse version="v3.4" type="reports" title={"Sample survey filter"} json="surveyFilter"/>
...
|                     |                                                           |
| ------------------- | --------------------------------------------------------- |
| **Method URL**      | `https://api.livechatinc.com/v3.4/reports/chats/duration` |
...
<CodeResponse type="reports" version="v3.4" json="duration"/>
...
<CodeResponse type="reports" version="v3.4" json="engagement"/>
...
The method will return only up to 100 values for each day, and it's connected with the response size. If there are more than 100 values, please use the Agent App to access the full data for a given day.

#### Specifics

|                     |                                                                       |
| ------------------- | --------------------------------------------------------------------- |
| **Method URL**      | `https://api.livechatinc.com/v3.4/reports/chats/greetings_conversion` |
| **HTTP method**     | POST, GET                                                             |
| **Required scopes** | `reports_read`                                                        |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.4/reports/chats/greetings_conversion \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <your_access_token>' \
  -d '{
   "distribution": "day",
...
<CodeResponse type="reports" version="v3.4" json="greetingsConversion"/>
...
|                     |                                                          |
| ------------------- | -------------------------------------------------------- |
| **Method URL**      | `https://api.livechatinc.com/v3.4/reports/chats/surveys` |
| **HTTP method**     | POST, GET                                                |
| **Required scopes** | `reports_read`                                           |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.4/reports/chats/surveys \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <your_access_token>' \
  -d '{
    "filters": {
...
<CodeResponse type="reports" version="v3.4" json="surveys"/>
...
|                     |                                                                |
| ------------------- | -------------------------------------------------------------- |
| **Method URL**      | `https://api.livechatinc.com/v3.4/reports/chats/response_time` |
| **HTTP method**     | POST, GET                                                      |
| **Required scopes** | `reports_read`                                                 |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.4/reports/chats/response_time \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <your_access_token>' \
  -d '{
    "filters": {
...
<CodeResponse type="reports" version="v3.4" json="responseTime"/>
...
|                     |                                                                      |
| ------------------- | -------------------------------------------------------------------- |
| **Method URL**      | `https://api.livechatinc.com/v3.4/reports/chats/first_response_time` |
| **HTTP method**     | POST, GET                                                            |
| **Required scopes** | `reports_read`                                                       |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.4/reports/chats/first_response_time \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <your_access_token>' \
  -d '{
    "filters": {
...
<CodeResponse type="reports" version="v3.4" json="firstResponseTime"/>
...
|                     |                                                               |
| ------------------- | ------------------------------------------------------------- |
| **Method URL**      | `https://api.livechatinc.com/v3.4/reports/agents/performance` |
| **HTTP method**     | POST, GET                                                     |
| **Required scopes** | `reports_read`                                                |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.4/reports/agents/performance \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <your_access_token>' \
  -d '{
    "filters": {
...
<CodeResponse type="reports" version="v3.4" json="performance"/>
