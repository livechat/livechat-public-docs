...
This document describes the **LiveChat Reports API v3.6**. This is the latest stable version recommended for the production use. [Read more about versioning...](/data-reporting/#api-versioning)
...
| `records.agent.good`  | The number of the agent's chats rated `good`.                                                                          |
| `records.agent.bad`   | The number of the agent's chats rated `bad`.                                                                           |
...
| `records.day.greeting_id.goals`     | The number of goals that resulted from greetings that `day`.                |
...
| Field             | Notes                                                                                             |
| ----------------- | ------------------------------------------------------------------------------------------------- |
| `total`           | The total time the chat was available in the specified date range.                                |
| `records`         | Contains the `distribution` objects, for example, `day`.                                          |
...
| `records.chats_rated_good`           | The number of the agent's chats rated `good`.                                                          |
| `records.chats_rated_bad`            | The number of the agent's chats rated `bad`.                                                           |
...
| `total`                        | The total number of chats in the specified date range. |
| `records`                      | Contains `distribution` objects, for example, `day`.   |
| `records.day.left_queue`       | Visitors who left the queue without starting a chat.   |
...
| `records.day.queued`           | Visitors who waited in the queue and entered a chat.   |
