...
To find out more about resource limits and the possibilities to change them, <button style={{ background: 'none!important',
border: 'none',
padding: '0!important',
color: '#2200FF',
textDecoration: 'none',
cursor: 'pointer'}} href="#open-chat" onClick={openChatWindow}>contact our support</button>.
