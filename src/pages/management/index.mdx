...
Once **license webhooks** are set up, you will always receive them. Read our tutorial on <a href="https://platform.text.com/updates/setting-up-webhooks-with-livechat-api/" target="_blank">how to configure LiveChat license webhooks via the Configuration API</a>.
