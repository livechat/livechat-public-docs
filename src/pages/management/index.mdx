...
|                 |                                                                                                                                                                                                                                                                                  |
| --------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **dev preview** | It gives a preview of the features that are currently in development. **It's subject to change and comes with limited access**. Contact us at developers@livechat.com or <a href="#open-chat" onClick={openChatWindow}>ask on the chat</a> to get access. Lifetime: ~6-7 months. |
| **stable**      | It has a closed feature set and is publicly available. It receives all bug fixes. Lifetime: ~6-7 months.                                                                                                                                                                         |
| **legacy**      | We're gradually dropping support for this version. It receives only critical and security bug fixes. Lifetime: ~1-1.5 year.                                                                                                                                                      |
| **deprecated**  | It'll soon be decommissioned. It receives only critical and security bug fixes. Lifetime: 6 months.                                                                                                                                                                              |
...
<SectionLink href={"/management/webhooks/#available-webhooks"}>
