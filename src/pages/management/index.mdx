...
| **legacy**      | We're gradually dropping support for this version. It receives only critical and security bug fixes. Lasts for ~1-1.5 years.                                                                                                                                                     |
| **deprecated**  | It receives only critical and security bug fixes. Lasts for 6 months before it's decommissioned.                                                                                                                                                                                 |
