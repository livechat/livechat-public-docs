...
Starting from version v3.5, bots **are no longer** authorized with the use of the [agent token](/authorization/agent-authorization/). Version 3.5 introduced new Both Authorization Tokens in place of the `X-Author-Id` mechanism. Read more in [Changelog](/changelog/#bots).
