...
- Added canned response management methods: 
  - [**Create**](/management/configuration-api/#create-canned-response)
  - [**Update**](/management/configuration-api/#update-canned-response)
  - [**List**](/management/configuration-api/#list-canned-responses)
  - [**Delete**](/management/configuration-api/#delete-canned-response)
  - corresponding push events [RTM API](/messaging/agent-chat-api/v3.7/rtm-pushes/#canned_response_created).
