...
- Added the [**Ban Customer**](/management/configuration-api/v3.7#ban-customer) method.
...
- Added translations management methods:
  - [**Update Translations**](/management/configuration-api/v3.7#update-translations)
  - [**List Translations**](/management/configuration-api/v3.7#list-translations)

### Forms

- Added forms management methods:
  - [**Get Form**](/management/configuration-api/v3.7#get-form)
  - [**Update Form**](/management/configuration-api/v3.7#update-form)
  - [**Delete Form**](/management/configuration-api/v3.7#delete-form)
...
- Added support for the `supervisor` priority for the `groups[].priority` parameter. This applies to all **v3.x** versions of _the Configuration API_.
...
- Added support for the `supervisor` priority for the `agent_priorities` parameter. This applies to all **v3.x** versions of _the Configuration API_.
...
- The [**Create Bot**](/management/configuration-api/v3.3/#create-bot) method:
  ...
  - had a new parameter, `owner_client_id`, added. It's required when authorizing with [PATs](/authorization/personal-access-tokens); otherwise ignored.
