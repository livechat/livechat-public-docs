...
- There are new methods for managing new bot templates, which aim to simplify bot usage:
  - [**Create Bot Template**](/management/configuration-api/v3.6/#create-bot-template)
  - [**Update Bot Template**](/management/configuration-api/v3.6/#update-bot-template)
  - [**Delete Bot Template**](/management/configuration-api/v3.6/#delete-bot-template)
  - [**List Bot Templates**](/management/configuration-api/v3.6/#list-bot-templates)

- There are new methods for obtaining Bot Authorization Tokens. These tokens are used to authorize bots in the API. They replace the old 'X-Author-Id' mechanism. The new methods are:
  - [**Issue Bot Token**](/management/configuration-api/v3.6/#issue-bot-token)
  - [**Reset Bot Secret**](/management/configuration-api/v3.6/#reset-bot-secret)
  - [**Reset Bot Template Secret**](/management/configuration-api/v3.6/#reset-bot-template-secret)
