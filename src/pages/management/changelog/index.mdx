...
- There are new methods:
  - [**Create greeting**](/management/configuration-api/v3.6/#create-greeting)
  - [**Update greeting**](/management/configuration-api/v3.6/#update-greeting)
  - [**Delete greeting**](/management/configuration-api/v3.6/#delete-greeting)
  - [**List greeting**](/management/configuration-api/v3.6/#list-greeting)
  - [**List greeting**](/management/configuration-api/v3.6/#get-greeting)
