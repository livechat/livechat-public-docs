...
- `work_scheduler` parameter in [**Create Agent**](/management/configuration-api/v3.5/#create-agent), [**Update Agent**](/management/configuration-api/v3.5/#update-agent), [**Create Bot**](/management/configuration-api/v3.5/#create-bot), and [**Update Bot**](/management/configuration-api/v3.5/#update-bot) methods has a new format. It is now possible to configure multiple working hours for each day.
...
- `work_scheduler` field in [**agent_created**](/management/webhooks/v3.5/#agent_created), [**agent_updated**](/management/webhooks/v3.5/#agent_updated), [**bot_created**](/management/webhooks/v3.5/#bot_created), and [**bot_updated**](/management/webhooks/v3.5/#bot_updated) webhooks has a new format.
