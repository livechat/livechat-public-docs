...
title: "Changelog"
tagline: "Changelog of the Confuguration API"
desc: "Changelog of the Confuguration API"
---
...
### Other
- There is a new [**Reactivate email**](/management/configuration-api/v3.6/#reactivate-email) method that reactivates a bounced email address.
