...
- The following methods now support batch requests: [Create Agent](#create-agent), [Update Agent](#update-agent), [Delete Agent](#delete-agent), [Suspend Agent](#suspend-agent), [Unsuspend Agent](#unsuspend-agent), and [Approve Agent](#approve-agent).
