...
- Added new additional agent field `last_logout` for methods [**List Agents**](/management/configuration-api/v3.5/#list-agents) and [**Get Agent**](/management/configuration-api/v3.5/#get-agent).
