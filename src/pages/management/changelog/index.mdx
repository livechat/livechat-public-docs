...
### Webhooks
- The [**Configuration**](/management/webhooks/v3.6#configuration) webhooks now contains new property `requester`. It contains details of who triggered webhook: `user_id`, `client_id` and `account_id`.
