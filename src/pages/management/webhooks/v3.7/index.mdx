...
Informs about the update of a user's access to a particular chat. It contains the updated [access](/messaging/agent-chat-api/v3.7/data-structures/#access-1) data structure.
...
Informs about an incoming [event](/messaging/agent-chat-api/v3.7/data-structures/#events) sent to a chat.
...
Informs that an [event](/messaging/agent-chat-api/v3.7/data-structures/#events) was deleted.
...
Informs that an [event](/messaging/agent-chat-api/v3.7/data-structures/#events) was updated.
...
Informs about an incoming [rich message](/messaging/agent-chat-api/v3.7/data-structures/#rich-message) postback. The webhook payload contains the info on the postback itself, as well as the chat it was sent in.
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.7/rtm-pushes/#incoming_customer) |
...
Informs that a new agent account was created. The payload contains the full state of the [agent](/messaging/agent-chat-api/v3.7/data-structures/#agent) data structure, including empty fields.
...
Informs that a new bot was added. The payload contains the full state of the [bot](/management/configuration-api/v3.7/#bots) data structure, including empty fields.
...
Informs that a tag was created within a license. The payload contains the full state of the [tag](/management/configuration-api/v3.7/#tags) data structure, including empty fields.
