...
Informs about an incoming [rich message](/messaging/agent-chat-api/v3.4/data-structures/#rich-message) postback. The webhook payload contains the info on the postback itself, as well as the chat it was sent in.
