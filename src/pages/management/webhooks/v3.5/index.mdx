...
desc: "Check the refrence of available LiveChat webhooks. Use them to build automated flows in your integrations."
apiVersion: "3.5"
---
...
In order to receive webhooks, you need to [register](/management/configuration-api/v3.5/#register-webhook) them first.
...
Indicates about the update of a user's access to a particular chat. It contains the updated [access](/messaging/agent-chat-api/v3.5/data-structures/#access-1) data structure.
...
Indicates about an incoming [event](/messaging/agent-chat-api/v3.5/data-structures/#events) sent to a chat.
...
Indicates that an [event](/messaging/agent-chat-api/v3.5/data-structures/#events) was updated.
...
Indicates about an incoming [rich message](/messaging/agent-chat-api/v3.5/data-structures/#rich-message) postback. The webhook payload contains the info on the postback itself, as well as the chat it was sent in.
...
Indicates that a new agent account was created. The payload contains the full state of the [agent](/messaging/agent-chat-api/v3.5/data-structures/#agent) data structure, including empty fields.
...
Indicates that a new bot was added. The payload contains the full state of the [bot](/management/configuration-api/v3.5/#bots) data structure, including empty fields.
...
Indicates that a group was created within a license. The payload contains the full state of the [group](/management/configuration-api/v3.5/#groups) data structure, including empty fields.
...
Indicates that a tag was created within a license. The payload contains the full state of the [tag](/management/configuration-api/v3.5/#tags) data structure, including empty fields.
