...
Informs about the update of a user's access to a particular chat. It contains the updated [access](/messaging/agent-chat-api/v3.6/data-structures/#access-1) data structure.
...
Informs about an incoming [event](/messaging/agent-chat-api/v3.6/data-structures/#events) sent to a chat.
...
Informs that an [event](/messaging/agent-chat-api/v3.6/data-structures/#events) was updated.
...
Informs about an incoming [rich message](/messaging/agent-chat-api/v3.6/data-structures/#rich-message) postback. The webhook payload contains the info on the postback itself, as well as the chat it was sent in.
...
Informs that a new agent account was created. The payload contains the full state of the [agent](/messaging/agent-chat-api/v3.6/data-structures/#agent) data structure, including empty fields.
...
Informs that a new bot was added. The payload contains the full state of the [bot](/management/configuration-api/v3.6/#bots) data structure, including empty fields.
...
Informs that a group was created within a license. The payload contains the full state of the [group](/management/configuration-api/v3.6/#groups) data structure, including empty fields.
...
Informs that a tag was created within a license. The payload contains the full state of the [tag](/management/configuration-api/v3.6/#tags) data structure, including empty fields.
