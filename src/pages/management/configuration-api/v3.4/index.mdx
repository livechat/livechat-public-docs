...
This document describes the **Configuration API v3.4**, which is a deprecated version. For production-ready applications, it's best to use to the current stable version. [Read more about versioning...](/management/#api-versioning)
