...
Lookup actions allow you to easily translate `license_id` into `organization_id` and vice versa.

## Methods

| HTTP method | The Lookup API endpoint                                        |
| ----------- | ---------------------------------------------------------------- |
| `GET`       | `https://api.livechatinc.com/v3.4/configuration/action/<action>` |
...
Returns license ID for given organization ID.
...
```shell
curl -X GET \
  https://api.livechatinc.com/v3.4/configuration/action/get_organization_id?license_id=10000000
```
