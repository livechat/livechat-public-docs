...
This document describes the **Configuration API v3.4**, which is a legacy version. For production-ready applications, it's best to use to the current stable version. [Read more about versioning...](/management/#api-versioning)
...
You can find all the requests from the Configuration API v3.4 in Postman. In our collection, we use [environment variables](https://learning.getpostman.com/docs/postman/environments_and_globals/manage_environments/) that store, for example, the access token. Importing the collection from the link below downloads the environment as well. Remember to replace sample tokens with your own.

[<div style={{maxWidth: '123px'}}><img alt="Run in Postman" src="https://run.pstmn.io/button.svg" width="123px" height="30px"/></div>](https://god.gw.postman.com/run-collection/18768877-43af9280-025a-4a4a-b101-8074d45215f9?action=collection%2Ffork&collection-url=entityId%3D18768877-43af9280-025a-4a4a-b101-8074d45215f9%26entityType%3Dcollection%26workspaceId%3D5e6fb31b-587b-4258-b215-4dccaae38a38#?env%5BLiveChat%20APIs%5D=)
...
| ----------- | ---------------------------------------------------------------- |
| `POST`      | `https://api.livechatinc.com/v3.4/configuration/action/<action>` |
...
|                 |                                                                                                                                                         |
| --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/create_agent`                                                                                    |
...
| `work_scheduler.****.<work_scheduler>` | `object`   | No       | `<work_scheduler>` values <sup>**7**</sup>                                                                                                              |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.4/configuration/action/create_agent \
...
<CodeResponse type="configuration" version="v3.4" json="createAgent"/>
...
|                 |                                                                   |
| --------------- | ----------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/get_agent` |
...
| Possible value                   | Notes                                                     |
| -------------------------------- | --------------------------------------------------------- |
| `work_scheduler`<sup>**2**</sup> | Work scheduler object for an Agent                        |
...
**2)** This method doesn’t support the new version of `work_scheduler` (see parameters in [**Create Agent**](/management/configuration-api/v3.5/#create-agent)). Requesting it in the call might result in the [`validation`](#possible-errors) error.
...
<CodeResponse type="configuration" version="v3.4" json="getAgent"/>
...
|                 |                                                                     |
| --------------- | ------------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/list_agents` |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.4/configuration/action/list_agents \
  -H 'Authorization: Bearer <your_access_token>' \
  -H 'Content-Type: application/json' \
  -d '{
       "fields": [
...
<CodeResponse type="configuration" version="v3.4" json="listAgents"/>
...
|                 |                                                                                              |
| --------------- | -------------------------------------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/update_agent`                         |
...
| `work_scheduler.****.<work_scheduler>` | `object`   | No       | `<work_scheduler>` values <sup>**6**</sup>                                                                                         |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.4/configuration/action/update_agent \
  -H 'Authorization: Bearer <your_access_token>' \
  -H 'Content-Type: application/json' \
  -d '{
        "id": "smith@example.com",
...
|                 |                                                                                                         |
| --------------- | ------------------------------------------------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/delete_agent`                                    |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.4/configuration/action/delete_agent \
  -H 'Authorization: Bearer <your_access_token>' \
  -H 'Content-Type: application/json' \
  -d '{
        "id": "smith@example.com"
...
|                 |                                                                           |
| --------------- | ------------------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/suspend_agent`     |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.4/configuration/action/suspend_agent \
  -H 'Authorization: Bearer <your_access_token>' \
  -H 'Content-Type: application/json' \
  -d '{
        "id": "smith@example.com"
...
|                 |                                                                          |
| --------------- | ------------------------------------------------------------------------ |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/unsuspend_agent`  |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.4/configuration/action/unsuspend_agent \
  -H 'Authorization: Bearer <your_access_token>' \
  -H 'Content-Type: application/json' \
  -d '{
        "id": "smith@example.com"
...
|                 |                                                                                    |
| --------------- | ---------------------------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/request_agent_unsuspension` |
| Required scopes | -                                                                                  |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.4/configuration/action/request_agent_unsuspension \
  -H 'Authorization: Bearer <your_access_token>' \
  -H 'Content-Type: application/json' \
  -d '{}'
```
...
|                 |                                                                           |
| --------------- | ------------------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/approve_agent`     |
| Required scopes | `agents--all:rw` `accounts--all:rw` `subscription.lc:rw` <sup>**1**</sup> |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.4/configuration/action/approve_agent \
  -H 'Authorization: Bearer <your_access_token>' \
  -H 'Content-Type: application/json' \
  -d '{
        "id": "smith@example.com"
...
Every time a customer calls [**Login**](/messaging/customer-chat-api/v3.4/rtm-reference/#login) or
[**Update Customer Page**](/messaging/customer-chat-api/v3.4/rtm-reference/#update-customer-page), our backend checks if
...
If a customer starts a chat via [**Start Chat**](/messaging/customer-chat-api/v3.4/rtm-reference/#start-chat) or
[**Activate Chat**](/messaging/customer-chat-api/v3.4/rtm-reference/#activate-chat) with the `chat.access` parameter,
...
|                 |                                                                         |
| --------------- | ----------------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/add_auto_access` |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.4/configuration/action/add_auto_access \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <your_access_token>' \
  -d '{
...
|                 |                                                                            |
| --------------- | -------------------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/list_auto_accesses` |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.4/configuration/action/list_auto_accesses \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <your_access_token>' \
  -d '{}'
```
...
|                 |                                                                            |
| --------------- | -------------------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/delete_auto_access` |
| Required scopes | `access_rules:rw`                                                          |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.4/configuration/action/delete_auto_access \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <your_access_token>' \
  -d '{
    "id": "pqi8oasdjahuakndw9nsad9na"
...
|                 |                                                                            |
| --------------- | -------------------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/update_auto_access` |
| Required scopes | `access_rules:rw`                                                          |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.4/configuration/action/update_auto_access \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <your_access_token>' \
  -d '{
    "id": "pqi8oasdjahuakndw9nsad9na",
...
Creates a new bot. To make the bot available for receiving chats or webhooks, use the [Set Routing Status](/messaging/agent-chat-api/v3.4/#set-routing-status) method.

#### Specifics

|                 |                                                                    |
| --------------- | ------------------------------------------------------------------ |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/create_bot` |
...
| `default_group_priority` <sup>**4**</sup>    | No       | `string`   | The default routing priority for a group without defined priority.                                                                                                                                           |
...
| `work_scheduler.**.<work_scheduler>` | No       | `object`   | `<work_scheduler>` values <sup>**3**</sup>.                                                                                                                                                                           |
...
| `owner_client_id` <sup>**5**</sup>          | Yes      | `string`   | Required only when authorizing via [PATs](/authorization/authorizing-api-calls/#personal-access-tokens). The request will be rejected if you provide `owner_client_id` when authorizing with a Bearer Token. |
...
**3)**`<work_scheduler>` contains the following fields:
...
**4)** The table below presents the possible values for the `default_group_priority` parameter:
...
**5)** The number of sent webhooks depends on the number of webhooks registered for an `owner_client_id`, not the number of bots belonging to that `owner_client_id`.
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.4/configuration/action/create_bot \
  -H 'Authorization: Bearer <your_access_token>' \
  -H 'Content-Type: application/json' \
  -d '{
      "name": "Bot Name"
...
<CodeResponse type="configuration" version="v3.4" json="createBot"/>
...
|                 |                                                                    |
| --------------- | ------------------------------------------------------------------ |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/delete_bot` |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.4/configuration/action/delete_bot \
  -H 'Authorization: Bearer <your_access_token>' \
  -H 'Content-Type: application/json' \
  -d '{
...
|                 |                                                                                         |
| --------------- | --------------------------------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/update_bot`                      |
...
| `default_group_priority` <sup>**2**</sup> | No       | `string`   | The default routing priority for a group without defined priority.                                        |
| `work_scheduler`                          | No       | `object`   | Work scheduler options to set for the new Bot.                                                            |
| `work_scheduler.***.<work_scheduler>`     | No       | `object`   | `<work_scheduler>` values <sup>**4**</sup>.                                                               |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.4/configuration/action/update_bot \
  -H 'Authorization: Bearer <your_access_token>' \
  -H 'Content-Type: application/json' \
  -d '{
...
|                 |                                                                   |
| --------------- | ----------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/list_bots` |
...
| `work_scheduler`<sup>**3**</sup> | Work scheduler object for a Bot                          |
...
**3)** This method doesn’t support the new version of `work_scheduler` (see parameters in [**Create Agent**](/management/configuration-api/v3.5/#create-agent)). Requesting it in the call might result in the [`validation`](#possible-errors) error.
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.4/configuration/action/list_bots \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <your_access_token>' \
  -d '{
        "all": false
...
<CodeResponse type="configuration" version="v3.4" json="listBots"/>
...
|                 |                                                                 |
| --------------- | --------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/get_bot` |
| Required scopes | `agents-bot--my:ro` `agents-bot--all:ro`                        |
...
| Possible value                   | Notes                                                    |
| -------------------------------- | -------------------------------------------------------- |
| `work_scheduler`<sup>**2**</sup> | Work scheduler object for a Bot                          |
| `groups`                         | Groups a Bot belongs to                                  |
| `job_title`                      | Bot's job title                                          |
| `max_chats_count`                | Bot's maximum number of concurrent chats                 |
| `timezone`                       | The time zone in which the Bot's work scheduler operates |
...
<CodeResponse type="configuration" version="v3.4" json="getBot"/>
...
|                 |                                                                      |
| --------------- | -------------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/create_group` |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.4/configuration/action/create_group \
  -H 'Authorization: Bearer <your_access_token>' \
  -H 'Content-Type: application/json' \
  -d '{
        "name": "Sports shoes",
...
<CodeResponse type="configuration" version="v3.4" json="createGroup"/>
...
|                 |                                                                                      |
| --------------- | ------------------------------------------------------------------------------------ |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/update_group`                 |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.4/configuration/action/update_group \
  -H 'Authorization: Bearer <your_access_token>' \
  -H 'Content-Type: application/json' \
  -d '{
        "id": 19,
...
|                 |                                                                                      |
| --------------- | ------------------------------------------------------------------------------------ |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/delete_group`                 |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.4/configuration/action/delete_group \
  -H 'Authorization: Bearer <your_access_token>' \
  -H 'Content-Type: application/json' \
  -d '{
        "id": 19
...
|                 |                                                                     |
| --------------- | ------------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/list_groups` |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.4/configuration/action/list_groups \
  -H 'Authorization: Bearer <your_access_token>' \
  -H 'Content-Type: application/json' \
  -d '{}'
```
...
<CodeResponse type="configuration" version="v3.4" json="listGroups"/>
...
|                 |                                                                                   |
| --------------- | --------------------------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/get_group`                 |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.4/configuration/action/get_group \
  -H 'Authorization: Bearer <your_access_token>' \
  -H 'Content-Type: application/json' \
  -d '{
        "id": 19,
...
<CodeResponse type="configuration" version="v3.4" json="getGroup"/>
...
```bash
curl -X POST \
  https://api.livechatinc.com/v3.4/configuration/action/publish_property \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <your_access_token>' \
  -d '{
    "name": "string_property",
...
|                 |                                                                           |
| --------------- | ------------------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/register_property` |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.4/configuration/action/register_property \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <your_access_token>' \
  -d '{
    "name": "string_property",
...
|                 |                                                                             |
| --------------- | --------------------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/unregister_property` |
| Required scopes | `properties.configuration:rw`                                               |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.4/configuration/action/unregister_property \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <your_access_token>' \
  -d '{
    "name": "string_property",
...
|                 |                                                                          |
| --------------- | ------------------------------------------------------------------------ |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/publish_property` |
| Required scopes | `properties.configuration:rw`                                            |
...
|                 |                                                                         |
| --------------- | ----------------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/list_properties` |
| Required scopes | `properties.configuration:rw`                                           |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.4/configuration/action/list_properties \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <your_access_token>' \
  -d '{
    "owner_client_id": "0805e283233042b37f460ed8fbf22160"
...
<CodeResponse type="configuration" version="v3.4" json="listProperties"/>
...
|                 |                                                                                                       |
| --------------- | ----------------------------------------------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/update_license_properties`                     |
...
<CodeResponse type="configuration" version="v3.4" json="listLicenseProperties"/>
...
|                 |                                                                                                       |
| --------------- | ----------------------------------------------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/delete_license_properties`                     |
| Required scopes | `properties.license.value--my:rw`<sup>**1**</sup>, `properties.license.value--all:rw`<sup>**2**</sup> |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.4/configuration/action/delete_license_properties \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <your_access_token>' \
  -d '{
    "properties": {
...
|                 |                                                                                                   |
| --------------- | ------------------------------------------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/update_group_properties`                   |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.4/configuration/action/update_group_properties \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <your_access_token>' \
  -d '{
      "group_id": 1,
...
| Required scopes | `properties.group.value--my:ro`<sup>**1**</sup>, `properties.group.value--all:ro`<sup>**2**</sup> |

**1)** The `properties.group.value--my:ro` scope allows you to access all properties from your namespace only.

**2)** The `properties.group.value--all:ro` scope allows you to access all properties from your namespace and [public properties](#public-properties) from `core` and other namespaces.
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.4/configuration/action/list_group_properties \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <your_access_token>' \
  -d '{
      "id": 1,
...
<CodeResponse type="configuration" version="v3.4" json="listGroupProperties"/>
...
|                 |                                                                                                   |
| --------------- | ------------------------------------------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/delete_group_properties`                   |
| Required scopes | `properties.group.value--my:rw`<sup>**1**</sup>, `properties.group.value--all:rw`<sup>**2**</sup> |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.4/configuration/action/delete_group_properties \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <your_access_token>' \
  -d '{
      "id": 1,
...
Registers a webhook for the Client ID (application) provided in the request. One Client ID can register up to three webhooks for every `action`. The `license` webhooks'll be enabled automatically.
...
For `bot` webhooks, you need to [create a bot](#create-bot), [register webhooks](#register-webhook), and then, call [Set Routing Status](/messaging/agent-chat-api/v3.4/#set-routing-status).
...
| ---------------------------------------------------------------------------------------------- | -------------------------------------------------------------: |
| [`incoming_chat`](/management/webhooks/v3.4#incoming_chat)                                     |                `chat_presence`, `only_my_chats`, `source_type` |
| [`chat_deactivated`](/management/webhooks/v3.4#chat_deactivated)                               |                `chat_presence`, `only_my_chats`, `source_type` |
| [`chat_access_updated`](/management/webhooks/v3.4#chat_access_updated)                         |                `chat_presence`, `only_my_chats`, `source_type` |
| [`chat_transferred`](/management/webhooks/v3.4#chat_transferred)                               |                `chat_presence`, `only_my_chats`, `source_type` |
| [`user_added_to_chat`](/management/webhooks/v3.4#user_added_to_chat)                           |                `chat_presence`, `only_my_chats`, `source_type` |
| [`user_removed_from_chat`](/management/webhooks/v3.4#user_removed_from_chat)                   |                `chat_presence`, `only_my_chats`, `source_type` |
| [`incoming_event`](/management/webhooks/v3.4#incoming_event)                                   | `chat_presence`, `author_type`, `only_my_chats`, `source_type` |
| [`event_updated`](/management/webhooks/v3.4#event_updated)                                     | `chat_presence`, `author_type`, `only_my_chats`, `source_type` |
| [`incoming_rich_message_postback`](/management/webhooks/v3.4#incoming_rich_message_postback)   |                `chat_presence`, `only_my_chats`, `source_type` |
| [`chat_properties_updated`](/management/webhooks/v3.4#chat_properties_updated)                 |                `chat_presence`, `only_my_chats`, `source_type` |
| [`chat_properties_deleted`](/management/webhooks/v3.4#chat_properties_deleted)                 |                `chat_presence`, `only_my_chats`, `source_type` |
| [`thread_properties_updated`](/management/webhooks/v3.4#thread_properties_updated)             |                `chat_presence`, `only_my_chats`, `source_type` |
| [`thread_properties_deleted`](/management/webhooks/v3.4#thread_properties_deleted)             |                `chat_presence`, `only_my_chats`, `source_type` |
| [`event_properties_updated`](/management/webhooks/v3.4#event_properties_updated)               |                `chat_presence`, `only_my_chats`, `source_type` |
| [`event_properties_deleted`](/management/webhooks/v3.4#event_properties_deleted)               |                `chat_presence`, `only_my_chats`, `source_type` |
| [`thread_tagged`](/management/webhooks/v3.4#thread_tagged)                                     |                `chat_presence`, `only_my_chats`, `source_type` |
| [`thread_untagged`](/management/webhooks/v3.4#thread_untagged)                                 |                `chat_presence`, `only_my_chats`, `source_type` |
| [`routing_status_set`](/management/webhooks/v3.4#routing_status_set)                           |                                     `agent_ids`, `source_type` |
| [`incoming_customer`](/management/webhooks/v3.4#incoming_customer)                             |                                                  `source_type` |
| [`customer_session_fields_updated`](/management/webhooks/v3.4#customer_session_fields_updated) |                                 `chat_presence`, `source_type` |
| [`events_marked_as_seen`](/management/webhooks/v3.4#events_marked_as_seen)                     |                `chat_presence`, `only_my_chats`, `source_type` |
| [`group_created`](/management/webhooks/v3.4#group_created)                                     |                                                  `source_type` |
| [`group_updated`](/management/webhooks/v3.4#group_updated)                                     |                                                  `source_type` |
| [`group_deleted`](/management/webhooks/v3.4#group_deleted)                                     |                                                  `source_type` |
| [`agent_created`](/management/webhooks/v3.4#agent_created)                                     |                                                  `source_type` |
| [`agent_updated`](/management/webhooks/v3.4#agent_updated)                                     |                                                  `source_type` |
| [`agent_deleted`](/management/webhooks/v3.4#agent_deleted)                                     |                                                  `source_type` |
| [`agent_suspended`](/management/webhooks/v3.4#agent_suspended)                                 |                                                  `source_type` |
| [`agent_unsuspended`](/management/webhooks/v3.4#agent_unsuspended)                             |                                                  `source_type` |
| [`agent_approved`](/management/webhooks/v3.4#agent_approved)                                   |                                                  `source_type` |
| [`bot_created`](/management/webhooks/v3.4#bot_created)                                         |                                                  `source_type` |
| [`bot_updated`](/management/webhooks/v3.4#bot_updated)                                         |                                                  `source_type` |
| [`bot_deleted`](/management/webhooks/v3.4#bot_deleted)                                         |                                                  `source_type` |
| [`auto_access_created`](/management/webhooks/v3.4#auto_access_created)                         |                                                  `source_type` |
| [`auto_access_updated`](/management/webhooks/v3.4#auto_access_updated)                         |                                                  `source_type` |
| [`auto_access_deleted`](/management/webhooks/v3.4#auto_access_deleted)                         |                                                  `source_type` |
...
<CodeResponse type="configuration" version="v3.4" json="registerWebhook"/>
...
|                 |                                                                       |
| --------------- | --------------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/list_webhooks` |
...
<CodeResponse type="configuration" version="v3.4" json="listWebhooks"/>
...
|                 |                                                                            |
| --------------- | -------------------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/unregister_webhook` |
| Required scopes | `webhooks.configuration:rw`                                                |
...
|                 |                                                                            |
| --------------- | -------------------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/list_webhook_names` |
| Required scopes | -                                                                          |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.4/configuration/action/list_webhook_names \
  -H 'Content-Type: application/json' \
  -d '{
        "version": "3.4"
      }'
...
<CodeResponse type="configuration" version="v3.4" json="listWebhookNames"/>
...
Enables the webhooks [disabled](#disable-license-webhooks) by a given **Client Id** (application). The webhooks will be installed for the license associated with the access token used in the request.

Webhooks will be automatically enabled if you [register them via Developer Console](/getting-started/app-guides/chat-webhooks/).

#### Specifics

|                 |                                                                                 |
| --------------- | ------------------------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/enable_license_webhooks` |
...
|                 |                                                                                  |
| --------------- | -------------------------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/disable_license_webhooks` |
| Required scopes | `webhooks.state:rw`                                                              |
...
|                 |                                                                                    |
| --------------- | ---------------------------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.4/configuration/action/get_license_webhooks_state` |
...
<CodeResponse type="configuration" version="v3.4" json="getWebhooksState"/>
...
To see the list of available webhooks v3.4, [visit the Webhooks](/management/webhooks/v3.4/) document.
...
| ----------- | ---------------------------------------------------------------------- |
| HTTP Method | **GET**                                                                |
| Method URL  | `https://api.livechatinc.com/v3.4/configuration/action/get_license_id` |
...
```shell
curl -X GET \
  https://api.livechatinc.com/v3.4/configuration/action/get_license_id?organization_id=142cf3ad-5d54-4cf6-8ce1-3773d14d7f3f
```

</CodeSample>

<CodeResponse type="configuration" version="v3.4" json="getLicenseID"/>
...
| ----------- | --------------------------------------------------------------------------- |
| HTTP Method | **GET**                                                                     |
| Method URL  | `https://api.livechatinc.com/v3.4/configuration/action/get_organization_id` |
...
```shell
curl -X GET \
  https://api.livechatinc.com/v3.4/configuration/action/get_organization_id?license_id=104130623
```

</CodeSample>

<CodeResponse type="configuration" version="v3.4" json="getOrganizationID"/>
