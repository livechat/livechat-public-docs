...
| Possible value         | Notes                                                     |
| ---------------------- | --------------------------------------------------------- |
| `work_scheduler`__**__ | Work scheduler object for an Agent                        |
...
__**__ This method doesn’t support the new version of `work_scheduler` (see parameters in [**Create Agent**](/management/configuration-api/v3.5/#create-agent)). Requesting it in the call might result in the [`validation`](#possible-errors) error.
...
| `work_scheduler`__***__ | Work scheduler object for a Bot                          |
