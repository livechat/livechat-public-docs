...
| `owner_client_id` <sup>**5**</sup>          | Yes      | `string`   | Required only when authorizing via [PATs](/authorization/agent-authorization#personal-access-tokens). The request will be rejected if you provide `owner_client_id` when authorizing with a Bearer Token. |
...
| Parameter         | Required | Data type | Notes                                                                                                                                                                                                        |
| ----------------- | -------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `owner_client_id` | Yes      | `string`  | Required only when authorizing via [PATs](/authorization/agent-authorization#personal-access-tokens). The request will be rejected if you provide `owner_client_id` when authorizing with a Bearer Token. |
