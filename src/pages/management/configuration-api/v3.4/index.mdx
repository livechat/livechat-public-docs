...
<Errors errors="authentication,authorization,already_exists,group_not_found,internal,license_expired,limit_reached,misdirected_request,not_found,too_many_requests,transfer_ownership,unsupported_version,validation"/>
