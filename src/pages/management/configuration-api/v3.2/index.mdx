...
| ------------------------------------------------------------------- | ------------------------------------------------: |
| [`incoming_chat`](/management/webhooks#incoming_chat)                                   |                `chat_member_ids`, `only_my_chats` |
| [`chat_deactivated`](/management/webhooks#chat_deactivated)                             |                `chat_member_ids`, `only_my_chats` |
| [`chat_access_granted`](/management/webhooks#chat_access_granted)                       |                `chat_member_ids`, `only_my_chats` |
| [`chat_access_revoked`](/management/webhooks#chat_access_revoked)                       |                `chat_member_ids`, `only_my_chats` |
| [`user_added_to_chat`](/management/webhooks#user_added_to_chat)                         |                `chat_member_ids`, `only_my_chats` |
| [`user_removed_from_chat`](/management/webhooks#user_removed_from_chat)                 |                `chat_member_ids`, `only_my_chats` |
| [`incoming_event`](/management/webhooks#incoming_event)                                 | `chat_member_ids`, `author_type`, `only_my_chats` |
| [`event_updated`](/management/webhooks#event_updated)                                   | `chat_member_ids`, `author_type`, `only_my_chats` |
| [`incoming_rich_message_postback`](/management/webhooks#incoming_rich_message_postback) |                `chat_member_ids`, `only_my_chats` |
| [`chat_properties_updated`](/management/webhooks#chat_properties_updated)               |                `chat_member_ids`, `only_my_chats` |
| [`chat_properties_deleted`](/management/webhooks#chat_properties_deleted)               |                `chat_member_ids`, `only_my_chats` |
| [`thread_properties_updated`](/management/webhooks#thread_properties_updated)           |                `chat_member_ids`, `only_my_chats` |
| [`thread_properties_deleted`](/management/webhooks#thread_properties_deleted)           |                `chat_member_ids`, `only_my_chats` |
| [`event_properties_updated`](/management/webhooks#event_properties_updated)             |                `chat_member_ids`, `only_my_chats` |
| [`event_properties_deleted`](/management/webhooks#event_properties_deleted)             |                `chat_member_ids`, `only_my_chats` |
| [`thread_tagged`](/management/webhooks#thread_tagged)                                   |                `chat_member_ids`, `only_my_chats` |
| [`thread_untagged`](/management/webhooks#thread_untagged)                               |                `chat_member_ids`, `only_my_chats` |
| [`routing_status_set`](/management/webhooks#routing_status_set)                         |                                                 - |
| [`agent_deleted`](/management/webhooks#agent_deleted)                                   |                                       `agent_ids` |
| [`customer_created`](/management/webhooks#customer_created)                             |                                                 - |
| [`events_marked_as_seen`](/management/webhooks#events_marked_as_seen)                   |                `chat_member_ids`, `only_my_chats` |
