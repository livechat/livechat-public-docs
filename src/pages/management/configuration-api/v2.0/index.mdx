...
Please note that this documentation refers to the **API version 2.0**. This is the **deprecated** version, and you'll maintain access only to methods used in the last 30 days. We encourage you to migrate to the latest stable version. [Read more about versioning...](/management/#api-versioning)
