...
New version of the method can be found [here](/management/configuration-api#list-agents).
...
New version of the method can be found [here](/management/configuration-api#get-agent).
...
New version of the method can be found [here](/management/configuration-api#create-agent).
...
New version of the method can be found [here](/management/configuration-api#update-agent).
...
New version of the method can be found [here](/management/configuration-api#delete-agent).
...
**Please note this method is deprecated**. We highly recommend switching to the new [Messaging APIs](/messaging/agent-chat-api#list-chats).
...
**Please note this method is deprecated**. We highly recommend switching to the new [Messaging APIs](messaging/agent-chat-api#get-chat).
...
**Please note this method is deprecated**. We highly recommend switching to the new [Messaging APIs Tag Thread](/messaging/agent-chat-api#tag-thread) and [Messaging APIs Untag Thread](/messaging/agent-chat-api#untag-thread) methods.
...
New version of the method can be found [here](/management/configuration-api#list-groups).
...
New version of the method can be found [here](/management/configuration-api#get-group).
...
New version of the method can be found [here](/management/configuration-api#create-group).
...
New version of the method can be found [here](/management/configuration-api#update-group).
...
New version of the method can be found [here](/management/configuration-api#delete-group).
...
New version of the method can be found [here](/messaging/agent-chat-api#list-routing-statuses).
...
New version of the method can be found [here](/management/configuration-api#list-tags).
...
New version of the method can be found [here](/management/configuration-api#create-tag).
...
New version of the method can be found [here](/management/configuration-api#delete-tag).
...
**Please note this API is deprecated**. We highly recommend switching to the [new versions of the methods](/management/configuration-api#webhooks).
...
**Please note this method is deprecated**. We highly recommend switching to the [new version of the method](/management/configuration-api#list-webhooks).
...
**Please note this method is deprecated**. We highly recommend switching to the [new version of the method](/management/configuration-api#register-webhook).
...
**Please note this method is deprecated**. We highly recommend switching to the the [new version of the method](/management/configuration-api#unregister-webhook).
