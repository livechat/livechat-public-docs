...
| `ads_traffic`       | The greeting will be sent when the customer first visits the page that contains ad provider parameters              |
...
The greeting will be sent when the customer first visits the URL containing specified ads parameters.
