...
You can create a PAT from <a href="https://platform.text.com/console/" target="_blank">Developer Console</a>. For more guidelines on creating PATs, check out [this tutorial](/authorization/agent-authorization#personal-access-tokens).
