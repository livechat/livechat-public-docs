...
When providing only `variable_name`, the greeting will be sent when the customer first visit url contains any of the
ads parameters with the specified name.
