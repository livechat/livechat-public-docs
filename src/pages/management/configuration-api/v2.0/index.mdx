...
There are 3 common authentication methods supported: **OAuth 2.1** and **Personal Access Token (PAT)**.
...
You can call the LiveChat API using librariers written in backend languages. Here is the list of the ready-to-use libraries:
