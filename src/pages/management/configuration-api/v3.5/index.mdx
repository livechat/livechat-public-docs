...
This document describes the **Configuration API v3.5**, which is a legacy version. For production-ready applications, it's best to use to the current stable version. [Read more about versioning...](/data-reporting/#api-versioning)
...
You can find all the requests from the Configuration API v3.5 in Postman. In our collection, we use [environment variables](https://learning.getpostman.com/docs/postman/environments_and_globals/manage_environments/) that store, for example, the access token. Importing the collection from the link below downloads the environment as well. Remember to replace sample tokens with your own.

[<div style={{maxWidth: '123px'}}><img alt="Run in Postman" src="https://run.pstmn.io/button.svg" width="123px" height="30px"/></div>](https://god.gw.postman.com/run-collection/20754404-64151b88-db16-46f5-a00f-296fe4d26576?action=collection%2Ffork&collection-url=entityId%3D20754404-64151b88-db16-46f5-a00f-296fe4d26576%26entityType%3Dcollection%26workspaceId%3D5e6fb31b-587b-4258-b215-4dccaae38a38#?env%5BLiveChat%20APIs%5D=)
...
| ----------------------------------- | ------------------------------------------------------------------------------ |
| [Create Agent](#create-agent)       | `https://api.livechatinc.com/v3.5/configuration/action/batch_create_agents`    |
| [Update Agent](#update-agent)       | `https://api.livechatinc.com/v3.5/configuration/action/batch_update_agents`    |
| [Delete Agent](#delete-agent)       | `https://api.livechatinc.com/v3.5/configuration/action/batch_delete_agents`    |
| [Suspend Agent](#suspend-agent)     | `https://api.livechatinc.com/v3.5/configuration/action/batch_suspend_agents`   |
| [Unsuspend Agent](#unsuspend-agent) | `https://api.livechatinc.com/v3.5/configuration/action/batch_unsuspend_agents` |
| [Approve Agent](#approve-agent)     | `https://api.livechatinc.com/v3.5/configuration/action/batch_approve_agents`   |

#### Batch support for Bots

| Method                    | Batch method URL                                                          |
| ------------------------- | ------------------------------------------------------------------------- |
| [Create Bot](#create-bot) | `https://api.livechatinc.com/v3.5/configuration/action/batch_create_bots` |
| [Update Bot](#update-bot) | `https://api.livechatinc.com/v3.5/configuration/action/batch_update_bots` |
| [Delete Bot](#delete-bot) | `https://api.livechatinc.com/v3.5/configuration/action/batch_delete_bots` |
...
| `groups[].priority`<sup>**4**</sup>   | `string`   | Yes      | Agent's priority in a group; required only when `group` is included.                                                                                  |
| `notifications`<sup>**5**</sup>       | `string[]` | No       | Represents which Agent notifications are turned on.                                                                                                   |
| `email_subscriptions`<sup>**6**</sup> | `string[]` | No       | Represents which subscriptions will be send to the Agent via email.                                                                                   |
...
| `groups[].priority` <sup>**3**</sup>  | `string`   | Yes      | Agent's priority in a group; required only when `group`'s included.                                                               |
| `notifications`<sup>**4**</sup>       | `string[]` | No       | Represents which Agent notifications are turned on.                                                                               |
| `email_subscriptions`<sup>**5**</sup> | `string[]` | No       | Represents which subscriptions will be send to an Agent via email.                                                                |
...
[**Resume Chat**](/messaging/customer-chat-api/v3.5/rtm-reference/#resume-chat) with the `chat.access` parameter,
...
Bots enable writing integrations using the [**Agent Chat API**](/messaging/agent-chat-api/) to communicate in chats similarly to regular agents. Unlike agents, bots don't have passwords or emails - you cannot log in as a bot. Each bot is a resource owned by an application (`client_id`) in Developer Console.

There are two authorization mechanisms for bots:

- old (v3.5 and lower): a bot shares the access token with the agent who created it. To make calls as a bot, you need to provide the [agent token](/authorization/agent-authorization/) and the `X-Author-Id` header.
- new (v3.5 and higher): bots use their own authorization tokens generated with the [Issue Bot Token](#issue-bot-token) method.
...
|                                  |                                                                             |
| -------------------------------- | --------------------------------------------------------------------------- |
| Method URL                       | `https://api.livechatinc.com/v3.5/configuration/action/create_bot_template` |
...
<CodeResponse type="configuration" version="v3.5" json="createBotTemplate"/>
...
|                                  |                                                                             |
| -------------------------------- | --------------------------------------------------------------------------- |
| Method URL                       | `https://api.livechatinc.com/v3.5/configuration/action/delete_bot_template` |
| Required scopes                  | `bots.templates:rw`                                                         |
| [Batch support](#batch-requests) | No                                                                          |
...
|                                  |                                                                             |
| -------------------------------- | --------------------------------------------------------------------------- |
| Method URL                       | `https://api.livechatinc.com/v3.5/configuration/action/update_bot_template` |
| Required scopes                  | `bots.templates:rw`                                                         |
| [Batch support](#batch-requests) | No                                                                          |
...
__1)__ Possible priority values:
...
|                                  |                                                                            |
| -------------------------------- | -------------------------------------------------------------------------- |
| Method URL                       | `https://api.livechatinc.com/v3.5/configuration/action/list_bot_templates` |
| Required scopes                  | `bots.templates:rw`                                                        |
| [Batch support](#batch-requests) | No                                                                         |
...
<CodeResponse type="configuration" version="v3.5" json="listBotTemplates"/>
...
|                                  |                                                                         |
| -------------------------------- | ----------------------------------------------------------------------- |
| Method URL                       | `https://api.livechatinc.com/v3.5/configuration/action/issue_bot_token` |
| Required scopes                  | -                                                                       |
| [Batch support](#batch-requests) | No                                                                      |
...
<CodeResponse type="configuration" version="v3.5" json="issueBotToken"/>
...
|                                  |                                                                                   |
| -------------------------------- | --------------------------------------------------------------------------------- |
| Method URL                       | `https://api.livechatinc.com/v3.5/configuration/action/reset_bot_template_secret` |
| Required scopes                  | `bots.templates:rw`                                                               |
| [Batch support](#batch-requests) | No                                                                                |
...
<CodeResponse type="configuration" version="v3.5" json="resetBotTemplateSecret"/>
...
|                                  |                                                                          |
| -------------------------------- | ------------------------------------------------------------------------ |
| Method URL                       | `https://api.livechatinc.com/v3.5/configuration/action/reset_bot_secret` |
| Required scopes                  | `agents-bot--my:rw`                                                      |
| [Batch support](#batch-requests) | No                                                                       |
...
<CodeResponse type="configuration" version="v3.5" json="resetBotSecret"/>
...
| `agent_priorities`<sup>**1**</sup> | `object`  | Yes      | Agents' priorities in a group as a map in the `"<id>": "<priority>"` format. At least one Agent must have the `normal` priority. |
...
|                                  |                                                                                |
| -------------------------------- | ------------------------------------------------------------------------------ |
| Method URL                       | `https://api.livechatinc.com/v3.5/configuration/action/list_groups_properties` |
...
<CodeResponse type="configuration" version="v3.5" json="listGroupsProperties"/>
...
To create a new tag, call the [**Create Tag**](/management/configuration-api/v3.5/#create-tag) method with a `name`. Letter case is ignored when checking if a tag already exists. When creating a tag, you can also provide `group_ids` to assign the tag to some groups right away. It's also possible to create a tag with empty `group_ids` and update the group assignment later with [**Update Tag**](/management/configuration-api/v3.5/#update-tag).

 To remove a tag, call [**Delete Tag**](/management/configuration-api/v3.5/#delete-tag). Both **Update Tag** and **Delete Tag** methods respect the letter case when matching the tag. You can list all tags existing on your account with the [**List Tags**](/management/configuration-api/v3.5/#list-tags) method.
...
|                                  |                                                                    |
| -------------------------------- | ------------------------------------------------------------------ |
| Method URL                       | `https://api.livechatinc.com/v3.5/configuration/action/create_tag` |
...
|                                  |                                                                    |
| -------------------------------- | ------------------------------------------------------------------ |
| Method URL                       | `https://api.livechatinc.com/v3.5/configuration/action/delete_tag` |
| Required scopes                  | `tags--all:rw` `tags--groups:rw`                                   |
| [Batch support](#batch-requests) | No                                                                 |
...
|                                  |                                                                   |
| -------------------------------- | ----------------------------------------------------------------- |
| Method URL                       | `https://api.livechatinc.com/v3.5/configuration/action/list_tags` |
...
<CodeResponse type="configuration" version="v3.5" json="listTags"/>
...
|                                  |                                                                    |
| -------------------------------- | ------------------------------------------------------------------ |
| Method URL                       | `https://api.livechatinc.com/v3.5/configuration/action/update_tag` |
| Required scopes                  | `tags--all:rw` `tags--groups:rw`                                   |
| [Batch support](#batch-requests) | No                                                                 |
...
Tag Master allows you to create, view, and delete tags and canned responses in an easy and predictable way. It uses  <a href="https://platform.text.com/docs/authorization/sign-in-with-livechat/#accounts-sdk" target="_blank">Accounts SDK</a> and its <a href="https://platform.text.com/docs/authorization/sign-in-with-livechat#redirect-1" target="_blank">Redirect</a> method for authorization and  **Configuration API v3.5** endpoints:
...
To read more and experiment with the Tag Master app, go on our <a href="https://github.com/livechat/tag-master" target="_blank">GitHub</a>. You can also check out our different sample apps <a href="https://developers.livechat.com/updates/livechat-sample-apps" target="_blank">here</a>.
...
As an alternative to calling Register Webhook, you can register webhooks via Developer Console by configuring the Chat Webhooks building block.  [Learn more...](/getting-started/app-guides/chat-webhooks/)
...
| ----------------------------------------------------------------------------------------- | -------------------------------------------------------------: |
| [`incoming_chat`](/management/webhooks#incoming_chat)                                     |                `chat_presence`, `only_my_chats`, `source_type` |
| [`chat_deactivated`](/management/webhooks#chat_deactivated)                               |                `chat_presence`, `only_my_chats`, `source_type` |
| [`chat_access_updated`](/management/webhooks#chat_access_updated)                         |                `chat_presence`, `only_my_chats`, `source_type` |
| [`chat_transferred`](/management/webhooks#chat_transferred)                               |                `chat_presence`, `only_my_chats`, `source_type` |
| [`user_added_to_chat`](/management/webhooks#user_added_to_chat)                           |                `chat_presence`, `only_my_chats`, `source_type` |
| [`user_removed_from_chat`](/management/webhooks#user_removed_from_chat)                   |                `chat_presence`, `only_my_chats`, `source_type` |
| [`incoming_event`](/management/webhooks#incoming_event)                                   | `chat_presence`, `author_type`, `only_my_chats`, `source_type` |
| [`event_updated`](/management/webhooks#event_updated)                                     | `chat_presence`, `author_type`, `only_my_chats`, `source_type` |
| [`incoming_rich_message_postback`](/management/webhooks#incoming_rich_message_postback)   |                `chat_presence`, `only_my_chats`, `source_type` |
| [`chat_properties_updated`](/management/webhooks#chat_properties_updated)                 |                `chat_presence`, `only_my_chats`, `source_type` |
| [`chat_properties_deleted`](/management/webhooks#chat_properties_deleted)                 |                `chat_presence`, `only_my_chats`, `source_type` |
| [`thread_properties_updated`](/management/webhooks#thread_properties_updated)             |                `chat_presence`, `only_my_chats`, `source_type` |
| [`thread_properties_deleted`](/management/webhooks#thread_properties_deleted)             |                `chat_presence`, `only_my_chats`, `source_type` |
| [`event_properties_updated`](/management/webhooks#event_properties_updated)               |                `chat_presence`, `only_my_chats`, `source_type` |
| [`event_properties_deleted`](/management/webhooks#event_properties_deleted)               |                `chat_presence`, `only_my_chats`, `source_type` |
| [`thread_tagged`](/management/webhooks#thread_tagged)                                     |                `chat_presence`, `only_my_chats`, `source_type` |
| [`thread_untagged`](/management/webhooks#thread_untagged)                                 |                `chat_presence`, `only_my_chats`, `source_type` |
| [`routing_status_set`](/management/webhooks#routing_status_set)                           |                                     `agent_ids`, `source_type` |
| [`incoming_customer`](/management/webhooks#incoming_customer)                             |                                                  `source_type` |
| [`customer_session_fields_updated`](/management/webhooks#customer_session_fields_updated) |                                 `chat_presence`, `source_type` |
| [`events_marked_as_seen`](/management/webhooks#events_marked_as_seen)                     |                `chat_presence`, `only_my_chats`, `source_type` |
| [`group_created`](/management/webhooks#group_created)                                     |                                                  `source_type` |
| [`group_updated`](/management/webhooks#group_updated)                                     |                                                  `source_type` |
| [`group_deleted`](/management/webhooks#group_deleted)                                     |                                                  `source_type` |
| [`agent_created`](/management/webhooks#agent_created)                                     |                                                  `source_type` |
| [`agent_updated`](/management/webhooks#agent_updated)                                     |                                                  `source_type` |
| [`agent_deleted`](/management/webhooks#agent_deleted)                                     |                                                  `source_type` |
| [`agent_suspended`](/management/webhooks#agent_suspended)                                 |                                                  `source_type` |
| [`agent_unsuspended`](/management/webhooks#agent_unsuspended)                             |                                                  `source_type` |
| [`agent_approved`](/management/webhooks#agent_approved)                                   |                                                  `source_type` |
| [`bot_created`](/management/webhooks#bot_created)                                         |                                                  `source_type` |
| [`bot_updated`](/management/webhooks#bot_updated)                                         |                                                  `source_type` |
| [`bot_deleted`](/management/webhooks#bot_deleted)                                         |                                                  `source_type` |
| [`auto_accesses_updated`](/management/webhooks#auto_accesses_updated)                     |                                                  `source_type` |
| [`tag_created`](/management/webhooks#tag_created)                                         |                                                  `source_type` |
| [`tag_deleted`](/management/webhooks#tag_deleted)                                         |                                                  `source_type` |
| [`tag_updated`](/management/webhooks#tag_updated)                                         |                                                  `source_type` |
...
|                                  |                                                                       |
| -------------------------------- | --------------------------------------------------------------------- |
| Method URL                       | `https://api.livechatinc.com/v3.5/configuration/action/list_channels` |
| Required scopes                  | -                                                                     |
| [Batch support](#batch-requests) | No                                                                    |
...
<CodeResponse type="configuration" version="v3.5" json="listChannels"/>
...
|                                  |                                                                                       |
| -------------------------------- | ------------------------------------------------------------------------------------- |
| Method URL                       | `https://api.livechatinc.com/v3.5/configuration/action/check_product_limits_for_plan` |
...
<CodeResponse type="configuration" version="v3.5" json="checkProductLimitsForPlan"/>
...
|                 |                                                                            |
| --------------- | -------------------------------------------------------------------------- |
| Method URL      | `https://api.livechatinc.com/v3.5/configuration/action/get_product_source` |
| Required scopes | -                                                                          |
...
<CodeResponse type="configuration" version="v3.5" json="getProductSource"/>
