...
### Get Product Channel Activity

Returns the summary of chat activity in communication channels.

#### Specifics

|                 |                                                                                      |
| --------------- | ------------------------------------------------------------------------------------ |
| Method URL      | `https://api.livechatinc.com/v3.5/configuration/action/get_product_channel_activity` |
| Required scopes | -                                                                                    |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.5/configuration/action/get_product_channel_activity \
  -H 'Authorization: Bearer <your_access_token>' \
  -H 'Content-Type: application/json' \
  -d '{}'
```
...
<CodeResponse type="configuration" version="v3.5" json="getProductChannelActivity"/>
