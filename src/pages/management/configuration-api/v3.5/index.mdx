...
| Field         | Notes                                                                      |
| ------------- | -------------------------------------------------------------------------- |
| `source_id`   | The source ID parameter passed when activating the LiveChat product.   |
| `source_type` | The source type parameter passed when activating the LiveChat product. |
| `source_url`  | The source URL parameter passed when activating the LiveChat product.  |
