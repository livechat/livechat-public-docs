...
Resource limits in the LiveChat product are different for each plan. This method compares your organization's current resources with a given plan and returns those which exceeded the called plan's limits.

Limited resources in LiveChat:

| Resource Name          | Notes                                                                                                                                |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| `agents`               | The max number of active agents, including bots                                                                                      |
| `groups`               | The max number of groups                                                                                                             |
| `banned`               | The max number of banned customers                                                                                                   |
| `queue`                | The max number of chats waiting in the queue (with [Messaging Mode](/messaging#messaging-mode) disabled)                             |
| `queue_continuous`     | The max number of chats waiting in the queue (with [Messaging Mode](/messaging#messaging-mode) enabled)                              |
...
| `group_chooser_groups` | The max number of groups available in the [pre-chat survey](https://www.livechat.com/help/dividing-live-chat-by-group/#target-field) |
