...
Tag Master allows you to create, view, and delete tags and canned responses in an easy and predictable way. It uses  <a href="https://platform.text.com/docs/authorization/oauth-authorization/#accounts-sdk" target="_blank">Accounts SDK</a> and its <a href="https://platform.text.com/docs/authorization/oauth-authorization#redirect-1" target="_blank">Redirect</a> method for authorization and  **Configuration API v3.5** endpoints:
