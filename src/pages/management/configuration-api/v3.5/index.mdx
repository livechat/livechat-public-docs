...
__*)__ If the requester's Client ID matches the namespace, deleting license properties requires `properties.license.value--my:ro`.

__**)__ If the requester's Client ID doesn't match the namespace, deleting license properties requires `properties.license.value--all:ro`. The scope allows to
