...
Each pricing plan has different resource limits (number of groups, agents). When the user wants to downgrade, this method allows checking what resources exceeded the limits for a given plan.
...
| Required scopes | `subscription_manage` __*__ |
