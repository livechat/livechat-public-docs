...
__*)__ If the requester's Client ID matches the namespace, setting license properties requires `properties.license.value--my:ro`.

__**)__ If the requester's Client ID doesn't match the namespace, setting license properties requires `properties.license.value--all:ro`. Scope allows to
...
__**)__ If the requester's Client ID doesn't match the namespace, retrieving license properties requires `properties.license.value--all:ro`. Scope allows to
...
__**)__ If the requester's Client ID doesn't match the namespace, deleting license properties requires `properties.license.value--all:ro`. Scope allows to
...
__**)__ If the requester's Client ID doesn't match the namespace, retrieving group properties requires `properties.license.value--all:ro`. Scope allows to
