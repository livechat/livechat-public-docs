...
LiveChat Platform limits some resources to keep infrastructure healthy and stable for all clients. The limits are different for each pricing plan. The method `check_products_limits_for_plan` shows which resources are exceeding for any given plan.

Limited resources in LiveChat:

|                        |                                                                                                                     |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------- |
| `agents`               | The max number of agents can be invited                                                                             |
| `groups`               | The max number of groups can be created                                                                             |
...
| `groups_per_agent`     | The max number of groups can be assigned to agent                                                                   |
