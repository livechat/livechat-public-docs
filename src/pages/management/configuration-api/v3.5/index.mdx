...
| `work_scheduler`<a name="work-scheduler-desc"></a> | `object`   | No       | Work scheduler options to set for the new Agent                                                                                                       |
| `work_scheduler.timezone`              | `string`   | Yes      | Timezone for the work scheduler. Falls back to the agent's timezone if empty.                                                                         |
