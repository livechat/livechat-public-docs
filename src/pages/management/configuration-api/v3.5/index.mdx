...
| Field         | Notes                                                                      |
| ------------- | -------------------------------------------------------------------------- |
| `source_id`   | The source ID parameter, as passed when activating the LiveChat product.   |
| `source_type` | The source type parameter, as passed when activating the LiveChat product. |
| `source_url`  | The source URL parameter, as passed when activating the LiveChat product.  |
