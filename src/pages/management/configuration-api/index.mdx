...
| `elements[].buttons[].postback_id`  | yes      | `string`  | A unique value in the whole greeting.                                                                                                                                                                                                                      |
| `elements[].buttons[].button_id`    | no       | `string`  | A unique value in the whole greeting. This value is auto-generated on the API side.                                                                                                                                                                        |
