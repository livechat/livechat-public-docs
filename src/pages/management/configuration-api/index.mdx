...
Bots enable writing integrations using the [**Agent Chat API**](/messaging/agent-chat-api/) to communicate in chats similarly to regular agents. Unlike agents,bot don't have passwords or emails - you cannot log in as a bot. Each bot is a resource owned by an application (`client_id`) in Developer Console.
