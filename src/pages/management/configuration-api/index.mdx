...
| Required scopes | `properties.license.value--all:ro`*                                             |

__*)__ If the requester's Client ID doesn't match the namespace, retrieving license properties requires `properties.license.value--all:ro`. The scope allows to
...
__*)__ If the requester's Client ID doesn't match the namespace, retrieving group properties requires `properties.license.value--all:ro`. The scope allows to
