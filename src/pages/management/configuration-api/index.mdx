...
Tag Master allows you to create, view, and delete tags and canned responses in an easy and predictable way. The App uses **Configuration API v3.5** endpoints:
...
This method is used by one of our Sample Apps, the <a href="https://github.com/livechat/tag-master" target="_blank">Tag Master</a> app. Check it out and experiment with an already existing app.
