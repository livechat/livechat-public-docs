...
Creates a new canned response with the specified text, tags, and group assignment.
...
| Parameter   | Required | Data type        | Notes                                                    |
| ----------- | -------- | ---------------- | -------------------------------------------------------- |
| `text`      | Yes      | `string`         | Canned response text content                         |
...
Updates an existing canned response. All parameters are optional - only provided parameters will be updated.
...
| `text`      | No       | `string`         | New canned response text (max 2000 characters)          |
| `tags`      | No       | `array[string]`  | Array of tags (max 20 tags, each max 50 characters)     |
...
Returns a paginated list of canned responses filtered by group access and privacy settings.
...
| Parameter         | Required | Data type        | Notes                                                    |
| ----------------- | -------- | ---------------- | -------------------------------------------------------- |
| `group_ids`       | No       | `array[number]`  | Filter by specific group IDs (if not provided, uses user's accessible groups) |
...
| `group_id`  | `number`         | Group ID the response belongs to    |
| `is_private`| `bool`           | Whether the response is private     |
| `author_id` | `string`         | ID of the user of last change       |
