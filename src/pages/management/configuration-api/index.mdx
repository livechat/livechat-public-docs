...
This document describes the **Configuration API v3.5**. This is the latest stable version recommended for the production use. [Read more about versioning...](/management/#api-versioning)
...
| `avatar`                              | `string`   | No       | **Deprecated**. Avatar URL. Use [**Update Account Organization Settings**](/authorization/global-accounts-api#tag/AccountOrganizationSettings/paths/~1accounts~1%7Baccount_id%7D~1organization_settings~1%7Borganization_id%7D/patch) instead. |
...
| ----------------------------------------- | ---------- | -------- | --------------------------------------------------------------------------------------------------------------------------------- |
| `id`                                      | `string`   | Yes      | Agent ID                                                                                                                          |
| `name`                                    | `string`   | No       | **Deprecated**. Agent name. Use [**Update an account**](/authorization/global-accounts-api#tag/Accounts/paths/~1accounts~1%7Baccount_id%7D/patch) instead.|
