...
| `role`                                | `string`   | No       | The agent role. Possible values: `viceowner`, `administrator`, `normal` (default).                                                                        |
| `login_status`                        | `string`   | No       | The agent's default status right after the login. Possible values: `accepting chats`, `not accepting chats` (default).                                    |
...
| `work_scheduler.schedule[].start`     | `string`   | Yes      | The time when working hours start.                                                                                                                        |
| `work_scheduler.schedule[].end`       | `string`   | Yes      | The time when working hours end.                                                                                                                          |
...
| Parameter                | Required | Type       | Notes                                                                                                                             |
| ------------------------ | -------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------- |
| `all`                    | No       | `bool`     | If set to `true`: gets all bots within a license. If set to `false` (default)<sup>**1**</sup>: returns only the requester's bots. |
...
| `url`                                           | yes      | `string`   | The destination URL for the webhook.                                                                                                                                                                                                                 |
