...
> The exception of these rules is namespace named `core` which contains properties required to valid configuration
> of license (e.g. `max_chats_count`) and is preconfigured for every license by default.
...
set all properties from your namespace and [public properties](#register-property) from `core` and other namespaces.
...
__*)__ If the requester's Client ID matches the namespace, retrieving license properties requires `properties.license.value--my:ro`.
...
access all properties from your namespace and [public properties](#register-property) from `core` and other namespaces.
...
delete all properties from your namespace and [public properties](#register-property) from `core` and other namespaces.
...
set all properties from your namespace and [public properties](#register-property) from other namespaces.
...
__*)__ If the requester's Client ID matches the namespace, retrieving group properties requires `properties.license.value--my:ro`.
...
access all properties from your namespace and [public properties](#register-property)from other namespaces.
...
delete all properties from your namespace and [public properties](#register-property) from other namespaces.
