...
This document describes the **Configuration API v3.4**. This is the latest stable version recommended for the production use. [Read more about versioning...](/management/#api-versioning)
...
__**__ This method doesn’t support [the new version](/management/configuration-api/v3.5/#work-scheduler-desc) of `work_scheduler`. Requesting it in the call might result in the [`validation`](#possible-errors) error.
...
__**__ This method doesn’t support the new version of `work_scheduler`. Requesting it in the call might result in the [`validation`](#possible-errors) error.
...
| [`auto_access_created`](/management/webhooks/#auto_access_created)                         |                                                  `source_type` |
| [`auto_access_updated`](/management/webhooks/#auto_access_updated)                         |                                                  `source_type` |
| [`auto_access_deleted`](/management/webhooks/#auto_access_deleted)                         |                                                  `source_type` |
