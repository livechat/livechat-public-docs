...
Bans a customer for a given period of time. While banned, the customer cannot connect to or interact with the [Customer Chat API](/messaging/customer-chat-api).
