...
| `notifications`<sup>**4**</sup>       | `string[]` | No       | Agent notifications that are enabled.                                                                                                                     |
| `email_subscriptions`<sup>**5**</sup> | `string[]` | No       | Subscriptions that will be sent to the agent via email.                                                                                                   |
...
| `filters.group_ids`      | No       | `int[]`    | IDs of the groups from which you want to list agents. Returns only the agents from the specified groups. |
...
| `notifications`<sup>**2**</sup>       | `string[]` | No       | Agent notifications that are enabled.                                                                                                        |
| `email_subscriptions`<sup>**3**</sup> | `string[]` | No       | Subscriptions that will be sent to an agent via email.                                                                                       |
