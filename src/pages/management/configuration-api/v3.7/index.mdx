...
[**Activate Chat**](/messaging/customer-chat-api/v3.7/rtm-reference/#activate-chat) with the `chat.access` parameter,
...
To see the list of available webhooks v3.6, [visit the Webhooks](/management/webhooks/v3.7/) document.
