...
A bot shares the SSO access token with the agent who created the bot. Each  is a resource owned by an application in Developers Platform, identified by its own `client_id`.
