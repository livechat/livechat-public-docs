...
__*)__ If the requester's Client ID matches the namespace, retrieving group properties requires `properties.group.value--my:rw`.

__**)__ If the requester's Client ID doesn't match the namespace, retrieving group properties requires `properties.group.value--all:rw`. Scope allows to
