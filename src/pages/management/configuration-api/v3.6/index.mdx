...
Customers can be banned for a specific period of time. During ban connect or otherwise interact with customer chatting API.  Note that banning is only possible via agent API.
...
<CodeResponse type="configuration" version="v3.6" json="list_customer_bans"/>
...
Remove an existing customer ban.
...
<CodeResponse type="configuration" version="v3.6" json="unban_customer"/>
