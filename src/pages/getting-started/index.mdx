...
To make chatting more engaging, you could make use of [Chat Widget Moments](https://developers.livechat.com/docs/extending-chat-widget/chat-widget-moments) (shown above) and [Rich Messages](https://www.livechat.com/help/rich-messages/).
