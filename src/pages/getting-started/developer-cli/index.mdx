...
- by executing a `texdev` command. Running a command will automatically update your app in the Developer Console. You need to run `txdev app pull` to fetch the changes to your local environment.
- by manipulating the JSON file manually. Run `txdev app push` to push the changes to the Developer Console.

<CodeSample path={'EXAMPLE APP MANIFEST'}>
...
| ------------- | --------------------------------------------------------------------------------------- | ----------------- |
| `--id`        | App ID. Available in the Developer Console or in `livechat.config.json` (app manifest). | from app manifest |
| `--dir`       | Location for the app manifest file. Specfiy to override the default location.           | `./`              |
| `--targetDir` | Specifies where to clone the app                                                        | --dir             |
...
| Parameter     | Description                                             | Default value     |
| ------------- | ------------------------------------------------------- | ----------------- |
| `--id`        | App ID                                                  | from app manifest |
| `--dir`       | Location of the app manifest you're pulling changes to. | `./`              |
| `--targetDir` | Specifies where to save the manifest                    | --dir             |
...
| --------------- | -------------------------------------------------- |
| `--id`, `--dir` | The same as in [`txdev app pull`](#txdev-app-pull) |
...
| Parameter       | Description                                            |
| --------------- | ------------------------------------------------------ |
| `--id`, `--dir` | The same as in [`txdev app verify`](#txdev-app-verify) |
...
|          | `--id`, `--dir` | The same as for [`txdev app clone`](#txdev-app-clone)                                         |
| `remove` |                 | Removes all or selected widgets. The CLI will prompt you to select.                           |
|          | `--id`, `--dir` | The same as for [`txdev app authorization`](#txdev-app-authorization)                         |
...
|          | `--id`, `--dir` | The same as for other commands         |
...
|          | `--provider`     | One of: `neon`, `planetscale`                                         |
|          | `--type`         |                                                                       |
|          | `--databaseName` |                                                                       |
|          | `--id`, `--dir`  | The same as for other commands.                                       |
| `unlink` |                  | Fetch environment variables stored in the Developer Console           |
