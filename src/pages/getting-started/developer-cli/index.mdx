...
| `--dir`       | Location of the app manifest you're currently working on                                | `./`              |
| `--targetDir` | Target location of the manifest/app files to be created in                              | --dir             |
...
| ------------------------------ | ------------------------------------------- |
| `--id`, `--dir`, `--targetDir` | See [Common parameters](#common-parameters) |
...
|            | `--dir`, `--targetDir` | See [Common parameters](#common-parameters)                                 |
...
| Parameter       | Description                                 |
| --------------- | ------------------------------------------- |
| `--id`, `--dir` | See [Common parameters](#common-parameters) |
