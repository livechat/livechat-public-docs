...
Agent App Widgets are web apps loaded inside the LiveChat Agent App. They can interact and communicate with the LiveChat Agent App. 
...
2. Add a new Agent App Widgets by clicking the **Get started** button. 
...
5. The **Initial state** section is not required. However, it allows you to build the initial state for the Customer Details Widget (JSON format).
6. Click the **Continue button** and enjoy your new widget.
...
Now, it is time for the **Display details** tab that allows you to configure your app's short description and add an icon for better visibility in the Agent App.
...
3. Add an icon for your app and save your changes. Your icon will be displayed in the Marketplace and the Agent App. You can drag and drop your image or browse your file manager for it.
