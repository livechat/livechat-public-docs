...
💡 **Need helping hand?** Right after signing in to the Developers Console, you can launch the **App wizard**. It will guide you through the whole app creation process.
...
You can configure your app using Building blocks which are components that form your app. Depending on which building block you add to your app, the app will work differently. If you want to know how each building block can enrich your app, click the **Read docs** redirect and learn more about them. 

To create a simple frontend app, we'll use the **Agent App Widgets building block**. 
Agent App Widgets are web apps loaded inside the LiveChat App. They can interact and communicate with the LiveChat App. 
...
4. Now, go to the **Widget placement** and choose one. It allows you to decide where exactly in the LiveChat App you want to display your integration. We have chosen Full screen application in our example.
...
<img
  ...
  src="/images/getting-started/livechat-apps/LiveChat-appsstep2.1.1.png"
  width="1515px"
  height="819px"
/>
...
When the installation is done, you can return to your LiveChat App and refresh the website. After doing that, you’ll see your widget. 
...
If you want to build a public app, please go to the [App review process](https://developers.livechat.com/docs/monetization/app-review-process#header), where you’ll find out how to submit your application for review. 
