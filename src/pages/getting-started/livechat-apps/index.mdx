...
To create LiveChat Apps you need an account in [Developer Console](https://developers.livechat.com/console/). It's a panel dedicated to managing and distributing your apps.

1. Sign in to [Developer Console](https://developers.livechat.com/console/).
2. Go to the [Apps](https://developers.livechat.com/console/apps/) section.
3. Create a new app.

See a 4-minute tutorial explaining how to creating a simple app in the Developer Console.
