...
4. Now, go to the **Widget placement** and choose one. It allows you to decide where exactly in the LiveChat App you want to display your integration. We've chosen the **Fullscreen App** option in our example. In the LiveChat App, full screen apps are located in the navigation bar on the left, and they open maximized in the LiveChat App. [Learn more...](https://developers.livechat.com/docs/extending-agent-app#main-menu-fullscreen-apps)
...
If you want to build a public app, please go to the [app review process page](https://developers.livechat.com/docs/monetization/app-review-process), where you’ll get all the necessary details on this process and find out how to submit your application for review.
