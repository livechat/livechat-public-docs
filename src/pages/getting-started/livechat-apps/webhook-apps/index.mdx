...
- [Configuration API v3](/management/configuration-api/#webhooks)
  ...
  💡 Read the tutorial on  <a href="https://developers.livechat.com/updates/setting-up-webhooks-with-livechat-api" target="_blank">how to register LiveChat webhooks v3.</a>
