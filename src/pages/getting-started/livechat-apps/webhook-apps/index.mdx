...
💡 Not familiar with webhook registration and enablement? Version 3.3 of the Configuration API introduced significant changes to the way LiveChat webhooks work. To learn the details, <a href="https://platform.text.com/updates/setting-up-webhooks-with-livechat-api" target="_blank">read this article.</a>
>>>>>>> 54ca4ff3 (Change links to a new domain)
