...
If your `ChatWindow` isn't recreated when `ChatWindowConfiguration` changes (i.e. VisitorName), you might want to fully reload chat window by invoking `chatWindow.reload(true)`.
