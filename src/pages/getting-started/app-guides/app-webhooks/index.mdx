...
<div style={{maxWidth:"500px"}}>
  <img alt="App Webhooks in LiveChat Developer Console" src="/images/getting-started/app-guides/app-webhooks/livechat-app-webhooks.png" width="498px" height="362px"/>
</div>
