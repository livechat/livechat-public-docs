...
If you want to be notified about your app installation and uninstallation events, configure an App Webhooks building block in <Placeholder id="DEVELOPER_CONSOLE_URL" />. To do that, provide a URL to your backend that will receive the webhooks.
