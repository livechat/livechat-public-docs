...
If you want to be notified about your app installation, uninstallation, and payment events, configure an App Webhooks building block in {{DEVELOPER_CONSOLE_URL}}. To do that, provide a URL to your backend that will receive the webhooks.
