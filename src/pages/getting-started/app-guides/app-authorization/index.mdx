...
<div style={{maxWidth: '600px'}}>
  <img src="/images/getting-started/app-guides/app-authorization/livechat-authorization-block.png" alt="Authorizaton building block" width="52px" height="53px"/>
</div>
...
[HelpDesk API](https://api.labs.helpdesk.com/docs#section/Authentication) shares an authentication and authorization system with LiveChat. If you would like to authenticate or authorize within HelpDesk, take a look at:
...
If you want to build an integration within HelpDesk, you'll need to implement an authorization flow and configure the App authorization building block.