...
- 💡 [Onboarding & Settings](/getting-started/app-guides/onboarding-and-settings/) **(new)**

<div style={{maxWidth: '700px'}}>
  <img src="/images/getting-started/app-guides/developers-building-blocks-livechat.png" alt="LiveChat building blocks" width="700px" height="500px"/>
</div>
