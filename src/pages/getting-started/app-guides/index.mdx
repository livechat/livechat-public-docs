...
**App guides** are a collection of **tutorials** created to help you navigate through <Placeholder id="DEVELOPER_CONSOLE_URL" /> and **effectively use the tools** it provides to build applications for LiveChat and HelpDesk. If you're not familiar with Developer Console, it's your own developer portal, where you can build integrations that can be later on published on the <Placeholder id="LIVECHAT_MARKETPLACE_URL" />.
