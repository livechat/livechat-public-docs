...
Additionally, for fullscreen widgets, LiveChat app provides a way to embed the table with upgrades in a modal. You can utilize this invoking `window.postMessage()` method with `event_name: 'open_in_app_upgrades_modal'` parameter.
