...
💡 If <a href="https://developers.livechat.com/docs/extending-agent-app#app-settings" target="_blank">App settings</a> were added to your app in the Developer Console, they will be visible in the same place as In-App upgrades.
