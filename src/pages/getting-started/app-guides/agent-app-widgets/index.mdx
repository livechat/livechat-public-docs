...
<div style={{maxWidth: '600px', marginBottom: '30px'}}>
  <img src="/images/getting-started/app-guides/agent-app-widgets/livechat-agent-app-widgets-modal.png" alt="LiveChat Agent App Widgets" width="600px" height="560px"/>
</div>
