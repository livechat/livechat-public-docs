...
<div style={{maxWidth: '600px', marginBottom: '30px'}}>
  <img src="/images/getting-started/app-guides/agent-app-widgets/livechat-agent-app-widgets-modal.png" alt="LiveChat Agent App Widgets"/>
</div>
...
<div style={{maxWidth: '700px', marginBottom: '30px'}}>
  <img src="/images/getting-started/app-guides/agent-app-widgets/customer-details-initial-state-livechat.png" alt="LiveChat Agent App Widgets"/>
</div>
