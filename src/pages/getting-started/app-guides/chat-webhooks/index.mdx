...
2. **In Developer Console**. To do that, you need to configure the Chat Webhooks building block in <Placeholder id="DEVELOPER_CONSOLE_URL" />. [This tutorial](#tutorial) will show you how to do that.
...
<img alt="Chat webhooks building block" src="/images/getting-started/app-guides/chat-webhooks/livechat-chat-webhooks.png" width="800px" height="330px"/>
...
1. Create an app in <Placeholder id="DEVELOPER_CONSOLE_URL" /> and add the Agent App Widgets building block.
...
<img alt="Chat Webhooks LiveChat" src="/images/getting-started/app-guides/chat-webhooks/chat-webhooks-block-2x-livechat.png" width="800px" height="700px"/>

### Backend apps

In a nutshell:

1. Create an app in <Placeholder id="DEVELOPER_CONSOLE_URL" />.
