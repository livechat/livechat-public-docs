...
For testing, you can make use of the **Private installation** feature. Also, you need to use `prompt: consent` in your authorization flow to invoke the stage of giving the app consent. Then, perform the action that's your webhook trigger (for example, start a chat if you selected the `incoming_chat` webhook).
