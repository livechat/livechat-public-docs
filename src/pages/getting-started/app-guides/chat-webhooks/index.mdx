...
For testing, you can make use of the **Private installation** feature. If you used **Direct installation URL**, you'll be automatically redirected to accounts.livechat.com to authorize your app to install webhooks for your license. Then, perform the action that's your webhook trigger (for example, start a chat if you selected the `incoming_chat` webhook).
