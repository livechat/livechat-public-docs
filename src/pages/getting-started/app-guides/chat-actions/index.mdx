...
![Chat Actions in LiveChat Agent App](/images/getting-started/app-guides/chat-actions/chat-actions-dropdown-livechat-1.png)
...
<div style={{maxWidth: '600px'}}>
  <img src="/images/getting-started/app-guides/chat-actions/chat-action-modal-livechat-example.png" alt="LiveChat Action modal" />
</div>
