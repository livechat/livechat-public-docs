...
To start the forking process of your published app, you need to go to the **Apps** tab on the left of your screen and click the burger menu button of the app you want to fork. Then, click the **Edit app** button to proceed with the forking process.
...
The forked app is treated as a separate application until it's published, so it'll receive new, temporary authorization credentials (**Client Id** and **Client Secret**). New credentials will be removed and replaced with the original ones when the fork merges with the original app. The original credentials will remain unchanged when the fork is published.
