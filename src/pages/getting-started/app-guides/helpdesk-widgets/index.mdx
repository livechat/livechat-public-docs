...
As for the **widget placement**, you can choose one of the following locations: the Details section, Fullscreen apps, or Settings. To create a Ticket Details widget, you need to edit all three required fields: Widget source URL, Widget placement, and Opening state. If you want to create Full Screen or Message Box widgets, only Widget source URL and Widget placement fields are required.
