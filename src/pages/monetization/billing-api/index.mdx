...
The LiveChat Billing API allows you to charge for your apps in the LiveChat Marketplace. Therefore, you can offer paid applications to over {{NUMBER_OF_CUSTOMERS}} LiveChat customers.
...
![LiveChat Billing API demo](/images/monetization/billing-api/billing-demo-in-app-payment.png)

# User guide

## 1. Authorization

The Billing API is based on the [LiveChat OAuth](https://developers.livechat.com/docs/authorization/) authorization flow. All endpoints require access tokens, and some endpoints are limited by scope or client ID.
