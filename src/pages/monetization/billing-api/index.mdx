...
If you want to use this API, you must create an app in Developer Console and check **"billing_manage"** or **"billing--all:rw"** scope (depending on the product) in the app settings. After successful authorization (by using Sign in with Text), you will get an access token with the correct scope.
...
If you want to use this API, you must create an app in Developer Console and check **"ledger_read"** scope in the app settings. After successful authorization (by using Sign in with Text), you will get an access token with `ledger_read` scope.
