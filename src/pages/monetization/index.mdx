...
Paid apps within the <Placeholder id="DEVELOPER_CONSOLE_URL" /> are the simplest way to generate revenue from apps installed by LiveChat or HelpDesk customers.
