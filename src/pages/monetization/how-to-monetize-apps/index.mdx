...
- Monetizing your application using the App Monetization building block.
- Collecting payments through an in-app modal with Agent App SDK.
- Redirecting the user directly to the Marketplace checkout from a link created with the Billing API.
- Using the available Billing API methods to build a custom payment solution.
