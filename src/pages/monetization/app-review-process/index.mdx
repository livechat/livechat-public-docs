...
Make sure to test your integration on <a href="https://www.livechat.com/help/stay-mobile-with-livechat/" rel="noopener nofollow" target="_blank">the LiveChat mobile app</a>. If your integration makes use of [Accounts SDK](/authorization/oauth-authorization#sign-in-with-livechat/) for authorization, ensure the SDK version is 2.0.1 or higher. Otherwise, your integration won't work with the LiveChat mobile app.
...
Use the [`prompt=consent`](/authorization/oauth-authorization#step-2-redirect-users-to-livechat-oauth-server) parameter to test how this step looks from the user's perspective.
