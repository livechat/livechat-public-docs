...
Use the [`prompt=consent`](https://developers.livechat.com/docs/authorization/authorizing-api-calls#step-2-redirect-users-to-livechat-oauth-server) parameter to test how this step looks from the user's perspective.
