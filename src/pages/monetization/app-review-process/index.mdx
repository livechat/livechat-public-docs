...
If your application has some sort of settings, the best way to present them from the UX perspective is in **Settings > Integrations & apps** in the **LiveChat or HelpDesk Applications**. This is where users intuitively look for the settings of the integrations they have installed.
