...
`GET /v2/partners/reports/commission` - get commission reports
...
`GET /v2/partners/balance` - get balance information
...
`GET /v2/partners/metrics/commission` - get commission metric
...
- `trial_duration` - only for the `livechat` product - the number of days of a trial period (min. 14 - default, max. 30)
...
`GET /v2/partners/affiliates/campaigns/<campaign_id>/metrics/earnings` - get affiliate campaign earnings metric
...
`GET /v2/partners/affiliates/campaigns/<campaign_id>/reports/earnings` - get affiliate campaign earnings report
...
`GET /v2/partners/affiliates/campaigns/<campaign_id>/summary` - get affiliate campaigns summary
...
`POST /v2/partners/solutions/summary` - get summary from Solution Program
