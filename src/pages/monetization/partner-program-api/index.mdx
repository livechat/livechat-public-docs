...
`POST /v2/partners/solutions/licenses/<product>/<license_id>/subscription` - create a new subscription for license
...
`PUT /v2/partners/solutions/licenses/<product>/<license_id>/subscription` - update a subscription for license
