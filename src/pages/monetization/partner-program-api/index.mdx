...
- `aggregation` - **required** - get trials report aggregated by a given timespan (one of: `day`, `week`, `month`)
- `product` - get trials report for a given product (one of: `livechat`, `chatbot`, `partner_program`, `all`; default: `all`)
