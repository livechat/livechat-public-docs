...
desc: "Engage better with your Customers using interactive and visually appealing affluent messages."
...
* `elements.buttons` - optional; an array of displayed buttons. The maximum number of buttons is 11 (13 if using API in version 3.3 and above). They can have the following parameters (all required if the `elements.buttons` is included):
...
If you feel inspired to create your own app, be sure to check our tutorial on [Building LiveChat apps](/guides/livechat-apps)!
