...
![LiveChat Rich Messages](/images/extending-chat-widget/livechat-rich-messages.png)
...
![Card](/images/extending-chat-widget/card-preview.png)
...
![Carousel](/images/extending-chat-widget/carousel-preview.png)
...
![Quick Replies](/images/extending-chat-widget/quick-replies-preview.png)
...
![Chatbot integration](/images/extending-chat-widget/chatbot-integration.png)
...
![Product Cards](/images/extending-chat-widget/product-cards.png)

Another app that might be useful if you have an account on [KnowledgeBase](https://www.knowledgebase.ai/), is the [KnowledgeBase integration](https://www.livechat.com/marketplace/apps/knowledge-base/). It allows you to send your articles as Cards, making them much more engaging for your Customers.
...
![Calendly Integration](/images/extending-chat-widget/calendly.png)
...
If you feel inspired to create your own app, be sure to check our tutorial on [Building LiveChat apps](https://developers.livechat.com/build-apps/)!
