...
This library lets you easily add [chat widget functionality](https://platform.text.com/open-chat-widget) to your [Angular](http://angular.io/)  application, whether you have an account on [livechat.com](https://livechat.com) or [text.com](https://text.com). This package supports both [LiveChat](https://www.livechat.com) and [Text](https://www.text.com) widgets.
