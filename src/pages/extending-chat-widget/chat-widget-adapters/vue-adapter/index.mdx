...
This library lets you easily add [chat widget functionality](https://platform.text.com/open-chat-widget) to your [Vue](https://vuejs.org/) application, whether you have an account on [livechat.com](https://livechat.com) or [text.com](https://text.com). This package supports both [LiveChat](https://www.livechat.com) and [Text](https://www.text.com) widgets.
...
### 1. LiveChat Widget (for organizations using [LiveChat](https://www.livechat.com/))
...
### 2. Text Widget (for organizations using [Text](https://www.text.com/))
...
This package exports a set of [Vue Composition API](https://v3.vuejs.org/api/composition-api.html#composition-api) utilities that allow for consuming reactive data from the chat widget in any place of the application as long as the `LiveChatWidget` or `TextWidget` component is rendered in the tree.
