...
title: "Vue Adapter"
tagline: "Interact with the LiveChat Chat Widget inside a Vue 3 app."
desc: "This library allows to render and interact with the LiveChat Chat Widget inside a Vue 3 application."
---

This library allows to render and interact with the LiveChat Chat Widget inside a [Vue 3](https://v3.vuejs.org/) application.
