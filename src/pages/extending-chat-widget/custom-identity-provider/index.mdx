...
If you would like to learn more about setting up a Custom Identity Provider, please see our [tutorial](https://platform.text.com/updates/livechat-custom-identity-provider-setup-tutorial).
