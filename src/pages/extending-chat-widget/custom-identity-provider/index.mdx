...
Here are our suggested implementations of Custom Identity Provider. The `fetchLiveChatToken()` method is used in the examples to acquire the [Chat Widget token](#chat-widget-token).
