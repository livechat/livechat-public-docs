...
You can also use it with [Customer SDK](https://developers.livechat.com/docs/extending-chat-widget/customer-sdk#using-the-api) if you build your own chat widget implementation. Pass it through the optional `identityProvider` parameter of the configuration object.
