...
| isFragile | boolean | When set to true, widget will require additional confirmation from user in order to close the moment. |
...
-   `chatId` - ID of customer's chat (returns `null` if no chat)
