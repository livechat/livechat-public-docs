...
It triggers a sales tracker created in LiveChat application and passes over data about a sale. The data is then visible in LiveChat's Reports and Archives. For more information about how Sales Tracker works and how to set it up on your website, check out our official Help Center article: https://www.livechat.com/help/sales-tracker/#how-sales-tracker-works-in-practice
