...
3. Add an icon for your app and save your changes. Your icon will be displayed in the LiveChat App. You can drag and drop your image, browse your file manager for it, or generate a random icon.
...
Before you allow other users to access your app, it's best to test it and ensure that no bugs or errors appear. To do that, you need to install your app privately on your LiveChat license by going to the **Private installation** tab and clicking the **Install app** button.

<img
  alt="Creating LiveChat apps step 4, private installation"
...
<img
  alt="Creating LiveChat apps step 4.1, finding your app in LiveChat Application"
...
If you need to access LiveChat user data, we recommend using the [Sign in with LiveChat flow](/authorization/oauth-authorization#sign-in-with-livechat) on your settings page. For more information on possible widget placements, visit the [app locations](/extending-agent-app/#app-locations) document.
...
1. Makes use of the [Sign in with LiveChat flow](/getting-started/authorization/oauth-authorization#sign-in-with-livechat/).
2. Imports your sign in form or other authorization flow, e.g. server-side [authorization code grant flow](https://platform.text.com/docs/authorization/oauth-authorization/#authorization-code-grant) for backend apps.
