...
- Create an app for which you'll create properties. If you don't know how to create an app, [here's the tutorial](/guides/livechat-apps/#creating-livechat-apps).
