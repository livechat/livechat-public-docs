...
If your app uses <a href="https://platform.text.com/docs/guides/console-guides/chat-webhooks" target="_blank">Chat Webhooks</a>, the **Secret Key** will also stay the same unless a different one is given in one of the two Security update modals appearing during the forking process.
