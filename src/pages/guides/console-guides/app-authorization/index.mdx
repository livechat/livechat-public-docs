...
- <SectionLink to={"/authorization#use-cases"}>Read about different authorization flows</SectionLink>
...
- <SectionLink to={"/authorization/oauth-authorization#sign-in-with-livechat"}>Sign in with LiveChat flow</SectionLink>