...
desc: "Web apps loaded inside the LiveChat Agent Application that can display static content or use external services."
---
...
- [Building LiveChat apps 101 webinar](/guides/livechat-apps/#building-apps-webinar)
