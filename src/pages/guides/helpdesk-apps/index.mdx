...
- Let users sign in to your service via [Accounts SDK](/authorization/oauth-authorization#accounts-sdk)
...
- triggering [app authorization](/authorization/oauth-authorization#sign-in-with-livechat), especially if the app doesn't have a Ticket Details widget.
