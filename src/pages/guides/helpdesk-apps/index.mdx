...
[Developer Console](https://platform.text.com/console/) allows you not only to create [LiveChat Apps](/guides/livechat-apps), but also to develop integrations for <a href="https://www.helpdesk.com/" target="_blank">HelpDesk</a> and publish them on the <a href="https://www.helpdesk.com/marketplace/" target="_blank">HelpDesk Marketplace</a>.
...
Next, you need to decide which product you want to build your app for. In this tutorial guide, we will cover HelpDesk. Want to build for LiveChat instead? See the [tutorial](/guides/livechat-apps).
...
You can form your app using components called building blocks, which serve different purposes. To learn more about building blocks, go to [Console guides](/guides/console-guides).
...
<SectionLink to={"/guides/console-guides/helpdesk-widgets#building-block-configuration"}>
