...
1. Log in to your LiveChat account and go to **Settings** &rarr; **Channels** &rarr; [**Website**](https://my.livechatinc.com/settings/code).
...
The Chat widget is now installed on a website.
...
<Code>
<CodeSample path={'LIVECHAT COMPONENT'}>
