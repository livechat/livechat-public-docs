...
<SectionLink to={"/authorization/livechat-accounts/"}>Global Accounts</SectionLink>
<SectionLink to={"/authorization/livechat-accounts-api/"}>Global Accounts API</SectionLink>
