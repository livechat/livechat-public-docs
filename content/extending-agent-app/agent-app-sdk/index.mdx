...
3. Go to **Building blocks** and add a new **Agent App Widgets** block.
    ...
    - Choose the **widget placement**. It allows you to decide where exactly in the Agent App you want to display your integration. Currently, the possible locatuions are: the Details section, message box, settings, main menu (fullscreen apps). [Read more](/extending-ui/extending-agent-app/#app-locations) about app locations.  
