...
- App base price: $100
- App price with discount applied: $85
- Commission (discount applied): $85 * 0.20 = $17
- Net profit (discount applied): $85 * 0.80 = $68 -->
...
<SectionLink to={"/monetization/app-review-process/#common-problems"}>
  Things to remember about when testing the app
</SectionLink>
...
- You will receive the payment in **up to two weeks** after you've requested the withdrawal.
