...
`GET /v2/partners/resellers/licenses/<license_id>/invoices` - get invoices for given license
...
`GET /v2/partners/resellers/licenses/<license_id>/invoices/<invoice_no>` - get PDF invoice
