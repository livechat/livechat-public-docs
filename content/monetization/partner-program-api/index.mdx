...
- `operators` - **required** - list of the **users** you want to invite to the license.
...
- `200 - OK` - success (could be partly, check for `status_code` in response body), see the example on the right
- `400 - Bad Request` - missing or incorrect `license_id` parameter
- `401 - Unauthorized` - a missing or incorrect authorization header
