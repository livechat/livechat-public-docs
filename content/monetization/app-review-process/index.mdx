...
![LiveChat App Ideas](images/livechat-app-ideas.png)
...
![LiveChat App Description](images/livechat-app-details-console.png)

Apart from descriptions, remember to add at least one **feature** and one **benefit**.
![LiveChat App Features and Benefits](images/livechat-app-features-section.png)
...
![LiveChat App Screenshots](images/livechat_app_screenshots.png)
...
![LiveChat App Name](images/livechat-app-display-details.png)
...
![LiveChat Mailchimp Settings](images/livechat-mailchimp-settings.png)
...
![LiveChat App Settings Building Block](images/livechat-app-settings-building-block.png)
...
Use the the [`prompt=consent`](/getting-started/authorization/#step-2-redirect-to-livechat-oauth-server) parameter to test how this step looks from the user's perspective.
...
Make sure to test your integration on <a href="https://www.livechat.com/help/stay-mobile-with-livechat/" rel="noopener nofollow" target="_blank">the LiveChat mobile app</a>. If your integration makes use of [Accounts SDK](/authorization/sign-in-with-livechat/) for authorization, ensure the SDK's version isn't lower than 2.0.1. Otherwise, your integration won't work with the LiveChat mobile app. In that case, consider migrating to the latest version of Accounts SDK.
