...
Make sure to test your integration on LiveChat mobile. If your integration makes use of [Accounts SDK](/authorization/sign-in-with-livechat/) for authorization, ensure the SDK's version isn't lower than 2.0.1. Otherwise, your integration won't work with the LiveChat mobile app. In that case, consider migrating to the latest version of Accounts SDK.
# Contact us
