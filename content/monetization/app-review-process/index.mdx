...
![LiveChat App Screenshots](livechat_app_screenshots.png)
...
<SectionLink to={"/extending-ui/extending-agent-app/design-system/"}>
  See Design System
</SectionLink>

# Common problems

To speed up app development, you can check out what parts were confusing for other developers and learn from their experience:

**1. Forgetting to ask users to give the app consent**

It's easy to forget about implementing the give consent step when you develop and test out the app on your own. If you omit this step and submit your app for review, we won't be able to test it.
Thanks to the [`prompt=consent`](/getting-started/authorization/#step-2-redirect-to-livechat-oauth-server) parameter, users will be asked to give your app access to the necessary resources.

Don't forget to implement this step on your own if you use other authorization flows.
