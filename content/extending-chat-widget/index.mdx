...
If you want to make your communication with clients even more seamless, with Custom Identity Provider you can pair your own customer identity with ours. With this setup you are able to create cross-platfrom communication and keep chat history for the customer no matter where one is typing from as long as is authorized within your services.
