...
<div style="max-width: 800px; padding: 30px 30px 30px 30px; background-color: rgb(240, 244, 247); border-radius: 10px; margin-bottom: 20px" class='rm-preview'>
...
<div style="justify-self:center" class='rm-preview'>
	<RichMessagePreview richMessage={{
		"template_id": "cards",
		"elements": [{
			"title": "How to?",
