...
For example, if you have used BigCommerce to set up your online store and LiveChat to communicate with Customers, you try out our [Product Cards for Big Commerce](https://www.livechatinc.com/help/product-cards-bigcommerce/) app. After installation, you can send to Customers the previews of your products directly from the Agent App. They'll be presented as Cards or Carousels:

![Product Cards](images/product-cards.png)

Another app, which might be useful if you have an account on [KnowledgeBase](https://www.knowledgebase.ai/), is the [KnowledgeBase integration](https://www.livechatinc.com/marketplace/apps/knowledge-base/). It allows you to send your articles as Cards, making them much more engaging for your Customers.
...
The [Join.me integration](https://www.livechatinc.com/marketplace/apps/joinme/) is yet another example. It allows you to send Customers invitations to session in the form of ta Card with a button. Upon clicking, the button opens screen sharing, which makes the whole experience simple and seamless!
