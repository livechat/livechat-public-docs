...
See how to create a fullscreen app in the [documentation](/extending-ui/extending-agent-app/agent-app-sdk/#getting-started).
...
See how to set up a Settings page for your app in the [documentation](/extending-ui/extending-agent-app/agent-app-sdk/#fullscreen-widgets).
