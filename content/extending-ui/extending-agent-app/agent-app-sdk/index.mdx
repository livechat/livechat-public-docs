...
If you want to connect the Fullscreen widget to the LiveChat Agent App, you should use the `createFullscreenWidget` function. It returns a promise resolving to a fullscreen widget instance.
