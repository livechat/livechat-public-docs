...
| `customVariables` | Object containing [custom variables](https://www.livechatinc.com/help/custom-variables-configuration/) for given customer/chat; this object may be empty when custom variables were not set |
