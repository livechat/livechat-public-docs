...
This instruction applies to [widgets in the Details section](/extending-ui/extending-agent-app/#details-section), [Fullscreen apps](/extending-ui/extending-agent-app/#main-menu-fullscreen-apps), [MessageBox integrations](/extending-ui/extending-agent-app/#messagebox), and [App Settings](/extending-ui/extending-agent-app/#app-settings). Make sure to choose **the placement corresponding to your app type** in Step 4.

1. Go to <a href="https://developers.livechatinc.com/console/apps">LiveChat Developer Console</a>.
...
| `id`          | No       | string                                                   | ID passed to widget on click       |
| `clickable`   | No       | boolean                                                  | Adds border and makes it clickable |
...
Renders a line with customer's avatar, name and email.

Example of a customer component
