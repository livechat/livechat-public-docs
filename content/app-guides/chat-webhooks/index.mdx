...
As a developer, you need to handle the authorization flow in your app. For a backend app, we recommend [Authorization code grant](/getting-started/authorization/#authorization-code-grant), where your app exchanges `code` for `token`.
