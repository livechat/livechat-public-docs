...
To finish off, install the app privately (**Private installation** tab in Developer Console) and perform an action that's your webhook trigger. You can also ensure the webhooks were registered properly by calling [Get Webhooks Config](/management/configuration-api/v3.1/#get-webhooks-config) (v3.1) or [List Registered Webhooks](/management/configuration-api/#list-registered-webhooks) (v3.2 and v3.3). Remember about adding the right scopes to use those methods.
