...
If the value of a property has not been set explicitly then **default value** will be returned, if any.
The **default value** of the property, can be set during property registration.
...
For properties without explicit property value assignment, will return default values if exists.
