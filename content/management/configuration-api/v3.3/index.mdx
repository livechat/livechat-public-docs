...
Lists all webhooks that are supported in given API version. This method requires no authorization.
...
| Parameter      | Required | Data type | Notes                                  |
| -------------- | -------- | --------- | -------------------------------------- |
| `version`      | No       | `string`  | Defaults to current stable API version |
