...
Configuratiosn API is a service for storing configuration of license. You can set up here different types of features such as properties or webhooks.
...
<CodeResponseNew version="v3.3" payload="createAgent"/>
...
<CodeResponseNew version="v3.3" payload="getAgent"/>
