...
The **default value** of a property can be set during [property registration](#register-property) as the `deafult_value` parameter.
...
__**)__ Register is possible only if `access.<location>` set to `license` or `group`.
