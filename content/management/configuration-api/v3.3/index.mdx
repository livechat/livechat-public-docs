...
Enables webhooks assigned to **Client Id** from authorization token.
...
| Parameter         | Required | Data type | Notes                                                |
| ----------------- | -------- | --------- | ---------------------------------------------------- |
| `owner_client_id` | No       | `string`  | Required when authorizing via PAT; ignored otherwise |
...
Disables webhooks assigned to **Client Id** from authorization token.
...
Gets state of webhooks assigned to **Client Id** from authorization token.
