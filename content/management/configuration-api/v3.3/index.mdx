...
import createAgent_v3_3 from "../../../../payloads/management/v3.3/configuration-api/responses/agents/createAgent_v3_3.json"
import getAgent_v3_3 from "../../../../payloads/management/v3.3/configuration-api/responses/agents/getAgent_v3_3.json"
import listAgents_v3_3 from "../../../../payloads/management/v3.3/configuration-api/responses/agents/listAgents_v3_3.json"

import createBot_v3_3 from "../../../../payloads/management/v3.3/configuration-api/responses/bots/createBot_v3_3.json"
import getBot_v3_3 from "../../../../payloads/management/v3.3/configuration-api/responses/bots/getBot_v3_3.json"
import listBots_v3_3 from "../../../../payloads/management/v3.3/configuration-api/responses/bots/listBots_v3_3.json"

import createGroup_v3_3 from "../../../../payloads/management/v3.3/configuration-api/responses/groups/createGroup_v3_3.json"
import getGroup_v3_3 from "../../../../payloads/management/v3.3/configuration-api/responses/groups/getGroup_v3_3.json"
import listGroups_v3_3 from "../../../../payloads/management/v3.3/configuration-api/responses/groups/listGroups_v3_3.json"

import listGroupProperties_v3_3 from "../../../../payloads/management/v3.3/configuration-api/responses/properties/listGroupProperties_v3_3.json"
import listLicenseProperties_v3_3 from "../../../../payloads/management/v3.3/configuration-api/responses/properties/listLicenseProperties_v3_3.json"
import listRegisteredProperties_v3_3 from "../../../../payloads/management/v3.3/configuration-api/responses/properties/listRegisteredProperties_v3_3.json"

import registerWebhook_v3_3 from "../../../../payloads/management/v3.3/configuration-api/responses/webhooks/registerWebhook_v3_3.json"
import listRegisteredWebhooks_v3_3 from "../../../../payloads/management/v3.3/configuration-api/responses/webhooks/listRegisteredWebhooks_v3_3.json"
...
<CodeResponse json={createAgent_v3_3}/>
...
<CodeResponse json={getAgent_v3_3}/>
...
<CodeResponse json={listAgents_v3_3}/>
...
| `max_chats_count`                    | `int`      | No       | Max. number of incoming chats that can be routed to the Bot; default: 6.                                                               |
| `groups`                             | `object[]` | No       | Groups the Bot belongs to.                                                                                                             |
| `groups[].id`                        | `uint`     | Yes      | Group ID; required only when `group`'s included.                                                                                       |
| `groups[].priority` __*__            | `string`   | Yes      | Bot's priority in a group; required only when `group`'s included.                                                                      |
| `webhooks`                           | `object`   | No       | Webhooks sent to the Bot; for more info on possible values and payload, see [Webhooks](#webhooks). Webhooks work only for online Bots. |
...
<CodeResponse json={createBot_v3_3}/>
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.0/configuration/action/update_bot \
  -H 'Authorization: Bearer <your_access_token>' \
  -H 'Content-Type: application/json' \
  -d '{
...
| Parameter          | Required | Type     | Notes                                                            |
| ------------------------ | -------- | -------- | ---------------------------------------------------------------- |
| `all`                |  No      | `bool` |  Get all Bots, if `false` returns only caller's Bots, default value is `false`|
...
<CodeResponse json={listBots_v3_3}/>
...
<CodeResponse json={createGroup_v3_3}/>
...
<CodeResponse json={listGroups_v3_3}/>
...
<CodeResponse json={getGroup_v3_3}/>
...
|                 |                                                                             |
|-----------------|-----------------------------------------------------------------------------|
| Method URL      | `https://api.livechatinc.com/v3.3/configuration/action/register_properties` |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.3/configuration/action/register_properties \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <your_access_token>' \
  -d '{
    "string_property": {
...
|                 |                                                                                    |
|-----------------|------------------------------------------------------------------------------------|
| Method URL      | `https://api.livechatinc.com/v3.3/configuration/action/list_registered_properties` |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.3/configuration/action/list_registered_properties \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <your_access_token>' \
  -d '{}'
```
...
<CodeResponse json={listRegisteredProperties_v3_3}/>
...
<CodeResponse json={listLicenseProperties_v3_3}/>
...
<CodeResponse json={listGroupProperties_v3_3}/>
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.3/rtm-reference/#chat_access_set) [`Customer Chat API`](/messaging/customer-chat-api/v3.3/rtm-reference/#access_set)   |
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.3/rtm-reference/#customer_created)|
...
<CodeResponse json={registerWebhook_v3_3}/>
...
<CodeResponse json={listRegisteredWebhooks_v3_3}/>
