...
Enables the webhooks [registered](#register_webhook) for a given **Client Id** (application) for the license associated with the access token used in the request.
...
Disables the [enabled webhooks](#enable_webhooks).
