...
Publishes a private property. A published property cannot be unpublished and cannot be unregistered. Published properties can be accessed by tokens belonging to any **Client Id**.
