...
- If a Bot was created directly by an Agent ([PAT authorization](/getting-started/authorization/#personal-access-tokens)), all Agents who authorize with PATs will get the Bot in the response.
...
Registers a new private property to given **Client Id**.
...
| `owner_client_id`          | Yes                 | `string`   | **Client Id** which will own the property; must be owned by your organization         |
...
| ----------------- | -------- | ---------- | ------------------------------------------------------------------------- |
| `name`            | Yes      | `string`   | Property name                                                             |
| `owner_client_id` | Yes      | `string`   | **Client Id** which owns the property; must be owned by your organization |
...
Publishes a private property. Published property cannot be unpublished and cannot be unregistered. Published property can be accessed by tokens belonging to any **Client Id**.
...
| `name`            | Yes                 | `string`   | Property name                                                                                                |
| `owner_client_id` | Yes                 | `string`   | **Client Id** which owns the property; must be owned by your organization                                    |
| `access_type`     | Yes                 | `[string]` | Possible values: `read`, `write`; determines access level to **Client Ids** different than `owner_client_id` |
...
Lists private and public properties owned by given **Client Id**.
...
| Parameter         | Required            | Data type  | Notes                                                                       |
| ------------------| ------------------- | ---------- | --------------------------------------------------------------------------- |
| `owner_client_id` | Yes                 | `string`   | **Client Id** which owns the properties; must be owned by your organization |
