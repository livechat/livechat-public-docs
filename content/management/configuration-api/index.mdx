...
To receive the [`license`](#request-29) type webhooks, you need to enable them after registration. You can do that by calling the [Enable License Webhooks](#enable-license-webhooks) method that will install your registered webhooks for a given license.

For the [`bot`](#request-29) type webhooks, you need to [create a bot](#create-bot), [register webhooks](#register-webhook), and then, call [Set Routing Status](/messaging/agent-chat-api/#set-routing-status).
