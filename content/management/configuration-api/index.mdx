...
import createAgent from "payloads/management/v3.2/configuration-api/responses/agents/createAgent.json"
import getAgent from "payloads/management/v3.2/configuration-api/responses/agents/getAgent.json"
import listAgents from "payloads/management/v3.2/configuration-api/responses/agents/listAgents.json"

import createBot from "payloads/management/v3.2/configuration-api/responses/bots/createBot.json"
import getBot from "payloads/management/v3.2/configuration-api/responses/bots/getBot.json"
import listBots from "payloads/management/v3.2/configuration-api/responses/bots/listBots.json"

import createGroup from "payloads/management/v3.2/configuration-api/responses/groups/createGroup.json"
import getGroup from "payloads/management/v3.2/configuration-api/responses/groups/getGroup.json"
import listGroups from "payloads/management/v3.2/configuration-api/responses/groups/listGroups.json"

import listGroupProperties from "payloads/management/v3.2/configuration-api/responses/properties/listGroupProperties.json"
import listLicenseProperties from "payloads/management/v3.2/configuration-api/responses/properties/listLicenseProperties.json"
import listRegisteredProperties from "payloads/management/v3.2/configuration-api/responses/properties/listRegisteredProperties.json"

import registerWebhook from "payloads/management/v3.2/configuration-api/responses/webhooks/registerWebhook.json"
import listRegisteredWebhooks from "payloads/management/v3.2/configuration-api/responses/webhooks/listRegisteredWebhooks.json"
...
This document describes the **Configuration API v3.2**. This is the latest stable version recommended for the production use. [Read more about versioning...](/messaging/#api-versioning)
...
<CodeResponseNew version="v3.2" payload="createAgent"/>
...
<CodeResponseNew version="v3.2" payload="getAgent"/>
...
<CodeResponse json={listRegisteredProperties}/>
...
<CodeResponse json={listLicenseProperties}/>
...
<CodeResponse json={listGroupProperties}/>
...
<CodeResponse json={registerWebhook}/>
...
<CodeResponse json={listRegisteredWebhooks}/>
