...
| `supervisor`   |                                                                                                         Agent works as `supervisor` so it will not be assigned to any chats.                                                                                                        |
