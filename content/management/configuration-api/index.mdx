...
| `agent_status_changed`            | [`agent_updated`](/messaging/agent-chat-api/rtm-reference/#agent_updated)                                   | -                                                 |
| `agent_deleted`                   | An Agent's account being deleted from the license                                                           | -                                                 |
