...
For the [`license`](#request-29) type webhooks, you need to enable them after registration. You can do that by calling the [Enable License Webhooks](#enable-license-webhooks) method that will install your registered webhooks for a given license.
