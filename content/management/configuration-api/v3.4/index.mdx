...
Informs that the account for a new agent was created.
...
Informs that the agent's account got approved and is now active.
...
Informs that the agent's config changed. Contains only updated properties.
...
Informs that the agent's account got suspended.
...
Informs that the agent's account got unsuspended.
...
Informs that the agent's account got deleted.
...
Informs that a new auto_access rule was added.
...
Informs that the auto_access rule's config changed. Contains only updated properties.
...
Informs that the auto_access rule got deleted.
...
Informs that the bot's config changed. Contains only updated properties.
...
Informs that the bot got deleted.
