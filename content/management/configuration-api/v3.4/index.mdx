...
This document describes the **Configuration API v3.4**. This is the developer preview version that provides a preview of the upcoming changes to the API. **It's not open to public use.** In case you need to test some features, contact us at developers@livechat.com or start a chat. We'll consider each request for access to the dev preview version individually.
