...
Informs that a group has been created within a license. The payload contains the full state of the [group](/management/configuration-api/v3.4/#groups) data structure, including empty fields.
