...
| `filters.source_type`                           | no       | `[]string` | Array of source types. Possible values: `my_client`, `other_clients`, `system`; if webhook source match, the webhook will be triggered.                                                        |
