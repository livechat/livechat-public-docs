...
| `avatar`                               | `string`   | No       | URL path of the Agent's avatar                                                                                                                |
...
| `avatar`                               | `string`   | No       | URL path for Agent avatar                                                          |
| `job_title`                            | `string`   | No       | Agent's job title                                                                  |
| `mobile`                               | `string`   | No       | Agent's mobile number                                                              |
...
Registers a webhook for the Client ID (application) provided in the request. To activate license webhooks, you can [enable](#enable-license-webhooks) registered webhooks for a given license. To activate bot webhooks, you need to [create a bot](#create-bot), and then, use [Set Routing Status](/messaging/agent-chat-api/v3.4/#set-routing-status) method. One Client ID can register up to three webhooks for every `action`.
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#incoming_chat) [`Customer Chat API`](/messaging/customer-chat-api/v3.4/rtm-reference/#incoming_chat) |
...
| ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Action**             | `chat_deactivated`                                                                                                                                                          |
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#chat_deactivated) [`Customer Chat API`](/messaging/customer-chat-api/v3.4/rtm-reference/#chat_deactivated) |
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#chat_transferred) |
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#user_added_to_chat) [`Customer Chat API`](/messaging/customer-chat-api/v3.4/rtm-reference/#user_added_to_chat) |
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#user_removed_from_chat) [`Customer Chat API`](/messaging/customer-chat-api/v3.4/rtm-reference/#user_removed_from_chat) |
...
Informs about an incoming [event](/messaging/agent-chat-api/v3.4/#events) sent to a chat.
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#incoming_event) [`Customer Chat API`](/messaging/customer-chat-api/v3.4/rtm-reference/#incoming_event) |
...
Informs that an [event](/messaging/agent-chat-api/v3.4/#events) was updated.
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#event_updated) [`Customer Chat API`](/messaging/customer-chat-api/v3.4/rtm-reference/#event_updated) |
...
Informs about an incoming [rich message](/messaging/agent-chat-api/v3.4/#rich-message) postback. The webhook payload contains the info on the postback itself, as well as the chat it was sent in.
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#incoming_rich_message_postback) [`Customer Chat API`](/messaging/customer-chat-api/v3.4/rtm-reference/#incoming_rich_message_postback) |
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#chat_properties_updated) [`Customer Chat API`](/messaging/customer-chat-api/v3.4/rtm-reference/#chat_properties_updated) |
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#chat_properties_deleted) [`Customer Chat API`](/messaging/customer-chat-api/v3.4/rtm-reference/#chat_properties_deleted) |
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#thread_properties_updated) [`Customer Chat API`](/messaging/customer-chat-api/v3.4/rtm-reference/#thread_properties_updated) |
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#thread_properties_deleted) [`Customer Chat API`](/messaging/customer-chat-api/v3.4/rtm-reference/#thread_properties_deleted) |
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#event_properties_updated) [`Customer Chat API`](/messaging/customer-chat-api/v3.4/rtm-reference/#event_properties_updated) |
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#event_properties_deleted) [`Customer Chat API`](/messaging/customer-chat-api/v3.4/rtm-reference/#event_properties_deleted) |
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#thread_tagged) |
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#thread_untagged) |
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#routing_status_set) |
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#incoming_customer) |
...
Informs that a new agent account was created. Response will contain full state of agent resource - empty fields won't be omitted.
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#agent_created) |
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#agent_approved) |
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#agent_updated) |
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#agent_suspended) |
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#agent_unsuspended) |
...
| ---------------------- | ------------------------------------------------------------------------------- |
| **Action**             | `agent_deleted`                                                                 |
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#agent_deleted) |
...
Informs that a new auto access rule was added. Response will contain full state of auto access rule resource - empty fields won't be omitted. Adding rule may result in multiple [`auto_access_updated`](#auto_access_updated) webhooks, depending on `next_id` value.
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#auto_access_added) |
...
Informs that the configuration of an auto access rule changed. Contains only the updated properties. Updating rule may result in multiple [`auto_access_updated`](#auto_access_updated) webhooks, depending on `next_id` value.
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#auto_access_updated) |
...
Informs that an autoaccess rule was deleted. Deleting rule may result in multiple [`auto_access_updated`](#auto_access_updated) webhooks, depending on rules `next_id` value.
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#auto_access_deleted) |
...
Informs that a new bot was added. Response will contain full state of bot resource - empty fields won't be omitted.
...
| ---------------------- | ----------------------------------------------------------------------------- |
| **Action**             | `bot_created`                                                                 |
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#bot_created) |
...
| ---------------------- | ----------------------------------------------------------------------------- |
| **Action**             | `bot_updated`                                                                 |
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#bot_updated) |
...
| ---------------------- | ----------------------------------------------------------------------------- |
| **Action**             | `bot_deleted`                                                                 |
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#bot_deleted) |
...
Informs that a group has been created within a license. Response will contain full state of group resource - empty fields won't be omitted.
...
| ---------------------- | -----------------------§-------------------------------------------------------- |
| **Action**             | `create_group`                                                                  |
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#group_created) |
...
| ---------------------- | ------------------------------------------------------------------------------- |
| **Action**             | `delete_group`                                                                  |
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#group_deleted) |
...
| ---------------------- | ------------------------------------------------------------------------------- |
| **Action**             | `update_group`                                                                  |
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#group_updated) |
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/v3.4/rtm-reference/#events_marked_as_seen) [`Customer Chat API`](/messaging/customer-chat-api/v3.4/rtm-reference/#events_marked_as_seen) |
