...
| `filters.source_type`                           | no       | `[]string` | Filters to check if a webhook should be triggered based on webhook's source. Possible values in array : `my_client`, `other_clients`, `system`.                                                |
