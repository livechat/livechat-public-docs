...
Informs that a new agent account was created. The payload contains the full state of the [agent](/messaging/agent-chat-api/v3.4/#agent) data structure, including empty fields.
