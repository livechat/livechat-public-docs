...
For **bot webhooks**, you need to [create a bot](#create-bot), [register webhooks](#register-webhook), and then, use [Set Routing Status](/messaging/agent-chat-api/v3.4/#set-routing-status).
...
Informs that a new agent account was created.
...
Informs that a new auto access rule was added.
...
Informs that a new bot was added.
...
Informs that a group has been created within a license.
