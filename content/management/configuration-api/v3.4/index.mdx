...
Informs that a new agent account was created. The payload contains the full state of the [agent](/management/configuration-api/v3.4/#agent) data structure, including empty fields.
...
Informs that a group has been created within a license. The payload contains the full state of the [agent](/management/configuration-api/v3.4/#groups) data structure, including empty fields.
