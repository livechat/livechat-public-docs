...
| `subtype` | possible values: `announcement`; you can have up to 10 `announcement` greetings; if given `announcement` greeting is canceled by the customer, it'll never be shown again for that customer |
