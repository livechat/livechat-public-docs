...
Number of webhooks that you can register is limited and depends on authorization method:
- while using PAT (using diffrent PATs *doesn't* rise this limit): 10 for every action
- while using Bearer token: 60 for every action
