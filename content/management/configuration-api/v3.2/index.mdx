...
import createAgent from "./payloads/responses/agents/createAgent.json"
import getAgent from "./payloads/responses/agents/getAgent.json"
import listAgents from "./payloads/responses/agents/listAgents.json"

import createBot from "./payloads/responses/bots/createBot.json"
import getBot from "./payloads/responses/bots/getBot.json"
import listBots from "./payloads/responses/bots/listBots.json"

import createGroup from "./payloads/responses/groups/createGroup.json"
import getGroup from "./payloads/responses/groups/getGroup.json"
import listGroups from "./payloads/responses/groups/listGroups.json"

import listGroupProperties from "./payloads/responses/properties/listGroupProperties.json"
import listLicenseProperties from "./payloads/responses/properties/listLicenseProperties.json"
import listRegisteredProperties from "./payloads/responses/properties/listRegisteredProperties.json"

import registerWebhook from "./payloads/responses/webhooks/registerWebhook.json"
import listRegisteredWebhooks from "./payloads/responses/webhooks/listRegisteredWebhooks.json"
...
This document describes the **Configuration API v3.2**. This is the **developer preview** version recommended only for the **experimental** use. [Read more about versioning...](/messaging/#api-versioning)
...
| Possible value     | Notes                                                                           |
|--------------------|-------------------------------------------------------------------------------- |
| `agent_priorities` | An object containing agents belonging to the Group along with their priorities. |
| `routing_status`   | Routing status of the Group.                                                    |
