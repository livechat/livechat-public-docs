...
| `password`                               | `string`   | No       | Agent Passowrd (Could be set later via link in email)                   |
...
| `fields`                                 | `object`   | No       | Fields to set for new agent.                                            |
| `fields`.__*__                           | `any`      | No       | Value for given agent field.                                            |
...
| `acl`                    | Agent permission, should be on of following: `viceowner`, `administrator`, `normal` |
| `avatar_path`            | URL path for agent avatar                                                           |
| `job`                    | Agent's job title                                                                   |

__**__ Possible values for the `work_scheduler` object keys: `sunday`, `monday`, `tuesday`, `wednesday`, `thursday`, `friday`, `saturday`
...
| `nick`                               | No       | `string`  | Agent's nickname            |
| `job`                                | No       | `string`  | Agent's job title           |
| `name`                               | No       | `string`  | Agent's display name        |
| `mobile`                             | No       | `string`  | Agent's mobile phone number |
