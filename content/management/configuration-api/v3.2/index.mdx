...
Groups let you organize your work by creating teams with Agent and Bot members. You can use groups to do basic configuration and separate chat routing. It worth mentioning that one Agent can belong to mutliple groups at the same time. It's possible to configure routing priorities for Agents and Bots specifically per group.
