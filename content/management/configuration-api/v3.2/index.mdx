...
Every time a customer calls [**Login**](/messaging/customer-chat-api/v3.2/rtm-reference/#login) or
[**Update Customer Page**](/messaging/customer-chat-api/v3.2/rtm-reference/#update-customer-page), our backend checks if
...
If a customer starts a chat via [**Start Chat**](/messaging/customer-chat-api/v3.2/rtm-reference/#start-chat) or
[**Activate Chat**](/messaging/customer-chat-api/v3.2/rtm-reference/#activate-chat) with the `chat.access` parameter,
...
|                |                                                                               |
| -------------- | ----------------------------------------------------------------------------- |
| Method URL     | `https://api.livechatinc.com/v3.2/configuration/action/add_auto_access`       |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.2/configuration/action/add_auto_access \
...
|                |                                                                                      |
| -------------- | ------------------------------------------------------------------------------------ |
| Method URL     | `https://api.livechatinc.com/v3.2/configuration/action/list_auto_accesses`           |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.2/configuration/action/list_auto_accesses \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <your_access_token>' \
  -d '{}'
```
...
|                |                                                                                  |
| -------------- | -------------------------------------------------------------------------------- |
| Method URL     | `https://api.livechatinc.com/v3.2/configuration/action/delete_auto_access`       |
| Required scopes| `access_rules:rw`                                                                |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.2/configuration/action/delete_auto_access \
  -H 'Content-Type: application/json' \
  -H 'Authorization: Bearer <your_access_token>' \
  -d '{
    "id": "pqi8oasdjahuakndw9nsad9na"
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/rtm-reference/#incoming_chat) [`Customer Chat API`](/messaging/customer-chat-api/rtm-reference/#incoming_chat) |
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/rtm-reference/#chat_deactivated) [`Customer Chat API`](/messaging/customer-chat-api/rtm-reference/#chat_deactivated) |
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/rtm-reference/#chat_access_granted)    |
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/rtm-reference/#chat_access_revoked)   |
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/rtm-reference/#chat_access_set) [`Customer Chat API`](/messaging/customer-chat-api/rtm-reference/#access_set)   |
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/rtm-reference/#thread_properties_updated) [`Customer Chat API`](/messaging/customer-chat-api/rtm-reference/#thread_properties_updated)|
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/rtm-reference/#thread_properties_deleted) [`Customer Chat API`](/messaging/customer-chat-api/rtm-reference/#thread_properties_deleted)|
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/rtm-reference/#thread_tagged)|
...
| **Push equivalent in** | [`Agent Chat API`](/messaging/agent-chat-api/rtm-reference/#thread_untagged)|
