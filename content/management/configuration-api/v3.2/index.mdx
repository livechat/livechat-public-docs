...
Groups organize agents and bots into teams useful for common configuration as well as separate chat routing. An agent can be in many groups at the same time. Agents and bots can have different routing priorities in each group.
...
| `language_code`                      | `string`   | No       | Code of group languange                                                                                                    |
| `agent_priorities` __*__             | `object`   | Yes      | Agents' priorities in group as a map in the `"<id>": "<priority>"` format. At least one agent must have priority `normal`. |
...
| Required scopes| `groups--my:rw` `groups--all:rw` (to update other group than caller's one)  |
...
| `language_code`                      | `string`   | No       | Code of group languange                                                                                                    |
| `agent_priorities` __*__             | `object`   | No       | Agents' priorities in group as a map in the `"<id>": "<priority>"` format. |
...
| Required scopes| `groups--my:rw` `groups--all:rw` (to remove other group than caller's one)  |
...
| Required scopes| `groups--my:ro` `groups--all:ro` (to get other group than caller's one) |
