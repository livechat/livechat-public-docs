...
Returns all Agents within a license. You can request only the Agents from a specific group.
...
| `filters.group_ids` | No       | `int[]`    | IDs of the groups from which you want to list Agents. |
