...
| Required scopes| `webhooks.state--my:rw`  |
...
| Required scopes| `webhooks.state--my:ro` `webhooks.state--all:ro` |
...
| Required scopes| `webhooks.state--my:rw` `webhooks.state--all:rw`  |
