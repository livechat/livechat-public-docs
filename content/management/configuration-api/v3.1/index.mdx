...
| `incoming_rich_message_postback` | [`incoming_rich_message_postback`](/messaging/agent-chat-api/v3.1/rtm-reference/#incoming_rich_message_postback) |                `chat_member_ids`, `only_my_chats` |
...
| `thread_closed`                  |                  [`thread_closed`](/messaging/agent-chat-api/v3.1/rtm-reference/#thread_closed)                  |                `chat_member_ids`, `only_my_chats` |
| `chat_properties_updated`        |        [`chat_properties_updated`](/messaging/agent-chat-api/v3.1/rtm-reference/#chat_properties_updated)        |                `chat_member_ids`, `only_my_chats` |
| `chat_properties_deleted`        |        [`chat_properties_deleted`](/messaging/agent-chat-api/v3.1/rtm-reference/#chat_properties_deleted)        |                `chat_member_ids`, `only_my_chats` |
| `chat_thread_properties_updated` | [`chat_thread_properties_updated`](/messaging/agent-chat-api/v3.1/rtm-reference/#chat_thread_properties_updated) |                `chat_member_ids`, `only_my_chats` |
| `chat_thread_properties_deleted` | [`chat_thread_properties_deleted`](/messaging/agent-chat-api/v3.1/rtm-reference/#chat_thread_properties_deleted) |                `chat_member_ids`, `only_my_chats` |
| `chat_user_added`                |                [`chat_user_added`](/messaging/agent-chat-api/v3.1/rtm-reference/#chat_user_added)                |                `chat_member_ids`, `only_my_chats` |
| `chat_user_removed`              |              [`chat_user_removed`](/messaging/agent-chat-api/v3.1/rtm-reference/#chat_user_removed)              |                `chat_member_ids`, `only_my_chats` |
...
### `incoming_event`
Informs about an incoming [event](/messaging/agent-chat-api/v3.1/#events) sent to a chat.
...
### `event_updated`
Informs that an [event](/messaging/agent-chat-api/v3.1/#events) was updated.
...
Informs about an incoming [rich message](/messaging/agent-chat-api/v3.1/#rich-message) postback. The webhook payload contains the info on the postback itself, as well as the chat it was sent in.
