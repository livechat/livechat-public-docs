...
- The [**Create Bot**](/management/configuration-api/v3.3/#create-bot) method has new parameter, `timezone`. It's required when used with `work_scheduler`; otherwise optional.
- The [**Update Bot**](/management/configuration-api/v3.3/#update-bot) method has new parameter, `timezone`. It's required when used with `work_scheduler`; otherwise optional.
