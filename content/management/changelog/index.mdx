...
- The [**Delete Bot**](/management/configuration-api/v3.3/#delete-bot) method had `bot_agent_id` parameter renamed to `id`.
- The [**Get Bot**](/management/configuration-api/v3.3/#get-bot) method had `bot_agent_id` parameter renamed to `id`

### Properties

- The [**List Group Properties**](/management/configuration-api/v3.3/#list-group-properties) method had `group_id` parameter renamed to `id`.
- The [**Delete Group Properties**](/management/configuration-api/v3.3/#delete-group-properties) method had `group_id` parameter renamed to `id`.

### Webhooks

- The [**Unregister Webhook**](/management/configuration-api/v3.3/#unregister-webhook) method had `webhook_id` parameter renamed to `id`.
...
- The **Update Bot** method no longer accepts the `status` parameter. To change the Bot's status, use [**Set Routing Status**](/messaging/agent-chat-api/v3.2/#set-routing-status) from **the Agent Chat API**.
