...
- The [**Create Bot**](/management/configuration-api/v3.3/#create-bot) method has new parameter - `timezone`. It is required in combination with `work_scheduler` provided, otherwise it's optional.
- The [**Update Bot**](/management/configuration-api/v3.3/#update-bot) method has new parameter - `timezone`. It is required in combination with `work_scheduler` provided, otherwise it's optional.
