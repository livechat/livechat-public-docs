...
- [**Get Agent**](/management/configuration-api/v3.3/#get-agent) method may no longer be used to fetch bots.
- [**List Agents**](/management/configuration-api/v3.3/#list-agents) method will no longer return bots.
...
- [**Get Bot**](/management/configuration-api/v3.3/#get-bot) method:
  - had the `bot_agent_id` parameter renamed to `id`;
  - response is unnested, removing redundant `bot_agent` level;
