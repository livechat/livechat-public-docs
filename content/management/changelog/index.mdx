...
- There are new methods for managing Agents: [**Get Agent**](/management/configuration-api/v3.2/#get-agent), [**Get Agents**](/management/configuration-api/v3.2/#get-agents), [**Update Agent**](/management/configuration-api/v3.2/#update-agent).
