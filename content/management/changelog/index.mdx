...
- There are new methods for managing Agents: [**Get Agent**](/management/configuration-api/v3.2/#get-agent), [**List Agents**](/management/configuration-api/v3.2/#list-agents), [**Update Agent**](/management/configuration-api/v3.2/#update-agent).
