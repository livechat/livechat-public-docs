...
- The [**Get Bot**](/management/configuration-api/v3.3/#get-bot) method had the `bot_agent_id` parameter renamed to `id`.
...
- Properties configuration is now owned by **Client Id**, not by **License**, which resulted in the following changes:
  - The **Register Properties** method is removed.
  - The **List Registered Properties** method is removed.
  - There is a new method [**Register Property**](/management/configuration-api/v3.3/#register-property).
  - There is a new method [**Unregister Property**](/management/configuration-api/v3.3/#unregister-property).
  - There is a new method [**Publish Property**](/management/configuration-api/v3.3/#publish-property).
  - There is a new method [**List Properties**](/management/configuration-api/v3.3/#list-properties).
