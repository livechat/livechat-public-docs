...
- There are new methods for managing auto access: [**Add Auto Access**](/management/configuration-api/v3.2/#add-auto-access), [**List Auto Accesses**](/management/configuration-api/v3.2/#list-auto-accesses), and [**Delete Auto Access**](/management/configuration-api/v3.2/#delete-auto-access).
