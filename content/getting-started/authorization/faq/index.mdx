...
## What's the easiet way to authorize calls to the LiveChat API?
...
Log in to <a href="https://developers.livechatinc.com/console/" target="_blank" rel="noopener noreferrer">**Developer Console**</a> with your LiveChat login and password. Go to **Tools** and click **Create new token +**, or use an existing token if you have one.
...
You need to create a customer. You'll, then, use the access token of this customer to authorize your calls to the Customer Chat API. To create a customer, send a request described in [**Creating new customer**](/getting-started/authorization/#creating-new-customer).
...
5. To check if your token is valid, complete, and has all necessary scopes, you can use our <a href="https://developers.livechatinc.com/console/tools/token-debugger/" target="_blank" rel="noopener noreferrer">**Token Debugger**</a>.  
