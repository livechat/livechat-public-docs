...
Next, fill in the **Redirect URI whitelist** field. **Redirect URI** is the address of your app that will receive the **access token** in a URL. Using only this address one can acquire a token. 

![LiveChat Developer Console](images/console_1.png)

You also need to choose the right scopes. Usually, you need scopes to be able to use a method. 
...
Given that your **Client Id** was **0805e283233042b37f460ed8fbf22160** and **Redirect URI** was **https://www.livechatinc.com/**, this is how your request will look: 
