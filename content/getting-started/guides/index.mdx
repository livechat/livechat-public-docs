...
- **From business perspective:** <br/>The primary goal of an app is to abstract some functionality in an installable package, which can be published and distributed at the [Apps Marketplace](https://my.livechatinc.com/settings/apps/). App can also remain private and available only for the license it was created on.
