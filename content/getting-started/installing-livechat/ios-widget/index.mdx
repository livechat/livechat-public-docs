...
tagline: "Embed LiveChat inside your iOS app"
desc: "Learn how to embed LiveChat inside your iOS app. The LiveChat Widget for iOS allows your users to contact agents directly from the mobile application."
---
