...
Go to the Building Blocks section and create a new Agent App Widget with `App Settings` as a placement. This widget will be displayed as a settings page for your app.
...
- prompt users to connect their accounts with your OAuth2.0 provider,
