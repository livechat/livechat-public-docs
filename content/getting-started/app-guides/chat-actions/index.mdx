...
**2. Open a modal** in an iframe. If you choose this option, provide the link to the modal in the Action target URL.

**3. Send a webook** to the Action target URL. See [what info](#parameters) the webhook will contain.

**4. Open a widget** in the Chat Details section. To use this option, you need to [create an Agent App Widget](/extending-agent-app/agent-app-sdk/#getting-started) first.
