...
❗️ Currently, Developer Console only supports [webhooks v3.2](/management/configuration-api/v3.2/#webhooks). If you want to use v3.3, you need to register them using the first method.
