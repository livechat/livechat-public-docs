...
Keep in mind that the Chat Webhooks building block allow you to configure `license` webhooks, and that is what this document focuses on. The document doesn't apply to `bot` webhooks.
