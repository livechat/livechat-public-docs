...
The LiveChat Platform lets you extract data from all the [Reports](https://www.livechatinc.com/help/reporting-options-available-in-livechat/) available in LiveChat. You can use this data to create your own reports, build custom dashboards or set up custom email reporting.
