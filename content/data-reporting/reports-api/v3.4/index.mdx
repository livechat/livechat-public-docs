...
| `timezone`                                                            | No       | `string`  | IANA [Time Zone](http://en.wikipedia.org/wiki/List_of_tz_database_time_zones) (e.g. America/Phoenix). Defaults to the requester's timezone. When requester's timezone is not present then `filters.from` is parsed to get timezone.  |
| `filters`                                                             | No       | `object`  | If not provided your report will be spanned last seven days.                                                                                                                                                                         |
