...
https://api.livechatinc.com/v3.4/reports/chats/ratings \
  ...
  -d '{
    "distribution": "day",
    "filters": {
      "from": "2021-06-23T00:00:00-00:00",
      "to": "2021-06-27T23:59:59-00:00"
    }
  }'
```
...
| `ranking.agent.name`     | Name of `agent`                                          |
| `ranking.agent.total`    | The total number of agent's chats that period.           |
| `ranking.agent.good`     | The number of agent's chats rated `good`                 |
| `ranking.agent.bad`      | The number of agent's chats rated `good`                 |
| `ranking.agent.score`    | Score of agent                                           |
