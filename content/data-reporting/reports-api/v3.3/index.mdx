...
Shows distribution of tags for chats.
...
| `agents`              | no       | Agent emails separated by a comma; if not specified, returns the data for all agents within the license.                                                                |
| `groups`              | no       | Group IDs separated by a comma                                                                                                                                          |
| `names`               | no       | Names of tags separated by a comma; when tags=:without: you will get total number of chats without tags, when tags=:with: you will get total number of chats with tags. |
