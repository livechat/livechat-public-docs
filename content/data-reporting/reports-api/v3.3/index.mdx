...
| --------------------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `to`                  | yes      | Date in the RFC3339 format. If `timezone` provided, the Timezone from this format will be ignored.                                                                                                        |
| `from`                | yes      | Date in the RFC3339 format. If `timezone` provided, the Timezone from this format will be ignored.                                                                                                        |
...
| `timezone`            | no       | Timezone in the [TZ format](http://en.wikipedia.org/wiki/List_of_tz_database_time_zones) (e.g. America/Phoenix). Defaults to requester Timezone. If not present, `from` is parsed to get it's Timezone.   |
