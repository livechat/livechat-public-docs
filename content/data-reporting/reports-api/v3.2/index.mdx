...
This document describes the **LiveChat Reports API v3.2**. This is the legacy version we don't recommend for production-ready applications. Instead, use [**LiveChat Reports API v3.3**](../).
