...
Shows the average agents chatting duration.
...
| `agents`              | agent emails separated by comma            |
| `groups`              | group IDs separated by comma               |
| `tags`                | names of tags separated by comma           |
| `customer_client_ids` | client IDs separated by comma              |
| `distribution`        | one of hour, day, month  defaults to `day` |
| `tagged`              | one of true, 1, false, 0                   |
