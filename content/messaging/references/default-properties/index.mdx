...
Specifies if the automating routing should be disabled for given chat.
...
Specifies if the chat should not be routed to Bots during the automatic routing.
...
Specifies if no Agent or Bot responded to given chat.
