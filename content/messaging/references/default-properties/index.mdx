...
| **routing**     | [`continuous`](#continuous) [`email_follow_up`](#email_follow_up) [`idle`](#idle) [`last_transfer_timestamp`](#last_transfer_timestamp#)  [`pinned`](#pinned) [`referrer`](#referrer) [`start_url`](#start_url)  [`transcript_email`](#transcript_email) [`offline_message`](#offline_message) |
...
Specifies if a thread is an offline message.
