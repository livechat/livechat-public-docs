...
<Errors errors="authentication,authorization,customer_banned,entity_too_large,greeting_not_found,group_not_found,group_offline,group_unavailable,groups_offline,internal,license_expired,license_not_found,misdirected_request,request_timeout,service_unavailable,unsupported_version,validation,wrong_product_version,too_many_requests"/>
