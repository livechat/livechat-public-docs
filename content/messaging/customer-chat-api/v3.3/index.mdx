...
Returns the dynamic config of a given group. It provides data to get a [`config`](#config) and a [`localization`](#localization).
...
| Parameters              | Required | Data type | Notes                                                       |
| ----------------------- | -------- | --------- | ----------------------------------------------------------- |
| `group_id`              | Yes      | `number`  | Id of the group that you want to get a dynamic config for.  |
...
```json
{
  ...
  "config_version": "194.159.276.6.1",
...
Returns the config of a given group in a given version. Contains data on the basis of which the Chat Window can be built.
...
| Parameters              | Required | Data type | Notes                                              |
| ----------------------- | -------- | --------- | -------------------------------------------------- |
| `group_id`              | Yes      | `number`  | Id of the group that you want to get a config for. |
| `version`               | Yes      | `string`  | The version that you want to get a config for.     |
...
```shell
curl -X GET \
  'https://api.livechatinc.com/v3.3/customer/action/config?license_id=<license_id>&group_id=0&version=194.159.276.6.1'
```
...
```json
{
  ...
  "offline_form": {
    "fields": [
      {
        "type": "header",
        "value": "Our agents are not available right now. Please leave a message and we'll get back to you.",
        "order": 0
      },
      {
        "type": "name",
  ...
  "prechat_survey": {
    "fields": [
        ...
        {
          "type": "header",
          "value": "Welcome to our LiveChat! Please fill in the form below before starting the chat.",
          "order": 0
        },
        {
          "type": "email",
          "id": "158282965186603864",
          "required": false,
          "order": 2,
          "label": "E-mail:"
        }
...
| Parameters              | Required | Data type | Notes                                                    |
| ----------------------- | -------- | --------- | -------------------------------------------------------- |
| `group_id`              | Yes      | `number`  | Id of the group that you want to get a localization for. |
| `language`              | Yes      | `string`  | The language that you want to get a localization for.    |
| `version`               | Yes      | `string`  | The version that you want to get a localization for.     |
