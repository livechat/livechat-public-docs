...
| Field                   | Data type  | Notes                                                                                                                                                                     |
| ----------------------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `group_id`              | `number`   | The ID of the group for which you requested the dynamic configuration.                                                                                                                                                                          |
| `client_limit_exceeded` | `bool`     | Specifies if the limit of customers having a chat was exceeded. |
| `domain_whitelisted`    | `bool`     | Specifies if `url` is configured as a trusted domain (configurable in the Agent Application).  |
