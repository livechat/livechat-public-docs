...
import ca_custom_v3_3 from "../../../../payloads/messaging/v3.3/customer-chat-api/events/ca_custom_v3_3.json"
import ca_file_v3_3 from "../../../../payloads/messaging/v3.3/customer-chat-api/events/ca_file_v3_3.json"
import ca_filledForm_v3_3 from "../../../../payloads/messaging/v3.3/customer-chat-api/events/ca_filledForm_v3_3.json"
import ca_message_v3_3 from "../../../../payloads/messaging/v3.3/customer-chat-api/events/ca_message_v3_3.json"
import ca_richMessage_v3_3 from "../../../../payloads/messaging/v3.3/customer-chat-api/events/ca_richMessage_v3_3.json"
import ca_systemMessage_v3_3 from "../../../../payloads/messaging/v3.3/customer-chat-api/events/ca_systemMessage_v3_3.json"

import ca_agent_v3_3 from "../../../../payloads/messaging/v3.3/customer-chat-api/users/ca_agent_v3_3.json"
import ca_customer_v3_3 from "../../../../payloads/messaging/v3.3/customer-chat-api/users/ca_customer_v3_3.json"

import ca_access_v3_3 from "../../../../payloads/messaging/v3.3/customer-chat-api/other-structures/ca_access_v3_3.json"
import ca_chat_v3_3 from "../../../../payloads/messaging/v3.3/customer-chat-api/other-structures/ca_chat_v3_3.json"
import ca_chatSummary_v3_3 from "../../../../payloads/messaging/v3.3/customer-chat-api/other-structures/ca_chatSummary_v3_3.json"
import ca_formFields_v3_3 from "../../../../payloads/messaging/v3.3/customer-chat-api/other-structures/ca_formFields_v3_3.json"
import ca_properties_v3_3 from "../../../../payloads/messaging/v3.3/customer-chat-api/other-structures/ca_properties_v3_3.json"
import ca_thread_v3_3 from "../../../../payloads/messaging/v3.3/customer-chat-api/other-structures/ca_thread_v3_3.json"
...
<CodeResponse title={'Sample File in response'} json={ca_file_v3_3}/>
...
<CodeResponse title={'Sample Filled form in response'} json={ca_filledForm_v3_3}/>
...
<Code>
<CodeResponse title={'Sample Message in response'} json={ca_message_v3_3}/>
</Code>
...
<Code>
<CodeResponse title={'Sample Rich message in response'} json={ca_richMessage_v3_3}/>
</Code>
</Section>
...
<Code>
<CodeResponse title={'Sample Custom event in response'} json={ca_custom_v3_3}/>
</Code>
</Section>
...
<Code>
<CodeResponse title={'Sample System message in response'} json={ca_systemMessage_v3_3}/>
</Code>
</Section>
...
<CodeResponse title={'Sample Customer data structure'} json={ca_customer_v3_3}/>
...
<CodeResponse title={'Sample Agent data structure'} json={ca_agent_v3_3}/>
...
<CodeResponse title={'Sample Access data structure'} json={ca_access_v3_3}/>
...
<CodeResponse title={'Sample Chat data structure'} json={ca_chat_v3_3}/>
...
<CodeResponse title={'Sample Chat summary data structure'} json={ca_chatSummary_v3_3}/>

## Form fields

A component of the [Filled form](#filled-form) event.

<CodeResponse title={'Sample Form fields'} json={ca_formFields_v3_3}/>
...
<CodeResponse title={'Sample Properties data structure'} json={ca_properties_v3_3}/>

## Threads

<CodeResponse title={'Sample Thread data structure'} json={ca_thread_v3_3}/>
...
| ----------- | ----------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- |
| **POST**    | `https://api.livechatinc.com/v3.3/customer/action/<action>` | All except for **Get License Properties** and **Get Group Properties**                                      |
| **GET**     | `https://api.livechatinc.com/v3.3/customer/action/<action>` | [**Get License Properties**](#list-license-properties) and [**Get Group Properties**](#list-group-properties) |
