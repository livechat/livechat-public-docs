...
| **Web API equivalent** | [`mark_events_as_seen`](../customer-chat-web-api-v3.1/#mark-events-as-seen) <sup>[![LiveChat Link](link.svg)](../customer-chat-web-api-v3.1/#mark-events-as-seen)</sup> |
