...
- There are 2 new pushes: [`incoming_greeting`](/messaging/customer-chat-api/v3.2/rtm-reference/#incoming_greeting) and [`greeting_canceled`](/messaging/customer-chat-api/v3.2/rtm-reference/#greeting_canceled).
