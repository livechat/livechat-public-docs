...
- The response of the [**Login**](/messaging/customer-chat-api/v3.2/rtm-reference/#login) method was extended with the `greeting` object. The returned customer data was moved from `__priv_dynamic_config` to the `customer` object.
