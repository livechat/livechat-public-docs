...
- **Get URL details** ([Web](/messaging/customer-chat-api/v3.2/#get-url-details) & [RTM](/messaging/customer-chat-api/v3.2/rtm-reference/#get-url-details)) now returns the `image_original_URL` parameter.
...
- Many methods and pushes have been renamed:
    ...
    * method: **Get License Properties** -> **List License Properties**
    * method: **Get Group Properties** -> **List Group Properties**
    * method: **Get Chats Summary** -> **List Chats**
    * method: **Update Chat Thread Properties** -> **Update Thread Properties** and push: **Chat Thread Propertiess Updated** -> **Thread Propertiess Updated**
    * method: **Delete Chat Thread Properties** -> **Delete Thread Properties** and push: **Chat Thread Propertiess Deleted** -> **Thread Propertiess Deleted**
