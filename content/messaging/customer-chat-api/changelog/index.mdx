...
### Added
- There are 5 new methods: **Get Customer** ([Web](/messaging/customer-chat-api/v3.2/#get-customer) & [RTM](/messaging/customer-chat-api/v3.2/rtm-reference/#get-customer)), **Accept Greeting** ([Web](/messaging/customer-chat-api/v3.2/#accept-greeting) & [RTM](/messaging/customer-chat-api/v3.2/rtm-reference/#accept-greeting)), **Reject Greeting** ([Web](/messaging/customer-chat-api/v3.2/#reject-greeting) & [RTM](/messaging/customer-chat-api/v3.2/rtm-reference/#reject-greeting)), **Get License Properties** ([Web](/messaging/customer-chat-api/v3.2/#get-license-properties)), and **Get Group Properties** ([Web](/messaging/customer-chat-api/v3.2/#get-group-properties)).
- There are 2 new pushes: [`incoming_greeting`](/messaging/customer-chat-api/v3.2/rtm-reference/#incoming_greeting) and [`greeting_cancelled`](/messaging/customer-chat-api/v3.2/rtm-reference/#greeting_cancelled).
