...
| `properties` | optionally |                                                                                                                                                                                                                                                                                           |
| `form_id`    | always     |                                                                                                                                                                                                                                                                                           |
| `form_type`  | optionally | The most popular form types include: prechat_survey, postchat_survey, ask_for_email, but those aren’t the only possible options. If you don’t see this field in a chat, it means that chat had been started before we introduced this field (see [Changelog](../../changelog/index.mdx)). |
