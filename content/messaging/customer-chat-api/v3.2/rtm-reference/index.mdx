...
| Field                   | Sending    | Data type               |  Notes                                                                                                   |
| ------------------------| :--------: | ----------------------- | -------------------------------------------------------------------------------------------------------: |
| `custom_id`             | optional   | `string`                |                                                                                                          |
| `type`                  | required   | `string`                | `filled_form`                                                                                            |
| `recipients`            | required   | `string`                | Possible values: `all` (default), `agents`                                                               |
| `properties`            | optional   | [`object`](#properties) |                                                                                                          |
| `form_id`               | ?          | `string`                | ?                                                                                                        |
| `fields`                | required   | `array of objects`      | The fields a form contains.                                                                              |
| `fields.type`           | required   | `string`                | Possible values: `checkbox`, `email`, `name`, `question`, `textarea`, `group_chooser`, `radio`, `select` |
| `fields.id`             | ?          | `string`                | For all field types                                                                                      |
| `fields.label`          | required   | `string`                | For all field types                                                                                      |
| `fields.answer`         | N/A        | `any`                   | For `email`, `name, `radio`, `group_chooser`                                                         |
| `fields.answer.id`      | N/A        | `string`                | For `email`, `name, `radio`, `group_chooser`                                                         |
| `fields.answer.label`   | required   | `string`                | For `email`, `name, `radio`, `group_chooser`                                                         |
| `fields.answer.group_id`| required   | `number`                | For `group_chooser`                                                                                      |
| `fields.answers`        | required   | `array of objects`      | For `checkbox`                                                                                           |
| `fields.answers.id`     | required   | `string`                | For `checkbox`                                                                                           |
| `fields.answers.label`  | required   | `string`                | For `checkbox`                                                                                           |
...
| `created_at`            | always      | Generated server-side; Date & time format with a resolution of microseconds, `UTC string`. |
| `type`                  | always      | |
...
| `fields.id`             | ?           |  |
| `fields.label`          | always      |  |
| `fields.answer`         | optionally  |  |
| `fields.answer.id`      | optionally  |  |
| `fields.answer.label`   | always      |  |
| `fields.answer.group_id`| always      |  |
| `fields.answers`        | always      |  |
| `fields.answers.id`     | always      |  |
| `fields.answers.label`  | always      |  |
