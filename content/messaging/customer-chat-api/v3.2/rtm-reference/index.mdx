...
| `content_type`                                        | yes      | `string`  | Supported image types: `image/png`, `image/jpeg`, `image/gif`       |
...
| `name`                              | always          | Generated server-side                                               |
| `url`                               | always          |                                                                     |
| `thumbnail_url`, `thumbnail2x_url`  | only for images | Generated server-side                                               |
| `content_type`                      | always          | Generated server-side                                               |
| `size`, `width`, `height`           | only for images | Generated server-side                                               |
...
| `fields.type`           | yes      | `string`                | Possible values: `checkbox`, `email`, `name`, `question`, `textarea`, `group_chooser`, `radio`, `select` |
| `fields.id`             | yes      | `string`                | Field id, for all field types                                                                            |
| `fields.label`          | yes      | `string`                | Field label; for all field types                                                                         |
| `fields.answer`         | yes      | `any`                   | For all field types                                                                                      |
| `fields.answer.id`      | yes      | `string`                | Answer id; for all field types                                                                           |
| `fields.answer.label`   | yes      | `string`                | Answer label; for all field types                                                                        |
| `fields.answer.group_id`| yes      | `number`                | For `group_chooser`                                                                                      |
