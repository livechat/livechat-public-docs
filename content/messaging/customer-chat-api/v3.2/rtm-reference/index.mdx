...
This document describes the **Customer Chat Real-Time Messaging API v3.2**. This is the **developer preview** version recommended only for the **experimental** use. [Read more about versioning...](/messaging/#api-versioning)
