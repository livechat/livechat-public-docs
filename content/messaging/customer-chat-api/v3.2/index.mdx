...
```shell
curl -X GET \
  'https://api.livechatinc.com/v3.2/customer/action/public/get_license_properties?license_id=123&namespace=58737b5829e65621a45d598aa6f2ed81&name=my_integer_property_name' \
  -H 'Content-Type: application/json' \
  -d '{}'
```
...
| ---------------------- | -------------------------------------------------------------------------------- |
| **HTTP Method**        | **GET**                                                                          |
| **Method URL**         | `https://api.livechatinc.com/v3.2/customer/action/public/get_group_properties`   |
| **RTM API equivalent** | -                                                                                |
| **Webhook**            | -                                                                                |
...
```shell
curl -X GET \
  'https://api.livechatinc.com/v3.2/customer/action/public/get_license_properties?license_id=123&group=10&namespace=58737b5829e65621a45d598aa6f2ed81&name=my_integer_property_name' \
  -H 'Content-Type: application/json' \
  -d '{}'
```
