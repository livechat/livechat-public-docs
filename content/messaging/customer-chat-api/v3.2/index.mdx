...
| `custom_id`           | optional  |                                                                                                                                   |
| `recipients`          | optional  | It can be specified when sending a system messages via the [**Send Event**](#send-event) method. Possible values: `all`, `agents` |
...
| `unique_id`   | Yes      | `string`  | ID of the greeting to accept.                               |
