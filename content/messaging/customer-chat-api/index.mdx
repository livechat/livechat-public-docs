...
"values": [{"key": "api_version", "value": "3.1", "enabled": true},{"key": "access_token","value": "<your_access_token>","enabled": true}],"_postman_variable_scope": "environment","_postman_exported_at": "2019-09-19T10:24:52.465Z","_postman_exported_using": "Postman/7.6.0"}))}`} download="environment.json">environment.json</a> with already defined variables.

<a href="https://app.getpostman.com/run-collection/521935b4232b6f924644" target="_blank"><img src="https://run.pstmn.io/button.svg"></img></a>
