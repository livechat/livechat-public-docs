...
This document describes the **Customer Chat Web API v3.1**. vvvvvvv
...
| `postback.thread_id` | yes      | `string`  | ID of the thread with the rich messsage event.                                                                                |
...
| `postback.type`      | optionally | Appears onnly if `postback.value` is present.                       |
