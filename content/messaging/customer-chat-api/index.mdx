...
<CodeResponseNew version="v3.2" type="customer" title={'Sample File in response'} json="file"/>
...
<CodeResponseNew version="v3.2" type="customer" title={'Sample Filled form in response'} json="filledForm"/>
...
<Code>
<CodeResponseNew version="v3.2" type="customer" title={'Sample Message in response'} json="message"/>
</Code>
...
<Code>
<CodeResponseNew version="v3.2" type="customer" title={'Sample Rich message in response'} json="richMessage"/>
</Code>
</Section>
...
<Code>
<CodeResponseNew version="v3.2" type="customer" title={'Sample Custom event in response'} json="custom"/>
</Code>
</Section>
...
<Code>
<CodeResponseNew version="v3.2" type="customer" title={'Sample System message in response'} json="systemMessage"/>
</Code>
</Section>
...
<CodeResponseNew version="v3.2" type="customer" title={'Sample Customer data structure'} json="customer"/>
...
<CodeResponseNew version="v3.2" type="customer" title={'Sample Agent data structure'} json="agent"/>
...
<CodeResponseNew version="v3.2" type="customer" title={'Sample Access data structure'} json="access"/>
...
<CodeResponseNew version="v3.2" type="customer" title={'Sample Chat data structure'} json="chat"/>
...
<CodeResponseNew version="v3.2" type="customer" title={'Sample Chat summary data structure'} json="chatSummary"/>

## Form fields

A component of the [Filled form](#filled-form) event.

<CodeResponseNew version="v3.2" type="customer" title={'Sample Form fields'} json="formFields"/>
...
<CodeResponseNew version="v3.2" type="customer" title={'Sample Properties data structure'} json="properties"/>

## Threads

<CodeResponseNew version="v3.2" type="customer" title={'Sample Thread data structure'} json="thread"/>
