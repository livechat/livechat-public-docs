...
| **Webhook**            | [`incoming_event`](#incoming_event) and [`thread_closed`](#thread_closed) |
...
Webhooks notify you when specific events are triggered. Webhooks equivalents in Customer Chat RTM API are [pushes](/messaging/customer-chat-api/rtm-reference/#pushes).
