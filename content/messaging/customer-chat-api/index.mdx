...
import ca_custom from "../../../payloads/messaging/v3.2/customer-chat-api/events/ca_custom.json"
import ca_file from "../../../payloads/messaging/v3.2/customer-chat-api/events/ca_file.json"
import ca_filledForm from "../../../payloads/messaging/v3.2/customer-chat-api/events/ca_filledForm.json"
import ca_message from "../../../payloads/messaging/v3.2/customer-chat-api/events/ca_message.json"
import ca_richMessage from "../../../payloads/messaging/v3.2/customer-chat-api/events/ca_richMessage.json"
import ca_systemMessage from "../../../payloads/messaging/v3.2/customer-chat-api/events/ca_systemMessage.json"

import ca_agent from "../../../payloads/messaging/v3.2/customer-chat-api/users/ca_agent.json"
import ca_customer from "../../../payloads/messaging/v3.2/customer-chat-api/users/ca_customer.json"

import ca_access from "../../../payloads/messaging/v3.2/customer-chat-api/other-structures/ca_access.json"
import ca_chat from "../../../payloads/messaging/v3.2/customer-chat-api/other-structures/ca_chat.json"
import ca_chatSummary from "../../../payloads/messaging/v3.2/customer-chat-api/other-structures/ca_chatSummary.json"
import ca_formFields from "../../../payloads/messaging/v3.2/customer-chat-api/other-structures/ca_formFields.json"
import ca_properties from "../../../payloads/messaging/v3.2/customer-chat-api/other-structures/ca_properties.json"
import ca_thread from "../../../payloads/messaging/v3.2/customer-chat-api/other-structures/ca_thread.json"

# Introduction

## Versioning

This document describes the **Customer Chat Web API v3.2**. This is the latest stable version recommended for the production use. [Read more about versioning...](/messaging/#api-versioning)
...
<CodeResponse title={'Sample File in response'} json={ca_file}/>
...
<CodeResponse title={'Sample Filled form in response'} json={ca_filledForm}/>
...
<Code>
<CodeResponse title={'Sample Message in response'} json={ca_message}/>
</Code>
...
<Code>
<CodeResponse title={'Sample Rich message in response'} json={ca_richMessage}/>
</Code>
</Section>
...
<Code>
<CodeResponse title={'Sample Custom event in response'} json={ca_custom}/>
</Code>
</Section>
...
<Code>
<CodeResponse title={'Sample System message in response'} json={ca_systemMessage}/>
</Code>
</Section>
...
<CodeResponse title={'Sample Customer data structure'} json={ca_customer}/>
...
<CodeResponse title={'Sample Agent data structure'} json={ca_agent}/>
...
<CodeResponse title={'Sample Access data structure'} json={ca_access}/>
...
<CodeResponse title={'Sample Chat data structure'} json={ca_chat}/>
...
<CodeResponse title={'Sample Chat summary data structure'} json={ca_chatSummary}/>

## Form fields

A component of the [Filled form](#filled-form) event.

<CodeResponse title={'Sample Form fields'} json={ca_formFields}/>
...
<CodeResponse title={'Sample Properties data structure'} json={ca_properties}/>

## Threads

<CodeResponse title={'Sample Thread data structure'} json={ca_thread}/>
