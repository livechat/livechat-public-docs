...
- [Authorization in practice](/getting-started/authorization/authorization-in-practice/)
...
5. In <a href="https://developers.livechatinc.com/console/" target="_blank" rel="noopener noreferrer">Developer Console</a>, go to the **Authorization** building block of your app. Copy **Client Id** and paste it into the `.env` file in the **example** folder.
