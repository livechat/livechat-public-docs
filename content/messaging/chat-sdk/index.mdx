...
2. Configure the **Authorization** building block by entering _http://localhost:3000/_ in **Redirect URI whitelist** and by adding the following scopes:
    - chats--my:ro
    - chats.conversation--all:rw
    - chats.conversation--access:rw
    - chats.conversation--my:rw

3. Go to **Private installation** and install the app.

4. Paste your **Client Id** into the `.env` file in the **example** folder.
