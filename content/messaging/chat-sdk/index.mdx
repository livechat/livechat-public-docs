...
4. Clone the <a href="https://github.com/livechat/chat-sdk/" target="_blank">Chat SDK repository</a> from GitHub.

5. In <a href="https://developers.livechatinc.com/console/" target="_blank">Developer Console</a>, go to the **Authorization** building block of your app. Copy **Client Id** and paste it into the `.env` file in the **example** folder.

5. Run **Simple Agent** with the following commands:
