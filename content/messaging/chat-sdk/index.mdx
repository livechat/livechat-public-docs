...
1. [Create an app](/getting-started/guides/#creating-livechat-apps) in Developer Console. You need it to get a **Client Id**. Once the app is created, you can find it in
**Building Blocks -> Authorization** in Developer Console.

2. Paste the **Client Id** into the `.env` file.

3. Fire **Simple Agent** with the following command:
