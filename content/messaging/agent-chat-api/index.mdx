...
Rich message event contains a rich message data structure. Rich messages are so powerful that we dedicated them a [separate doc](/extending-ui/extending-chat-widget/rich-messages/).
