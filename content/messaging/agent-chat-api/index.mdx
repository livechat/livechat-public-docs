...
<Code>
<CodeResponseNew version="v3.2" type="agent" title={'Sample File in response'} json="file"/>
</Code>
</Section>
...
<Code>
<CodeResponseNew version="v3.2" type="agent" title={'Sample Filled form in response'} json="filledForm"/>
</Code>
</Section>
...
<Code>
<CodeResponseNew version="v3.2" type="agent" title={'Sample Message in response'} json="message"/>
</Code>
</Section>
...
<Code>
<CodeResponseNew version="v3.2" type="agent" title={'Sample Rich message in response'} json="richMessage"/>
</Code>
</Section>
...
<Code>
<CodeResponseNew version="v3.2" type="agent" title={'Sample Custom event in response'} json="custom"/>
</Code>
</Section>
...
<Code>
<CodeResponseNew version="v3.2" type="agent" title={'Sample System message in response'} json="systemMessage"/>
</Code>
</Section>
...
<CodeResponseNew version="v3.2" type="agent" title={'Sample Agent data structure'} json="agent"/>
...
<CodeResponseNew version="v3.2" type="agent" title={'Sample My profile data structure'} json="myProfile"/>

## Customer

<CodeResponseNew version="v3.2" type="agent" title={'Sample Customer data structure'} json="customer"/>
...
<CodeResponseNew version="v3.2" type="agent" title={'Sample Access data structure'} json="access"/>
...
<CodeResponseNew version="v3.2" type="agent" title={'Sample Chat data structure'} json="chat"/>
...
<CodeResponseNew version="v3.2" type="agent" title={'Sample Chat summary data structure'} json="chatSummary"/>

## Form fields

A component of the [Filled form](#filled-form) event.

<CodeResponseNew version="v3.2" type="agent" title={'Sample Form fields'} json="formFields"/>
...
<CodeResponseNew version="v3.2" type="agent" title={'Sample Properties data structure'} json="properties"/>

## Threads

<CodeResponseNew version="v3.2" type="agent" title={'Sample Thread data structure'} json="thread"/>
