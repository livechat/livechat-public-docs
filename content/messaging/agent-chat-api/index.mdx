...
| **Other**       | [`mark_events_as_seen`](#mark-event-as-seen) [`send_typing_indicator`](#send-typing-indicator) [`multicast`](#multicast)                                                                                                                                                                                 |
...
| **RTM API equivalent** | [`mark_events_as_seen`](../agent-chat-rtm-api-v3.1/#mark-events-as-seen)<sup>[![LiveChat Link](link.svg)](../agent-chat-rtm-api-v3.1/#mark-events-as-seen)</sup> |
