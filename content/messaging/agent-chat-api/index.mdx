...
import fileEventPayload from "./payloads/events/file.json"
import filledFormEventPayload from "./payloads/events/filled-form.json"
import messageEventPayload from "./payloads/events/message.json"
import richMessageEventPayload from "./payloads/events/rich-message.json"
import customEventPayload from "./payloads/events/custom.json"
import systemMessageEventPayload from "./payloads/events/system-message.json"

# Introduction
  
## Versioning

This document describes the **Agent Chat Web API v3.1**. This is the latest stable version recommended for the production use. [Read more about versioning...](/messaging/#api-versioning)
...
<Scopes
  title="Agents scopes"
  scopes="agents--my:rw,agents--all:rw,access_rules:ro,access_rules:rw"
/>

<Scopes
  title="Bot Agents scopes"
...
<Code>
<CodeResponse title={'Sample File in response'} json={fileEventPayload} />
...
<Code>
<CodeResponse title={'Sample Filled form in response'} json={filledFormEventPayload} />
</Code>
</Section>
...
<Code>
<CodeResponse title={'Sample Message in response'} json={messageEventPayload} />
</Code>
</Section>
...
<Code>
<CodeResponse title={'Sample Rich message in response'} json={richMessageEventPayload} />
</Code>
</Section>
...
<Code>
<CodeResponse title={'Sample Custom in response'} json={customEventPayload} />
</Code>
</Section>
...
<Code>
<CodeResponse title={'Sample System message in response'} json={systemMessageEventPayload} />
</Code>
...
- When using RTM API, you can be also notified about events with [pushes](/messaging/agent-chat-api/rtm-reference/#pushes).
