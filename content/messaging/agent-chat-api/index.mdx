...
| `elements.buttons.value` <sup>1</sup> | yes      | `string`  | Should be used together with `elements.buttons.type`.                                                                                                                                                                                            |
...
**1)** If you're embedding a static page into your [Moment](/extending-chat-widget/chat-widget-moments/), you can overwrite the default Moment title (Moment’s URL) by passing your custom title as the `moment-title` query string parameter.

For example: `"value": "https://my-moment-url.com/?moment-title=my-custom-title"`
...
| **Webhook**            | [`chat_transferred`](/management/configuration-api/v3.3/#chat_transferred) |
