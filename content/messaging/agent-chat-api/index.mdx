...
This document describes the **Agent Chat Web API v3.1**. This is the latest stable version recommended for the production use. [Read more about versionig...](/messaging/#api-versioning)
