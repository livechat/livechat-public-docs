...
import aa_custom from "../../../payloads/messaging/v3.2/agent-chat-api/events/aa_custom.json"
import aa_file from "../../../payloads/messaging/v3.2/agent-chat-api/events/aa_file.json"
import aa_filledForm from "../../../payloads/messaging/v3.2/agent-chat-api/events/aa_filledForm.json"
import aa_message from "../../../payloads/messaging/v3.2/agent-chat-api/events/aa_message.json"
import aa_richMessage from "../../../payloads/messaging/v3.2/agent-chat-api/events/aa_richMessage.json"
import aa_systemMessage from "../../../payloads/messaging/v3.2/agent-chat-api/events/aa_systemMessage.json"

import aa_agent from "../../../payloads/messaging/v3.2/agent-chat-api/users/aa_agent.json"
import aa_myProfile from "../../../payloads/messaging/v3.2/agent-chat-api/users/aa_myProfile.json"
import aa_customer from "../../../payloads/messaging/v3.2/agent-chat-api/users/aa_customer.json"

import aa_access from "../../../payloads/messaging/v3.2/agent-chat-api/other-structures/aa_access.json"
import aa_chat from "../../../payloads/messaging/v3.2/agent-chat-api/other-structures/aa_chat.json"
import aa_chatSummary from "../../../payloads/messaging/v3.2/agent-chat-api/other-structures/aa_chatSummary.json"
import aa_formFields from "../../../payloads/messaging/v3.2/agent-chat-api/other-structures/aa_formFields.json"
import aa_properties from "../../../payloads/messaging/v3.2/agent-chat-api/other-structures/aa_properties.json"
import aa_thread from "../../../payloads/messaging/v3.2/agent-chat-api/other-structures/aa_thread.json"

# Introduction

## Versioning

This document describes the **Agent Chat Web API v3.2**. This is the latest stable version recommended for the production use. [Read more about versioning...](/messaging/#api-versioning)
