...
Informs that a new bot was added. The payload contains the full state of the [bot](/messaging/agent-chat-api/v3.4/#bot) data structure, including empty fields.
...
Informs that a group was created within a license. The payload contains the full state of the [group](/messaging/agent-chat-api/v3.4/#group) data structure, including empty fields.
