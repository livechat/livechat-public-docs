...
Informs that a new agent account was created. Push will contain full state of agent rule resource - empty fields won't be omitted.
...
Informs that a new [auto access](/management/configuration-api/v3.4/#auto-access) rule was added. Push will contain full state of auto access rule resource - empty fields won't be omitted. Updating rule may result in multiple [`auto_access_updated`](#auto_access_updated) pushes, depending on `next_id` value
...
Informs that the configration of an [auto access](/management/configuration-api/v3.4/#auto-access) rule changed. Contains only the updated properties. Updating rule may result in multiple [`auto_access_updated`](#auto_access_updated) webhooks, depending on `next_id` value
...
Informs that an [auto access](/management/configuration-api/v3.4/#auto-access) rule was deleted. Deleting rule may result in multiple [`auto_access_updated`](#auto_access_updated) webhooks, depending on rule `next_id` value
...
Informs that a new bot was added. Push will contain full state of bot resource - empty fields won't be omitted.
...
Informs that a group was created within a license. Push will contain full group resource - empty fields won't be omitted.
