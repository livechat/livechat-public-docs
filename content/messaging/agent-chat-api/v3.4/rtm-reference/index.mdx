...
Adds a user to the chat. The chat must be active. You can't add more than one `customer` user type to the chat.
...
Informs that a new [auto access](/management/configuration-api/v3.4/#auto-access) rule was added.
