...
<!-- > **`deactivate_chat`** sample **request** with optional params
...
<!-- > **`grant_chat_access`** sample **request** with optional params
```json
{
	"request_id": "680",
	"payload": {
...
<!-- > **`set_chat_access`** sample **request** with optional params
...
<!-- > **`tag_thread`** sample **request** with optional params
...
<!-- > **`untag_thread`** sample **request** with optional params
...
| **Webhook equivalent** | [`chat_access_granted`](/management/configuration-api/#chat_access_granted) |
...
| **Webhook equivalent** | [`chat_access_revoked`](/management/configuration-api/#chat_access_revoked) |
...
| **Webhook equivalent** | [`chat_access_set`](/management/configuration-api/#chat_access_set) |
