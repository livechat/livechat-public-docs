...
| `chat.users`             | No       | `array`   | The list of existing users. Up to 4 additional agents and 1 customer allowed. |
...
| `chat.users`             | No       | `array`  | List of existing users. Up to 4 additional agents and 1 customer allowed. |
| `chat.thread`            | No       | `object` |                                                                     |
