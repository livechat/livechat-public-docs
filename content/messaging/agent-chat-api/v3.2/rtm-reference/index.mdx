...
| `filters.agent_ids`                                   | No       | `array`   | Array of agent IDs (Deprecated, use `agents`)                                             || `filters.thread_ids`                                  | No       | `array`   | Array of thread IDs. Cannot be used with other filters or pagination; max array size: 20. |
| `filters.group_ids`                                   | No       | `array`   | Array of group IDs. Max array size: 200                                                   |
