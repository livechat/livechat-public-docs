...
It returns Agents to whom you could transfer a chat. Agents are sorted ascendingly by the total number of active chats they have. Offline Agents aren't returned.
...
| **Required scopes**    | -                                                                      |
| **RTM API equivalent** | [`get_active_chat_count`](rtm-reference/#get-agents-for-transfer)      |
| **Webhook**            | -                                                                      |
