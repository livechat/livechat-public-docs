...
| **Required scopes**    | `agents--my:rw` `agents--all:rw` (for Agents); `agents-bot--my:rw` `agents-bot--all:rw` (for Bot Agents)|
| **RTM API equivalent** | [`set_routing_status`](/v3.2/rtm-reference/#set-routing-status)                 |
