...
This document describes the **Agent Chat Web API v3.2**.
...
**Agent authentication** is handled by access tokens. Find out how to get an **access token** from [Agent authorization flows](/getting-started/authorization/#agent-authorization-flows). Take note **you won't be able to use this token** for the Customer Chat API.

All authorization scopes are listed in the [Scopes](#scopes) section. If a method requires certain scopes, you'll find them included in the method description. Keep in mind that Web API requires authorization every time you make a request.
...
| **Other**       | [`mark_events_as_seen`](#mark-events-as-seen) [`send_typing_indicator`](#send-typing-indicator) [`multicast`](#multicast) [`get_agents_chat_load`](#get-agents-chat-load)                                                                                                                                                                               |
...
|                        |                                                                   |
| ---------------------- | ----------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.2/agent/action/get_chats_summary` |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.2/agent/action/get_chats_summary \
...
|                        |                                                              |
| ---------------------- | ------------------------------------------------------------ |
| **Method URL**         | `https://api.livechatinc.com/v3.2/agent/action/get_archives` |
| **Required scopes**    | `chats--all:ro` `chats--access:ro`                           |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.2/agent/action/get_archives \
  -H 'Authorization: Bearer <your_access_token>' \
  -H 'Content-Type: application/json' \
  -d '{}'
```
...
| **Webhook**            | [`incoming_chat_thread`](/management/configuration-api/#incoming-chat-thread)            |
...
|                        |                                                                 |
| ---------------------- | --------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.2/agent/action/close_thread`    |
| **Required scopes**    | `chats--all:rw` `chats--access:rw` `chats--my:rw`               |
| **RTM API equivalent** | [`close_thread`](rtm-reference/#close-thread)                   |
| **Webhook**            | [`thread_closed`](/management/configuration-api/#thread_closed) |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.2/agent/action/close_thread \
  -H 'Authorization: Bearer <your_access_token>' \
  -H 'Content-Type: application/json' \
  -d '{
      "chat_id": "PJ0MRSHTDG"
...
|                        |                                                                   |
| ---------------------- | ----------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.2/agent/action/grant_access`      |
| **Required scopes**    | `chats--all:rw` `chats--access:rw` `chats--my:rw`                 |
| **RTM API equivalent** | [`grant_access`](rtm-reference/#grant-access)                     |
| **Webhook**            | [`access_granted`](/management/configuration-api/#access_granted) |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.2/agent/action/grant_access \
-H 'Authorization: Bearer <your_access_token>' \
-H 'Content-Type: application/json' \
-d '{
    "resource": "chat",
...
|                        |                                                                   |
| ---------------------- | ----------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.2/agent/action/revoke_access`     |
| **Required scopes**    | `chats--all:rw` `chats--access:rw` `chats--my:rw`                 |
| **RTM API equivalent** | [`revoke_access`](rtm-reference/#revoke-access)                   |
| **Webhook**            | [`access_revoked`](/management/configuration-api/#access_revoked) |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.2/agent/action/revoke_access \
-H 'Authorization: Bearer <your_access_token>' \
-H 'Content-Type: application/json' \
-d '{
   "resource": "chat",
...
|                        |                                                            |
| ---------------------- | ---------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.2/agent/action/set_access` |
| **Required scopes**    | `chats--all:rw` `chats--access:rw` `chats--my:rw`          |
| **RTM API equivalent** | [`set_access`](rtm-reference/#set-access)                  |
| **Webhook**            | [`access_set`](/management/configuration-api/#access_set)  |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.2/agent/action/set_access \
-H 'Authorization: Bearer <your_access_token>' \
-H 'Content-Type: application/json' \
-d '{
   "resource": "chat",
...
|                        |                                                                                                   |
| ---------------------- | ------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.2/agent/action/update_chat_thread_properties`                     |
| **Required scopes**    | `chats.conversation--all:rw` `chats.conversation--access:rw` `chats.conversation--my:rw`          |
...
```shell
curl -X POST \
  https://api.livechatinc.com/v3.2/agent/action/update_chat_thread_properties \
  -H 'Authorization: Bearer <your_access_token>' \
  -H 'Content-Type: application/json' \
  -d '{
      "chat_id": "Q1WZ073OA7",
...
|                        |                                                                                                   |
| ---------------------- | ------------------------------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.2/agent/action/delete_chat_thread_properties`                     |
| **Required scopes**    | `chats.conversation--all:rw` `chats.conversation--access:rw` `chats.conversation--my:rw`          |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.2/agent/action/delete_chat_thread_properties \
-H 'Authorization: Bearer <your_access_token>' \
-H 'Content-Type: application/json' \
-d '{
    "chat_id": "Q1WZ073OA7",
...
|                        |                                                                           |
| ---------------------- | ------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.2/agent/action/tag_chat_thread`           |
| **Required scopes**    | `chats--all:rw` `chats--access:rw` `chats--my:rw`                         |
| **RTM API equivalent** | [`tag_chat_thread`](rtm-reference/#tag-chat-thread)                       |
| **Webhook**            | [`chat_thread_tagged`](/management/configuration-api/#chat_thread_tagged) |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.2/agent/action/tag_chat_thread \
-H 'Authorization: Bearer <your_access_token>' \
-H 'Content-Type: application/json' \
-d '{
    "chat_id": "PW94SJTGW6",
...
|                        |                                                                               |
| ---------------------- | ----------------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.2/agent/action/untag_chat_thread`             |
| **Required scopes**    | `chats--all:rw` `chats--access:rw` `chats--my:rw`                             |
| **RTM API equivalent** | [`untag_chat_thread`](rtm-reference/#untag-chat-thread)                       |
| **Webhook**            | [`chat_thread_untagged`](/management/configuration-api/#chat_thread_untagged) |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.2/agent/action/untag_chat_thread \
-H 'Authorization: Bearer <your_access_token>' \
-H 'Content-Type: application/json' \
-d '{
    "chat_id": "PW94SJTGW6",
...
|                        |                                                               |
| ---------------------- | ------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.2/agent/action/get_customers` |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.2/agent/action/get_customers \
-H 'Authorization: Bearer <your_access_token>' \
-H 'Content-Type: application/json' \
-d '{}'
```
...
### Get Agents Chat Load

It returns a **chat load** - the total number of active chats an Agent has. Agent's chats from **all groups** are taken into account.

The `group_ids` parameter, which you need to specify in the request, works as a filter. To understand it better, consider the following situation. 

1. You specify `"group_ids" : [0, 1, 2, 3]` in your request.
2. The method checks which Agents from these groups are currently accepting chats. 
3. Then, it calculates the chat loads for each of those Agents. 
4. Chat loads (active chats per Agent) are returned.

If you look at the sample request and response, you'll notice that the chat load for **agent1@example.com** is 5. There are several possible scenarios:
- **agent1** had 5 chats in one of the groups.
- **agent1** had 3 chat in one group and 2 chats in another.
- other combinations

Another possibility is that **agent1** had 1 chat in each group and 1 chat in **group 4**. Even though this group wasn't specified in the request, chats from all groups are added up when calculating an Agent's chat load.

If there was **agent3** having chats in **groups 4 and 5**, but you would only request **groups 0, 1, 2, 3**, you wouldn't get the chat load for this Agent.
...
|                        |                                                                       |
| ---------------------- | --------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.2/agent/action/get_agents_chat_load`  |
| **Required scopes**    | -                                                                     |
| **RTM API equivalent** | [`get_agents_chat_load`](rtm-reference/#get-agents-chat-load)         |
| **Webhook**            | -                                                                     |
...
| Parameter    | Required | Data type | Notes                                                |
| ------------ | -------- | --------- | ---------------------------------------------------- |
| `group_ids`  | Yes      | `array`   | Groups in which you want to search for Agents        |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.2/agent/action/get_agents_chat_load \
-H 'Authorization: Bearer <your_access_token>' \
-H 'Content-Type: application/json' \
-d '{
    "group_ids": [0,1,2,3]
