...
This documentation describes the **Agent Chat Real-Time Messaging API v3.1**. This is the latest stable version recommended for the production use. [Read more about versioning...](/messaging/#api-versioning)
