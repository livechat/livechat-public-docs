...
<<<<<<< HEAD:content/messaging/agent-chat-api/v3.2/rtm-reference/index.mdx
...
>>>>>>> Manually moved files to switch versions:content/messaging/agent-chat-api/v3.1/rtm-reference/index.mdx
### `chat_transferred`
