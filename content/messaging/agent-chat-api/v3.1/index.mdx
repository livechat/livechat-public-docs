...
<Code>
<CodeResponse version="v3.1" type="agent" title={'Sample File in response'} json="file" />
...
<Code>
<CodeResponse version="v3.1" type="agent" title={'Sample Filled form in response'} json="filledForm" />
</Code>
</Section>
...
<Code>
<CodeResponse version="v3.1" type="agent" title={'Sample Message in response'} json="message" />
</Code>
</Section>
...
<Code>
<CodeResponse version="v3.1" type="agent" title={'Sample Rich message in response'} json="richMessage" />
</Code>
</Section>
...
<Code>
<CodeResponse version="v3.1" type="agent" title={'Sample Custom in response'} json="custom" />
</Code>
</Section>
...
<Code>
<CodeResponse version="v3.1" type="agent" title={'Sample System message in response'} json="systemMessage" />
</Code>
