...
<Errors errors="authentication,authorization,entity_too_large,internal,license_expired,license_not_found,misdirected_request,request_timeout,unsupported_version,validation,wrong_product_version,too_many_requests"/>
