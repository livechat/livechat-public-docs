...
| `properties` | Yes      | `object`  | Chat properties to set. You should stick to the <a href="/docs/management/configuration-api/#properties" target="_blank"> general properties format</a> and include _namespace_, _property name_ and _value_. |
...
| `properties` | Yes      | `object`  | Chat properties to delete. You should stick to the <a href="/docs/management/configuration-api/#properties" target="_blank"> general properties format</a> and include _namespace_, _property name_ and _value_. |
...
| `properties` | Yes      | `object`  | Chat thread properties to delete. You should stick to the <a href="/docs/management/configuration-api/#properties" target="_blank"> general properties format</a> and include _namespace_, _property name_ and _value_. |
...
| `properties` | Yes      | `object`  | Event properties to delete. You should stick to the <a href="/docs/management/configuration-api/#properties" target="_blank"> general properties format</a> and include _namespace_, _property name_ and _value_. |
