...
To set correct agent/bot name use `author_id` property in payload.
...
| `pushes`                            | No       | `object`  | A map of push subscriptions. By default, it's set to `all` for the version of your currently established RTM connection.                                                                      |
...
```json
{
  ...
  "payload": {
    ...
    "pushes": {
      "v3.3": ["incoming_chat", "incoming_multicast"],
      "v3.4": ["all"]
    }
  }
}
