...
| `attach_to_last_thread` | No       | `bool`    | If `true`, adds event to last thread. Otherwise, it creates a new one; default `false`. |
...
| **Web API equivalent** | [`mark_events_as_seen`](../agent-chat-web-api-v3.1/#mark-events-as-seen) <sup>[![LiveChat Link](link.svg)](../agent-chat-web-api-v3.1/#mark-events-as-seen)</sup> |
