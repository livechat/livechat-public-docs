...
### `incoming_sneak_peek`
Informs about the message a Customer is currently typing. The push payload contains the [sneak peek](https://www.livechatinc.com/features/chat-tools/#Message-sneak-peak) content.
