...
desc: "Build powerful LiveChat integrations with open messaging protocol. Send chat messages as an agent using Agent Chat RTM API."
---
...
**Not what you're looking for?** Perhaps, you need to use [**Agent Chat Web API**](../agent-chat-web-api-v3.1) instead.

## Authentication

**Agent authentication** is handled by access tokens. Find out how to get an **access token** from [Agent authorization flows](../beta-authorization/#agent-authorization-flows). Client must authorize himself by [logging in](#login) within 30 seconds, otherwise the connection will be closed.
...
<Code>
<CodeSample path={'RTM API request format'}>
...
| **Web API equivalent** | [`get_chats_summary`](../#get_chats_summary)      |
| **Push message**       | -                                                 |
...
| Parameter       | Data type | Notes                           |
| --------------- | --------- | ------------------------------- |
| `found_threads` | `string`  | The number of threads in a chat |
...
| **Action**             | `send_event`                                                                             |
| **Required scopes**    | `chats.conversation--all:rw` `chats.conversation--access:rw` `chats.conversation--my:rw` |
| **Web API equivalent** | [`send_event`](../#send_event)                                                           |
| **Push message**       | -                                                                                        |
...
| **Chat access** | [`access_granted`](#access_granted) [`access_revoked`](#access_revoked) [`access_set`](#access_set) [`chat_transferred`](#chat_transferred)                                                                                                                                                                                                                         |
...
| **Webhook equivalent** | [`incoming_chat_thread`](../agent-chat-web-api/#incoming-chat-thread) |
...
| **Webhook equivalent** | [`thread_closed`](../agent-chat-web-api/#thread-closed) |
...
| **Webhook equivalent** | [`access_granted`](../agent-chat-web-api/#access-granted) |
...
| **Webhook equivalent** | [`access_revoked`](../agent-chat-web-api/#access-revoked) |
...
| ---------------------- | ------------------------------------------------- |
| **Action**             | `access_set`                                      |
| **Webhook equivalent** | [`access_set`](../agent-chat-web-api/#access-set) |
...
| **Webhook equivalent** | [`chat_user_added`](../agent-chat-web-api/#chat-user-added) |
...
| **Webhook equivalent** | [`chat_user_removed`](../agent-chat-web-api/#chat-user-removed) |
...
| **Webhook equivalent** | [`incoming_event`](../agent-chat-web-api/#incoming-event) |
...
| **Webhook equivalent** | [`event_updated`](../agent-chat-web-api/#event-updated) |
...
| **Webhook equivalent** | [`incoming_rich_message_postback`](../agent-chat-web-api/#incoming-rich-message-postback) |
...
| **Webhook equivalent** | [`chat_properties_updated`](../agent-chat-web-api/#chat-properties-updated) |
...
| **Webhook equivalent** | [`chat_properties_deleted`](../agent-chat-web-api/#chat-properties-deleted) |
...
| **Webhook equivalent** | [`chat_thread_properties_updated`](../agent-chat-web-api/#chat-thread-properties-updated) |
...
| **Webhook equivalent** | [`chat_thread_properties_deleted`](../agent-chat-web-api/#chat-thread-properties-deleted) |
...
| **Webhook equivalent** | [`event_properties_updated`](../agent-chat-web-api/#event-properties-updated) |
...
| **Webhook equivalent** | [`event_properties_deleted`](../agent-chat-web-api/#event-properties-deleted) |
...
| **Webhook equivalent** | [`chat_thread_tagged`](../agent-chat-web-api/#chat-thread-tagged) |
...
| **Webhook equivalent** | [`chat_thread_untagged`](../agent-chat-web-api/#chat-thread-untagged) |
...
| **Webhook equivalent** | [`customer_created`](../agent-chat-web-api/#customer-created) |
...
| **Webhook equivalent** | [`last_seen_timestamp_updated`](../agent-chat-web-api/#last-seen-timestamp-updated) |
