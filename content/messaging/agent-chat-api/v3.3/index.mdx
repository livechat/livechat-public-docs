...
import aa_custom_v3_3 from "../../../../payloads/messaging/v3.3/agent-chat-api/events/aa_custom_v3_3.json"
import aa_file_v3_3 from "../../../../payloads/messaging/v3.3/agent-chat-api/events/aa_file_v3_3.json"
import aa_filledForm_v3_3 from "../../../../payloads/messaging/v3.3/agent-chat-api/events/aa_filledForm_v3_3.json"
import aa_message_v3_3 from "../../../../payloads/messaging/v3.3/agent-chat-api/events/aa_message_v3_3.json"
import aa_richMessage_v3_3 from "../../../../payloads/messaging/v3.3/agent-chat-api/events/aa_richMessage_v3_3.json"
import aa_systemMessage_v3_3 from "../../../../payloads/messaging/v3.3/agent-chat-api/events/aa_systemMessage_v3_3.json"

import aa_agent_v3_3 from "../../../../payloads/messaging/v3.3/agent-chat-api/users/aa_agent_v3_3.json"
import aa_myProfile_v3_3 from "../../../../payloads/messaging/v3.3/agent-chat-api/users/aa_myProfile_v3_3.json"
import aa_customer_v3_3 from "../../../../payloads/messaging/v3.3/agent-chat-api/users/aa_customer_v3_3.json"

import aa_access_v3_3 from "../../../../payloads/messaging/v3.3/agent-chat-api/other-structures/aa_access_v3_3.json"
import aa_chat_v3_3 from "../../../../payloads/messaging/v3.3/agent-chat-api/other-structures/aa_chat_v3_3.json"
import aa_chatSummary_v3_3 from "../../../../payloads/messaging/v3.3/agent-chat-api/other-structures/aa_chatSummary_v3_3.json"
import aa_formFields_v3_3 from "../../../../payloads/messaging/v3.3/agent-chat-api/other-structures/aa_formFields_v3_3.json"
import aa_properties_v3_3 from "../../../../payloads/messaging/v3.3/agent-chat-api/other-structures/aa_properties_v3_3.json"
import aa_thread_v3_3 from "../../../../payloads/messaging/v3.3/agent-chat-api/other-structures/aa_thread_v3_3.json"
...
<Code>
<CodeResponse title={'Sample File in response'} json={aa_file_v3_3}/>
</Code>
</Section>
...
<Code>
<CodeResponse title={'Sample Filled form in response'} json={aa_filledForm_v3_3}/>
</Code>
</Section>
...
<Code>
<CodeResponse title={'Sample Message in response'} json={aa_message_v3_3}/>
</Code>
</Section>
...
<Code>
<CodeResponse title={'Sample Rich message in response'} json={aa_richMessage_v3_3}/>
</Code>
</Section>
...
<Code>
<CodeResponse title={'Sample Custom event in response'} json={aa_custom_v3_3}/>
</Code>
</Section>
...
<Code>
<CodeResponse title={'Sample System message in response'} json={aa_systemMessage_v3_3}/>
</Code>
</Section>
...
<CodeResponse title={'Sample Agent data structure'} json={aa_agent_v3_3}/>
...
<CodeResponse title={'Sample My profile data structure'} json={aa_myProfile_v3_3}/>

## Customer

<CodeResponse title={'Sample Customer data structure'} json={aa_customer_v3_3}/>
...
<CodeResponse title={'Sample Access data structure'} json={aa_access_v3_3}/>
...
<CodeResponse title={'Sample Chat data structure'} json={aa_chat_v3_3}/>
...
<CodeResponse title={'Sample Chat summary data structure'} json={aa_chatSummary_v3_3}/>

## Form fields

A component of the [Filled form](#filled-form) event.

<CodeResponse title={'Sample Form fields'} json={aa_formFields_v3_3}/>
...
<CodeResponse title={'Sample Properties data structure'} json={aa_properties_v3_3}/>

## Threads

<CodeResponse title={'Sample Thread data structure'} json={aa_thread_v3_3}/>
...
|                        |                                                                        |
| ---------------------- | ---------------------------------------------------------------------- |
| **Method URL**         | `https://api.livechatinc.com/v3.3/agent/action/set_chat_access`        |
| **Required scopes**    | `chats--all:rw` `chats--access:rw` `chats--my:rw`                      |
| **RTM API equivalent** | [`set_chat_access`](rtm-reference/#set-chat-access)                    |
| **Webhook**            | [`chat_access_set`](/management/configuration-api/v3.3/#chat_access_set)    |
...
```shell
curl -X POST \
https://api.livechatinc.com/v3.3/agent/action/set_chat_access \
-H 'Authorization: Bearer <your_access_token>' \
-H 'Content-Type: application/json' \
-d '{
   "id": "PW94SJTGW6",
...
-H 'Content-Type: application/json' \
-d '{
   "id": "3cd19fff-f852-4402-59ce-ebd03af3f15a",
   "ban": {
     "days": 3
     }
   }'
