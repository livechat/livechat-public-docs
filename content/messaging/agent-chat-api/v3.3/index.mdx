...
The **Form** event contains data from a form (sent during agent inactivity for example).
...
| `created_at` | always     | Date & time format with a resolution of microseconds, `UTC string`. |
| `type`       | always     |                                                                     |
| `author_id`  | optionally | If its generated by system then, it's omitted.                      |
| `properties` | optionally |                                                                     |
| `form_id`    | always     |                                                                     |
...
<Code>
<CodeResponse version="v3.3" type="agent" title={'Sample Form in response'} json="filledForm"/>
</Code>
</Section>
