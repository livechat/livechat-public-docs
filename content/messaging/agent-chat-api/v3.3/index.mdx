...
| `attach_to_last_thread` | No       | `bool`    | The flag is ignored for active chats. For inactive chats: true – the event will added to the last thread; false – the request will fail. Default: false. |
