...
### Added
- There's a new method **Get Active Chat Count** ([Web](/messaging/agent-chat-api/v3.2/#get-active-chat-count) & [RTM API](/messaging/agent-chat-api/v3.2/rtm-reference/#get-active-chat-count)).
