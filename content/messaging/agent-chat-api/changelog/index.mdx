...
### Added
- There's a new method **Get Agents For Transfer** ([Web](/messaging/agent-chat-api/v3.2/#get-agents-for-transfer) & [RTM API](/messaging/agent-chat-api/v3.2/rtm-reference/#get-agents-for-transfer)).
