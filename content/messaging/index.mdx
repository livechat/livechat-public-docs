...
- **developer preview (dev preview)**
  ...
  An unstable version that provides a preview of the upcoming features. **It's not open to public use.** However, if you want to test some features, contact us at developers@livechat.com or start a chat, and we'll give you access.
