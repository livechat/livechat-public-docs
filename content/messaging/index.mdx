...
Bots are authorized with the use of the Agent's token. Using Bots requires sending the `X-Author-Id` header for web API, and `author_id` property for websocket connection.
