...
- **developer preview (dev preview)**
  ...
  An unstable version that provides a preview of the upcoming features. **It's not open to public use.** In case you need to test some features, contact us at developers@livechat.com or start a chat. We'll consider each request for access to the dev preview version individually.
