...
If you're looking for the previous versions of REST API, please refer to [**Configuration API V2**](/management/configuration-apiv2).
...
In the near future, it will allow for groups configuration. For now, refer to [**Configuration API v2**](https://developers.livechatinc.com/docs/rest-api/) to manage groups properties.
