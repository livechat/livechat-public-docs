...
<video width="750" height="500" style="height: auto;" controls>
...
LiveChat Messaging API doesn't follow <a href="hhttps://semver.org/" target="_blank">semantic versioning</a>. We suggest you learn our system and terminology:

- **stable**
  
  The latest stable version we encourage developers to use. We don't introduce any new functionalities or breaking changes - only bug fixes are allowed.
